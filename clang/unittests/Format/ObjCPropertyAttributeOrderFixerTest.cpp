...
TEST_F(ObjCPropertyAttributeOrderFixerTest, SortsInPPDirective) {
  ...
  verifyFormat("#define MACRO @property() int p;",
               "#define MACRO @property() int p;", Style);
  verifyFormat("#define MACRO @property(a) int p;",
               "#define MACRO @property(a, a) int p;", Style);
