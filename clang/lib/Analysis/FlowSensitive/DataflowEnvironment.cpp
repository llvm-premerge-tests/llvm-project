...
/// `exprLocsEquivalent()`.
/// FIXME: Ignoring certain classes of expressions is a temporary fix to aid
/// convergence. As discussed in https://reviews.llvm.org/D156658, the real fix
/// is to add widening for `PointerValue`s.
