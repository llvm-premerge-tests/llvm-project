...
Sema::ActOnOpenMPSimdDirective(ArrayRef<OMPClause *> Clauses, Stmt *AStmt,
  ...
  SimdDirective->setMappedDirective(DSAStack->getMappedDirective());
...
Sema::ActOnOpenMPForDirective(ArrayRef<OMPClause *> Clauses, Stmt *AStmt,
  ...
  ForDirective->setMappedDirective(DSAStack->getMappedDirective());
  return ForDirective;
}
...
StmtResult Sema::ActOnOpenMPDistributeDirective(
  ...
  auto *DistributeDirective = OMPDistributeDirective::Create(
      Context, StartLoc, EndLoc, NestedLoopCount, Clauses, AStmt, B);
  DistributeDirective->setMappedDirective(DSAStack->getMappedDirective());
