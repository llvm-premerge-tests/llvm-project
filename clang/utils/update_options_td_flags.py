...
def translate_flags(flags):
    ...
    flag_to_vis = {
        'CoreOption': ['Default', 'CLOption', 'DXCOption'],
        'CLOption': ['CLOption'],
        'CC1Option': ['Default', 'CC1Option'],
        'CC1AsOption': ['Default', 'CC1AsOption'],
        'FlangOption': ['Default', 'FlangOption'],
        'FC1Option': ['Default', 'FC1Option'],
        'DXCOption': ['DXCOption'],
    ...
    for vis in vis_mods:
        if vis in new_vis_mods:
            continue
        if has_no_driver and vis == 'Default':
            continue
        if has_flang_only and vis == 'Default':
            continue
        new_vis_mods += [vis]
