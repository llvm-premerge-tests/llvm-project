...
void eq(vint8m8_t i8, vint16m4_t i16, vint32m2_t i32, vint64m1_t i64,
        vuint8m8_t u8, vuint16m4_t u16, vuint32m2_t u32, vuint64m1_t u64,
        vfloat16m4_t f16, vfloat32m2_t f32, vfloat64m1_t f64,
        vbool1_t b) {
  (void)(i8 == b);   // expected-error{{cannot convert between vector and non-scalar values}}
  ...
  (void)(u8 == b);   // expected-error{{cannot convert between vector and non-scalar values}}
  ...
  (void)(i16 == b);   // expected-error{{cannot convert between vector and non-scalar values}}
  ...
  (void)(u16 == b);   // expected-error{{cannot convert between vector and non-scalar values}}
  ...
  (void)(i32 == b);   // expected-error{{cannot convert between vector and non-scalar values}}
  ...
  (void)(u32 == b);   // expected-error{{cannot convert between vector and non-scalar values}}
  ...
  (void)(i64 == b);   // expected-error{{cannot convert between vector and non-scalar values}}
  ...
  (void)(u64 == b);   // expected-error{{cannot convert between vector and non-scalar values}}
  ...
  (void)(f16 == b);   // expected-error{{cannot convert between vector and non-scalar values}}
  ...
  (void)(f32 == b);   // expected-error{{cannot convert between vector and non-scalar values}}
  ...
  (void)(f64 == b);   // expected-error{{cannot convert between vector and non-scalar values}}
...
void neq(vint8m8_t i8, vint16m4_t i16, vint32m2_t i32, vint64m1_t i64,
         vuint8m8_t u8, vuint16m4_t u16, vuint32m2_t u32, vuint64m1_t u64,
         vfloat16m4_t f16, vfloat32m2_t f32, vfloat64m1_t f64,
         vbool1_t b) {
  (void)(i8 != b);   // expected-error{{cannot convert between vector and non-scalar values}}
...
void lt(vint8m8_t i8, vint16m4_t i16, vint32m2_t i32, vint64m1_t i64,
        vuint8m8_t u8, vuint16m4_t u16, vuint32m2_t u32, vuint64m1_t u64,
        vfloat16m4_t f16, vfloat32m2_t f32, vfloat64m1_t f64,
        vbool1_t b) {
  (void)(i8 < b);   // expected-error{{cannot convert between vector and non-scalar values}}
...
void leq(vint8m8_t i8, vint16m4_t i16, vint32m2_t i32, vint64m1_t i64,
         vuint8m8_t u8, vuint16m4_t u16, vuint32m2_t u32, vuint64m1_t u64,
         vfloat16m4_t f16, vfloat32m2_t f32, vfloat64m1_t f64,
         vbool1_t b) {
  (void)(i8 <= b);   // expected-error{{cannot convert between vector and non-scalar values}}
...
void gt(vint8m8_t i8, vint16m4_t i16, vint32m2_t i32, vint64m1_t i64,
        vuint8m8_t u8, vuint16m4_t u16, vuint32m2_t u32, vuint64m1_t u64,
        vfloat16m4_t f16, vfloat32m2_t f32, vfloat64m1_t f64,
        vbool1_t b) {
  (void)(i8 > b);   // expected-error{{cannot convert between vector and non-scalar values}}
...
void geq(vint8m8_t i8, vint16m4_t i16, vint32m2_t i32, vint64m1_t i64,
         vuint8m8_t u8, vuint16m4_t u16, vuint32m2_t u32, vuint64m1_t u64,
         vfloat16m4_t f16, vfloat32m2_t f32, vfloat64m1_t f64,
         vbool1_t b) {
  (void)(i8 >= b);   // expected-error{{cannot convert between vector and non-scalar values}}
