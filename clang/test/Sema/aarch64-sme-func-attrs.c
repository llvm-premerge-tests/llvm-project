...
// expected-cpp-error@+2 {{virtual function 'shared_za_memberfn' has different attributes ('void () __arm_shared_za __arm_preserves_za') than the function it overrides (which has 'void () __arm_shared_za')}}
// expected-cpp-note@-11 {{overridden virtual function is here}}
  void shared_za_memberfn(void) __arm_shared_za __arm_preserves_za override {}
};
