...
// LINUX: @__cpu_features2 = external dso_local global [4 x i32]
...
// LINUX-NEXT:   load i32, ptr getelementptr inbounds ([4 x i32], ptr @__cpu_features2, i32 0, i32 2)
// LINUX-NEXT:   and i32 %[[#]], 4
// LINUX:        ret ptr @isa_level.arch_x86-64-v4.3
// LINUX:        load i32, ptr getelementptr inbounds ([4 x i32], ptr @__cpu_features2, i32 0, i32 2)
// LINUX-NEXT:   and i32 %[[#]], 2
// LINUX:        ret ptr @isa_level.arch_x86-64-v3.2
// LINUX:        load i32, ptr getelementptr inbounds ([4 x i32], ptr @__cpu_features2, i32 0, i32 2)
// LINUX-NEXT:   and i32 %[[#]], 1
// LINUX:        ret ptr @isa_level.arch_x86-64-v2.1
// LINUX:        load i32, ptr getelementptr inbounds ([4 x i32], ptr @__cpu_features2, i32 0, i32 1)
