...
// CHECK-NEXT:    tail call void @__ubsan_handle_out_of_bounds(ptr nonnull @[[GLOB2:[0-9]+]], i64 [[TMP4]]) #[[ATTR4:[0-9]+]], !nosanitize !9
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[COUNT:%.*]] = getelementptr inbounds [[STRUCT_ANNOTATED:%.*]], ptr [[P]], i64 0, i32 1
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[COUNT]], align 8, !tbaa [[TBAA5]]
// CHECK-NEXT:    [[TMP1:%.*]] = shl i32 [[TMP0]], 2
// CHECK-NEXT:    [[TMP2:%.*]] = zext i32 [[TMP1]] to i64
// CHECK-NEXT:    tail call void @func(i64 noundef [[TMP2]]) #[[ATTR4]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = load volatile i32, ptr @vcount, align 4, !tbaa [[TBAA5]]
...
// CHECK-NEXT:    [[TMP1:%.*]] = load volatile i32, ptr @vcount, align 4, !tbaa [[TBAA5]]
// CHECK-NEXT:    [[TMP2:%.*]] = icmp ult i64 [[ADD1]], 8
// CHECK-NEXT:    [[TMP3:%.*]] = icmp eq i32 [[ADD]], -2
// CHECK-NEXT:    [[TMP4:%.*]] = or i1 [[TMP2]], [[TMP3]]
// CHECK-NEXT:    br i1 [[TMP4]], label [[TRAP:%.*]], label [[TMP5:%.*]]
// CHECK:       5:
// CHECK-NEXT:    tail call void @func(i64 noundef [[ADD1]]) #[[ATTR4]]
// CHECK-NEXT:    ret void
// CHECK:       trap:
// CHECK-NEXT:    tail call void @llvm.trap() #[[ATTR5:[0-9]+]]
