...
__builtin_fmaximum(f,f);       __builtin_fmaximumf(f,f);      __builtin_fmaximuml(f,f); __builtin_fmaximumf128(f,f);
__builtin_fmaximumf16(f,f);   __builtin_fmaximumbf16(f,f);
...
__builtin_fminimum(f,f);       __builtin_fminimumf(f,f);      __builtin_fminimuml(f,f); __builtin_fminimumf128(f,f);
__builtin_fminimumf16(f,f);    __builtin_fminimumbf16(f,f);
