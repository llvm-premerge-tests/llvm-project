...
//
// CHECK-GNU-LABEL: define dso_local [2 x i32] @foo1
// CHECK-GNU-SAME: ([2 x i32] noundef [[X_COERCE:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-GNU-NEXT:  entry:
// CHECK-GNU-NEXT:    [[RETVAL:%.*]] = alloca { float, float }, align 4
// CHECK-GNU-NEXT:    [[X:%.*]] = alloca { float, float }, align 4
// CHECK-GNU-NEXT:    store [2 x i32] [[X_COERCE]], ptr [[X]], align 4
...
// CHECK-GNU-NEXT:    [[TMP0:%.*]] = load [2 x i32], ptr [[RETVAL]], align 4
// CHECK-GNU-NEXT:    ret [2 x i32] [[TMP0]]
//
...
// CHECK-DEF-NEXT:    ret void
//
// CHECK-GNU-LABEL: define dso_local [2 x i64] @foo2
// CHECK-GNU-SAME: ([2 x i64] noundef [[X_COERCE:%.*]]) #[[ATTR0]] {
// CHECK-GNU-NEXT:  entry:
// CHECK-GNU-NEXT:    [[RETVAL:%.*]] = alloca { double, double }, align 8
// CHECK-GNU-NEXT:    [[X:%.*]] = alloca { double, double }, align 8
// CHECK-GNU-NEXT:    store [2 x i64] [[X_COERCE]], ptr [[X]], align 8
...
// CHECK-GNU-NEXT:    [[TMP0:%.*]] = load [2 x i64], ptr [[RETVAL]], align 8
// CHECK-GNU-NEXT:    ret [2 x i64] [[TMP0]]
//
...
// CHECK-DEF-NEXT:    ret void
//
// CHECK-GNU-LABEL: define dso_local [4 x i64] @foo3
// CHECK-GNU-SAME: ([4 x i64] noundef [[X_COERCE:%.*]]) #[[ATTR0]] {
// CHECK-GNU-NEXT:  entry:
// CHECK-GNU-NEXT:    [[RETVAL:%.*]] = alloca { ppc_fp128, ppc_fp128 }, align 16
// CHECK-GNU-NEXT:    [[X:%.*]] = alloca { ppc_fp128, ppc_fp128 }, align 16
// CHECK-GNU-NEXT:    store [4 x i64] [[X_COERCE]], ptr [[X]], align 16
...
// CHECK-GNU-NEXT:    [[TMP0:%.*]] = load [4 x i64], ptr [[RETVAL]], align 16
// CHECK-GNU-NEXT:    ret [4 x i64] [[TMP0]]
//
