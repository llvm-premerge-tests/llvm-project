...
// CHECK-LABEL: Record: RecordDecl {{.*}} struct STest1 definition
// CHECK: Layout: <CGRecordLayout
// CHECK-NEXT: LLVMType:%struct.STest1 = type { i32, [4 x i16], double }
// CHECK: BitFields:[
// CHECK-NEXT: ]>

// CHECK-LABEL: Record: RecordDecl {{.*}} struct STest2 definition
// CHECK: Layout: <CGRecordLayout
// CHECK-NEXT: LLVMType:%struct.STest2 = type { i16, i16, i32, i32 }
// CHECK: BitFields:[
// CHECK-NEXT: ]>

// CHECK-LABEL: Record: RecordDecl {{.*}} struct STest3 definition
// CHECK: Layout: <CGRecordLayout
// CHECK-NEXT: LLVMType:%struct.STest3 = type { i8, i16, i32 }
// CHECK: BitFields:[
// CHECK-NEXT: ]>

// CHECK-LABEL: Record: RecordDecl {{.*}} struct STestB1 definition
// CHECK: Layout: <CGRecordLayout
// CHECK-NEXT: LLVMType:%struct.STestB1 = type { i8, i8 }
// CHECK: BitFields:[
// CHECK-NEXT: <CGBitFieldInfo Offset:0 Size:2 IsSigned:1 StorageSize:8 StorageOffset:1
// CHECK-NEXT: ]>

// CHECK-LABEL: Record: RecordDecl {{.*}} struct STestB2 definition
// CHECK: Layout: <CGRecordLayout
// CHECK-NEXT: LLVMType:%struct.STestB2 = type { i8, i8, i8 }
// CHECK: BitFields:[
...
// CHECK-LABEL: Record: RecordDecl {{.*}} struct STestB3 definition
// CHECK: Layout: <CGRecordLayout
// CHECK-NEXT: LLVMType:%struct.STestB3 = type { i8, i8 }
// CHECK: BitFields:[
// CHECK-NEXT: <CGBitFieldInfo Offset:0 Size:2 IsSigned:1 StorageSize:8 StorageOffset:1
// CHECK-NEXT: ]>

// CHECK-LABEL: Record: RecordDecl {{.*}} struct STestB4 definition
// CHECK: Layout: <CGRecordLayout
// CHECK-NEXT: LLVMType:%struct.STestB4 = type { i8, i8, i8, i8 }
// CHECK: BitFields:[
// CHECK-NEXT: <CGBitFieldInfo Offset:0 Size:2 IsSigned:1 StorageSize:8 StorageOffset:1
// CHECK-NEXT: ]>

// CHECK-LABEL: Record: RecordDecl {{.*}} struct STestB5 definition
// CHECK: Layout: <CGRecordLayout
// CHECK-NEXT: LLVMType:%struct.STestB5 = type { i8, i16, i8 }
// CHECK: BitFields:[
// CHECK-NEXT: <CGBitFieldInfo Offset:0 Size:10 IsSigned:1 StorageSize:16 StorageOffset:2
// CHECK-NEXT: ]>

// CHECK-LABEL: Record: RecordDecl {{.*}} struct STestB6 definition
// CHECK: Layout: <CGRecordLayout
// CHECK-NEXT: LLVMType:%struct.STestB6 = type { i8, i8, i16 }
// CHECK: BitFields:[
