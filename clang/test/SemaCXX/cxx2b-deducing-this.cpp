...
auto l3 = [](this auto...){}; // expected-error {{an explicit object parameter cannot be a function parameter pack}}
...
struct S {
    ...
    void i(this auto) &&; // expected-error{{a function with an explicit object parameter cannot be reference-qualified}}
    void j(this auto) volatile; // expected-error{{a function with an explicit object parameter cannot have qualifiers}}
    void k(this auto) __restrict; // expected-error{{a function with an explicit object parameter cannot have qualifiers}}
    void l(this auto) _Nonnull; // expected-error{{a function with an explicit object parameter cannot have qualifiers}}
...
struct CannotUseThis {
    ...
    void f(this auto) {
        ...
        fun(); // expected-error {{call to explicit member function without an object argument}}
