...
// expected-warning@-1 0-1{{variable length arrays are a Clang extension}} expected-warning@-1 {{folded to constant array as an extension}}
...
int arr[nonconst];
#if __cplusplus <= 199711L
// expected-warning@-2 0-1{{variable length arrays are a Clang extension}} expected-warning@-2 {{folded to constant array as an extension}}
