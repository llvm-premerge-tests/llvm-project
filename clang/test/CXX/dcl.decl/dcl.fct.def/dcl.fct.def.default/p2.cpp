...
struct S1 {
  constexpr S1() = default; // expected-error {{default constructor cannot be 'constexpr' in a class or struct with virtual base classes}}
...
struct S2 {
  ...
  constexpr S2(const S2&) = default; // expected-error {{copy constructor cannot be 'constexpr' in a class or struct with virtual base classes}}
  constexpr S2(S2&&) = default; // expected-error {{move constructor cannot be 'constexpr' in a class or struct with virtual base classes}}
  NoCopyMove ncm;
};
