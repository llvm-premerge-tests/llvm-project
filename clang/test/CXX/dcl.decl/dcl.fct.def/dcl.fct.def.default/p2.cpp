...
struct S1 {
  constexpr S1() = default; // expected-error {{default constructor cannot be 'constexpr' in a class or struct with virtual base classes}} expected-note {{see reference to function 'S1' in 'S1' class or struct}}
...
struct S2 {
  ...
  constexpr S2(const S2&) = default; // expected-error {{copy constructor cannot be 'constexpr' in a class or struct with virtual base classes}} expected-note {{see reference to function 'S2' in 'S2' class or struct}}
  constexpr S2(S2&&) = default; // expected-error {{move constructor cannot be 'constexpr' in a class or struct with virtual base classes}} expected-note {{see reference to function 'S2' in 'S2' class or struct}}
  NoCopyMove ncm;
};
