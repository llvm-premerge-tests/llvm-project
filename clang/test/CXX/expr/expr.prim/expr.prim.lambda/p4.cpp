...
void test_result_type(int N) {  // expected-note {{declared here}}
  ...
  typedef int vla[N]; // expected-warning {{variable length arrays are a Clang extension}} \
...
void test_result_type_tpl(int N) { // expected-note 2{{declared here}}
  ...
  typedef int vla[N]; // expected-warning 2{{variable length arrays are a Clang extension}} \
