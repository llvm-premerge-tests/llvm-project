...
// CHECK1-NEXT:    store ptr [[ARGV]], ptr [[ARGV_ADDR]], align 8
// CHECK1-NEXT:    [[TMP0:%.*]] = load i32, ptr [[ARGC_ADDR]], align 4, !freeze_bits [[FREEZE_BITS3]]
// CHECK1-NEXT:    store i32 [[TMP0]], ptr [[ARGC_CASTED]], align 4
// CHECK1-NEXT:    [[TMP1:%.*]] = load i64, ptr [[ARGC_CASTED]], align 8, !freeze_bits [[FREEZE_BITS3]]
// CHECK1-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[ARGV_ADDR]], align 8, !freeze_bits [[FREEZE_BITS3]]
...
// CHECK1-NEXT:    [[TMP2:%.*]] = load i64, ptr [[DOTOMP_COMB_UB]], align 8, !freeze_bits [[FREEZE_BITS3]]
// CHECK1-NEXT:    [[CMP:%.*]] = icmp sgt i64 [[TMP2]], 9
// CHECK1-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK1:       cond.true:
// CHECK1-NEXT:    br label [[COND_END:%.*]]
// CHECK1:       cond.false:
// CHECK1-NEXT:    [[TMP3:%.*]] = load i64, ptr [[DOTOMP_COMB_UB]], align 8, !freeze_bits [[FREEZE_BITS3]]
// CHECK1-NEXT:    br label [[COND_END]]
// CHECK1:       cond.end:
// CHECK1-NEXT:    [[COND:%.*]] = phi i64 [ 9, [[COND_TRUE]] ], [ [[TMP3]], [[COND_FALSE]] ]
// CHECK1-NEXT:    store i64 [[COND]], ptr [[DOTOMP_COMB_UB]], align 8
// CHECK1-NEXT:    [[TMP4:%.*]] = load i64, ptr [[DOTOMP_COMB_LB]], align 8, !freeze_bits [[FREEZE_BITS3]]
// CHECK1-NEXT:    store i64 [[TMP4]], ptr [[DOTOMP_IV]], align 8
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK1:       omp.inner.for.cond:
// CHECK1-NEXT:    [[TMP5:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !freeze_bits [[FREEZE_BITS3]]
// CHECK1-NEXT:    [[TMP6:%.*]] = load i64, ptr [[DOTOMP_COMB_UB]], align 8, !freeze_bits [[FREEZE_BITS3]]
// CHECK1-NEXT:    [[CMP1:%.*]] = icmp sle i64 [[TMP5]], [[TMP6]]
// CHECK1-NEXT:    br i1 [[CMP1]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK1:       omp.inner.for.body:
// CHECK1-NEXT:    [[TMP7:%.*]] = load i64, ptr [[DOTOMP_COMB_LB]], align 8, !freeze_bits [[FREEZE_BITS3]]
// CHECK1-NEXT:    [[TMP8:%.*]] = load i64, ptr [[DOTOMP_COMB_UB]], align 8, !freeze_bits [[FREEZE_BITS3]]
// CHECK1-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[ARGV_ADDR]], align 8, !freeze_bits [[FREEZE_BITS3]]
...
// CHECK1-NEXT:    [[TMP10:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !freeze_bits [[FREEZE_BITS3]]
// CHECK1-NEXT:    [[TMP11:%.*]] = load i64, ptr [[DOTOMP_STRIDE]], align 8, !freeze_bits [[FREEZE_BITS3]]
