...
class TemplateClass {
  T a;
public:
  TemplateClass() { throw 1;} // expected-warning {{target 'nvptx64-unknown-unknown' does not support exception handling; 'throw' is assumed to be never reached}}
...
int baz2() {
#pragma omp target // expected-warning@+1 {{target 'nvptx64-unknown-unknown' does not support exception handling; 'catch' block is ignored}}
