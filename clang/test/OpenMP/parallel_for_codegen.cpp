...
// RUN: %clang_cc1 -fopenmp -fopenmp-version=45 -x c++ -triple x86_64-unknown-unknown -fexceptions -fcxx-exceptions -std=c++11 -include-pch %t -verify %s -emit-llvm -o - | FileCheck %s --check-prefix=CHECK2
...
// RUN: %clang_cc1 -fopenmp -DOMP5 -x c++ -triple x86_64-unknown-unknown -fexceptions -fcxx-exceptions -std=c++11 -include-pch %t -verify %s -emit-llvm -o - | FileCheck %s --check-prefix=CHECK11
...
// CHECK1-NEXT:    [[ADD:%.*]] = add i32 131071, [[MUL]]
// CHECK1-NEXT:    store i32 [[ADD]], ptr [[I]], align 4
// CHECK1-NEXT:    [[CALL:%.*]] = call unwindabort noundef i32 @_Z3foov()
...
// CHECK1-NEXT:    call void @llvm.stackrestore(ptr [[TMP24]])
// CHECK1-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    [[ADD:%.*]] = add i32 131071, [[MUL]]
// CHECK2-NEXT:    store i32 [[ADD]], ptr [[I]], align 4
// CHECK2-NEXT:    [[CALL:%.*]] = call unwindabort noundef i32 @_Z3foov()
...
// CHECK2-NEXT:    call void @llvm.stackrestore(ptr [[TMP24]])
// CHECK2-NEXT:    ret void
//
//
...
// CHECK5-NEXT:    [[TMP2:%.*]] = call ptr @llvm.stacksave(), !dbg [[DBG105]]
...
// CHECK5-NEXT:    [[TMP2:%.*]] = call ptr @llvm.stacksave(), !dbg [[DBG109]]
...
// CHECK5-NEXT:    [[CALL:%.*]] = call unwindabort noundef i32 @_Z3foov(), !dbg [[DBG111:![0-9]+]]
...
// CHECK5-NEXT:    call void @llvm.stackrestore(ptr [[TMP24]]), !dbg [[DBG109]]
...
// CHECK6-NEXT:    [[TMP2:%.*]] = call ptr @llvm.stacksave()
...
// CHECK6-NEXT:    call void @llvm.stackrestore(ptr [[TMP24]])
// CHECK6-NEXT:    ret void
//
//
