...
// CHECK-SAME: (i32 noundef [[ARGC:%.*]], ptr noundef [[ARGV:%.*]]) #[[ATTR4:[0-9]+]] {
// CHECK:         call void {{.+}}parallel_taskgroup_loopv{{.*}}()
// CHECK-NEXT:    call void {{.+}}parallel_taskwait_loopv{{.*}}()
// CHECK-NEXT:    call void {{.+}}parallel_single_loopv{{.*}}()
// CHECK-NEXT:    call void {{.+}}parallel_order_loopv{{.*}}()
// CHECK-NEXT:    call void {{.+}}parallel_cancel_loopb{{.*}}(i1 noundef zeroext true)
// CHECK-NEXT:    call void {{.+}}parallel_cancel_loopb{{.*}}(i1 noundef zeroext false)
//
