...
wchar_t wc5;
void *v5 = NULL;
nullptr_t n5; // c99-error{{unknown}} c23-error{{unknown}}
...
static void f6(void) { unreachable(); } // c99-error{{undeclared}} c23-error{{undeclared}}
...
max_align_t m7; // c99-error{{unknown}} c23-error{{unknown}}
...
max_align_t m8;
size_t o8 = offsetof(struct astruct, member); // c99-error{{undeclared}} c99-error{{expected expression}} \
                                                 c23-error{{undeclared}} c23-error{{expected expression}} c23-error{{undeclared}}
...
wint_t wi9; // c99-error{{unknown}} c23-error{{unknown}}
...
wchar_t wc10;
void *v10 = NULL;
nullptr_t n10; // c99-error{{unknown}}
