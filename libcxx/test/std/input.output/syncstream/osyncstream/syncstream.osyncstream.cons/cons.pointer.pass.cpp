...
void test() {
  {
    ...
    static_assert(!std::convertible_to<OS, std::basic_syncbuf<CharT>*>);
...

  {
    ...
    static_assert(!std::convertible_to<OS, std::basic_syncbuf<CharT, constexpr_char_traits<CharT>>*>);
...

  {
    ...
    static_assert(
        !std::convertible_to<OS, std::basic_syncbuf<CharT, constexpr_char_traits<CharT>, test_allocator<CharT>>*>);
    static_assert(
