...
constexpr bool tests() {
  ...
  test_default_constructible<forward_iterator<int*>, false>();       /* noexcept */
  test_default_constructible<bidirectional_iterator<int*>, false>(); /* noexcept */
  test_default_constructible<random_access_iterator<int*>, false>(); /* noexcept */
  test_default_constructible<contiguous_iterator<int*>, false>();    /* noexcept */
  test_default_constructible<int*, true>();
