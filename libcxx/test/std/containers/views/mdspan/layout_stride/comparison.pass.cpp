...
concept layout_mapping_comparable =
  requires(E1 e1, E2 e2, std::array<typename E1::index_type, E1::rank()> s1,
...
constexpr void test_comparison_same_rank() {
  ...
  test_comparison(true, std::extents<T1, D>(0), std::extents<T2, D>(0),
                        std::array<int, 1>{1}, std::array<int, 1>{1});
