...
public:
  constexpr mapping() noexcept = delete;
  constexpr mapping(const mapping& other) noexcept : extents_(other.extents_), offset_(other.offset_), scaling_(other.scaling_){};
  ...
  constexpr index_type operator()(Indices... idx) const noexcept {
    ...
    return offset_ + scaling_ * ([&]<size_t... Pos>(std::index_sequence<Pos...>) {
      index_type res = 0;
