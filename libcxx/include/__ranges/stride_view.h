...
_LIBCPP_HIDE_FROM_ABI constexpr inline _Value div_ceil(_Value __left, _Value __right) {
...
public:
    ...
    requires sized_sentinel_for<iterator_t<_Base>, iterator_t<_Base>>
  {
    auto __n = __x.__current_ - __y.__current_;
    if (__n < 0) {
      return -ranges::div_ceil(-__n, __x.__stride_);
    }
    return ranges::div_ceil(__n, __x.__stride_);
  }
  ...
  {
    return ranges::div_ceil(__x.__end_ - __x.__current_, __x.__stride_);
  }
