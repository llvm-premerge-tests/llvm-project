...
#  ifndef _LIBCPP_HAS_NO_INT128
template <class _Tp>
inline constexpr bool __can_broadcast_v<_Tp, __int128_t> = __is_non_narrowing_convertible_v<__int128_t, _Tp>;
template <class _Tp>
inline constexpr bool __can_broadcast_v<_Tp, __uint128_t> = __is_non_narrowing_convertible_v<__uint128_t, _Tp>;
#  endif
