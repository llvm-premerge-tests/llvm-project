...
template <class Container, class GenInputs>
static void BM_Compare_equal_true(benchmark::State& st, Container, GenInputs gen) {
  auto in = gen(st.range(0));
...
template <class Container, class GenInputs>
static void BM_Compare_equal_false(benchmark::State& st, Container, GenInputs gen) {
  auto in1 = gen(st.range(0));
  auto in2 = gen(st.range(0));
  Container c1(in1.begin(), in1.end());
  Container c2 = c1;
  c2.insert(in2.begin(), in2.end());
