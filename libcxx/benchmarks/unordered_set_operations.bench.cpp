...
BENCHMARK_CAPTURE(
    BM_Compare_shared_prefix, unordered_set_string, std::unordered_set<std::string>{}, getRandomStringInputs)
    ->Arg(TestNumInputs);

BENCHMARK_CAPTURE(BM_Compare_shared_prefix, unordered_set_int, std::unordered_set<int>{}, getRandomIntegerInputs<int>)
    ->Arg(TestNumInputs);
