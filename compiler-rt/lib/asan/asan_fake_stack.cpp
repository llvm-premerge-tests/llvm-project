...
// makecontext. It should be possible to make GC to discard wrong stack frame.
// For now, lets support only simplest case and GC only allowed to discard
// frames from the default stack, assuming there is no buffer on the stack which
// is used for makecontext or sigaltstack.
//
