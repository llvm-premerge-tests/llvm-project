...
private:
  void yieldProcessor() {
    // The value comes from the minimum time spent among operations that guarded
    // by mutex.
    constexpr u32 SpinTimes = 256;
    volatile u32 V = 0;
  ...
  // secondary allocator have different allocation time.
