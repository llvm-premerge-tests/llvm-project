...
public:
  ...
  virtual std::vector<InstructionOperand> getApplyDefsNeeded() const = 0;
...
public:
  ...
  std::vector<InstructionOperand> getApplyDefsNeeded() const override;
...
std::vector<InstructionOperand> PatFragPattern::getApplyDefsNeeded() const {
