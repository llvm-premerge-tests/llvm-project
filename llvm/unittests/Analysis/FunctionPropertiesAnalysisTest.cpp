...
define internal i32 @top() {
  ...
  EXPECT_EQ(DetailedBranchesFeatures.ConstantOperandCount, 1);
...
br1:
  ...
  EXPECT_EQ(DetailedF1Properties.ConstantOperandCount, 3);
...
define i64 @f1(i64 %e) {
  ...
  EXPECT_EQ(DetailedF1Properties.IntegerConstantCount, 1);
  EXPECT_EQ(DetailedF1Properties.FloatingPointConstantCount, 0);
  EXPECT_EQ(DetailedF1Properties.ConstantOperandCount, 1);
