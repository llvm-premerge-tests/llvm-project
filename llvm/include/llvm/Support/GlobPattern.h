...
///   supported.
/// * \p "{<term>,...}" matches one of the terms in the list. Nested brace
...
private:
  ...
  struct SubGlobPattern {
    ...
    /// \param Original the original pattern which may include brace expansions
    static Expected<SubGlobPattern> create(StringRef Pat, StringRef Original);
    /// \returns \p true if \p S matches this glob pattern
    bool match(StringRef S) const;
