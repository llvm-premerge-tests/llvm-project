...
namespace llvm {
  ...
  /// real code) appear as the result of optimization passes removing instructions.
  /// These blocks confuscate profile analysis (e.g., basic block sections) since they will share the address of their fallthrough blocks.
