...
// Ideas:
// ------
// With a function specialization attribute for arguments, we could have a
// direct way to steer function specialization, avoiding the cost-model, and
// thus control compile-times / code-size.
//
// References:
// -----------
