...
enum class RelocationKind : uint8_t { DebugInfo, DebugAddr };

/// DwarfLinkerForBinaryRelocationMap contains the logic to handle the relocations
/// and to store them inside an associated RelocationMap.
...
public:
  ...
  void updateAndSaveValidRelocs(RelocationKind kind,
...
private:
  ...
  public:
    ...
    void updateAndSaveValidRelocs(uint64_t OriginalUnitOffset,
