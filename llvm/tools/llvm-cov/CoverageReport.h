...
protected:
  ...
  using SubFileReports = StringMap<FileCoverageSummary>;
  using SubDirReports =
      StringMap<std::pair<FileCoverageSummary, SmallVector<StringRef, 0>>>;
  ...
  /// directories. FileCoverageSummary::Name will be set to the relative path
  /// of current LCP. For trivial directories, the name will be set to the
