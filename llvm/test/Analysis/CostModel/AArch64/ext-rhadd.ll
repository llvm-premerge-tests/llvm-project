...
define void @urhadd_i8_sext_i64(ptr %a, ptr %b, ptr %dst) {
; SVE-LABEL: 'urhadd_i8_sext_i64'
...
define void @urhadd_i16_sext_i32(ptr %a, ptr %b, ptr %dst) {
