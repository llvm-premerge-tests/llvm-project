...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 102 for instruction: %4 = call <8 x float> @llvm.sin.v8f32(<8 x float> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 236 for instruction: %5 = call <16 x float> @llvm.sin.v16f32(<16 x float> undef)
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 50 for instruction: %13 = call <4 x double> @llvm.sin.v4f64(<4 x double> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 116 for instruction: %14 = call <8 x double> @llvm.sin.v8f64(<8 x double> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 296 for instruction: %15 = call <16 x double> @llvm.sin.v16f64(<16 x double> undef)
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 102 for instruction: %4 = call <8 x float> @llvm.cos.v8f32(<8 x float> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 236 for instruction: %5 = call <16 x float> @llvm.cos.v16f32(<16 x float> undef)
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 50 for instruction: %13 = call <4 x double> @llvm.cos.v4f64(<4 x double> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 116 for instruction: %14 = call <8 x double> @llvm.cos.v8f64(<8 x double> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 296 for instruction: %15 = call <16 x double> @llvm.cos.v16f64(<16 x double> undef)
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 102 for instruction: %4 = call <8 x float> @llvm.exp.v8f32(<8 x float> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 236 for instruction: %5 = call <16 x float> @llvm.exp.v16f32(<16 x float> undef)
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 50 for instruction: %13 = call <4 x double> @llvm.exp.v4f64(<4 x double> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 116 for instruction: %14 = call <8 x double> @llvm.exp.v8f64(<8 x double> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 296 for instruction: %15 = call <16 x double> @llvm.exp.v16f64(<16 x double> undef)
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 102 for instruction: %4 = call <8 x float> @llvm.exp2.v8f32(<8 x float> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 236 for instruction: %5 = call <16 x float> @llvm.exp2.v16f32(<16 x float> undef)
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 50 for instruction: %13 = call <4 x double> @llvm.exp2.v4f64(<4 x double> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 116 for instruction: %14 = call <8 x double> @llvm.exp2.v8f64(<8 x double> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 296 for instruction: %15 = call <16 x double> @llvm.exp2.v16f64(<16 x double> undef)
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 102 for instruction: %4 = call <8 x float> @llvm.log.v8f32(<8 x float> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 236 for instruction: %5 = call <16 x float> @llvm.log.v16f32(<16 x float> undef)
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 50 for instruction: %13 = call <4 x double> @llvm.log.v4f64(<4 x double> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 116 for instruction: %14 = call <8 x double> @llvm.log.v8f64(<8 x double> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 296 for instruction: %15 = call <16 x double> @llvm.log.v16f64(<16 x double> undef)
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 102 for instruction: %4 = call <8 x float> @llvm.log10.v8f32(<8 x float> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 236 for instruction: %5 = call <16 x float> @llvm.log10.v16f32(<16 x float> undef)
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 50 for instruction: %13 = call <4 x double> @llvm.log10.v4f64(<4 x double> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 116 for instruction: %14 = call <8 x double> @llvm.log10.v8f64(<8 x double> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 296 for instruction: %15 = call <16 x double> @llvm.log10.v16f64(<16 x double> undef)
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 102 for instruction: %4 = call <8 x float> @llvm.log2.v8f32(<8 x float> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 236 for instruction: %5 = call <16 x float> @llvm.log2.v16f32(<16 x float> undef)
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 50 for instruction: %13 = call <4 x double> @llvm.log2.v4f64(<4 x double> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 116 for instruction: %14 = call <8 x double> @llvm.log2.v8f64(<8 x double> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 296 for instruction: %15 = call <16 x double> @llvm.log2.v16f64(<16 x double> undef)
