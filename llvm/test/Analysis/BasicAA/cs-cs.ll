...
; CHECK-NEXT: declare void @llvm.memset.p0.i64({{.*}}) [[ATTRSET:#[0-9]+]]
...
; CHECK-NEXT: declare void @llvm.memcpy.p0.p0.i64({{.*}}) [[ATTRCPY:#[0-9]+]]
...
; CHECK-NEXT: declare void @llvm.memcpy.element.unordered.atomic.p0.p0.i64({{.*}})  [[ATTRATOMIC:#[0-9]+]]
...
; CHECK-NEXT: declare void @a_readonly_func(ptr) [[ATTR3:#[0-9]+]]
declare void @a_readonly_func(ptr) #1

; CHECK: Function Attrs: noinline nounwind memory(write)
; CHECK-NEXT: declare void @a_writeonly_func(ptr) [[ATTR4:#[0-9]+]]
declare void @a_writeonly_func(ptr) #2

; CHECK: Function Attrs: nounwind ssp
; CHECK-NEXT: define void @test2(ptr %P, ptr %Q) [[ATTR5:#[0-9]+]]
...
; CHECK: Function Attrs: nounwind ssp
; CHECK-NEXT: define void @test2_atomic(ptr %P, ptr %Q) [[ATTR5]]
...
; CHECK: Function Attrs: nounwind ssp
; CHECK-NEXT: define void @test2a(ptr noalias %P, ptr noalias %Q) [[ATTR5]]
...
; CHECK: Function Attrs: nounwind ssp
; CHECK-NEXT: define void @test2b(ptr noalias %P, ptr noalias %Q) [[ATTR5]]
...
; CHECK: Function Attrs: nounwind ssp
; CHECK-NEXT: define void @test2c(ptr noalias %P, ptr noalias %Q) [[ATTR5]]
...
; CHECK: Function Attrs: nounwind ssp
; CHECK-NEXT: define void @test2d(ptr noalias %P, ptr noalias %Q) [[ATTR5]]
...
; CHECK: Function Attrs: nounwind ssp
; CHECK-NEXT: define void @test2e(ptr noalias %P, ptr noalias %Q) [[ATTR5]]
...
; CHECK: Function Attrs: nounwind ssp
; CHECK-NEXT: define void @test3(ptr %P, ptr %Q) [[ATTR5]]
...
; CHECK: Function Attrs: nounwind ssp
; CHECK-NEXT: define void @test3a(ptr noalias %P, ptr noalias %Q) [[ATTR5]]
...
; CHECK: Function Attrs: nounwind ssp
; CHECK-NEXT: define void @test4(ptr %P, ptr noalias %Q) [[ATTR5]]
...
; CHECK: Function Attrs: nounwind ssp
; CHECK-NEXT: define void @test5(ptr %P, ptr %Q, ptr %R) [[ATTR5]]
...
; CHECK: Function Attrs: nounwind ssp
; CHECK-NEXT: define void @test5a(ptr noalias %P, ptr noalias %Q, ptr noalias %R) [[ATTR5]]
...
; CHECK: Function Attrs: nounwind ssp
; CHECK-NEXT: define void @test6(ptr %P) [[ATTR5]]
...
; CHECK: Function Attrs: nounwind ssp
; CHECK-NEXT: define void @test7(ptr %P) [[ATTR5]]
...
; CHECK-NEXT: declare void @an_inaccessiblememonly_func() [[ATTR6:#[0-9]+]]
...
; CHECK-NEXT: declare void @an_inaccessibleorargmemonly_func(ptr) [[ATTR7:#[0-9]+]]
declare void @an_inaccessibleorargmemonly_func(ptr) #5
; CHECK: Function Attrs: nounwind memory(argmem: readwrite)
; CHECK-NEXT: declare void @an_argmemonly_func(ptr) [[ATTR8:#[0-9]+]]
...
; CHECK: Function Attrs: nounwind memory(argmem: readwrite)
; CHECK-NEXT: declare void @another_argmemonly_func(ptr, ptr) [[ATTR8]]
...
entry:
  ...
  load i8, ptr %p
  load i8, ptr %q
  ; CHECK: call void @a_readonly_func({{.*}}) [[ATTR9:#[0-9]+]]
  call void @a_readonly_func(ptr %p) #6 [ "unknown"() ]
  ; CHECK: call void @an_inaccessiblememonly_func({{.*}}) [[ATTR10:#[0-9]+]]
  call void @an_inaccessiblememonly_func() #7 [ "unknown"() ]
  ; CHECK: call void @an_inaccessibleorargmemonly_func({{.*}}) [[ATTR11:#[0-9]+]]
  call void @an_inaccessibleorargmemonly_func(ptr %q) #8 [ "unknown"() ]
  ; CHECK: call void @an_argmemonly_func({{.*}}) [[ATTR12:#[0-9]+]]
...
; CHECK-DAG: attributes [[ATTRSET]] = { nocallback nofree nounwind willreturn memory(argmem: write) }
; CHECK-DAG: attributes [[ATTRCPY]] = { nocallback nofree nounwind willreturn memory(argmem: readwrite) }
; CHECK-DAG: attributes [[ATTRATOMIC]] = { nosync nounwind willreturn memory(argmem: readwrite) }
; CHECK-DAG: attributes [[ATTR3]] = { noinline nounwind memory(read) }
; CHECK-DAG: attributes [[ATTR4]] = { noinline nounwind memory(write) }
; CHECK-DAG: attributes [[ATTR5]] = { nounwind ssp }
; CHECK-DAG: attributes [[ATTR6]] = { nounwind memory(inaccessiblemem: readwrite) }
; CHECK-DAG: attributes [[ATTR7]] = { nounwind memory(argmem: readwrite, inaccessiblemem: readwrite) }
; CHECK-DAG: attributes [[ATTR8]] = { nounwind memory(argmem: readwrite) }
; CHECK-DAG: attributes [[ATTR9]] = { memory(read) }
; CHECK-DAG: attributes [[ATTR10]] = { memory(inaccessiblemem: readwrite) }
; CHECK-DAG: attributes [[ATTR11]] = { memory(argmem: readwrite, inaccessiblemem: readwrite) }
; CHECK-DAG: attributes [[ATTR12]] = { memory(argmem: readwrite) }
