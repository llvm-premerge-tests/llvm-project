...
; RUN: llc -march=amdgcn -mcpu=gfx900 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX9,DAG-GFX9 %s
...
;
; DAG-VI-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_undeflo:
; DAG-VI:       ; %bb.0:
...
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v0, v2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_undeflo:
; DAG-CI:       ; %bb.0:
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_constlo:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
...
; DAG-VI-NEXT:    v_mac_f32_e32 v2, v0, v1
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v0, v2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    v_or_b32_e32 v0, 0x3c00, v0
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_constlo:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mac_f32_e32 v2, v0, v1
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v2
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v1, v0
; DAG-CI-NEXT:    v_mov_b32_e32 v0, 1.0
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_reglo:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
...
; DAG-VI-NEXT:    v_mac_f32_e32 v2, v0, v1
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v0, v2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    v_or_b32_sdwa v0, v3, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_reglo:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mac_f32_e32 v2, v0, v1
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v2
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v1, v0
; DAG-CI-NEXT:    v_mov_b32_e32 v0, v3
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; DAG-GFX9-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_intpack:
; DAG-GFX9:       ; %bb.0:
; DAG-GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX9-NEXT:    v_mad_mixlo_f16 v0, v0, v1, v2 op_sel_hi:[1,1,1]
; DAG-GFX9-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; DAG-GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_intpack:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
...
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_intpack:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mac_f32_e32 v2, v0, v1
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v2
; DAG-CI-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; DAG-GFX9-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_intpack_sext:
; DAG-GFX9:       ; %bb.0:
; DAG-GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX9-NEXT:    v_mad_mixlo_f16 v0, v0, v1, v2 op_sel_hi:[1,1,1]
; DAG-GFX9-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; DAG-GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_intpack_sext:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
...
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_intpack_sext:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mac_f32_e32 v2, v0, v1
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v2
...
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v0, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_undeflo_clamp_precvt:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_undeflo_clamp_postcvt:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-VI-NEXT:    v_mac_f32_e32 v2, v0, v1
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v0, v2 clamp dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_undeflo_clamp_postcvt:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mac_f32_e32 v2, v0, v1
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v2
; DAG-CI-NEXT:    v_cvt_f32_f16_e64 v1, v0 clamp
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_undeflo_clamp_postcvt_multi_use:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-VI-NEXT:    v_mac_f32_e32 v2, v0, v1
; DAG-VI-NEXT:    v_cvt_f16_f32_e32 v0, v2
; DAG-VI-NEXT:    flat_store_short v[0:1], v0
; DAG-VI-NEXT:    s_waitcnt vmcnt(0)
; DAG-VI-NEXT:    v_max_f16_sdwa v0, v0, v0 clamp dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mixhi_f16_f16lo_f16lo_f16lo_undeflo_clamp_postcvt_multi_use:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mac_f32_e32 v2, v0, v1
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v2
; DAG-CI-NEXT:    s_mov_b32 s7, 0xf000
; DAG-CI-NEXT:    s_mov_b32 s6, -1
; DAG-CI-NEXT:    v_cvt_f32_f16_e64 v1, v0 clamp
; DAG-CI-NEXT:    buffer_store_short v0, off, s[4:7], 0
; DAG-CI-NEXT:    s_waitcnt vmcnt(0)
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
