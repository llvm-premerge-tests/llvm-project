...
; RUN: llc -march=amdgcn -mcpu=gfx1100 -mattr=-flat-for-global,+wavefrontsize64 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GFX11 %s
...
; GFX10-NEXT:    v_cndmask_b32_e64 v0, -1, s3, s[4:5]
...
; GFX11-NEXT:    v_cndmask_b32_e64 v0, -1, s3, s[4:5]
...
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_cndmask_b32_e64 v0, -v0, |v0|, s[4:5]
; VI-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; VI-NEXT:    s_endpgm
;
