...
; These 3 waitcnts are smashed into a signle waitcnt
; Notice that the simplification is not necessarly a waitcnt 0, since all the counters are assumed to be already 0
; CHECK-LABEL: test_waitcnt_builtin
; CHECK: s_waitcnt vmcnt(15) expcnt(7) lgkmcnt(15)
; CHECK-NOT: s_waitcnt
; CHECK: s_endpgm
...
; These 3 waitcnts are smashed with the non-kernel function waitcnt 0
