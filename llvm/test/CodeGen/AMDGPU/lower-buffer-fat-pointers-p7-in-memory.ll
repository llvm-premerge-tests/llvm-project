...
; CHECK-NEXT:    [[X:%.*]] = load i160, ptr [[A]], align 8
...
; CHECK-NEXT:    store i160 [[X_PTR_INT]], ptr [[B1]], align 8
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    [[X:%.*]] = load <4 x i160>, ptr [[A]], align 32
...
; CHECK-NEXT:    store <4 x i160> [[X_PTR_INT]], ptr [[B1]], align 32
; CHECK-NEXT:    ret void
;
...
; CHECK-SAME: (ptr [[A:%.*]], ptr [[B:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[ALLOCA:%.*]] = alloca [5 x i160], align 8, addrspace(5)
; CHECK-NEXT:    [[X:%.*]] = load i160, ptr [[A]], align 8
; CHECK-NEXT:    [[TMP1:%.*]] = lshr i160 [[X]], 32
; CHECK-NEXT:    [[TMP2:%.*]] = trunc i160 [[TMP1]] to i128
; CHECK-NEXT:    [[TMP3:%.*]] = trunc i160 [[X]] to i32
...
; CHECK-NEXT:    [[TMP4:%.*]] = shl nuw i160 [[X_PTR_INT_RSRC]], 32
; CHECK-NEXT:    [[X_PTR_INT:%.*]] = or i160 [[TMP4]], [[X_PTR_INT_OFF]]
; CHECK-NEXT:    store i160 [[X_PTR_INT]], ptr addrspace(5) [[L]], align 8
; CHECK-NEXT:    [[Y:%.*]] = load i160, ptr addrspace(5) [[L]], align 8
...
; CHECK-NEXT:    store i160 [[Y_PTR_INT]], ptr [[B]], align 8
; CHECK-NEXT:    ret void
;
...
; CHECK-SAME: (ptr [[A:%.*]], ptr [[B:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[X:%.*]] = load { [2 x i160], i32, i160 }, ptr [[A]], align 8
...
; CHECK-NEXT:    store { [2 x i160], i32, i160 } [[TMP35]], ptr [[B]], align 8
; CHECK-NEXT:    ret void
;
