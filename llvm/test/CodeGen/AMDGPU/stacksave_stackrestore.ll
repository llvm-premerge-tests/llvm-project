...
; WAVE32-OPT-NEXT:    s_movk_i32 s32, 0x200
...
; WAVE32-OPT-NEXT:    s_getpc_b64 s[4:5]
; WAVE32-OPT-NEXT:    s_add_u32 s4, s4, stack_passed_argument@rel32@lo+4
; WAVE32-OPT-NEXT:    s_addc_u32 s5, s5, stack_passed_argument@rel32@hi+12
...
; WAVE64-OPT-NEXT:    s_movk_i32 s32, 0x400
...
; WAVE64-OPT-NEXT:    s_getpc_b64 s[4:5]
; WAVE64-OPT-NEXT:    s_add_u32 s4, s4, stack_passed_argument@rel32@lo+4
; WAVE64-OPT-NEXT:    s_addc_u32 s5, s5, stack_passed_argument@rel32@hi+12
...
; WAVE32-O0-NEXT:    s_add_u32 s16, s16, stack_passed_argument@rel32@lo+4
; WAVE32-O0-NEXT:    s_addc_u32 s17, s17, stack_passed_argument@rel32@hi+12
...
; WAVE64-O0-NEXT:    s_add_u32 s16, s16, stack_passed_argument@rel32@lo+4
; WAVE64-O0-NEXT:    s_addc_u32 s17, s17, stack_passed_argument@rel32@hi+12
...
; WAVE32-OPT-NEXT:    buffer_store_dword v31, off, s[0:3], s33 offset:4 ; 4-byte Folded Spill
; WAVE32-OPT-NEXT:    s_mov_b32 exec_lo, s4
; WAVE32-OPT-NEXT:    v_writelane_b32 v31, s30, 0
; WAVE32-OPT-NEXT:    v_mov_b32_e32 v0, 42
; WAVE32-OPT-NEXT:    v_mov_b32_e32 v1, 17
; WAVE32-OPT-NEXT:    s_addk_i32 s32, 0x200
; WAVE32-OPT-NEXT:    s_getpc_b64 s[4:5]
; WAVE32-OPT-NEXT:    s_add_u32 s4, s4, stack_passed_argument@rel32@lo+4
; WAVE32-OPT-NEXT:    s_addc_u32 s5, s5, stack_passed_argument@rel32@hi+12
...
; WAVE32-OPT-NEXT:    s_xor_saveexec_b32 s4, -1
; WAVE32-OPT-NEXT:    buffer_load_dword v31, off, s[0:3], s33 offset:4 ; 4-byte Folded Reload
; WAVE32-OPT-NEXT:    s_mov_b32 exec_lo, s4
; WAVE32-OPT-NEXT:    s_addk_i32 s32, 0xfe00
...
; WAVE64-OPT-NEXT:    buffer_store_dword v31, off, s[0:3], s33 offset:4 ; 4-byte Folded Spill
; WAVE64-OPT-NEXT:    s_mov_b64 exec, s[4:5]
; WAVE64-OPT-NEXT:    v_writelane_b32 v31, s30, 0
; WAVE64-OPT-NEXT:    v_mov_b32_e32 v0, 42
; WAVE64-OPT-NEXT:    v_mov_b32_e32 v1, 17
; WAVE64-OPT-NEXT:    s_addk_i32 s32, 0x400
; WAVE64-OPT-NEXT:    s_getpc_b64 s[4:5]
; WAVE64-OPT-NEXT:    s_add_u32 s4, s4, stack_passed_argument@rel32@lo+4
; WAVE64-OPT-NEXT:    s_addc_u32 s5, s5, stack_passed_argument@rel32@hi+12
...
; WAVE64-OPT-NEXT:    s_xor_saveexec_b64 s[4:5], -1
; WAVE64-OPT-NEXT:    buffer_load_dword v31, off, s[0:3], s33 offset:4 ; 4-byte Folded Reload
; WAVE64-OPT-NEXT:    s_mov_b64 exec, s[4:5]
; WAVE64-OPT-NEXT:    s_addk_i32 s32, 0xfc00
