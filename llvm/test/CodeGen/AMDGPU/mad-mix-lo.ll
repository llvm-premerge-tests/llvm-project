...
; RUN: llc -march=amdgcn -mcpu=gfx900 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX900,DAG-GFX900 %s
; RUN: llc -march=amdgcn -mcpu=gfx906 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX906,DAG-GFX906 %s
; RUN: llc -march=amdgcn -mcpu=fiji -verify-machineinstrs < %s | FileCheck -check-prefixes=VI,DAG-VI %s
; RUN: llc -march=amdgcn -mcpu=hawaii -verify-machineinstrs < %s | FileCheck -check-prefixes=CI,DAG-CI %s
...
;
; DAG-CI-LABEL: mixlo_simple:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mac_f32_e32 v2, v0, v1
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v2
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mixlo_f16_f16lo_f16lo_f16lo:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mac_f32_e32 v2, v0, v1
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v2
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mixlo_f16_f16lo_f16lo_f32:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mac_f32_e32 v2, v0, v1
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v2
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mixlo_f16_f16lo_f16lo_f32_clamp_post_cvt:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mac_f32_e32 v2, v0, v1
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v2
; DAG-CI-NEXT:    v_cvt_f32_f16_e64 v0, v0 clamp
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mixlo_f16_f16lo_f16lo_f32_clamp_pre_cvt:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mad_f32 v0, v0, v1, v2 clamp
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_v2f32:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v3, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v4, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v5, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-VI-NEXT:    v_mac_f32_e32 v5, v3, v4
; DAG-VI-NEXT:    v_mac_f32_e32 v2, v0, v1
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v0, v5 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    v_cvt_f16_f32_e32 v1, v2
; DAG-VI-NEXT:    v_or_b32_e32 v0, v1, v0
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_v2f32:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v4, v4
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v2, v2
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v5, v5
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v3, v3
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v1, v1
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v4, v4
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v5, v5
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v3, v3
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-CI-NEXT:    v_mac_f32_e32 v5, v1, v3
; DAG-CI-NEXT:    v_mac_f32_e32 v4, v0, v2
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v4
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v1, v5
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; DAG-GFX900-LABEL: v_mad_mix_v3f32:
; DAG-GFX900:       ; %bb.0:
; DAG-GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX900-NEXT:    v_mad_mixlo_f16 v1, v1, v3, v5 op_sel_hi:[1,1,1]
; DAG-GFX900-NEXT:    v_mad_mixlo_f16 v3, v0, v2, v4 op_sel_hi:[1,1,1]
; DAG-GFX900-NEXT:    v_mad_mixhi_f16 v3, v0, v2, v4 op_sel:[1,1,1] op_sel_hi:[1,1,1]
; DAG-GFX900-NEXT:    v_mov_b32_e32 v0, v3
; DAG-GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-GFX906-LABEL: v_mad_mix_v3f32:
; DAG-GFX906:       ; %bb.0:
; DAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX906-NEXT:    v_fma_mixlo_f16 v1, v1, v3, v5 op_sel_hi:[1,1,1]
; DAG-GFX906-NEXT:    v_fma_mixlo_f16 v3, v0, v2, v4 op_sel_hi:[1,1,1]
; DAG-GFX906-NEXT:    v_fma_mixhi_f16 v3, v0, v2, v4 op_sel:[1,1,1] op_sel_hi:[1,1,1]
; DAG-GFX906-NEXT:    v_mov_b32_e32 v0, v3
; DAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_v3f32:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v6, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v7, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v8, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v4, v4
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v3, v3
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v5, v5
; DAG-VI-NEXT:    v_mac_f32_e32 v8, v6, v7
; DAG-VI-NEXT:    v_mac_f32_e32 v4, v0, v2
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v0, v8 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    v_cvt_f16_f32_e32 v2, v4
; DAG-VI-NEXT:    v_mac_f32_e32 v5, v1, v3
; DAG-VI-NEXT:    v_cvt_f16_f32_e32 v1, v5
; DAG-VI-NEXT:    v_or_b32_e32 v0, v2, v0
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_v3f32:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v6, v6
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v3, v3
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v7, v7
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v4, v4
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v8, v8
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v5, v5
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v2, v2
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v1, v1
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v6, v6
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v3, v3
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v7, v7
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v4, v4
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v8, v8
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v5, v5
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-CI-NEXT:    v_mac_f32_e32 v8, v2, v5
; DAG-CI-NEXT:    v_mac_f32_e32 v7, v1, v4
; DAG-CI-NEXT:    v_mac_f32_e32 v6, v0, v3
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v6
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v1, v7
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v2, v8
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
...
; DAG-GFX900-LABEL: v_mad_mix_v4f32:
; DAG-GFX900:       ; %bb.0:
; DAG-GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX900-NEXT:    v_mad_mixlo_f16 v6, v1, v3, v5 op_sel_hi:[1,1,1]
; DAG-GFX900-NEXT:    v_mad_mixlo_f16 v7, v0, v2, v4 op_sel_hi:[1,1,1]
; DAG-GFX900-NEXT:    v_mad_mixhi_f16 v7, v0, v2, v4 op_sel:[1,1,1] op_sel_hi:[1,1,1]
; DAG-GFX900-NEXT:    v_mad_mixhi_f16 v6, v1, v3, v5 op_sel:[1,1,1] op_sel_hi:[1,1,1]
; DAG-GFX900-NEXT:    v_mov_b32_e32 v0, v7
; DAG-GFX900-NEXT:    v_mov_b32_e32 v1, v6
; DAG-GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-GFX906-LABEL: v_mad_mix_v4f32:
; DAG-GFX906:       ; %bb.0:
; DAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX906-NEXT:    v_fma_mixlo_f16 v6, v1, v3, v5 op_sel_hi:[1,1,1]
; DAG-GFX906-NEXT:    v_fma_mixlo_f16 v7, v0, v2, v4 op_sel_hi:[1,1,1]
; DAG-GFX906-NEXT:    v_fma_mixhi_f16 v7, v0, v2, v4 op_sel:[1,1,1] op_sel_hi:[1,1,1]
; DAG-GFX906-NEXT:    v_fma_mixhi_f16 v6, v1, v3, v5 op_sel:[1,1,1] op_sel_hi:[1,1,1]
; DAG-GFX906-NEXT:    v_mov_b32_e32 v0, v7
; DAG-GFX906-NEXT:    v_mov_b32_e32 v1, v6
; DAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_v4f32:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v6, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v7, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v8, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v9, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v3, v3
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v10, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v11, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v4, v4
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v5, v5
; DAG-VI-NEXT:    v_mac_f32_e32 v10, v7, v9
; DAG-VI-NEXT:    v_mac_f32_e32 v11, v6, v8
; DAG-VI-NEXT:    v_mac_f32_e32 v4, v0, v2
; DAG-VI-NEXT:    v_mac_f32_e32 v5, v1, v3
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v1, v11 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v0, v10 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    v_cvt_f16_f32_e32 v2, v4
; DAG-VI-NEXT:    v_cvt_f16_f32_e32 v3, v5
; DAG-VI-NEXT:    v_or_b32_e32 v0, v2, v0
; DAG-VI-NEXT:    v_or_b32_e32 v1, v3, v1
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_v4f32:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v8, v8
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v4, v4
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v9, v9
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v5, v5
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v10, v10
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v6, v6
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v1, v1
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v11, v11
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v7, v7
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v3, v3
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v2, v2
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v8, v8
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v4, v4
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v9, v9
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v5, v5
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v10, v10
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v6, v6
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v11, v11
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v7, v7
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v3, v3
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-CI-NEXT:    v_mac_f32_e32 v11, v3, v7
; DAG-CI-NEXT:    v_mac_f32_e32 v10, v2, v6
; DAG-CI-NEXT:    v_mac_f32_e32 v9, v1, v5
; DAG-CI-NEXT:    v_mac_f32_e32 v8, v0, v4
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v8
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v1, v9
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v2, v10
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v3, v11
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v3, v3
...
; GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_v2f32_clamp_postcvt:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v3, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
...
; DAG-VI-NEXT:    v_mac_f32_e32 v5, v3, v4
; DAG-VI-NEXT:    v_mac_f32_e32 v2, v0, v1
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v0, v5 clamp dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    v_cvt_f16_f32_e64 v1, v2 clamp
; DAG-VI-NEXT:    v_or_b32_e32 v0, v1, v0
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_v2f32_clamp_postcvt:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v5, v5
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v3, v3
...
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v1, v5
; DAG-CI-NEXT:    v_cvt_f32_f16_e64 v0, v0 clamp
; DAG-CI-NEXT:    v_cvt_f32_f16_e64 v1, v1 clamp
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; DAG-GFX900-LABEL: v_mad_mix_v3f32_clamp_postcvt:
; DAG-GFX900:       ; %bb.0:
; DAG-GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX900-NEXT:    v_mad_mixlo_f16 v1, v1, v3, v5 op_sel_hi:[1,1,1]
; DAG-GFX900-NEXT:    v_mad_mixlo_f16 v3, v0, v2, v4 op_sel_hi:[1,1,1] clamp
; DAG-GFX900-NEXT:    v_pack_b32_f16 v1, v1, 0
; DAG-GFX900-NEXT:    v_mad_mixhi_f16 v3, v0, v2, v4 op_sel:[1,1,1] op_sel_hi:[1,1,1] clamp
; DAG-GFX900-NEXT:    v_pk_max_f16 v1, v1, v1 clamp
; DAG-GFX900-NEXT:    v_mov_b32_e32 v0, v3
; DAG-GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-GFX906-LABEL: v_mad_mix_v3f32_clamp_postcvt:
; DAG-GFX906:       ; %bb.0:
; DAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX906-NEXT:    v_fma_mixlo_f16 v1, v1, v3, v5 op_sel_hi:[1,1,1]
; DAG-GFX906-NEXT:    v_fma_mixlo_f16 v3, v0, v2, v4 op_sel_hi:[1,1,1] clamp
; DAG-GFX906-NEXT:    v_pack_b32_f16 v1, v1, 0
; DAG-GFX906-NEXT:    v_fma_mixhi_f16 v3, v0, v2, v4 op_sel:[1,1,1] op_sel_hi:[1,1,1] clamp
; DAG-GFX906-NEXT:    v_pk_max_f16 v1, v1, v1 clamp
; DAG-GFX906-NEXT:    v_mov_b32_e32 v0, v3
; DAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_v3f32_clamp_postcvt:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v6, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
...
; DAG-VI-NEXT:    v_mac_f32_e32 v8, v6, v7
; DAG-VI-NEXT:    v_mac_f32_e32 v4, v0, v2
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v0, v8 clamp dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    v_cvt_f16_f32_e64 v2, v4 clamp
; DAG-VI-NEXT:    v_mac_f32_e32 v5, v1, v3
; DAG-VI-NEXT:    v_cvt_f16_f32_e64 v1, v5 clamp
; DAG-VI-NEXT:    v_or_b32_e32 v0, v2, v0
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_v3f32_clamp_postcvt:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v8, v8
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v5, v5
...
; DAG-CI-NEXT:    v_cvt_f32_f16_e64 v0, v0 clamp
; DAG-CI-NEXT:    v_cvt_f32_f16_e64 v1, v1 clamp
; DAG-CI-NEXT:    v_cvt_f32_f16_e64 v2, v2 clamp
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_v4f32_clamp_postcvt:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v6, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v7, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v8, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v9, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v3, v3
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v10, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v11, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v5, v5
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v4, v4
; DAG-VI-NEXT:    v_mac_f32_e32 v10, v7, v9
; DAG-VI-NEXT:    v_mac_f32_e32 v11, v6, v8
; DAG-VI-NEXT:    v_mac_f32_e32 v5, v1, v3
; DAG-VI-NEXT:    v_mac_f32_e32 v4, v0, v2
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v0, v11 clamp dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v1, v10 clamp dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    v_cvt_f16_f32_e64 v2, v4 clamp
; DAG-VI-NEXT:    v_cvt_f16_f32_e64 v3, v5 clamp
; DAG-VI-NEXT:    v_or_b32_e32 v0, v2, v0
; DAG-VI-NEXT:    v_or_b32_e32 v1, v3, v1
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_v4f32_clamp_postcvt:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v11, v11
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v7, v7
...
; DAG-CI-NEXT:    v_cvt_f32_f16_e64 v1, v1 clamp
; DAG-CI-NEXT:    v_cvt_f32_f16_e64 v2, v2 clamp
; DAG-CI-NEXT:    v_cvt_f32_f16_e64 v3, v3 clamp
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_v2f32_clamp_postcvt_lo:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v3, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
...
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_v2f32_clamp_postcvt_lo:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v5, v5
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v3, v3
...
; GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_v2f32_clamp_postcvt_hi:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v3, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
...
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_v2f32_clamp_postcvt_hi:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v4, v4
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v2, v2
...
; DAG-GFX900-LABEL: v_mad_mix_v2f32_clamp_precvt:
; DAG-GFX900:       ; %bb.0:
; DAG-GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX900-NEXT:    v_mad_mix_f32 v3, v0, v1, v2 op_sel:[1,1,1] op_sel_hi:[1,1,1] clamp
; DAG-GFX900-NEXT:    v_mad_mix_f32 v0, v0, v1, v2 op_sel_hi:[1,1,1] clamp
; DAG-GFX900-NEXT:    v_cvt_f16_f32_e32 v1, v3
; DAG-GFX900-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-GFX900-NEXT:    v_pack_b32_f16 v0, v0, v1
; DAG-GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-GFX906-LABEL: v_mad_mix_v2f32_clamp_precvt:
; DAG-GFX906:       ; %bb.0:
; DAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX906-NEXT:    v_fma_mix_f32 v3, v0, v1, v2 op_sel:[1,1,1] op_sel_hi:[1,1,1] clamp
; DAG-GFX906-NEXT:    v_fma_mix_f32 v0, v0, v1, v2 op_sel_hi:[1,1,1] clamp
; DAG-GFX906-NEXT:    v_cvt_f16_f32_e32 v1, v3
; DAG-GFX906-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-GFX906-NEXT:    v_pack_b32_f16 v0, v0, v1
; DAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_v2f32_clamp_precvt:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v3, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
...
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v5, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-VI-NEXT:    v_mad_f32 v3, v3, v4, v5 clamp
; DAG-VI-NEXT:    v_mad_f32 v0, v0, v1, v2 clamp
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v1, v3 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-VI-NEXT:    v_or_b32_e32 v0, v0, v1
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_v2f32_clamp_precvt:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v5, v5
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v3, v3
...
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-CI-NEXT:    v_mad_f32 v0, v0, v2, v4 clamp
; DAG-CI-NEXT:    v_mad_f32 v1, v1, v3, v5 clamp
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v1, v1
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v1, v1
...
; DAG-GFX900-LABEL: v_mad_mix_v3f32_clamp_precvt:
; DAG-GFX900:       ; %bb.0:
; DAG-GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX900-NEXT:    v_mad_mix_f32 v6, v0, v2, v4 op_sel:[1,1,1] op_sel_hi:[1,1,1] clamp
; DAG-GFX900-NEXT:    v_mad_mix_f32 v0, v0, v2, v4 op_sel_hi:[1,1,1] clamp
; DAG-GFX900-NEXT:    v_cvt_f16_f32_e32 v2, v6
; DAG-GFX900-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-GFX900-NEXT:    v_mad_mix_f32 v1, v1, v3, v5 op_sel_hi:[1,1,1] clamp
; DAG-GFX900-NEXT:    v_cvt_f16_f32_e32 v1, v1
; DAG-GFX900-NEXT:    v_pack_b32_f16 v0, v0, v2
; DAG-GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-GFX906-LABEL: v_mad_mix_v3f32_clamp_precvt:
; DAG-GFX906:       ; %bb.0:
; DAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX906-NEXT:    v_fma_mix_f32 v6, v0, v2, v4 op_sel:[1,1,1] op_sel_hi:[1,1,1] clamp
; DAG-GFX906-NEXT:    v_fma_mix_f32 v0, v0, v2, v4 op_sel_hi:[1,1,1] clamp
; DAG-GFX906-NEXT:    v_cvt_f16_f32_e32 v2, v6
; DAG-GFX906-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-GFX906-NEXT:    v_fma_mix_f32 v1, v1, v3, v5 op_sel_hi:[1,1,1] clamp
; DAG-GFX906-NEXT:    v_cvt_f16_f32_e32 v1, v1
; DAG-GFX906-NEXT:    v_pack_b32_f16 v0, v0, v2
; DAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_v3f32_clamp_precvt:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v6, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
...
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v3, v3
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v5, v5
; DAG-VI-NEXT:    v_mad_f32 v6, v6, v7, v8 clamp
; DAG-VI-NEXT:    v_mad_f32 v0, v0, v2, v4 clamp
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v2, v6 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-VI-NEXT:    v_mad_f32 v1, v1, v3, v5 clamp
; DAG-VI-NEXT:    v_cvt_f16_f32_e32 v1, v1
; DAG-VI-NEXT:    v_or_b32_e32 v0, v0, v2
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_v3f32_clamp_precvt:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v8, v8
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v5, v5
...
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-CI-NEXT:    v_mad_f32 v0, v0, v3, v6 clamp
; DAG-CI-NEXT:    v_mad_f32 v1, v1, v4, v7 clamp
; DAG-CI-NEXT:    v_mad_f32 v2, v2, v5, v8 clamp
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v1, v1
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v2, v2
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
...
; DAG-GFX900-LABEL: v_mad_mix_v4f32_clamp_precvt:
; DAG-GFX900:       ; %bb.0:
; DAG-GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX900-NEXT:    v_mad_mix_f32 v6, v1, v3, v5 op_sel:[1,1,1] op_sel_hi:[1,1,1] clamp
; DAG-GFX900-NEXT:    v_mad_mix_f32 v1, v1, v3, v5 op_sel_hi:[1,1,1] clamp
; DAG-GFX900-NEXT:    v_mad_mix_f32 v3, v0, v2, v4 op_sel:[1,1,1] op_sel_hi:[1,1,1] clamp
; DAG-GFX900-NEXT:    v_mad_mix_f32 v0, v0, v2, v4 op_sel_hi:[1,1,1] clamp
; DAG-GFX900-NEXT:    v_cvt_f16_f32_e32 v2, v6
; DAG-GFX900-NEXT:    v_cvt_f16_f32_e32 v3, v3
; DAG-GFX900-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-GFX900-NEXT:    v_cvt_f16_f32_e32 v1, v1
; DAG-GFX900-NEXT:    v_pack_b32_f16 v0, v0, v3
; DAG-GFX900-NEXT:    v_pack_b32_f16 v1, v1, v2
; DAG-GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-GFX906-LABEL: v_mad_mix_v4f32_clamp_precvt:
; DAG-GFX906:       ; %bb.0:
; DAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX906-NEXT:    v_fma_mix_f32 v6, v1, v3, v5 op_sel:[1,1,1] op_sel_hi:[1,1,1] clamp
; DAG-GFX906-NEXT:    v_fma_mix_f32 v1, v1, v3, v5 op_sel_hi:[1,1,1] clamp
; DAG-GFX906-NEXT:    v_fma_mix_f32 v3, v0, v2, v4 op_sel:[1,1,1] op_sel_hi:[1,1,1] clamp
; DAG-GFX906-NEXT:    v_fma_mix_f32 v0, v0, v2, v4 op_sel_hi:[1,1,1] clamp
; DAG-GFX906-NEXT:    v_cvt_f16_f32_e32 v2, v6
; DAG-GFX906-NEXT:    v_cvt_f16_f32_e32 v3, v3
; DAG-GFX906-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-GFX906-NEXT:    v_cvt_f16_f32_e32 v1, v1
; DAG-GFX906-NEXT:    v_pack_b32_f16 v0, v0, v3
; DAG-GFX906-NEXT:    v_pack_b32_f16 v1, v1, v2
; DAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_v4f32_clamp_precvt:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v6, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v7, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
...
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v5, v5
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v4, v4
; DAG-VI-NEXT:    v_mad_f32 v7, v7, v9, v10 clamp
; DAG-VI-NEXT:    v_mad_f32 v6, v6, v8, v11 clamp
; DAG-VI-NEXT:    v_mad_f32 v1, v1, v3, v5 clamp
; DAG-VI-NEXT:    v_mad_f32 v0, v0, v2, v4 clamp
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v2, v7 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    v_cvt_f16_f32_sdwa v3, v6 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; DAG-VI-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f16_f32_e32 v1, v1
; DAG-VI-NEXT:    v_or_b32_e32 v0, v0, v3
; DAG-VI-NEXT:    v_or_b32_e32 v1, v1, v2
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_v4f32_clamp_precvt:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v11, v11
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v7, v7
...
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v3, v3
; DAG-CI-NEXT:    v_mad_f32 v0, v0, v4, v8 clamp
; DAG-CI-NEXT:    v_mad_f32 v1, v1, v5, v9 clamp
; DAG-CI-NEXT:    v_mad_f32 v2, v2, v6, v10 clamp
; DAG-CI-NEXT:    v_mad_f32 v3, v3, v7, v11 clamp
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v1, v1
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v2, v2
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v3, v3
