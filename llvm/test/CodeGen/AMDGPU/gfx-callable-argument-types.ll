...
; GFX10-SCRATCH-NEXT:    s_setpc_b64 s[30:31]
  ...
  call amdgpu_gfx void @external_void_func_v2i8(<3 x i8> %val)
  ret void
}
...
; GFX10-SCRATCH-NEXT:    s_waitcnt vmcnt(0)
; GFX10-SCRATCH-NEXT:    s_setpc_b64 s[30:31]
  %val = load <4 x i8>, ptr addrspace(1) undef
  call amdgpu_gfx void @external_void_func_v2i8(<4 x i8> %val)
  ret void
}
...
; GFX10-SCRATCH-NEXT:    s_waitcnt vmcnt(0)
; GFX10-SCRATCH-NEXT:    s_setpc_b64 s[30:31]
  %val = load <5 x i8>, ptr addrspace(1) undef
  call amdgpu_gfx void @external_void_func_v2i8(<5 x i8> %val)
  ret void
}
...
; GFX10-SCRATCH-NEXT:    s_waitcnt vmcnt(0)
; GFX10-SCRATCH-NEXT:    s_setpc_b64 s[30:31]
  %val = load <8 x i8>, ptr addrspace(1) undef
  call amdgpu_gfx void @external_void_func_v2i8(<8 x i8> %val)
  ret void
}
...
; GFX9-NEXT:    s_addc_u32 s35, s35, external_void_func_v2i8@rel32@hi+12
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_lshrrev_b32_e32 v17, 8, v0
; GFX9-NEXT:    v_lshrrev_b32_e32 v18, 16, v0
; GFX9-NEXT:    v_lshrrev_b32_e32 v19, 24, v0
; GFX9-NEXT:    v_lshrrev_b32_e32 v5, 8, v1
; GFX9-NEXT:    v_lshrrev_b32_e32 v6, 16, v1
; GFX9-NEXT:    v_lshrrev_b32_e32 v7, 24, v1
...
; GFX10-NEXT:    v_writelane_b32 v40, s31, 1
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_lshrrev_b32_e32 v17, 8, v0
; GFX10-NEXT:    v_lshrrev_b32_e32 v18, 16, v0
; GFX10-NEXT:    v_lshrrev_b32_e32 v19, 24, v0
; GFX10-NEXT:    v_lshrrev_b32_e32 v5, 8, v1
; GFX10-NEXT:    v_lshrrev_b32_e32 v6, 16, v1
; GFX10-NEXT:    v_lshrrev_b32_e32 v7, 24, v1
...
; GFX10-NEXT:    v_mov_b32_e32 v1, v17
; GFX10-NEXT:    v_mov_b32_e32 v2, v18
...
; GFX10-NEXT:    v_mov_b32_e32 v29, v13
; GFX10-NEXT:    v_mov_b32_e32 v30, v14
; GFX10-NEXT:    v_mov_b32_e32 v31, v15
; GFX10-NEXT:    s_swappc_b64 s[30:31], s[34:35]
; GFX10-NEXT:    v_readlane_b32 s31, v40, 1
; GFX10-NEXT:    v_readlane_b32 s30, v40, 0
; GFX10-NEXT:    v_readlane_b32 s34, v40, 2
...
; GFX11-NEXT:    v_writelane_b32 v40, s31, 1
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_lshrrev_b32_e32 v17, 8, v0
; GFX11-NEXT:    v_lshrrev_b32_e32 v18, 16, v0
; GFX11-NEXT:    v_lshrrev_b32_e32 v19, 24, v0
; GFX11-NEXT:    v_lshrrev_b32_e32 v5, 8, v1
; GFX11-NEXT:    v_lshrrev_b32_e32 v6, 16, v1
; GFX11-NEXT:    v_lshrrev_b32_e32 v7, 24, v1
...
; GFX11-NEXT:    v_dual_mov_b32 v12, v3 :: v_dual_mov_b32 v21, v5
; GFX11-NEXT:    v_dual_mov_b32 v16, v0 :: v_dual_mov_b32 v23, v7
; GFX11-NEXT:    v_dual_mov_b32 v20, v1 :: v_dual_mov_b32 v27, v11
; GFX11-NEXT:    v_dual_mov_b32 v24, v2 :: v_dual_mov_b32 v25, v9
; GFX11-NEXT:    v_dual_mov_b32 v28, v3 :: v_dual_mov_b32 v29, v13
; GFX11-NEXT:    v_dual_mov_b32 v1, v17 :: v_dual_mov_b32 v2, v18
; GFX11-NEXT:    v_mov_b32_e32 v31, v15
; GFX11-NEXT:    v_dual_mov_b32 v3, v19 :: v_dual_mov_b32 v22, v6
; GFX11-NEXT:    v_mov_b32_e32 v26, v10
; GFX11-NEXT:    v_mov_b32_e32 v30, v14
; GFX11-NEXT:    s_swappc_b64 s[30:31], s[0:1]
; GFX11-NEXT:    v_readlane_b32 s31, v40, 1
; GFX11-NEXT:    v_readlane_b32 s30, v40, 0
; GFX11-NEXT:    v_readlane_b32 s0, v40, 2
...
; GFX10-SCRATCH-NEXT:    v_writelane_b32 v40, s31, 1
; GFX10-SCRATCH-NEXT:    s_waitcnt vmcnt(0)
; GFX10-SCRATCH-NEXT:    v_lshrrev_b32_e32 v17, 8, v0
; GFX10-SCRATCH-NEXT:    v_lshrrev_b32_e32 v18, 16, v0
; GFX10-SCRATCH-NEXT:    v_lshrrev_b32_e32 v19, 24, v0
; GFX10-SCRATCH-NEXT:    v_lshrrev_b32_e32 v5, 8, v1
; GFX10-SCRATCH-NEXT:    v_lshrrev_b32_e32 v6, 16, v1
; GFX10-SCRATCH-NEXT:    v_lshrrev_b32_e32 v7, 24, v1
...
; GFX10-SCRATCH-NEXT:    v_mov_b32_e32 v20, v1
; GFX10-SCRATCH-NEXT:    v_mov_b32_e32 v24, v2
; GFX10-SCRATCH-NEXT:    v_mov_b32_e32 v28, v3
; GFX10-SCRATCH-NEXT:    v_mov_b32_e32 v1, v17
; GFX10-SCRATCH-NEXT:    v_mov_b32_e32 v2, v18
; GFX10-SCRATCH-NEXT:    v_mov_b32_e32 v3, v19
; GFX10-SCRATCH-NEXT:    v_mov_b32_e32 v21, v5
; GFX10-SCRATCH-NEXT:    v_mov_b32_e32 v22, v6
; GFX10-SCRATCH-NEXT:    v_mov_b32_e32 v23, v7
; GFX10-SCRATCH-NEXT:    v_mov_b32_e32 v25, v9
; GFX10-SCRATCH-NEXT:    v_mov_b32_e32 v26, v10
; GFX10-SCRATCH-NEXT:    v_mov_b32_e32 v27, v11
; GFX10-SCRATCH-NEXT:    v_mov_b32_e32 v29, v13
; GFX10-SCRATCH-NEXT:    v_mov_b32_e32 v30, v14
; GFX10-SCRATCH-NEXT:    v_mov_b32_e32 v31, v15
; GFX10-SCRATCH-NEXT:    s_swappc_b64 s[30:31], s[0:1]
; GFX10-SCRATCH-NEXT:    v_readlane_b32 s31, v40, 1
; GFX10-SCRATCH-NEXT:    v_readlane_b32 s30, v40, 0
; GFX10-SCRATCH-NEXT:    v_readlane_b32 s0, v40, 2
...
; GFX10-SCRATCH-NEXT:    s_waitcnt vmcnt(0)
; GFX10-SCRATCH-NEXT:    s_setpc_b64 s[30:31]
  %val = load <32 x i8>, ptr addrspace(1) undef
  call amdgpu_gfx void @external_void_func_v2i8(<32 x i8> %val)
  ret void
}
