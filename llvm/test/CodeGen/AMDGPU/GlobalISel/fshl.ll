...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_and_b32 s1, s1, 0xff
; GFX10-NEXT:    s_and_b32 s2, 0xffff, 5
; GFX10-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX10-NEXT:    s_and_b32 s3, 0xffff, 3
; GFX10-NEXT:    s_lshl_b32 s0, s0, s2
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_and_b32 s1, s1, 0xff
; GFX11-NEXT:    s_and_b32 s2, 0xffff, 5
; GFX11-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX11-NEXT:    s_and_b32 s3, 0xffff, 3
; GFX11-NEXT:    s_lshl_b32 s0, s0, s2
...
; GFX8-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX8-NEXT:    s_and_b32 s6, 0xffff, 1
...
; GFX9-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX9-NEXT:    s_and_b32 s6, 0xffff, 1
...
; GFX10-NEXT:    s_lshr_b32 s4, s4, s7
; GFX10-NEXT:    s_andn2_b32 s2, 7, s2
...
; GFX11-NEXT:    s_lshr_b32 s4, s4, s7
; GFX11-NEXT:    s_and_not1_b32 s2, 7, s2
...
; GFX8-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX8-NEXT:    s_and_b32 s12, 0xffff, 1
...
; GFX8-NEXT:    s_lshr_b32 s4, s4, s12
...
; GFX8-NEXT:    s_lshr_b32 s5, s8, s12
; GFX8-NEXT:    s_and_b32 s0, s0, 0xff
...
; GFX9-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX9-NEXT:    s_and_b32 s12, 0xffff, 1
...
; GFX9-NEXT:    s_lshr_b32 s3, s3, s12
; GFX9-NEXT:    s_lshr_b32 s2, s3, s2
; GFX9-NEXT:    s_or_b32 s1, s1, s2
...
; GFX9-NEXT:    s_lshr_b32 s4, s4, s12
...
; GFX9-NEXT:    s_lshr_b32 s5, s8, s12
; GFX9-NEXT:    s_and_b32 s0, s0, 0xff
...
; GFX10-NEXT:    s_andn2_b32 s2, 7, s2
; GFX10-NEXT:    s_lshr_b32 s1, s1, s13
; GFX10-NEXT:    s_lshr_b32 s3, s0, 8
; GFX10-NEXT:    s_lshr_b32 s1, s1, s2
...
; GFX10-NEXT:    s_lshr_b32 s2, s2, s13
...
; GFX10-NEXT:    s_lshr_b32 s7, s8, s13
...
; GFX11-NEXT:    s_and_not1_b32 s2, 7, s2
; GFX11-NEXT:    s_lshr_b32 s1, s1, s13
; GFX11-NEXT:    s_lshr_b32 s3, s0, 8
; GFX11-NEXT:    s_lshr_b32 s1, s1, s2
...
; GFX11-NEXT:    s_lshr_b32 s2, s2, s13
...
; GFX11-NEXT:    s_lshr_b32 s7, s8, s13
...
; GFX10-NEXT:    s_and_b32 s2, 0xffff, 4
; GFX10-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX10-NEXT:    s_and_b32 s3, 0xffff, 12
; GFX10-NEXT:    s_lshl_b32 s0, s0, s2
; GFX10-NEXT:    s_lshr_b32 s1, s1, s3
; GFX10-NEXT:    s_or_b32 s0, s0, s1
; GFX10-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    s_and_b32 s2, 0xffff, 4
; GFX11-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX11-NEXT:    s_and_b32 s3, 0xffff, 12
; GFX11-NEXT:    s_lshl_b32 s0, s0, s2
; GFX11-NEXT:    s_lshr_b32 s1, s1, s3
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_or_b32 s0, s0, s1
...
; GFX10-NEXT:    s_and_b32 s2, 0xffff, 5
; GFX10-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX10-NEXT:    s_and_b32 s3, 0xffff, 11
; GFX10-NEXT:    s_lshl_b32 s0, s0, s2
; GFX10-NEXT:    s_lshr_b32 s1, s1, s3
; GFX10-NEXT:    s_or_b32 s0, s0, s1
; GFX10-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    s_and_b32 s2, 0xffff, 5
; GFX11-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX11-NEXT:    s_and_b32 s3, 0xffff, 11
; GFX11-NEXT:    s_lshl_b32 s0, s0, s2
; GFX11-NEXT:    s_lshr_b32 s1, s1, s3
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_or_b32 s0, s0, s1
...
; GFX8-NEXT:    s_and_b32 s1, 0xffff, 1
...
; GFX9-NEXT:    s_and_b32 s1, 0xffff, 1
...
; GFX6:       ; %bb.0:
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX6-NEXT:    s_and_b32 s4, 0xffff, 4
; GFX6-NEXT:    v_lshlrev_b32_e32 v0, s4, v0
; GFX6-NEXT:    v_bfe_u32 v2, v2, 1, 15
; GFX6-NEXT:    s_and_b32 s4, 0xffff, 11
...
; GFX8-NEXT:    s_and_b32 s2, 0xffff, s2
; GFX8-NEXT:    s_and_b32 s9, 0xffff, 1
