...
; GFX8-NEXT:    s_and_b32 s3, 0xffff, 1
...
; GFX9-NEXT:    s_and_b32 s3, 0xffff, 1
...
; GFX10-NEXT:    s_and_b32 s2, 0xffff, 1
...
; GFX11-NEXT:    s_and_b32 s2, 0xffff, 1
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_and_b32 s4, 0xffff, 1
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_and_b32 s4, 0xffff, 1
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_and_b32 s4, 0xffff, 1
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_and_b32 s4, 0xffff, 1
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_and_b32 s1, s1, 0xff
; GFX8-NEXT:    s_and_b32 s2, 0xffff, 4
; GFX8-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX8-NEXT:    s_lshl_b32 s0, s0, s2
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_and_b32 s1, s1, 0xff
; GFX9-NEXT:    s_and_b32 s2, 0xffff, 4
; GFX9-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX9-NEXT:    s_lshl_b32 s0, s0, s2
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_and_b32 s1, s1, 0xff
; GFX10-NEXT:    s_and_b32 s2, 0xffff, 4
; GFX10-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX10-NEXT:    s_lshl_b32 s0, s0, s2
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_and_b32 s1, s1, 0xff
; GFX11-NEXT:    s_and_b32 s2, 0xffff, 4
; GFX11-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX11-NEXT:    s_lshl_b32 s0, s0, s2
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_and_b32 s2, 0xffff, 3
; GFX8-NEXT:    s_and_b32 s1, s1, 0xff
; GFX8-NEXT:    s_lshl_b32 s0, s0, s2
; GFX8-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX8-NEXT:    s_and_b32 s2, 0xffff, 5
; GFX8-NEXT:    s_lshr_b32 s1, s1, s2
; GFX8-NEXT:    s_or_b32 s0, s0, s1
; GFX8-NEXT:    ; return to shader part epilog
;
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_and_b32 s2, 0xffff, 3
; GFX9-NEXT:    s_and_b32 s1, s1, 0xff
; GFX9-NEXT:    s_lshl_b32 s0, s0, s2
; GFX9-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX9-NEXT:    s_and_b32 s2, 0xffff, 5
; GFX9-NEXT:    s_lshr_b32 s1, s1, s2
; GFX9-NEXT:    s_or_b32 s0, s0, s1
; GFX9-NEXT:    ; return to shader part epilog
;
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_and_b32 s1, s1, 0xff
; GFX10-NEXT:    s_and_b32 s2, 0xffff, 3
; GFX10-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX10-NEXT:    s_and_b32 s3, 0xffff, 5
; GFX10-NEXT:    s_lshl_b32 s0, s0, s2
; GFX10-NEXT:    s_lshr_b32 s1, s1, s3
; GFX10-NEXT:    s_or_b32 s0, s0, s1
; GFX10-NEXT:    ; return to shader part epilog
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_and_b32 s1, s1, 0xff
; GFX11-NEXT:    s_and_b32 s2, 0xffff, 3
; GFX11-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX11-NEXT:    s_and_b32 s3, 0xffff, 5
; GFX11-NEXT:    s_lshl_b32 s0, s0, s2
; GFX11-NEXT:    s_lshr_b32 s1, s1, s3
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_or_b32 s0, s0, s1
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_and_b32 s7, 0xffff, 1
...
; GFX8-NEXT:    s_and_b32 s1, s1, 0xff
; GFX8-NEXT:    s_and_b32 s2, 0xffff, 8
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_and_b32 s7, 0xffff, 1
...
; GFX9-NEXT:    s_and_b32 s1, s1, 0xff
; GFX9-NEXT:    s_and_b32 s2, 0xffff, 8
...
; GFX10-NEXT:    s_and_b32 s7, 0xffff, 1
...
; GFX10-NEXT:    s_and_b32 s2, 0xffff, 8
...
; GFX11-NEXT:    s_and_b32 s7, 0xffff, 1
...
; GFX11-NEXT:    s_and_b32 s2, 0xffff, 8
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_and_b32 s13, 0xffff, 1
; GFX8-NEXT:    s_lshr_b32 s3, s0, 8
...
; GFX8-NEXT:    s_andn2_b32 s2, 7, s2
; GFX8-NEXT:    s_lshl_b32 s0, s0, s13
; GFX8-NEXT:    s_and_b32 s1, s1, 0xff
; GFX8-NEXT:    s_lshl_b32 s0, s0, s2
; GFX8-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX8-NEXT:    s_andn2_b32 s2, 7, s9
; GFX8-NEXT:    s_lshl_b32 s3, s3, s13
...
; GFX8-NEXT:    s_lshl_b32 s4, s4, s13
...
; GFX8-NEXT:    s_lshl_b32 s5, s5, s13
; GFX8-NEXT:    s_and_b32 s0, s0, 0xff
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_and_b32 s13, 0xffff, 1
; GFX9-NEXT:    s_lshr_b32 s3, s0, 8
...
; GFX9-NEXT:    s_andn2_b32 s2, 7, s2
; GFX9-NEXT:    s_lshl_b32 s0, s0, s13
; GFX9-NEXT:    s_and_b32 s1, s1, 0xff
; GFX9-NEXT:    s_lshl_b32 s0, s0, s2
; GFX9-NEXT:    s_and_b32 s1, 0xffff, s1
...
; GFX9-NEXT:    s_lshl_b32 s4, s4, s13
...
; GFX10-NEXT:    s_and_b32 s13, 0xffff, 1
; GFX10-NEXT:    s_lshr_b32 s3, s0, 8
...
; GFX10-NEXT:    s_lshl_b32 s3, s3, s13
...
; GFX10-NEXT:    s_lshl_b32 s4, s4, s13
; GFX10-NEXT:    s_and_b32 s6, 0xffff, s6
...
; GFX11-NEXT:    s_and_b32 s13, 0xffff, 1
; GFX11-NEXT:    s_lshr_b32 s3, s0, 8
...
; GFX11-NEXT:    s_lshl_b32 s4, s4, s13
; GFX11-NEXT:    s_and_b32 s6, 0xffff, s6
...
; GFX8-NEXT:    s_and_b32 s10, 0xffff, 8
; GFX8-NEXT:    s_and_b32 s1, s1, 0xff
...
; GFX9-NEXT:    s_and_b32 s12, 0xffff, 8
; GFX9-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GFX9-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX9-NEXT:    s_and_b32 s1, s1, 0xff
...
; GFX10-NEXT:    s_and_b32 s10, 0xffff, 8
; GFX10-NEXT:    s_and_b32 s1, s1, 0xff
; GFX10-NEXT:    v_rcp_iflag_f32_e32 v0, v0
...
; GFX11-NEXT:    s_and_b32 s9, 0xffff, 8
; GFX11-NEXT:    s_and_b32 s6, s6, 0xff
; GFX11-NEXT:    v_rcp_iflag_f32_e32 v0, v0
...
; GFX11-NEXT:    s_and_b32 s5, 0xffff, s11
; GFX11-NEXT:    s_and_b32 s4, 0xffff, s4
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_and_b32 s2, 0xffff, 12
; GFX8-NEXT:    s_lshl_b32 s0, s0, s2
; GFX8-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX8-NEXT:    s_and_b32 s2, 0xffff, 4
; GFX8-NEXT:    s_lshr_b32 s1, s1, s2
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_and_b32 s2, 0xffff, 12
; GFX9-NEXT:    s_lshl_b32 s0, s0, s2
; GFX9-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX9-NEXT:    s_and_b32 s2, 0xffff, 4
; GFX9-NEXT:    s_lshr_b32 s1, s1, s2
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_and_b32 s2, 0xffff, 12
; GFX10-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX10-NEXT:    s_and_b32 s3, 0xffff, 4
; GFX10-NEXT:    s_lshl_b32 s0, s0, s2
; GFX10-NEXT:    s_lshr_b32 s1, s1, s3
; GFX10-NEXT:    s_or_b32 s0, s0, s1
; GFX10-NEXT:    ; return to shader part epilog
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_and_b32 s2, 0xffff, 12
; GFX11-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX11-NEXT:    s_and_b32 s3, 0xffff, 4
; GFX11-NEXT:    s_lshl_b32 s0, s0, s2
; GFX11-NEXT:    s_lshr_b32 s1, s1, s3
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_or_b32 s0, s0, s1
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_and_b32 s2, 0xffff, 11
; GFX8-NEXT:    s_lshl_b32 s0, s0, s2
; GFX8-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX8-NEXT:    s_and_b32 s2, 0xffff, 5
; GFX8-NEXT:    s_lshr_b32 s1, s1, s2
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_and_b32 s2, 0xffff, 11
; GFX9-NEXT:    s_lshl_b32 s0, s0, s2
; GFX9-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX9-NEXT:    s_and_b32 s2, 0xffff, 5
; GFX9-NEXT:    s_lshr_b32 s1, s1, s2
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_and_b32 s2, 0xffff, 11
; GFX10-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX10-NEXT:    s_and_b32 s3, 0xffff, 5
; GFX10-NEXT:    s_lshl_b32 s0, s0, s2
; GFX10-NEXT:    s_lshr_b32 s1, s1, s3
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_and_b32 s2, 0xffff, 11
; GFX11-NEXT:    s_and_b32 s1, 0xffff, s1
; GFX11-NEXT:    s_and_b32 s3, 0xffff, 5
; GFX11-NEXT:    s_lshl_b32 s0, s0, s2
; GFX11-NEXT:    s_lshr_b32 s1, s1, s3
...
; GFX8-NEXT:    s_and_b32 s2, 0xffff, 1
...
; GFX9-NEXT:    s_and_b32 s2, 0xffff, 1
...
; GFX10-NEXT:    s_and_b32 s3, 0xffff, 1
...
; GFX11-NEXT:    s_and_b32 s3, 0xffff, 1
...
; GFX6-NEXT:    s_and_b32 s5, 0xffff, 1
; GFX6-NEXT:    s_lshl_b32 s0, s0, s5
; GFX6-NEXT:    s_bfe_u32 s6, s2, 0xf0001
; GFX6-NEXT:    s_and_b32 s7, 0xffff, 14
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_and_b32 s5, 0xffff, 1
; GFX8-NEXT:    s_and_b32 s6, 0xffff, s1
; GFX8-NEXT:    s_and_b32 s7, 0xffff, 15
...
; GFX6-NEXT:    s_and_b32 s4, 0xffff, 1
; GFX6-NEXT:    v_bfe_u32 v5, v2, 1, 15
; GFX6-NEXT:    s_and_b32 s5, 0xffff, 14
...
; GFX6:       ; %bb.0:
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX6-NEXT:    s_and_b32 s4, 0xffff, 12
; GFX6-NEXT:    v_lshlrev_b32_e32 v0, s4, v0
; GFX6-NEXT:    v_bfe_u32 v2, v2, 1, 15
; GFX6-NEXT:    s_and_b32 s4, 0xffff, 3
; GFX6-NEXT:    v_lshrrev_b32_e32 v2, s4, v2
; GFX6-NEXT:    s_and_b32 s4, 0xffff, 8
; GFX6-NEXT:    v_or_b32_e32 v0, v0, v2
; GFX6-NEXT:    v_lshlrev_b32_e32 v1, s4, v1
; GFX6-NEXT:    v_bfe_u32 v2, v3, 1, 15
; GFX6-NEXT:    s_and_b32 s4, 0xffff, 7
; GFX6-NEXT:    v_lshrrev_b32_e32 v2, s4, v2
; GFX6-NEXT:    v_or_b32_e32 v1, v1, v2
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX6-NEXT:    s_and_b32 s6, 0xffff, 14
; GFX6-NEXT:    v_xor_b32_e32 v0, -1, v0
...
; GFX8-NEXT:    s_and_b32 s6, 0xffff, 15
...
; GFX6-NEXT:    s_or_b32 s2, s3, s2
; GFX6-NEXT:    s_and_b32 s3, 0xffff, 1
; GFX6-NEXT:    v_bfe_u32 v2, v0, 1, 15
; GFX6-NEXT:    s_and_b32 s4, 0xffff, 14
...
; GFX8-NEXT:    s_and_b32 s4, 0xffff, 15
; GFX8-NEXT:    s_lshr_b32 s2, s0, 16
...
; GFX6-NEXT:    s_and_b32 s8, 0xffff, 1
; GFX6-NEXT:    s_bfe_u32 s9, s3, 0xf0001
; GFX6-NEXT:    s_and_b32 s10, 0xffff, 14
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_and_b32 s8, 0xffff, 1
; GFX8-NEXT:    s_and_b32 s9, 0xffff, s2
; GFX8-NEXT:    s_and_b32 s10, 0xffff, 15
...
; GFX6-NEXT:    s_and_b32 s10, 0xffff, 1
; GFX6-NEXT:    s_bfe_u32 s11, s4, 0xf0001
; GFX6-NEXT:    s_and_b32 s12, 0xffff, 14
...
; GFX6-NEXT:    s_and_b32 s13, 0xffff, s13
