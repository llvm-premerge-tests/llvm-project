...
; RUN: llc -march=amdgcn -mcpu=gfx1010 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX10,GFX10-SDAG %s
; RUN: llc -global-isel -march=amdgcn -mcpu=gfx1010 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX10,GFX10-GISEL %s
...
; VI-NEXT:    s_endpgm
;
; GFX10-SDAG-LABEL: fnearbyint_f16:
; GFX10-SDAG:       ; %bb.0:
; GFX10-SDAG-NEXT:    s_clause 0x1
; GFX10-SDAG-NEXT:    s_load_dword s4, s[0:1], 0x2c
; GFX10-SDAG-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x24
; GFX10-SDAG-NEXT:    v_mov_b32_e32 v0, 0
; GFX10-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-SDAG-NEXT:    v_rndne_f16_e32 v1, s4
; GFX10-SDAG-NEXT:    global_store_short v0, v1, s[2:3]
; GFX10-SDAG-NEXT:    s_endpgm
;
; GFX10-GISEL-LABEL: fnearbyint_f16:
; GFX10-GISEL:       ; %bb.0:
...
; GFX10-GISEL-NEXT:    v_rndne_f16_e32 v0, s4
; GFX10-GISEL-NEXT:    global_store_short v1, v0, s[2:3]
; GFX10-GISEL-NEXT:    s_endpgm
;
; GFX11-SDAG-LABEL: fnearbyint_f16:
; GFX11-SDAG:       ; %bb.0:
...
; GFX11-GISEL-NEXT:    v_rndne_f16_e32 v0, s2
...
; VI-NEXT:    s_endpgm
;
; GFX10-SDAG-LABEL: fnearbyint_f32:
...
; GFX10-SDAG-NEXT:    v_mov_b32_e32 v0, 0
; GFX10-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-SDAG-NEXT:    v_rndne_f32_e32 v1, s4
; GFX10-SDAG-NEXT:    global_store_dword v0, v1, s[2:3]
; GFX10-SDAG-NEXT:    s_endpgm
;
; GFX10-GISEL-LABEL: fnearbyint_f32:
...
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    v_rndne_f32_e32 v0, s4
; GFX10-GISEL-NEXT:    global_store_dword v1, v0, s[2:3]
; GFX10-GISEL-NEXT:    s_endpgm
;
; GFX11-SDAG-LABEL: fnearbyint_f32:
...
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    v_rndne_f32_e32 v1, s2
; GFX11-SDAG-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX11-SDAG-NEXT:    s_nop 0
; GFX11-SDAG-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX11-SDAG-NEXT:    s_endpgm
;
; GFX11-GISEL-LABEL: fnearbyint_f32:
...
; GFX11-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX11-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-NEXT:    v_rndne_f32_e32 v0, s2
...
; VI-NEXT:    s_endpgm
;
; GFX10-SDAG-LABEL: fnearbyint_v4f32:
; GFX10-SDAG:       ; %bb.0: ; %entry
; GFX10-SDAG-NEXT:    s_clause 0x1
...
; GFX10-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-SDAG-NEXT:    v_rndne_f32_e32 v3, s7
; GFX10-SDAG-NEXT:    v_rndne_f32_e32 v2, s6
; GFX10-SDAG-NEXT:    v_rndne_f32_e32 v1, s5
; GFX10-SDAG-NEXT:    v_rndne_f32_e32 v0, s4
; GFX10-SDAG-NEXT:    global_store_dwordx4 v4, v[0:3], s[2:3]
; GFX10-SDAG-NEXT:    s_endpgm
;
; GFX10-GISEL-LABEL: fnearbyint_v4f32:
; GFX10-GISEL:       ; %bb.0: ; %entry
; GFX10-GISEL-NEXT:    s_clause 0x1
...
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    v_rndne_f32_e32 v0, s4
; GFX10-GISEL-NEXT:    v_rndne_f32_e32 v1, s5
; GFX10-GISEL-NEXT:    v_rndne_f32_e32 v2, s6
; GFX10-GISEL-NEXT:    v_rndne_f32_e32 v3, s7
; GFX10-GISEL-NEXT:    global_store_dwordx4 v4, v[0:3], s[2:3]
; GFX10-GISEL-NEXT:    s_endpgm
;
; GFX11-SDAG-LABEL: fnearbyint_v4f32:
; GFX11-SDAG:       ; %bb.0: ; %entry
; GFX11-SDAG-NEXT:    s_clause 0x1
...
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    v_rndne_f32_e32 v3, s7
; GFX11-SDAG-NEXT:    v_rndne_f32_e32 v2, s6
; GFX11-SDAG-NEXT:    v_rndne_f32_e32 v1, s5
; GFX11-SDAG-NEXT:    v_rndne_f32_e32 v0, s4
; GFX11-SDAG-NEXT:    global_store_b128 v4, v[0:3], s[0:1]
; GFX11-SDAG-NEXT:    s_nop 0
; GFX11-SDAG-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX11-SDAG-NEXT:    s_endpgm
;
; GFX11-GISEL-LABEL: fnearbyint_v4f32:
; GFX11-GISEL:       ; %bb.0: ; %entry
; GFX11-GISEL-NEXT:    s_clause 0x1
...
; GFX11-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-NEXT:    v_rndne_f32_e32 v0, s4
; GFX11-GISEL-NEXT:    v_rndne_f32_e32 v1, s5
; GFX11-GISEL-NEXT:    v_rndne_f32_e32 v2, s6
; GFX11-GISEL-NEXT:    v_rndne_f32_e32 v3, s7
...
; VI-NEXT:    s_endpgm
;
; GFX10-LABEL: nearbyint_f64:
; GFX10:       ; %bb.0: ; %entry
; GFX10-NEXT:    s_load_dwordx4 s[0:3], s[0:1], 0x24
; GFX10-NEXT:    v_mov_b32_e32 v2, 0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    v_rndne_f64_e32 v[0:1], s[2:3]
...
; VI-NEXT:    s_endpgm
;
; GFX10-SDAG-LABEL: nearbyint_v2f64:
; GFX10-SDAG:       ; %bb.0: ; %entry
; GFX10-SDAG-NEXT:    s_load_dwordx4 s[4:7], s[0:1], 0x34
; GFX10-SDAG-NEXT:    v_mov_b32_e32 v4, 0
; GFX10-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX10-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-SDAG-NEXT:    v_rndne_f64_e32 v[2:3], s[6:7]
; GFX10-SDAG-NEXT:    v_rndne_f64_e32 v[0:1], s[4:5]
; GFX10-SDAG-NEXT:    global_store_dwordx4 v4, v[0:3], s[0:1]
; GFX10-SDAG-NEXT:    s_endpgm
;
; GFX10-GISEL-LABEL: nearbyint_v2f64:
; GFX10-GISEL:       ; %bb.0: ; %entry
; GFX10-GISEL-NEXT:    s_load_dwordx4 s[4:7], s[0:1], 0x34
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v4, 0
; GFX10-GISEL-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    v_rndne_f64_e32 v[0:1], s[4:5]
; GFX10-GISEL-NEXT:    v_rndne_f64_e32 v[2:3], s[6:7]
; GFX10-GISEL-NEXT:    global_store_dwordx4 v4, v[0:3], s[0:1]
; GFX10-GISEL-NEXT:    s_endpgm
;
; GFX11-SDAG-LABEL: nearbyint_v2f64:
; GFX11-SDAG:       ; %bb.0: ; %entry
; GFX11-SDAG-NEXT:    s_clause 0x1
; GFX11-SDAG-NEXT:    s_load_b128 s[4:7], s[0:1], 0x34
; GFX11-SDAG-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v4, 0
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    v_rndne_f64_e32 v[2:3], s[6:7]
; GFX11-SDAG-NEXT:    v_rndne_f64_e32 v[0:1], s[4:5]
; GFX11-SDAG-NEXT:    global_store_b128 v4, v[0:3], s[0:1]
; GFX11-SDAG-NEXT:    s_nop 0
; GFX11-SDAG-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX11-SDAG-NEXT:    s_endpgm
;
; GFX11-GISEL-LABEL: nearbyint_v2f64:
; GFX11-GISEL:       ; %bb.0: ; %entry
; GFX11-GISEL-NEXT:    s_clause 0x1
; GFX11-GISEL-NEXT:    s_load_b128 s[4:7], s[0:1], 0x34
; GFX11-GISEL-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX11-GISEL-NEXT:    v_mov_b32_e32 v4, 0
; GFX11-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-NEXT:    v_rndne_f64_e32 v[0:1], s[4:5]
; GFX11-GISEL-NEXT:    v_rndne_f64_e32 v[2:3], s[6:7]
; GFX11-GISEL-NEXT:    global_store_b128 v4, v[0:3], s[0:1]
; GFX11-GISEL-NEXT:    s_nop 0
; GFX11-GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX11-GISEL-NEXT:    s_endpgm
...
; VI-NEXT:    s_endpgm
;
; GFX10-SDAG-LABEL: nearbyint_v4f64:
; GFX10-SDAG:       ; %bb.0: ; %entry
; GFX10-SDAG-NEXT:    s_load_dwordx8 s[4:11], s[0:1], 0x44
; GFX10-SDAG-NEXT:    v_mov_b32_e32 v8, 0
; GFX10-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX10-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-SDAG-NEXT:    v_rndne_f64_e32 v[6:7], s[10:11]
; GFX10-SDAG-NEXT:    v_rndne_f64_e32 v[4:5], s[8:9]
; GFX10-SDAG-NEXT:    v_rndne_f64_e32 v[2:3], s[6:7]
; GFX10-SDAG-NEXT:    v_rndne_f64_e32 v[0:1], s[4:5]
; GFX10-SDAG-NEXT:    global_store_dwordx4 v8, v[4:7], s[0:1] offset:16
; GFX10-SDAG-NEXT:    global_store_dwordx4 v8, v[0:3], s[0:1]
; GFX10-SDAG-NEXT:    s_endpgm
;
; GFX10-GISEL-LABEL: nearbyint_v4f64:
; GFX10-GISEL:       ; %bb.0: ; %entry
...
; GFX10-GISEL-NEXT:    v_rndne_f64_e32 v[0:1], s[4:5]
; GFX10-GISEL-NEXT:    v_rndne_f64_e32 v[2:3], s[6:7]
; GFX10-GISEL-NEXT:    v_rndne_f64_e32 v[4:5], s[8:9]
; GFX10-GISEL-NEXT:    v_rndne_f64_e32 v[6:7], s[10:11]
; GFX10-GISEL-NEXT:    global_store_dwordx4 v8, v[0:3], s[0:1]
; GFX10-GISEL-NEXT:    global_store_dwordx4 v8, v[4:7], s[0:1] offset:16
; GFX10-GISEL-NEXT:    s_endpgm
;
; GFX11-SDAG-LABEL: nearbyint_v4f64:
; GFX11-SDAG:       ; %bb.0: ; %entry
; GFX11-SDAG-NEXT:    s_clause 0x1
...
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    v_rndne_f64_e32 v[6:7], s[10:11]
; GFX11-SDAG-NEXT:    v_rndne_f64_e32 v[4:5], s[8:9]
; GFX11-SDAG-NEXT:    v_rndne_f64_e32 v[2:3], s[6:7]
; GFX11-SDAG-NEXT:    v_rndne_f64_e32 v[0:1], s[4:5]
; GFX11-SDAG-NEXT:    s_clause 0x1
; GFX11-SDAG-NEXT:    global_store_b128 v8, v[4:7], s[0:1] offset:16
; GFX11-SDAG-NEXT:    global_store_b128 v8, v[0:3], s[0:1]
; GFX11-SDAG-NEXT:    s_nop 0
; GFX11-SDAG-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX11-SDAG-NEXT:    s_endpgm
;
; GFX11-GISEL-LABEL: nearbyint_v4f64:
; GFX11-GISEL:       ; %bb.0: ; %entry
; GFX11-GISEL-NEXT:    s_clause 0x1
...
; GFX11-GISEL-NEXT:    v_rndne_f64_e32 v[0:1], s[4:5]
; GFX11-GISEL-NEXT:    v_rndne_f64_e32 v[2:3], s[6:7]
; GFX11-GISEL-NEXT:    v_rndne_f64_e32 v[4:5], s[8:9]
; GFX11-GISEL-NEXT:    v_rndne_f64_e32 v[6:7], s[10:11]
; GFX11-GISEL-NEXT:    s_clause 0x1
