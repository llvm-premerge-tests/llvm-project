...
; CHECK-NEXT:    call void @llvm.dbg.value(metadata ptr addrspace(6) [[BUF_PTR_2_PTR_OFF]], metadata [[META16:![0-9]+]], metadata !DIExpression(DW_OP_LLVM_fragment, 128, 32)), !dbg [[DBG28:![0-9]+]]
...
; CHECK-NEXT:    [[BUF_PTR_3:%.*]] = getelementptr float, ptr addrspace(6) [[BUF_PTR_2_PTR_OFF]], i32 [[IDX]], !dbg [[DBG28]]
; CHECK-NEXT:    call void @llvm.dbg.value(metadata ptr addrspace(6) [[BUF_PTR_3]], metadata [[META17:![0-9]+]], metadata !DIExpression(DW_OP_LLVM_fragment, 128, 32)), !dbg [[DBG29:![0-9]+]]
...
; CHECK-NEXT:    call void @llvm.dbg.value(metadata ptr addrspace(6) [[BUF_PTR_4_PTR_OFF]], metadata [[META18:![0-9]+]], metadata !DIExpression(DW_OP_LLVM_fragment, 128, 32)), !dbg [[DBG31:![0-9]+]]
...
; CHECK-NEXT:    [[BUF_PTR_4_PTR_OFF_AS_INT:%.*]] = ptrtoint ptr addrspace(6) [[BUF_PTR_4_PTR_OFF]] to i32, !dbg [[DBG31]]
...
; CHECK-NEXT:    call void @llvm.dbg.value(metadata ptr addrspace(6) [[AUX_PTR_2_PTR_OFF]], metadata [[META20:![0-9]+]], metadata !DIExpression(DW_OP_LLVM_fragment, 128, 32)), !dbg [[DBG34:![0-9]+]]
