...
; GCN-NEXT:    v_cmp_lt_u32_e32 vcc_lo, v0, v6
; GCN-NEXT:    v_cmp_gt_u32_e64 s0, v1, v6
; GCN-NEXT:    v_cmp_lt_u32_e64 s1, v2, v6
; GCN-NEXT:    s_or_b32 s0, vcc_lo, s0
...
; GCN-NEXT:    v_min_u32_e32 v4, v8, v9
...
; GCN-NEXT:    v_cmp_lt_u32_e64 s3, v4, v10
; GCN-NEXT:    s_or_b32 s0, vcc_lo, s0
...
; GFX11-NEXT:    v_min3_f32 v0, v0, v1, v2
; GFX11-NEXT:    v_min_f32_e32 v1, v5, v3
; GFX11-NEXT:    v_cmp_lt_f32_e64 s0, v0, v8
; GFX11-NEXT:    v_cmp_lt_f32_e64 s1, v1, v8
...
; GFX11-NEXT:    v_dual_min_f32 v0, v0, v1 :: v_dual_max_f32 v1, v2, v3
; GFX11-NEXT:    v_dual_min_f32 v2, v4, v5 :: v_dual_max_f32 v3, v6, v7
; GFX11-NEXT:    v_min_f32_e32 v4, v8, v9
; GFX11-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v0, v10
; GFX11-NEXT:    v_cmp_gt_f32_e64 s0, v1, v10
; GFX11-NEXT:    v_cmp_lt_f32_e64 s1, v2, v10
...
; GFX11NONANS-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-NEXT:    v_dual_min_f32 v0, v0, v1 :: v_dual_max_f32 v1, v2, v3
; GFX11NONANS-NEXT:    v_dual_min_f32 v2, v4, v5 :: v_dual_max_f32 v3, v6, v7
; GFX11NONANS-NEXT:    v_min_f32_e32 v4, v8, v9
; GFX11NONANS-NEXT:    v_cmp_lt_f32_e32 vcc_lo, v0, v10
; GFX11NONANS-NEXT:    v_cmp_gt_f32_e64 s0, v1, v10
; GFX11NONANS-NEXT:    v_cmp_lt_f32_e64 s1, v2, v10
; GFX11NONANS-NEXT:    v_cmp_gt_f32_e64 s2, v3, v10
; GFX11NONANS-NEXT:    v_cmp_lt_f32_e64 s3, v4, v10
; GFX11NONANS-NEXT:    s_or_b32 s0, vcc_lo, s0
; GFX11NONANS-NEXT:    s_or_b32 s1, s1, s2
; GFX11NONANS-NEXT:    s_or_b32 s0, s3, s0
; GFX11NONANS-NEXT:    s_or_b32 s0, s1, s0
; GFX11NONANS-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s0
; GFX11NONANS-NEXT:    s_setpc_b64 s[30:31]
  %cmp1 = fcmp olt float %arg1, %C
  %cmp2 = fcmp olt float %arg2, %C
