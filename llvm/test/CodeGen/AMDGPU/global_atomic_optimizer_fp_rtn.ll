...
define amdgpu_ps float @global_atomic_fadd_uni_value_scope_agent(ptr addrspace(1) inreg %ptr, float inreg %val) #0 {
...
define amdgpu_ps float @global_atomic_fadd_div_value_scope_agent(ptr addrspace(1) inreg %ptr, float %val) #0 {
...
define amdgpu_ps float @global_atomic_fadd_uni_value_scope_one_as(ptr addrspace(1) inreg %ptr, float inreg %val) #1 {
...
define amdgpu_ps float @global_atomic_fadd_div_value_scope_one_as(ptr addrspace(1) inreg %ptr, float %val) #1 {
...
define amdgpu_ps float @global_atomic_fsub_uni_value_scope_agent(ptr addrspace(1) inreg %ptr, float inreg %val) #2 {
...
define amdgpu_ps float @global_atomic_fsub_div_value_scope_agent(ptr addrspace(1) inreg %ptr, float %val) #2 {
...
define amdgpu_ps float @global_atomic_fmin_uni_value_scope_agent(ptr addrspace(1) inreg %ptr, float inreg %val) #0 {
...
define amdgpu_ps float @global_atomic_fmin_div_value_scope_agent(ptr addrspace(1) inreg %ptr, float %val) #0 {
...
define amdgpu_ps float @global_atomic_fmax_uni_value_scope_agent(ptr addrspace(1) inreg %ptr, float inreg %val) #1{
