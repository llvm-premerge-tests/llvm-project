...
define void @global_atomic_fmin_uni_value_scope_agent_attr0(ptr addrspace(1) %ptr) #0 {
...
; GFX7LESS-NEXT:    v_mul_f32_e32 v2, 1.0, v3
; GFX7LESS-NEXT:    v_min_f32_e32 v2, 4.0, v2
...
;
; GFX8-LABEL: global_atomic_fmin_uni_value_scope_agent_attr0:
; GFX8:       ; %bb.0:
...
; GFX9-NEXT:    v_min_f32_e32 v2, 4.0, v2
...
; GFX1064-NEXT:    v_min_f32_e32 v2, 4.0, v2
...
; GFX1032-NEXT:    v_min_f32_e32 v2, 4.0, v2
...
; GFX1164-NEXT:    v_min_f32_e32 v2, 4.0, v2
...
; GFX1132-NEXT:    v_min_f32_e32 v2, 4.0, v2
...
; GFX9-DPP-NEXT:    v_min_f32_e32 v2, 4.0, v2
...
; GFX1064-DPP-NEXT:    v_min_f32_e32 v2, 4.0, v2
...
; GFX1032-DPP-NEXT:    v_min_f32_e32 v2, 4.0, v2
...
; GFX1164-DPP-NEXT:    v_min_f32_e32 v2, 4.0, v2
...
; GFX1132-DPP-NEXT:    v_min_f32_e32 v2, 4.0, v2
...
define void @global_atomic_fmin_div_value_scope_agent_attr0(ptr addrspace(1) %ptr) #0 {
...
; GFX7LESS-NEXT:    buffer_load_dword v1, v[41:42], s[36:39], 0 addr64
...
; GFX7LESS-NEXT:    s_setpc_b64 s[30:31]
;
; GFX8-LABEL: global_atomic_fmin_div_value_scope_agent_attr0:
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX8-NEXT:    flat_atomic_cmpswap v0, v[41:42], v[0:1] glc
; GFX8-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-NEXT:    global_atomic_cmpswap v0, v[41:42], v[0:1], off glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1064-NEXT:    global_atomic_cmpswap v0, v[41:42], v[0:1], off glc
; GFX1064-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1032-NEXT:    global_atomic_cmpswap v0, v[41:42], v[0:1], off glc
; GFX1032-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1164-NEXT:    global_atomic_cmpswap_b32 v0, v[41:42], v[0:1], off glc
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1132-NEXT:    global_atomic_cmpswap_b32 v0, v[41:42], v[0:1], off glc
; GFX1132-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-DPP-NEXT:    global_atomic_cmpswap v0, v[41:42], v[0:1], off glc
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1064-DPP-NEXT:    global_atomic_cmpswap v0, v[41:42], v[0:1], off glc
; GFX1064-DPP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1032-DPP-NEXT:    global_atomic_cmpswap v0, v[41:42], v[0:1], off glc
; GFX1032-DPP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1164-DPP-NEXT:    global_atomic_cmpswap_b32 v0, v[41:42], v[0:1], off glc
; GFX1164-DPP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1132-DPP-NEXT:    global_atomic_cmpswap_b32 v0, v[41:42], v[0:1], off glc
; GFX1132-DPP-NEXT:    s_waitcnt vmcnt(0)
