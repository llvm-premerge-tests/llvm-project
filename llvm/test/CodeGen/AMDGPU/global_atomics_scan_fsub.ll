...
; GFX7LESS-LABEL: global_atomic_fsub_uni_value:
; GFX7LESS:       ; %bb.0:
...
;
; GFX8-LABEL: global_atomic_fsub_uni_value:
; GFX8:       ; %bb.0:
...
; GFX8-NEXT:    v_add_f32_e32 v0, -4.0, v1
...
; GFX8-NEXT:    s_endpgm
;
; GFX9-LABEL: global_atomic_fsub_uni_value:
; GFX9:       ; %bb.0:
...
; GFX9-NEXT:    s_endpgm
;
; GFX1064-LABEL: global_atomic_fsub_uni_value:
; GFX1064:       ; %bb.0:
...
;
; GFX1032-LABEL: global_atomic_fsub_uni_value:
; GFX1032:       ; %bb.0:
...
;
; GFX1164-LABEL: global_atomic_fsub_uni_value:
; GFX1164:       ; %bb.0:
...
;
; GFX1132-LABEL: global_atomic_fsub_uni_value:
; GFX1132:       ; %bb.0:
...
;
; GFX9-DPP-LABEL: global_atomic_fsub_uni_value:
; GFX9-DPP:       ; %bb.0:
...
;
; GFX1064-DPP-LABEL: global_atomic_fsub_uni_value:
; GFX1064-DPP:       ; %bb.0:
...
;
; GFX1032-DPP-LABEL: global_atomic_fsub_uni_value:
; GFX1032-DPP:       ; %bb.0:
...
;
; GFX1164-DPP-LABEL: global_atomic_fsub_uni_value:
; GFX1164-DPP:       ; %bb.0:
...
;
; GFX1132-DPP-LABEL: global_atomic_fsub_uni_value:
; GFX1132-DPP:       ; %bb.0:
...
; GFX7LESS-LABEL: global_atomic_fsub_div_value:
; GFX7LESS:       ; %bb.0:
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x9
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_load_dword s2, s[0:1], 0x0
...
; GFX7LESS-NEXT:    s_endpgm
;
; GFX8-LABEL: global_atomic_fsub_div_value:
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX8-NEXT:    s_mov_b64 s[2:3], 0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX8-NEXT:    flat_atomic_cmpswap v1, v[3:4], v[1:2] glc
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    buffer_wbinvl1_vol
...
; GFX8-NEXT:    s_endpgm
;
; GFX9-LABEL: global_atomic_fsub_div_value:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX9-NEXT:    s_mov_b64 s[2:3], 0
...
; GFX9-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX9-NEXT:    global_atomic_cmpswap v1, v3, v[1:2], s[0:1] glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    buffer_wbinvl1_vol
...
; GFX9-NEXT:    s_endpgm
;
; GFX1064-LABEL: global_atomic_fsub_div_value:
; GFX1064:       ; %bb.0:
; GFX1064-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
...
; GFX1064-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1064-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX1064-NEXT:    global_atomic_cmpswap v1, v3, v[1:2], s[0:1] glc
; GFX1064-NEXT:    s_waitcnt vmcnt(0)
; GFX1064-NEXT:    buffer_gl0_inv
; GFX1064-NEXT:    buffer_gl1_inv
...
; GFX1064-NEXT:    s_endpgm
;
; GFX1032-LABEL: global_atomic_fsub_div_value:
; GFX1032:       ; %bb.0:
; GFX1032-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
...
; GFX1032-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1032-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX1032-NEXT:    global_atomic_cmpswap v1, v3, v[1:2], s[0:1] glc
; GFX1032-NEXT:    s_waitcnt vmcnt(0)
; GFX1032-NEXT:    buffer_gl0_inv
; GFX1032-NEXT:    buffer_gl1_inv
...
; GFX1032-NEXT:    s_endpgm
;
; GFX1164-LABEL: global_atomic_fsub_div_value:
; GFX1164:       ; %bb.0:
; GFX1164-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
...
; GFX1164-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1164-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX1164-NEXT:    global_atomic_cmpswap_b32 v1, v3, v[1:2], s[0:1] glc
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    buffer_gl0_inv
; GFX1164-NEXT:    buffer_gl1_inv
...
; GFX1164-NEXT:    s_endpgm
;
; GFX1132-LABEL: global_atomic_fsub_div_value:
; GFX1132:       ; %bb.0:
; GFX1132-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
...
; GFX1132-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1132-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX1132-NEXT:    global_atomic_cmpswap_b32 v1, v3, v[1:2], s[0:1] glc
; GFX1132-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-NEXT:    buffer_gl0_inv
; GFX1132-NEXT:    buffer_gl1_inv
...
; GFX1132-NEXT:    s_endpgm
;
; GFX9-DPP-LABEL: global_atomic_fsub_div_value:
; GFX9-DPP:       ; %bb.0:
; GFX9-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX9-DPP-NEXT:    s_mov_b64 s[2:3], 0
...
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX9-DPP-NEXT:    global_atomic_cmpswap v1, v3, v[1:2], s[0:1] glc
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DPP-NEXT:    buffer_wbinvl1_vol
...
; GFX9-DPP-NEXT:    s_endpgm
;
; GFX1064-DPP-LABEL: global_atomic_fsub_div_value:
; GFX1064-DPP:       ; %bb.0:
; GFX1064-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
...
; GFX1064-DPP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1064-DPP-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX1064-DPP-NEXT:    global_atomic_cmpswap v1, v3, v[1:2], s[0:1] glc
; GFX1064-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1064-DPP-NEXT:    buffer_gl0_inv
; GFX1064-DPP-NEXT:    buffer_gl1_inv
...
; GFX1064-DPP-NEXT:    s_endpgm
;
; GFX1032-DPP-LABEL: global_atomic_fsub_div_value:
; GFX1032-DPP:       ; %bb.0:
; GFX1032-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
...
; GFX1032-DPP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1032-DPP-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX1032-DPP-NEXT:    global_atomic_cmpswap v1, v3, v[1:2], s[0:1] glc
; GFX1032-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1032-DPP-NEXT:    buffer_gl0_inv
; GFX1032-DPP-NEXT:    buffer_gl1_inv
...
; GFX1032-DPP-NEXT:    s_endpgm
;
; GFX1164-DPP-LABEL: global_atomic_fsub_div_value:
; GFX1164-DPP:       ; %bb.0:
; GFX1164-DPP-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
...
; GFX1164-DPP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1164-DPP-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX1164-DPP-NEXT:    global_atomic_cmpswap_b32 v1, v3, v[1:2], s[0:1] glc
; GFX1164-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-DPP-NEXT:    buffer_gl0_inv
; GFX1164-DPP-NEXT:    buffer_gl1_inv
...
; GFX1164-DPP-NEXT:    s_endpgm
;
; GFX1132-DPP-LABEL: global_atomic_fsub_div_value:
; GFX1132-DPP:       ; %bb.0:
; GFX1132-DPP-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
...
; GFX1132-DPP-NEXT:    s_load_b32 s2, s[0:1], 0x0
; GFX1132-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-DPP-NEXT:    v_mov_b32_e32 v2, s2
; GFX1132-DPP-NEXT:    s_mov_b32 s2, 0
...
; GFX1132-DPP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1132-DPP-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX1132-DPP-NEXT:    global_atomic_cmpswap_b32 v1, v3, v[1:2], s[0:1] glc
; GFX1132-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-DPP-NEXT:    buffer_gl0_inv
; GFX1132-DPP-NEXT:    buffer_gl1_inv
...
define amdgpu_kernel void @global_atomic_fsub_uni_value_scope_defalut(ptr addrspace(1) %ptr) {
; GFX7LESS-LABEL: global_atomic_fsub_uni_value_scope_defalut:
; GFX7LESS:       ; %bb.0:
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x9
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_load_dword s2, s[0:1], 0x0
...
; GFX7LESS-NEXT:    s_endpgm
;
; GFX8-LABEL: global_atomic_fsub_uni_value_scope_defalut:
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX8-NEXT:    s_mov_b64 s[2:3], 0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    s_endpgm
;
; GFX9-LABEL: global_atomic_fsub_uni_value_scope_defalut:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX9-NEXT:    s_mov_b64 s[2:3], 0
; GFX9-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX9-NEXT:    s_endpgm
;
; GFX1064-LABEL: global_atomic_fsub_uni_value_scope_defalut:
; GFX1064:       ; %bb.0:
; GFX1064-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1064-NEXT:    v_mov_b32_e32 v2, 0
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064-NEXT:    s_endpgm
;
; GFX1032-LABEL: global_atomic_fsub_uni_value_scope_defalut:
; GFX1032:       ; %bb.0:
; GFX1032-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1032-NEXT:    v_mov_b32_e32 v2, 0
; GFX1032-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032-NEXT:    s_endpgm
;
; GFX1164-LABEL: global_atomic_fsub_uni_value_scope_defalut:
; GFX1164:       ; %bb.0:
; GFX1164-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1164-NEXT:    v_mov_b32_e32 v2, 0
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-NEXT:    s_endpgm
;
; GFX1132-LABEL: global_atomic_fsub_uni_value_scope_defalut:
; GFX1132:       ; %bb.0:
; GFX1132-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1132-NEXT:    v_mov_b32_e32 v2, 0
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132-NEXT:    s_endpgm
;
; GFX9-DPP-LABEL: global_atomic_fsub_uni_value_scope_defalut:
; GFX9-DPP:       ; %bb.0:
; GFX9-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX9-DPP-NEXT:    s_mov_b64 s[2:3], 0
; GFX9-DPP-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX9-DPP-NEXT:    s_endpgm
;
; GFX1064-DPP-LABEL: global_atomic_fsub_uni_value_scope_defalut:
; GFX1064-DPP:       ; %bb.0:
; GFX1064-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1064-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX1064-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064-DPP-NEXT:    s_endpgm
;
; GFX1032-DPP-LABEL: global_atomic_fsub_uni_value_scope_defalut:
; GFX1032-DPP:       ; %bb.0:
; GFX1032-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1032-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX1032-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032-DPP-NEXT:    s_endpgm
;
; GFX1164-DPP-LABEL: global_atomic_fsub_uni_value_scope_defalut:
; GFX1164-DPP:       ; %bb.0:
; GFX1164-DPP-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1164-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX1164-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-DPP-NEXT:    s_endpgm
;
; GFX1132-DPP-LABEL: global_atomic_fsub_uni_value_scope_defalut:
; GFX1132-DPP:       ; %bb.0:
; GFX1132-DPP-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1132-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX1132-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
define amdgpu_kernel void @global_atomic_fsub_div_value_scope_defalut(ptr addrspace(1) %ptr) {
; GFX7LESS-LABEL: global_atomic_fsub_div_value_scope_defalut:
; GFX7LESS:       ; %bb.0:
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x9
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_load_dword s2, s[0:1], 0x0
...
; GFX7LESS-NEXT:    s_endpgm
;
; GFX8-LABEL: global_atomic_fsub_div_value_scope_defalut:
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX8-NEXT:    s_mov_b64 s[2:3], 0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    s_endpgm
;
; GFX9-LABEL: global_atomic_fsub_div_value_scope_defalut:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX9-NEXT:    s_mov_b64 s[2:3], 0
; GFX9-NEXT:    v_mov_b32_e32 v3, 0
...
; GFX9-NEXT:    s_endpgm
;
; GFX1064-LABEL: global_atomic_fsub_div_value_scope_defalut:
; GFX1064:       ; %bb.0:
; GFX1064-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1064-NEXT:    v_mov_b32_e32 v3, 0
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064-NEXT:    s_endpgm
;
; GFX1032-LABEL: global_atomic_fsub_div_value_scope_defalut:
; GFX1032:       ; %bb.0:
; GFX1032-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1032-NEXT:    v_mov_b32_e32 v3, 0
; GFX1032-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032-NEXT:    s_endpgm
;
; GFX1164-LABEL: global_atomic_fsub_div_value_scope_defalut:
; GFX1164:       ; %bb.0:
; GFX1164-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1164-NEXT:    v_mov_b32_e32 v3, 0
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-NEXT:    s_endpgm
;
; GFX1132-LABEL: global_atomic_fsub_div_value_scope_defalut:
; GFX1132:       ; %bb.0:
; GFX1132-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1132-NEXT:    v_mov_b32_e32 v3, 0
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132-NEXT:    s_endpgm
;
; GFX9-DPP-LABEL: global_atomic_fsub_div_value_scope_defalut:
; GFX9-DPP:       ; %bb.0:
; GFX9-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX9-DPP-NEXT:    s_mov_b64 s[2:3], 0
; GFX9-DPP-NEXT:    v_mov_b32_e32 v3, 0
...
; GFX9-DPP-NEXT:    s_endpgm
;
; GFX1064-DPP-LABEL: global_atomic_fsub_div_value_scope_defalut:
; GFX1064-DPP:       ; %bb.0:
; GFX1064-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1064-DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX1064-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064-DPP-NEXT:    s_endpgm
;
; GFX1032-DPP-LABEL: global_atomic_fsub_div_value_scope_defalut:
; GFX1032-DPP:       ; %bb.0:
; GFX1032-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1032-DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX1032-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032-DPP-NEXT:    s_endpgm
;
; GFX1164-DPP-LABEL: global_atomic_fsub_div_value_scope_defalut:
; GFX1164-DPP:       ; %bb.0:
; GFX1164-DPP-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1164-DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX1164-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-DPP-NEXT:    s_endpgm
;
; GFX1132-DPP-LABEL: global_atomic_fsub_div_value_scope_defalut:
; GFX1132-DPP:       ; %bb.0:
; GFX1132-DPP-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1132-DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX1132-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
define amdgpu_kernel void @global_atomic_fsub_uni_value_scope_agent(ptr addrspace(1) %ptr) {
; GFX7LESS-LABEL: global_atomic_fsub_uni_value_scope_agent:
; GFX7LESS:       ; %bb.0:
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x9
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_load_dword s2, s[0:1], 0x0
...
; GFX7LESS-NEXT:    s_endpgm
;
; GFX8-LABEL: global_atomic_fsub_uni_value_scope_agent:
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX8-NEXT:    s_mov_b64 s[2:3], 0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    s_endpgm
;
; GFX9-LABEL: global_atomic_fsub_uni_value_scope_agent:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX9-NEXT:    s_mov_b64 s[2:3], 0
; GFX9-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX9-NEXT:    s_endpgm
;
; GFX1064-LABEL: global_atomic_fsub_uni_value_scope_agent:
; GFX1064:       ; %bb.0:
; GFX1064-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1064-NEXT:    v_mov_b32_e32 v2, 0
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064-NEXT:    s_endpgm
;
; GFX1032-LABEL: global_atomic_fsub_uni_value_scope_agent:
; GFX1032:       ; %bb.0:
; GFX1032-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1032-NEXT:    v_mov_b32_e32 v2, 0
; GFX1032-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032-NEXT:    s_endpgm
;
; GFX1164-LABEL: global_atomic_fsub_uni_value_scope_agent:
; GFX1164:       ; %bb.0:
; GFX1164-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1164-NEXT:    v_mov_b32_e32 v2, 0
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-NEXT:    s_endpgm
;
; GFX1132-LABEL: global_atomic_fsub_uni_value_scope_agent:
; GFX1132:       ; %bb.0:
; GFX1132-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1132-NEXT:    v_mov_b32_e32 v2, 0
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132-NEXT:    s_endpgm
;
; GFX9-DPP-LABEL: global_atomic_fsub_uni_value_scope_agent:
; GFX9-DPP:       ; %bb.0:
; GFX9-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX9-DPP-NEXT:    s_mov_b64 s[2:3], 0
; GFX9-DPP-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX9-DPP-NEXT:    s_endpgm
;
; GFX1064-DPP-LABEL: global_atomic_fsub_uni_value_scope_agent:
; GFX1064-DPP:       ; %bb.0:
; GFX1064-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1064-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX1064-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064-DPP-NEXT:    s_endpgm
;
; GFX1032-DPP-LABEL: global_atomic_fsub_uni_value_scope_agent:
; GFX1032-DPP:       ; %bb.0:
; GFX1032-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1032-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX1032-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032-DPP-NEXT:    s_endpgm
;
; GFX1164-DPP-LABEL: global_atomic_fsub_uni_value_scope_agent:
; GFX1164-DPP:       ; %bb.0:
; GFX1164-DPP-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1164-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX1164-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-DPP-NEXT:    s_endpgm
;
; GFX1132-DPP-LABEL: global_atomic_fsub_uni_value_scope_agent:
; GFX1132-DPP:       ; %bb.0:
; GFX1132-DPP-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1132-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX1132-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
define amdgpu_kernel void @global_atomic_fsub_div_value_scope_agent(ptr addrspace(1) %ptr) {
; GFX7LESS-LABEL: global_atomic_fsub_div_value_scope_agent:
; GFX7LESS:       ; %bb.0:
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x9
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_load_dword s2, s[0:1], 0x0
...
; GFX7LESS-NEXT:    s_endpgm
;
; GFX8-LABEL: global_atomic_fsub_div_value_scope_agent:
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX8-NEXT:    s_mov_b64 s[2:3], 0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    s_endpgm
;
; GFX9-LABEL: global_atomic_fsub_div_value_scope_agent:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX9-NEXT:    s_mov_b64 s[2:3], 0
; GFX9-NEXT:    v_mov_b32_e32 v3, 0
...
; GFX9-NEXT:    s_endpgm
;
; GFX1064-LABEL: global_atomic_fsub_div_value_scope_agent:
; GFX1064:       ; %bb.0:
; GFX1064-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1064-NEXT:    v_mov_b32_e32 v3, 0
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064-NEXT:    s_endpgm
;
; GFX1032-LABEL: global_atomic_fsub_div_value_scope_agent:
; GFX1032:       ; %bb.0:
; GFX1032-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1032-NEXT:    v_mov_b32_e32 v3, 0
; GFX1032-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032-NEXT:    s_endpgm
;
; GFX1164-LABEL: global_atomic_fsub_div_value_scope_agent:
; GFX1164:       ; %bb.0:
; GFX1164-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1164-NEXT:    v_mov_b32_e32 v3, 0
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-NEXT:    s_endpgm
;
; GFX1132-LABEL: global_atomic_fsub_div_value_scope_agent:
; GFX1132:       ; %bb.0:
; GFX1132-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1132-NEXT:    v_mov_b32_e32 v3, 0
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132-NEXT:    s_endpgm
;
; GFX9-DPP-LABEL: global_atomic_fsub_div_value_scope_agent:
; GFX9-DPP:       ; %bb.0:
; GFX9-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX9-DPP-NEXT:    s_mov_b64 s[2:3], 0
; GFX9-DPP-NEXT:    v_mov_b32_e32 v3, 0
...
; GFX9-DPP-NEXT:    s_endpgm
;
; GFX1064-DPP-LABEL: global_atomic_fsub_div_value_scope_agent:
; GFX1064-DPP:       ; %bb.0:
; GFX1064-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1064-DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX1064-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064-DPP-NEXT:    s_endpgm
;
; GFX1032-DPP-LABEL: global_atomic_fsub_div_value_scope_agent:
; GFX1032-DPP:       ; %bb.0:
; GFX1032-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1032-DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX1032-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032-DPP-NEXT:    s_endpgm
;
; GFX1164-DPP-LABEL: global_atomic_fsub_div_value_scope_agent:
; GFX1164-DPP:       ; %bb.0:
; GFX1164-DPP-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1164-DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX1164-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-DPP-NEXT:    s_endpgm
;
; GFX1132-DPP-LABEL: global_atomic_fsub_div_value_scope_agent:
; GFX1132-DPP:       ; %bb.0:
; GFX1132-DPP-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1132-DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX1132-DPP-NEXT:    s_waitcnt lgkmcnt(0)
