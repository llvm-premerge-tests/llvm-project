...
define amdgpu_kernel void @global_atomic_fsub_uni_value_scope_agent_attr0(ptr addrspace(1) %ptr) #0 {
...
define amdgpu_kernel void @global_atomic_fsub_div_value_scope_agent_attr0(ptr addrspace(1) %ptr) #0 {
...
define amdgpu_kernel void @global_atomic_fsub_uni_value_scope_one_as_attr1(ptr addrspace(1) %ptr) #1 {
...
define amdgpu_kernel void @global_atomic_fsub_div_value_scope_one_as_attr1(ptr addrspace(1) %ptr) #1 {
...
define amdgpu_kernel void @global_atomic_fsub_uni_value_scope_agent_attr1(ptr addrspace(1) %ptr) #2{
...
define amdgpu_kernel void @global_atomic_fsub_div_value_scope_agent_attr2(ptr addrspace(1) %ptr) #0 {
...
define amdgpu_kernel void @global_atomic_fsub_div_value_scope_agent_attr1(ptr addrspace(1) %ptr) #1 {
...
define amdgpu_kernel void @global_atomic_fsub_uni_value_scope_defalut_attr2(ptr addrspace(1) %ptr) #2 {
...
define amdgpu_kernel void @global_atomic_fsub_div_value_scope_defalut_attr2(ptr addrspace(1) %ptr) #2 {
