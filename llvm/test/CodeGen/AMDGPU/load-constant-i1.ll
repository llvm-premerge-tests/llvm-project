...
; GFX6-NEXT:    s_load_dwordx4 s[0:3], s[0:1], 0x9
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_load_dword s10, s[2:3], 0x0
; GFX6-NEXT:    s_mov_b32 s3, 0xf000
; GFX6-NEXT:    s_mov_b32 s2, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_lshr_b32 s60, s10, 30
; GFX6-NEXT:    s_lshr_b32 s18, s10, 31
; GFX6-NEXT:    s_lshr_b32 s22, s10, 28
; GFX6-NEXT:    s_lshr_b32 s4, s10, 29
; GFX6-NEXT:    s_lshr_b32 s6, s10, 26
; GFX6-NEXT:    s_lshr_b32 s8, s10, 27
; GFX6-NEXT:    s_lshr_b32 s12, s10, 24
; GFX6-NEXT:    s_lshr_b32 s14, s10, 25
; GFX6-NEXT:    s_lshr_b32 s16, s10, 22
; GFX6-NEXT:    s_lshr_b32 s20, s10, 23
; GFX6-NEXT:    s_lshr_b32 s24, s10, 20
; GFX6-NEXT:    s_lshr_b32 s26, s10, 21
; GFX6-NEXT:    s_lshr_b32 s28, s10, 18
; GFX6-NEXT:    s_lshr_b32 s30, s10, 19
; GFX6-NEXT:    s_lshr_b32 s34, s10, 16
; GFX6-NEXT:    s_lshr_b32 s36, s10, 17
; GFX6-NEXT:    s_lshr_b32 s38, s10, 14
; GFX6-NEXT:    s_lshr_b32 s40, s10, 15
; GFX6-NEXT:    s_lshr_b32 s42, s10, 12
; GFX6-NEXT:    s_lshr_b32 s44, s10, 13
; GFX6-NEXT:    s_lshr_b32 s46, s10, 10
; GFX6-NEXT:    s_lshr_b32 s48, s10, 11
; GFX6-NEXT:    s_lshr_b32 s50, s10, 8
; GFX6-NEXT:    s_lshr_b32 s52, s10, 9
; GFX6-NEXT:    s_lshr_b32 s54, s10, 6
; GFX6-NEXT:    s_lshr_b32 s56, s10, 7
; GFX6-NEXT:    s_bfe_i64 s[58:59], s[10:11], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[60:61], s[60:61], 0x10000
; GFX6-NEXT:    v_mov_b32_e32 v0, s58
; GFX6-NEXT:    v_mov_b32_e32 v1, s59
; GFX6-NEXT:    s_lshr_b32 s58, s10, 4
; GFX6-NEXT:    v_mov_b32_e32 v2, s60
; GFX6-NEXT:    v_mov_b32_e32 v3, s61
; GFX6-NEXT:    s_lshr_b32 s60, s10, 5
...
; GFX6-NEXT:    s_lshr_b32 s18, s10, 2
; GFX6-NEXT:    v_mov_b32_e32 v6, s22
; GFX6-NEXT:    v_mov_b32_e32 v7, s23
; GFX6-NEXT:    s_lshr_b32 s22, s10, 3
; GFX6-NEXT:    s_lshr_b32 s10, s10, 1
...
; GFX6-NEXT:    s_lshr_b32 s30, s5, 28
; GFX6-NEXT:    s_lshr_b32 s46, s5, 29
; GFX6-NEXT:    s_lshr_b32 s34, s5, 26
; GFX6-NEXT:    s_lshr_b32 s48, s5, 27
; GFX6-NEXT:    s_lshr_b32 s36, s5, 24
; GFX6-NEXT:    s_lshr_b32 s50, s5, 25
; GFX6-NEXT:    s_lshr_b32 s38, s5, 22
; GFX6-NEXT:    s_lshr_b32 s52, s5, 23
; GFX6-NEXT:    s_lshr_b32 s26, s5, 20
; GFX6-NEXT:    s_lshr_b32 s54, s5, 21
; GFX6-NEXT:    s_lshr_b32 s20, s5, 18
; GFX6-NEXT:    s_lshr_b32 s44, s5, 19
; GFX6-NEXT:    s_lshr_b32 s16, s5, 16
; GFX6-NEXT:    s_lshr_b32 s42, s5, 17
; GFX6-NEXT:    s_lshr_b32 s14, s5, 14
; GFX6-NEXT:    s_lshr_b32 s40, s5, 15
; GFX6-NEXT:    s_lshr_b32 s12, s5, 12
; GFX6-NEXT:    s_lshr_b32 s28, s5, 13
; GFX6-NEXT:    s_lshr_b32 s10, s5, 10
; GFX6-NEXT:    s_lshr_b32 s24, s5, 11
; GFX6-NEXT:    s_lshr_b32 s8, s5, 8
; GFX6-NEXT:    s_lshr_b32 s22, s5, 9
; GFX6-NEXT:    s_lshr_b32 s6, s5, 6
; GFX6-NEXT:    s_lshr_b32 s18, s5, 7
...
; GFX6-NEXT:    s_lshr_b32 s30, s5, 3
; GFX6-NEXT:    v_mov_b32_e32 v12, s46
; GFX6-NEXT:    v_mov_b32_e32 v13, s47
...
; GFX6-NEXT:    v_mov_b32_e32 v2, s54
; GFX6-NEXT:    v_mov_b32_e32 v3, s55
; GFX6-NEXT:    s_lshr_b32 s54, s4, 25
; GFX6-NEXT:    s_bfe_i64 s[44:45], s[44:45], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[20:21], s[20:21], 0x10000
...
; GFX6-NEXT:    s_lshr_b32 s44, s4, 23
; GFX6-NEXT:    s_bfe_i64 s[42:43], s[42:43], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[16:17], s[16:17], 0x10000
...
; GFX6-NEXT:    s_lshr_b32 s14, s4, 18
; GFX6-NEXT:    v_mov_b32_e32 v20, s40
; GFX6-NEXT:    v_mov_b32_e32 v21, s41
; GFX6-NEXT:    s_lshr_b32 s40, s4, 19
; GFX6-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[22:25], off, s[0:3], 0 offset:432
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v22, s12
; GFX6-NEXT:    v_mov_b32_e32 v23, s13
; GFX6-NEXT:    s_lshr_b32 s12, s4, 16
; GFX6-NEXT:    v_mov_b32_e32 v24, s28
; GFX6-NEXT:    v_mov_b32_e32 v25, s29
...
; GFX6-NEXT:    v_mov_b32_e32 v2, s24
; GFX6-NEXT:    v_mov_b32_e32 v3, s25
; GFX6-NEXT:    s_lshr_b32 s24, s4, 15
; GFX6-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[10:13], off, s[0:3], 0 offset:400
; GFX6-NEXT:    s_waitcnt expcnt(0)
...
; GFX6-NEXT:    s_lshr_b32 s22, s4, 13
; GFX6-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[14:17], off, s[0:3], 0 offset:384
; GFX6-NEXT:    s_waitcnt expcnt(0)
...
; GFX6-NEXT:    s_lshr_b32 s18, s4, 11
; GFX6-NEXT:    s_bfe_i64 s[60:61], s[60:61], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[56:57], s[56:57], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[18:21], off, s[0:3], 0 offset:368
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v18, s56
; GFX6-NEXT:    v_mov_b32_e32 v19, s57
; GFX6-NEXT:    s_lshr_b32 s56, s4, 8
; GFX6-NEXT:    v_mov_b32_e32 v20, s60
; GFX6-NEXT:    v_mov_b32_e32 v21, s61
; GFX6-NEXT:    s_lshr_b32 s60, s4, 9
; GFX6-NEXT:    s_bfe_i64 s[58:59], s[58:59], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[22:25], off, s[0:3], 0 offset:352
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v22, s58
; GFX6-NEXT:    v_mov_b32_e32 v23, s59
; GFX6-NEXT:    s_lshr_b32 s58, s4, 6
; GFX6-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[46:47], s[46:47], 0x10000
; GFX6-NEXT:    v_mov_b32_e32 v24, s30
; GFX6-NEXT:    v_mov_b32_e32 v25, s31
; GFX6-NEXT:    s_lshr_b32 s30, s4, 7
; GFX6-NEXT:    v_mov_b32_e32 v6, s46
; GFX6-NEXT:    v_mov_b32_e32 v7, s47
; GFX6-NEXT:    s_lshr_b32 s46, s4, 4
; GFX6-NEXT:    s_bfe_i64 s[48:49], s[48:49], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[34:35], s[34:35], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:336
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v0, s34
; GFX6-NEXT:    v_mov_b32_e32 v1, s35
; GFX6-NEXT:    s_lshr_b32 s34, s4, 5
; GFX6-NEXT:    v_mov_b32_e32 v2, s48
; GFX6-NEXT:    v_mov_b32_e32 v3, s49
; GFX6-NEXT:    s_lshr_b32 s48, s4, 2
; GFX6-NEXT:    s_bfe_i64 s[36:37], s[36:37], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[10:13], off, s[0:3], 0 offset:320
; GFX6-NEXT:    s_waitcnt expcnt(0)
...
; GFX6-NEXT:    s_bfe_i64 s[38:39], s[38:39], 0x10000
; GFX6-NEXT:    s_bfe_i64 s[50:51], s[50:51], 0x10000
; GFX6-NEXT:    buffer_store_dwordx4 v[14:17], off, s[0:3], 0 offset:304
; GFX6-NEXT:    buffer_store_dwordx4 v[18:21], off, s[0:3], 0 offset:288
; GFX6-NEXT:    buffer_store_dwordx4 v[22:25], off, s[0:3], 0 offset:272
; GFX6-NEXT:    buffer_store_dwordx4 v[4:7], off, s[0:3], 0 offset:256
; GFX6-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:240
; GFX6-NEXT:    v_mov_b32_e32 v12, s50
; GFX6-NEXT:    v_mov_b32_e32 v13, s51
