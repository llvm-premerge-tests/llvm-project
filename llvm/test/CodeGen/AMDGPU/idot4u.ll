...
; GFX9-DL-NEXT:    s_mov_b32 s0, 0x302050c
...
; GFX11-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX11-DL-NEXT:    v_perm_b32 v1, v1, v2, 0x302050c
; GFX11-DL-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-DL-NEXT:    s_mov_b32 s0, 0xc02050c
...
; GFX11-DL-NEXT:    s_load_b32 s0, s[6:7], 0x0
; GFX11-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX11-DL-NEXT:    v_perm_b32 v1, v1, v2, 0xc060c00
; GFX11-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DL-NEXT:    v_perm_b32 v0, v0, v0, 0xc0c010c
; GFX11-DL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)
; GFX11-DL-NEXT:    v_or_b32_e32 v0, v1, v0
; GFX11-DL-NEXT:    v_perm_b32 v1, v2, v2, 0xc020100
; GFX11-DL-NEXT:    v_mov_b32_e32 v2, 0
; GFX11-DL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-DL-NEXT:    s_mov_b32 s1, 0xc020c0c
...
; GFX11-DL-NEXT:    s_load_b32 s0, s[6:7], 0x0
; GFX11-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX11-DL-NEXT:    v_perm_b32 v1, v2, v1, 0xc0c0105
; GFX11-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DL-NEXT:    v_perm_b32 v0, v0, v0, 0xc020c0c
; GFX11-DL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)
; GFX11-DL-NEXT:    v_or_b32_e32 v0, v1, v0
; GFX11-DL-NEXT:    v_perm_b32 v1, v2, v2, 0xc020101
; GFX11-DL-NEXT:    v_mov_b32_e32 v2, 0
; GFX11-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-DL-NEXT:    v_dot4_u32_u8 v0, v1, v0, s0
; GFX11-DL-NEXT:    global_store_b32 v2, v0, s[6:7]
...
; GFX11-DL-NEXT:    s_load_b32 s2, s[0:1], 0x0
; GFX11-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX11-DL-NEXT:    v_perm_b32 v4, v3, v1, 0xc050c01
; GFX11-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DL-NEXT:    v_perm_b32 v5, v0, v2, 0x50c010c
; GFX11-DL-NEXT:    v_perm_b32 v1, v3, v1, 0xc040c00
; GFX11-DL-NEXT:    v_perm_b32 v0, v0, v2, 0x40c000c
; GFX11-DL-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX9-DL-NEXT:    s_mov_b32 s0, 0x2000604
...
; GFX9-DL-NEXT:    s_mov_b32 s4, 0x3010705
; GFX9-DL-NEXT:    s_mov_b32 s6, 0x3010301
; GFX9-DL-NEXT:    v_mov_b32_e32 v2, 0
; GFX9-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-DL-NEXT:    v_perm_b32 v4, v0, v1, s0
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
