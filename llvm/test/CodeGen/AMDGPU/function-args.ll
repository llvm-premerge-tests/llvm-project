...
; GFX11-NEXT:    buffer_store_b32 v0, off, s[0:3], 0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
  store <5 x i8> %arg0, ptr addrspace(1) undef
  ret void
}
...
; GFX11-NEXT:    buffer_store_b64 v[0:1], off, s[0:3], 0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
  store <8 x i8> %arg0, ptr addrspace(1) undef
  ret void
}
...
; GFX11-NEXT:    buffer_store_b128 v[0:3], off, s[0:3], 0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
  store <16 x i8> %arg0, ptr addrspace(1) undef
  ret void
}
...
; GFX11-NEXT:    v_lshlrev_b32_e32 v15, 16, v1
; GFX11-NEXT:    v_or_b32_e32 v4, v4, v5
; GFX11-NEXT:    v_or_b32_e32 v5, v6, v7
...
; GFX11-NEXT:    v_and_b32_e32 v4, 0xffff, v4
; GFX11-NEXT:    v_lshlrev_b32_e32 v5, 16, v5
; GFX11-NEXT:    v_and_b32_e32 v16, 0xffff, v2
; GFX11-NEXT:    v_and_b32_e32 v17, 0xffff, v3
...
; GFX11-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX11-NEXT:    v_or_b32_e32 v6, v17, v6
; GFX11-NEXT:    s_mov_b32 s3, 0x31016000
; GFX11-NEXT:    s_mov_b32 s2, -1
; GFX11-NEXT:    v_or_b32_e32 v3, v12, v13
; GFX11-NEXT:    v_or_b32_e32 v0, v0, v15
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    v_or_b32_e32 v7, v16, v8
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    buffer_store_b128 v[4:7], off, s[0:3], 0
; GFX11-NEXT:    buffer_store_b128 v[0:3], off, s[0:3], 0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
  store <32 x i8> %arg0, ptr addrspace(1) undef
  ret void
}
