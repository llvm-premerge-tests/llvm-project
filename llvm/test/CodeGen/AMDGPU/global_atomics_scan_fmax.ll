...
; GFX8-NEXT:  .LBB0_3: ; %atomicrmw.end
; GFX8-NEXT:    s_endpgm
;
...
; GFX9-NEXT:  .LBB0_3: ; %atomicrmw.end
; GFX9-NEXT:    s_endpgm
;
...
; GFX1064-NEXT:  .LBB0_3: ; %atomicrmw.end
...
; GFX1032-NEXT:  .LBB0_3: ; %atomicrmw.end
...
; GFX1164-NEXT:  .LBB0_3: ; %atomicrmw.end
...
; GFX1132-NEXT:  .LBB0_3: ; %atomicrmw.end
...
; GFX9-DPP-NEXT:  .LBB0_3: ; %atomicrmw.end
...
; GFX1064-DPP-NEXT:  .LBB0_3: ; %atomicrmw.end
...
; GFX1032-DPP-NEXT:  .LBB0_3: ; %atomicrmw.end
...
; GFX1164-DPP-NEXT:  .LBB0_3: ; %atomicrmw.end
...
; GFX1132-DPP-NEXT:  .LBB0_3: ; %atomicrmw.end
...
; GFX8-NEXT:    v_mov_b32_e32 v2, 0xff800000
...
; GFX8-NEXT:  .LBB1_5: ; %atomicrmw.end
; GFX8-NEXT:    s_endpgm
;
; GFX9-LABEL: global_atomic_fadd_div_value:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b64 s[2:3], exec
; GFX9-NEXT:    v_mov_b32_e32 v1, 0xff800000
...
; GFX9-NEXT:    v_max_f32_e64 v2, s6, s6
...
; GFX9-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX9-NEXT:    s_mov_b64 s[2:3], 0
; GFX9-NEXT:    v_max_f32_e32 v2, v1, v1
...
; GFX9-NEXT:  .LBB1_5: ; %atomicrmw.end
; GFX9-NEXT:    s_endpgm
;
...
; GFX1064-NEXT:    v_max_f32_e64 v2, s5, s5
...
; GFX1064-NEXT:  ; %bb.3:
; GFX1064-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1064-NEXT:    v_max_f32_e32 v2, v1, v1
...
; GFX1064-NEXT:  .LBB1_5: ; %atomicrmw.end
; GFX1064-NEXT:    s_endpgm
;
...
; GFX1032-NEXT:    v_max_f32_e64 v2, s4, s4
...
; GFX1032-NEXT:  ; %bb.3:
; GFX1032-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1032-NEXT:    v_max_f32_e32 v2, v1, v1
...
; GFX1032-NEXT:  .LBB1_5: ; %atomicrmw.end
; GFX1032-NEXT:    s_endpgm
;
...
; GFX1164-NEXT:    v_max_f32_e64 v2, s5, s5
...
; GFX1164-NEXT:  ; %bb.3:
; GFX1164-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1164-NEXT:    v_max_f32_e32 v2, v1, v1
...
; GFX1164-NEXT:  .LBB1_5: ; %atomicrmw.end
; GFX1164-NEXT:    s_endpgm
;
...
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1132-NEXT:    v_max_f32_e64 v2, s4, s4
...
; GFX1132-NEXT:    s_load_b32 s3, s[0:1], 0x0
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    v_dual_max_f32 v2, v1, v1 :: v_dual_mov_b32 v1, s3
...
; GFX1132-NEXT:  .LBB1_5: ; %atomicrmw.end
; GFX1132-NEXT:    s_endpgm
;
...
; GFX9-DPP-NEXT:    v_max_f32_e32 v2, v2, v2
; GFX9-DPP-NEXT:    v_max_f32_e32 v3, v3, v3
; GFX9-DPP-NEXT:    v_max_f32_e32 v2, v2, v3
; GFX9-DPP-NEXT:    v_mov_b32_e32 v3, 0xff800000
; GFX9-DPP-NEXT:    s_nop 1
...
; GFX9-DPP-NEXT:    v_max_f32_e32 v1, v2, v1
...
; GFX9-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-DPP-NEXT:    v_max_f32_e32 v4, v5, v5
; GFX9-DPP-NEXT:    v_max_f32_e32 v4, v4, v0
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX9-DPP-NEXT:    global_atomic_cmpswap v4, v6, v[4:5], s[0:1] glc
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DPP-NEXT:    buffer_wbinvl1_vol
...
; GFX1064-DPP-NEXT:    v_max_f32_e32 v2, v2, v2
; GFX1064-DPP-NEXT:    v_max_f32_e32 v1, v1, v2
; GFX1064-DPP-NEXT:    v_readlane_b32 s4, v1, 32
; GFX1064-DPP-NEXT:    v_readlane_b32 s5, v1, 0
; GFX1064-DPP-NEXT:    v_max_f32_e64 v1, s4, s4
; GFX1064-DPP-NEXT:    v_max_f32_e64 v2, s5, s5
; GFX1064-DPP-NEXT:    s_mov_b64 exec, s[2:3]
; GFX1064-DPP-NEXT:    v_mbcnt_lo_u32_b32 v0, exec_lo, 0
; GFX1064-DPP-NEXT:    s_or_saveexec_b64 s[2:3], -1
; GFX1064-DPP-NEXT:    v_max_f32_e32 v1, v2, v1
...
; GFX1064-DPP-NEXT:  ; %bb.1:
; GFX1064-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1064-DPP-NEXT:    v_max_f32_e32 v0, v0, v0
...
; GFX1064-DPP-NEXT:    v_max_f32_e32 v4, v4, v0
; GFX1064-DPP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1064-DPP-NEXT:    s_waitcnt_vscnt null, 0x0
...
; GFX1032-DPP-NEXT:  ; %bb.1:
; GFX1032-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1032-DPP-NEXT:    v_max_f32_e32 v0, v0, v0
...
; GFX1032-DPP-NEXT:    v_max_f32_e32 v4, v4, v0
; GFX1032-DPP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1032-DPP-NEXT:    s_waitcnt_vscnt null, 0x0
...
; GFX1032-DPP-NEXT:  .LBB1_3: ; %atomicrmw.end
; GFX1032-DPP-NEXT:    s_endpgm
;
...
; GFX1164-DPP-NEXT:  ; %bb.1:
; GFX1164-DPP-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1164-DPP-NEXT:    v_max_f32_e32 v0, v0, v0
...
; GFX1164-DPP-NEXT:    v_max_f32_e32 v4, v4, v0
; GFX1164-DPP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1164-DPP-NEXT:    s_waitcnt_vscnt null, 0x0
...
; GFX1164-DPP-NEXT:  .LBB1_3: ; %atomicrmw.end
; GFX1164-DPP-NEXT:    s_endpgm
;
...
; GFX1132-DPP-NEXT:    s_load_b32 s3, s[0:1], 0x0
; GFX1132-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-DPP-NEXT:    v_dual_max_f32 v0, v0, v0 :: v_dual_mov_b32 v5, s3
; GFX1132-DPP-NEXT:  .LBB1_2: ; %atomicrmw.start
; GFX1132-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1132-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1132-DPP-NEXT:    v_max_f32_e32 v4, v5, v5
; GFX1132-DPP-NEXT:    v_max_f32_e32 v4, v4, v0
; GFX1132-DPP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1132-DPP-NEXT:    s_waitcnt_vscnt null, 0x0
...
; GFX1132-DPP-NEXT:  .LBB1_3: ; %atomicrmw.end
; GFX1132-DPP-NEXT:    s_endpgm
...
define amdgpu_kernel void @global_atomic_fadd_uni_value_scope_defalut(ptr addrspace(1) %ptr) #0 {
...
; GFX7LESS-NEXT:  .LBB2_3: ; %atomicrmw.end
; GFX7LESS-NEXT:    s_endpgm
;
...
; GFX8-NEXT:  .LBB2_3: ; %atomicrmw.end
; GFX8-NEXT:    s_endpgm
;
...
; GFX9-NEXT:  .LBB2_3: ; %atomicrmw.end
; GFX9-NEXT:    s_endpgm
;
...
; GFX1064-NEXT:  .LBB2_3: ; %atomicrmw.end
; GFX1064-NEXT:    s_endpgm
;
...
; GFX1032-NEXT:  .LBB2_3: ; %atomicrmw.end
; GFX1032-NEXT:    s_endpgm
;
...
; GFX1164-NEXT:  .LBB2_3: ; %atomicrmw.end
; GFX1164-NEXT:    s_endpgm
;
...
; GFX1132-NEXT:  .LBB2_3: ; %atomicrmw.end
; GFX1132-NEXT:    s_endpgm
;
...
; GFX9-DPP-NEXT:  .LBB2_3: ; %atomicrmw.end
; GFX9-DPP-NEXT:    s_endpgm
;
...
; GFX1064-DPP-NEXT:  .LBB2_3: ; %atomicrmw.end
; GFX1064-DPP-NEXT:    s_endpgm
;
...
; GFX1032-DPP-NEXT:  .LBB2_3: ; %atomicrmw.end
; GFX1032-DPP-NEXT:    s_endpgm
;
...
; GFX1164-DPP-NEXT:  .LBB2_3: ; %atomicrmw.end
; GFX1164-DPP-NEXT:    s_endpgm
;
...
; GFX1132-DPP-NEXT:  .LBB2_3: ; %atomicrmw.end
; GFX1132-DPP-NEXT:    s_endpgm
  %result = atomicrmw fmax ptr addrspace(1) %ptr, float 4.0 monotonic, align 4
  ret void
}

define amdgpu_kernel void @global_atomic_fadd_div_value_scope_defalut(ptr addrspace(1) %ptr) #0 {
...
; GFX8-NEXT:  .LBB3_5: ; %atomicrmw.end
; GFX8-NEXT:    s_endpgm
;
...
; GFX9-NEXT:  .LBB3_5: ; %atomicrmw.end
; GFX9-NEXT:    s_endpgm
;
...
; GFX1064-NEXT:  .LBB3_5: ; %atomicrmw.end
; GFX1064-NEXT:    s_endpgm
;
...
; GFX1032-NEXT:  .LBB3_5: ; %atomicrmw.end
; GFX1032-NEXT:    s_endpgm
;
...
; GFX1164-NEXT:  .LBB3_5: ; %atomicrmw.end
; GFX1164-NEXT:    s_endpgm
;
...
; GFX1132-NEXT:  .LBB3_5: ; %atomicrmw.end
; GFX1132-NEXT:    s_endpgm
;
...
; GFX9-DPP-NEXT:  .LBB3_3: ; %atomicrmw.end
; GFX9-DPP-NEXT:    s_endpgm
;
...
; GFX1064-DPP-NEXT:  .LBB3_3: ; %atomicrmw.end
; GFX1064-DPP-NEXT:    s_endpgm
;
...
; GFX1032-DPP-NEXT:  .LBB3_3: ; %atomicrmw.end
; GFX1032-DPP-NEXT:    s_endpgm
;
...
; GFX1164-DPP-NEXT:  .LBB3_3: ; %atomicrmw.end
; GFX1164-DPP-NEXT:    s_endpgm
;
...
; GFX1132-DPP-NEXT:  .LBB3_3: ; %atomicrmw.end
; GFX1132-DPP-NEXT:    s_endpgm
  %id.x = call i32 @llvm.amdgcn.workitem.id.x()
  %divValue = bitcast i32 %id.x to float
...
define amdgpu_kernel void @global_atomic_fadd_uni_value_scope_agent(ptr addrspace(1) %ptr) #0 {
...
; GFX7LESS-NEXT:  .LBB4_3: ; %atomicrmw.end
; GFX7LESS-NEXT:    s_endpgm
;
...
; GFX8-NEXT:  .LBB4_3: ; %atomicrmw.end
; GFX8-NEXT:    s_endpgm
;
...
; GFX9-NEXT:  .LBB4_3: ; %atomicrmw.end
; GFX9-NEXT:    s_endpgm
;
...
; GFX1064-NEXT:  .LBB4_3: ; %atomicrmw.end
; GFX1064-NEXT:    s_endpgm
;
...
; GFX1032-NEXT:  .LBB4_3: ; %atomicrmw.end
; GFX1032-NEXT:    s_endpgm
;
...
; GFX1164-NEXT:  .LBB4_3: ; %atomicrmw.end
; GFX1164-NEXT:    s_endpgm
;
...
; GFX1132-NEXT:  .LBB4_3: ; %atomicrmw.end
; GFX1132-NEXT:    s_endpgm
;
...
; GFX9-DPP-NEXT:  .LBB4_3: ; %atomicrmw.end
; GFX9-DPP-NEXT:    s_endpgm
;
...
; GFX1064-DPP-NEXT:  .LBB4_3: ; %atomicrmw.end
; GFX1064-DPP-NEXT:    s_endpgm
;
...
; GFX1032-DPP-NEXT:  .LBB4_3: ; %atomicrmw.end
; GFX1032-DPP-NEXT:    s_endpgm
;
...
; GFX1164-DPP-NEXT:  .LBB4_3: ; %atomicrmw.end
; GFX1164-DPP-NEXT:    s_endpgm
;
...
; GFX1132-DPP-NEXT:  .LBB4_3: ; %atomicrmw.end
; GFX1132-DPP-NEXT:    s_endpgm
...
define amdgpu_kernel void @global_atomic_fadd_div_value_scope_agent(ptr addrspace(1) %ptr) #0 {
...
; GFX8-NEXT:  .LBB5_5: ; %atomicrmw.end
; GFX8-NEXT:    s_endpgm
;
...
; GFX9-NEXT:  .LBB5_5: ; %atomicrmw.end
; GFX9-NEXT:    s_endpgm
;
...
; GFX1064-NEXT:  .LBB5_5: ; %atomicrmw.end
; GFX1064-NEXT:    s_endpgm
;
...
; GFX1032-NEXT:  .LBB5_5: ; %atomicrmw.end
; GFX1032-NEXT:    s_endpgm
;
...
; GFX1164-NEXT:  .LBB5_5: ; %atomicrmw.end
; GFX1164-NEXT:    s_endpgm
;
...
; GFX1132-NEXT:  .LBB5_5: ; %atomicrmw.end
; GFX1132-NEXT:    s_endpgm
;
...
; GFX9-DPP-NEXT:  .LBB5_3: ; %atomicrmw.end
; GFX9-DPP-NEXT:    s_endpgm
;
...
; GFX1064-DPP-NEXT:  .LBB5_3: ; %atomicrmw.end
; GFX1064-DPP-NEXT:    s_endpgm
;
...
; GFX1032-DPP-NEXT:  .LBB5_3: ; %atomicrmw.end
; GFX1032-DPP-NEXT:    s_endpgm
;
...
; GFX1164-DPP-NEXT:  .LBB5_3: ; %atomicrmw.end
; GFX1164-DPP-NEXT:    s_endpgm
;
...
; GFX1132-DPP-NEXT:  .LBB5_3: ; %atomicrmw.end
; GFX1132-DPP-NEXT:    s_endpgm
  %id.x = call i32 @llvm.amdgcn.workitem.id.x()
  %divValue = bitcast i32 %id.x to float
