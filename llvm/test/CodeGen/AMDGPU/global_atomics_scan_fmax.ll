...
define amdgpu_kernel void @global_atomic_fmax_uni_value_scope_agent_attr0(ptr addrspace(1) %ptr) #0 {
...
define amdgpu_kernel void @global_atomic_fmax_div_value_scope_agent_attr0(ptr addrspace(1) %ptr) #0 {
...
define amdgpu_kernel void @global_atomic_fmax_uni_value_scope_one_as_attr1(ptr addrspace(1) %ptr) #0 {
; GFX7LESS-LABEL: global_atomic_fmax_uni_value_scope_one_as_attr1:
; GFX7LESS:       ; %bb.0:
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x9
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_load_dword s2, s[0:1], 0x0
...
; GFX7LESS-NEXT:    s_endpgm
;
; GFX9-LABEL: global_atomic_fmax_uni_value_scope_one_as_attr1:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX9-NEXT:    s_mov_b64 s[2:3], 0
; GFX9-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX9-NEXT:    s_endpgm
;
; GFX1064-LABEL: global_atomic_fmax_uni_value_scope_one_as_attr1:
; GFX1064:       ; %bb.0:
; GFX1064-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1064-NEXT:    v_mov_b32_e32 v2, 0
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064-NEXT:    s_endpgm
;
; GFX1032-LABEL: global_atomic_fmax_uni_value_scope_one_as_attr1:
; GFX1032:       ; %bb.0:
; GFX1032-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1032-NEXT:    v_mov_b32_e32 v2, 0
; GFX1032-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032-NEXT:    s_endpgm
;
; GFX1164-LABEL: global_atomic_fmax_uni_value_scope_one_as_attr1:
; GFX1164:       ; %bb.0:
; GFX1164-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1164-NEXT:    v_mov_b32_e32 v2, 0
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-NEXT:    s_endpgm
;
; GFX1132-LABEL: global_atomic_fmax_uni_value_scope_one_as_attr1:
; GFX1132:       ; %bb.0:
; GFX1132-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1132-NEXT:    v_mov_b32_e32 v2, 0
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132-NEXT:    s_endpgm
;
; GFX9-DPP-LABEL: global_atomic_fmax_uni_value_scope_one_as_attr1:
; GFX9-DPP:       ; %bb.0:
; GFX9-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX9-DPP-NEXT:    s_mov_b64 s[2:3], 0
; GFX9-DPP-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX9-DPP-NEXT:    s_endpgm
;
; GFX1064-DPP-LABEL: global_atomic_fmax_uni_value_scope_one_as_attr1:
; GFX1064-DPP:       ; %bb.0:
; GFX1064-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1064-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX1064-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064-DPP-NEXT:    s_endpgm
;
; GFX1032-DPP-LABEL: global_atomic_fmax_uni_value_scope_one_as_attr1:
; GFX1032-DPP:       ; %bb.0:
; GFX1032-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1032-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX1032-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032-DPP-NEXT:    s_endpgm
;
; GFX1164-DPP-LABEL: global_atomic_fmax_uni_value_scope_one_as_attr1:
; GFX1164-DPP:       ; %bb.0:
; GFX1164-DPP-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1164-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX1164-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-DPP-NEXT:    s_endpgm
;
; GFX1132-DPP-LABEL: global_atomic_fmax_uni_value_scope_one_as_attr1:
; GFX1132-DPP:       ; %bb.0:
; GFX1132-DPP-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1132-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX1132-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
define amdgpu_kernel void @global_atomic_fmax_div_value_scope_one_as_attr1(ptr addrspace(1) %ptr) #0 {
; GFX7LESS-LABEL: global_atomic_fmax_div_value_scope_one_as_attr1:
; GFX7LESS:       ; %bb.0:
; GFX7LESS-NEXT:    s_mov_b32 s32, 0
; GFX7LESS-NEXT:    s_mov_b32 s40, SCRATCH_RSRC_DWORD0
; GFX7LESS-NEXT:    s_mov_b32 s41, SCRATCH_RSRC_DWORD1
...
; GFX7LESS-NEXT:    s_endpgm
;
; GFX9-LABEL: global_atomic_fmax_div_value_scope_one_as_attr1:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s36, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s37, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s38, -1
...
; GFX9-NEXT:    s_endpgm
;
; GFX1064-LABEL: global_atomic_fmax_div_value_scope_one_as_attr1:
; GFX1064:       ; %bb.0:
; GFX1064-NEXT:    s_mov_b32 s36, SCRATCH_RSRC_DWORD0
; GFX1064-NEXT:    s_mov_b32 s37, SCRATCH_RSRC_DWORD1
; GFX1064-NEXT:    s_mov_b32 s38, -1
...
; GFX1064-NEXT:    s_endpgm
;
; GFX1032-LABEL: global_atomic_fmax_div_value_scope_one_as_attr1:
; GFX1032:       ; %bb.0:
; GFX1032-NEXT:    s_mov_b32 s36, SCRATCH_RSRC_DWORD0
; GFX1032-NEXT:    s_mov_b32 s37, SCRATCH_RSRC_DWORD1
; GFX1032-NEXT:    s_mov_b32 s38, -1
...
; GFX1032-NEXT:    s_endpgm
;
; GFX1164-LABEL: global_atomic_fmax_div_value_scope_one_as_attr1:
; GFX1164:       ; %bb.0:
; GFX1164-NEXT:    s_mov_b32 s12, s8
; GFX1164-NEXT:    s_add_u32 s8, s4, 44
; GFX1164-NEXT:    s_mov_b32 s13, s9
...
; GFX1164-NEXT:    s_endpgm
;
; GFX1132-LABEL: global_atomic_fmax_div_value_scope_one_as_attr1:
; GFX1132:       ; %bb.0:
; GFX1132-NEXT:    s_add_u32 s8, s4, 44
; GFX1132-NEXT:    s_addc_u32 s9, s5, 0
; GFX1132-NEXT:    s_mov_b64 s[10:11], s[6:7]
...
; GFX1132-NEXT:    s_endpgm
;
; GFX9-DPP-LABEL: global_atomic_fmax_div_value_scope_one_as_attr1:
; GFX9-DPP:       ; %bb.0:
; GFX9-DPP-NEXT:    s_mov_b32 s36, SCRATCH_RSRC_DWORD0
; GFX9-DPP-NEXT:    s_mov_b32 s37, SCRATCH_RSRC_DWORD1
; GFX9-DPP-NEXT:    s_mov_b32 s38, -1
...
; GFX9-DPP-NEXT:    s_endpgm
;
; GFX1064-DPP-LABEL: global_atomic_fmax_div_value_scope_one_as_attr1:
; GFX1064-DPP:       ; %bb.0:
; GFX1064-DPP-NEXT:    s_mov_b32 s36, SCRATCH_RSRC_DWORD0
; GFX1064-DPP-NEXT:    s_mov_b32 s37, SCRATCH_RSRC_DWORD1
; GFX1064-DPP-NEXT:    s_mov_b32 s38, -1
...
; GFX1064-DPP-NEXT:    s_endpgm
;
; GFX1032-DPP-LABEL: global_atomic_fmax_div_value_scope_one_as_attr1:
; GFX1032-DPP:       ; %bb.0:
; GFX1032-DPP-NEXT:    s_mov_b32 s36, SCRATCH_RSRC_DWORD0
; GFX1032-DPP-NEXT:    s_mov_b32 s37, SCRATCH_RSRC_DWORD1
; GFX1032-DPP-NEXT:    s_mov_b32 s38, -1
...
; GFX1032-DPP-NEXT:    s_endpgm
;
; GFX1164-DPP-LABEL: global_atomic_fmax_div_value_scope_one_as_attr1:
; GFX1164-DPP:       ; %bb.0:
; GFX1164-DPP-NEXT:    s_mov_b32 s12, s8
; GFX1164-DPP-NEXT:    s_add_u32 s8, s4, 44
; GFX1164-DPP-NEXT:    s_mov_b32 s13, s9
...
; GFX1164-DPP-NEXT:    s_endpgm
;
; GFX1132-DPP-LABEL: global_atomic_fmax_div_value_scope_one_as_attr1:
; GFX1132-DPP:       ; %bb.0:
; GFX1132-DPP-NEXT:    s_add_u32 s8, s4, 44
; GFX1132-DPP-NEXT:    s_addc_u32 s9, s5, 0
; GFX1132-DPP-NEXT:    s_mov_b64 s[10:11], s[6:7]
...
define amdgpu_kernel void @global_atomic_fmax_uni_value_scope_defalut_attr2(ptr addrspace(1) %ptr) #0 {
; GFX7LESS-LABEL: global_atomic_fmax_uni_value_scope_defalut_attr2:
; GFX7LESS:       ; %bb.0:
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x9
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_load_dword s2, s[0:1], 0x0
...
; GFX7LESS-NEXT:    s_endpgm
;
; GFX9-LABEL: global_atomic_fmax_uni_value_scope_defalut_attr2:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX9-NEXT:    s_mov_b64 s[2:3], 0
; GFX9-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX9-NEXT:    s_endpgm
;
; GFX1064-LABEL: global_atomic_fmax_uni_value_scope_defalut_attr2:
; GFX1064:       ; %bb.0:
; GFX1064-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1064-NEXT:    v_mov_b32_e32 v2, 0
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064-NEXT:    s_endpgm
;
; GFX1032-LABEL: global_atomic_fmax_uni_value_scope_defalut_attr2:
; GFX1032:       ; %bb.0:
; GFX1032-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1032-NEXT:    v_mov_b32_e32 v2, 0
; GFX1032-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032-NEXT:    s_endpgm
;
; GFX1164-LABEL: global_atomic_fmax_uni_value_scope_defalut_attr2:
; GFX1164:       ; %bb.0:
; GFX1164-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1164-NEXT:    v_mov_b32_e32 v2, 0
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-NEXT:    s_endpgm
;
; GFX1132-LABEL: global_atomic_fmax_uni_value_scope_defalut_attr2:
; GFX1132:       ; %bb.0:
; GFX1132-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1132-NEXT:    v_mov_b32_e32 v2, 0
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132-NEXT:    s_endpgm
;
; GFX9-DPP-LABEL: global_atomic_fmax_uni_value_scope_defalut_attr2:
; GFX9-DPP:       ; %bb.0:
; GFX9-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX9-DPP-NEXT:    s_mov_b64 s[2:3], 0
; GFX9-DPP-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX9-DPP-NEXT:    s_endpgm
;
; GFX1064-DPP-LABEL: global_atomic_fmax_uni_value_scope_defalut_attr2:
; GFX1064-DPP:       ; %bb.0:
; GFX1064-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1064-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX1064-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064-DPP-NEXT:    s_endpgm
;
; GFX1032-DPP-LABEL: global_atomic_fmax_uni_value_scope_defalut_attr2:
; GFX1032-DPP:       ; %bb.0:
; GFX1032-DPP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX1032-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX1032-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032-DPP-NEXT:    s_endpgm
;
; GFX1164-DPP-LABEL: global_atomic_fmax_uni_value_scope_defalut_attr2:
; GFX1164-DPP:       ; %bb.0:
; GFX1164-DPP-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1164-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX1164-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-DPP-NEXT:    s_endpgm
;
; GFX1132-DPP-LABEL: global_atomic_fmax_uni_value_scope_defalut_attr2:
; GFX1132-DPP:       ; %bb.0:
; GFX1132-DPP-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1132-DPP-NEXT:    v_mov_b32_e32 v2, 0
; GFX1132-DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
define amdgpu_kernel void @global_atomic_fmax_div_value_scope_defalut_attr2(ptr addrspace(1) %ptr) #0 {
; GFX7LESS-LABEL: global_atomic_fmax_div_value_scope_defalut_attr2:
; GFX7LESS:       ; %bb.0:
; GFX7LESS-NEXT:    s_mov_b32 s32, 0
; GFX7LESS-NEXT:    s_mov_b32 s40, SCRATCH_RSRC_DWORD0
; GFX7LESS-NEXT:    s_mov_b32 s41, SCRATCH_RSRC_DWORD1
...
; GFX7LESS-NEXT:    s_endpgm
;
; GFX9-LABEL: global_atomic_fmax_div_value_scope_defalut_attr2:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s36, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s37, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s38, -1
...
; GFX9-NEXT:    s_endpgm
;
; GFX1064-LABEL: global_atomic_fmax_div_value_scope_defalut_attr2:
; GFX1064:       ; %bb.0:
; GFX1064-NEXT:    s_mov_b32 s36, SCRATCH_RSRC_DWORD0
; GFX1064-NEXT:    s_mov_b32 s37, SCRATCH_RSRC_DWORD1
; GFX1064-NEXT:    s_mov_b32 s38, -1
...
; GFX1064-NEXT:    s_endpgm
;
; GFX1032-LABEL: global_atomic_fmax_div_value_scope_defalut_attr2:
; GFX1032:       ; %bb.0:
; GFX1032-NEXT:    s_mov_b32 s36, SCRATCH_RSRC_DWORD0
; GFX1032-NEXT:    s_mov_b32 s37, SCRATCH_RSRC_DWORD1
; GFX1032-NEXT:    s_mov_b32 s38, -1
...
; GFX1032-NEXT:    s_endpgm
;
; GFX1164-LABEL: global_atomic_fmax_div_value_scope_defalut_attr2:
; GFX1164:       ; %bb.0:
; GFX1164-NEXT:    s_mov_b32 s12, s8
; GFX1164-NEXT:    s_add_u32 s8, s4, 44
; GFX1164-NEXT:    s_mov_b32 s13, s9
...
; GFX1164-NEXT:    s_endpgm
;
; GFX1132-LABEL: global_atomic_fmax_div_value_scope_defalut_attr2:
; GFX1132:       ; %bb.0:
; GFX1132-NEXT:    s_add_u32 s8, s4, 44
; GFX1132-NEXT:    s_addc_u32 s9, s5, 0
; GFX1132-NEXT:    s_mov_b64 s[10:11], s[6:7]
...
; GFX1132-NEXT:    s_endpgm
;
; GFX9-DPP-LABEL: global_atomic_fmax_div_value_scope_defalut_attr2:
; GFX9-DPP:       ; %bb.0:
; GFX9-DPP-NEXT:    s_mov_b32 s36, SCRATCH_RSRC_DWORD0
; GFX9-DPP-NEXT:    s_mov_b32 s37, SCRATCH_RSRC_DWORD1
; GFX9-DPP-NEXT:    s_mov_b32 s38, -1
...
; GFX9-DPP-NEXT:    s_endpgm
;
; GFX1064-DPP-LABEL: global_atomic_fmax_div_value_scope_defalut_attr2:
; GFX1064-DPP:       ; %bb.0:
; GFX1064-DPP-NEXT:    s_mov_b32 s36, SCRATCH_RSRC_DWORD0
; GFX1064-DPP-NEXT:    s_mov_b32 s37, SCRATCH_RSRC_DWORD1
; GFX1064-DPP-NEXT:    s_mov_b32 s38, -1
...
; GFX1064-DPP-NEXT:    s_endpgm
;
; GFX1032-DPP-LABEL: global_atomic_fmax_div_value_scope_defalut_attr2:
; GFX1032-DPP:       ; %bb.0:
; GFX1032-DPP-NEXT:    s_mov_b32 s36, SCRATCH_RSRC_DWORD0
; GFX1032-DPP-NEXT:    s_mov_b32 s37, SCRATCH_RSRC_DWORD1
; GFX1032-DPP-NEXT:    s_mov_b32 s38, -1
...
; GFX1032-DPP-NEXT:    s_endpgm
;
; GFX1164-DPP-LABEL: global_atomic_fmax_div_value_scope_defalut_attr2:
; GFX1164-DPP:       ; %bb.0:
; GFX1164-DPP-NEXT:    s_mov_b32 s12, s8
; GFX1164-DPP-NEXT:    s_add_u32 s8, s4, 44
; GFX1164-DPP-NEXT:    s_mov_b32 s13, s9
...
; GFX1164-DPP-NEXT:    s_endpgm
;
; GFX1132-DPP-LABEL: global_atomic_fmax_div_value_scope_defalut_attr2:
; GFX1132-DPP:       ; %bb.0:
; GFX1132-DPP-NEXT:    s_add_u32 s8, s4, 44
; GFX1132-DPP-NEXT:    s_addc_u32 s9, s5, 0
; GFX1132-DPP-NEXT:    s_mov_b64 s[10:11], s[6:7]
