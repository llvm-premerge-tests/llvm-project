...
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_bfe_u32 s1, s0, 0x80008
; SI-NEXT:    s_add_i32 s0, s0, s0
...
entry:
  ...
  store <2 x i8> %add, ptr addrspace(1) undef
  ret void
}
...
; SI-NEXT:    s_bfe_u32 s4, s0, 0x80008
; SI-NEXT:    s_add_i32 s0, s0, s0
...
entry:
  ...
  store <4 x i8> %add, ptr addrspace(1) undef
  ret void
}
...
; GFX11-NEXT:    v_add_nc_u16 v2, s0, s0
; GFX11-NEXT:    v_add_nc_u16 v0, v0, v0
...
entry:
  ...
  store <3 x i8> %add, ptr addrspace(1) undef
  ret void
}
...
; SI-NEXT:    s_bfe_u32 s6, s0, 0x80008
; SI-NEXT:    s_add_i32 s0, s0, s0
; SI-NEXT:    s_add_i32 s1, s1, s1
...
entry:
  ...
  store <5 x i8> %add, ptr addrspace(1) undef
  ret void
}
...
; SI-NEXT:    s_lshr_b32 s4, s0, 24
; SI-NEXT:    s_lshr_b32 s5, s1, 16
; SI-NEXT:    s_lshr_b32 s6, s1, 24
; SI-NEXT:    s_bfe_u32 s7, s0, 0x80008
; SI-NEXT:    s_bfe_u32 s8, s1, 0x80008
; SI-NEXT:    s_add_i32 s1, s1, s1
; SI-NEXT:    s_add_i32 s0, s0, s0
; SI-NEXT:    s_add_i32 s6, s6, s6
; SI-NEXT:    s_add_i32 s5, s5, s5
...
entry:
  ...
  store <8 x i8> %add, ptr addrspace(1) undef
  ret void
}
...
; SI-NEXT:    s_lshr_b32 s4, s0, 16
; SI-NEXT:    s_lshr_b32 s5, s0, 24
; SI-NEXT:    s_lshr_b32 s6, s1, 16
; SI-NEXT:    s_lshr_b32 s8, s1, 24
; SI-NEXT:    s_lshr_b32 s9, s2, 16
; SI-NEXT:    s_lshr_b32 s10, s2, 24
; SI-NEXT:    s_lshr_b32 s11, s3, 16
; SI-NEXT:    s_lshr_b32 s12, s3, 24
; SI-NEXT:    s_bfe_u32 s13, s0, 0x80008
; SI-NEXT:    s_bfe_u32 s14, s1, 0x80008
; SI-NEXT:    s_bfe_u32 s15, s2, 0x80008
; SI-NEXT:    s_bfe_u32 s16, s3, 0x80008
...
; SI-NEXT:    s_or_b32 s3, s3, s16
; SI-NEXT:    s_lshl_b32 s9, s9, 16
; SI-NEXT:    s_or_b32 s2, s2, s15
; SI-NEXT:    s_lshl_b32 s6, s6, 16
; SI-NEXT:    s_or_b32 s1, s1, s14
; SI-NEXT:    s_lshl_b32 s4, s4, 16
...
; VI-NEXT:    v_or_b32_sdwa v0, v5, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
...
entry:
  ...
  store <16 x i8> %add, ptr addrspace(1) undef
  ret void
}
...
; SI-NEXT:    s_lshr_b32 s9, s4, 24
; SI-NEXT:    s_lshr_b32 s12, s5, 16
; SI-NEXT:    s_lshr_b32 s13, s5, 24
; SI-NEXT:    s_lshr_b32 s14, s6, 16
; SI-NEXT:    s_lshr_b32 s15, s6, 24
; SI-NEXT:    s_lshr_b32 s16, s7, 16
; SI-NEXT:    s_lshr_b32 s17, s7, 24
; SI-NEXT:    s_lshr_b32 s18, s0, 16
; SI-NEXT:    s_lshr_b32 s19, s0, 24
; SI-NEXT:    s_lshr_b32 s20, s1, 16
; SI-NEXT:    s_lshr_b32 s21, s1, 24
; SI-NEXT:    s_lshr_b32 s22, s2, 16
; SI-NEXT:    s_lshr_b32 s23, s2, 24
; SI-NEXT:    s_lshr_b32 s24, s3, 16
; SI-NEXT:    s_lshr_b32 s25, s3, 24
; SI-NEXT:    s_bfe_u32 s26, s4, 0x80008
; SI-NEXT:    s_bfe_u32 s27, s5, 0x80008
; SI-NEXT:    s_bfe_u32 s28, s6, 0x80008
; SI-NEXT:    s_bfe_u32 s29, s7, 0x80008
; SI-NEXT:    s_bfe_u32 s30, s0, 0x80008
; SI-NEXT:    s_bfe_u32 s31, s1, 0x80008
; SI-NEXT:    s_bfe_u32 s33, s2, 0x80008
; SI-NEXT:    s_bfe_u32 s34, s3, 0x80008
; SI-NEXT:    s_add_i32 s3, s3, s3
; SI-NEXT:    s_add_i32 s2, s2, s2
; SI-NEXT:    s_add_i32 s1, s1, s1
; SI-NEXT:    s_add_i32 s0, s0, s0
...
; SI-NEXT:    s_or_b32 s3, s3, s24
; SI-NEXT:    s_or_b32 s2, s2, s22
; SI-NEXT:    s_or_b32 s1, s1, s20
; SI-NEXT:    s_or_b32 s7, s7, s16
; SI-NEXT:    s_or_b32 s6, s6, s14
; SI-NEXT:    s_or_b32 s5, s5, s12
; SI-NEXT:    s_or_b32 s4, s4, s8
; SI-NEXT:    s_or_b32 s0, s0, s18
; SI-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX11-NEXT:    v_or_b32_e32 v9, v10, v9
; GFX11-NEXT:    v_add_nc_u16 v10, s13, s13
; GFX11-NEXT:    v_add_nc_u16 v11, s12, s12
; GFX11-NEXT:    v_add_nc_u16 v12, s5, s5
...
; GFX11-NEXT:    v_or_b32_e32 v6, v5, v10
; GFX11-NEXT:    v_or_b32_e32 v5, v4, v11
; GFX11-NEXT:    v_or_b32_e32 v4, v0, v12
; GFX11-NEXT:    v_or_b32_e32 v0, v8, v9
; GFX11-NEXT:    s_clause 0x1
...
entry:
  ...
  store <32 x i8> %add, ptr addrspace(1) undef
  ret void
}
