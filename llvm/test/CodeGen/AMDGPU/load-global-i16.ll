...
; GCN-HSA-NEXT:    flat_load_dwordx4 v[32:35], v[20:21]
; GCN-HSA-NEXT:    v_mov_b32_e32 v21, s3
; GCN-HSA-NEXT:    v_mov_b32_e32 v20, s2
...
; GCN-HSA-NEXT:    flat_store_dwordx4 v[16:17], v[20:23]
...
; GCN-HSA-NEXT:    flat_store_dwordx4 v[23:24], v[12:15]
; GCN-HSA-NEXT:    flat_store_dwordx4 v[20:21], v[16:19]
; GCN-HSA-NEXT:    s_waitcnt vmcnt(9)
...
; GCN-HSA-NEXT:    v_and_b32_e32 v17, 0xffff, v11
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s3
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 64
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v16, 16, v10
; GCN-HSA-NEXT:    v_and_b32_e32 v15, 0xffff, v10
; GCN-HSA-NEXT:    flat_store_dwordx4 v[0:1], v[19:22]
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s2
; GCN-HSA-NEXT:    flat_store_dwordx4 v[7:8], v[15:18]
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s3
...
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s2
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v10, 16, v31
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v8, 16, v30
; GCN-HSA-NEXT:    v_and_b32_e32 v9, 0xffff, v31
; GCN-HSA-NEXT:    v_and_b32_e32 v7, 0xffff, v30
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s3
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 32
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s8, s6
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s9, s7
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[0:3], off, s[8:11], 0 offset:80
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[4:7], off, s[8:11], 0 offset:64
...
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[16:19], off, s[8:11], 0 offset:32
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[20:23], off, s[8:11], 0 offset:48
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[24:27], off, s[8:11], 0 offset:96
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[28:31], off, s[8:11], 0 offset:112
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(5)
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v35, 16, v11
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v33, 16, v10
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v34, v11, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v32, v10, 0, 16
; GCN-NOHSA-SI-NEXT:    buffer_store_dword v32, off, s[12:15], 0 offset:4 ; 4-byte Folded Spill
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-SI-NEXT:    buffer_store_dword v33, off, s[12:15], 0 offset:8 ; 4-byte Folded Spill
; GCN-NOHSA-SI-NEXT:    buffer_store_dword v34, off, s[12:15], 0 offset:12 ; 4-byte Folded Spill
; GCN-NOHSA-SI-NEXT:    buffer_store_dword v35, off, s[12:15], 0 offset:16 ; 4-byte Folded Spill
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v39, 16, v9
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v37, 16, v8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v38, v9, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v36, v8, 0, 16
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v35, 16, v15
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v33, 16, v14
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v34, v15, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v32, v14, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v43, 16, v13
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v41, 16, v12
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v42, v13, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v40, v12, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v15, 16, v19
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v13, 16, v18
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v14, v19, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v12, v18, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v47, 16, v17
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v45, 16, v16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v46, v17, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v44, v16, 0, 16
...
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v51, 16, v21
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v49, 16, v20
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v50, v21, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v48, v20, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v23, 16, v7
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v21, 16, v6
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v22, v7, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v20, v6, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v55, 16, v5
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v53, 16, v4
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v54, v5, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v52, v4, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v11, 16, v3
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v9, 16, v2
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v10, v3, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v8, v2, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v59, 16, v1
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v57, 16, v0
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v58, v1, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v56, v0, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v63, 16, v27
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v61, 16, v26
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v62, v27, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v60, v26, 0, 16
...
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[60:63], off, s[0:3], 0 offset:208
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[56:59], off, s[0:3], 0 offset:160
...
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[32:35], off, s[0:3], 0 offset:48
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[36:39], off, s[0:3], 0
; GCN-NOHSA-SI-NEXT:    buffer_load_dword v0, off, s[12:15], 0 offset:4 ; 4-byte Folded Reload
; GCN-NOHSA-SI-NEXT:    buffer_load_dword v1, off, s[12:15], 0 offset:8 ; 4-byte Folded Reload
; GCN-NOHSA-SI-NEXT:    buffer_load_dword v2, off, s[12:15], 0 offset:12 ; 4-byte Folded Reload
...
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v31, 16, v17
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v29, 16, v16
; GCN-HSA-NEXT:    v_bfe_i32 v30, v17, 0, 16
; GCN-HSA-NEXT:    v_bfe_i32 v28, v16, 0, 16
; GCN-HSA-NEXT:    v_mov_b32_e32 v17, s1
; GCN-HSA-NEXT:    v_mov_b32_e32 v16, s0
; GCN-HSA-NEXT:    flat_store_dwordx4 v[16:17], v[28:31]
; GCN-HSA-NEXT:    v_mov_b32_e32 v17, s3
; GCN-HSA-NEXT:    v_mov_b32_e32 v16, s2
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 0xe0
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v31, 16, v19
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v29, 16, v18
; GCN-HSA-NEXT:    v_bfe_i32 v30, v19, 0, 16
; GCN-HSA-NEXT:    v_bfe_i32 v28, v18, 0, 16
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    flat_store_dwordx4 v[16:17], v[28:31]
; GCN-HSA-NEXT:    s_waitcnt vmcnt(8)
...
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    s_waitcnt vmcnt(9)
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v15, 16, v1
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v13, 16, v0
; GCN-HSA-NEXT:    v_bfe_i32 v14, v1, 0, 16
; GCN-HSA-NEXT:    v_bfe_i32 v12, v0, 0, 16
...
; GCN-HSA-NEXT:    flat_store_dwordx4 v[18:19], v[12:15]
; GCN-HSA-NEXT:    flat_store_dwordx4 v[28:29], v[3:6]
; GCN-HSA-NEXT:    v_mov_b32_e32 v13, s3
; GCN-HSA-NEXT:    v_mov_b32_e32 v12, s2
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 0x90
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
