...
;
; DAG-CI-LABEL: v_mad_mix_f32_f16lo_f16lo_f16lo:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mad_f32 v0, v0, v1, v2
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_f16hi_f16hi_f16hi_elt:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mad_f32 v0, v1, v3, v5
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; DAG-GFX900-LABEL: v_mad_mix_v2f32:
; DAG-GFX900:       ; %bb.0:
; DAG-GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX900-NEXT:    v_mad_mix_f32 v3, v0, v1, v2 op_sel:[1,1,1] op_sel_hi:[1,1,1]
; DAG-GFX900-NEXT:    v_mad_mix_f32 v0, v0, v1, v2 op_sel_hi:[1,1,1]
; DAG-GFX900-NEXT:    v_mov_b32_e32 v1, v3
; DAG-GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-GFX906-LABEL: v_mad_mix_v2f32:
; DAG-GFX906:       ; %bb.0:
; DAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX906-NEXT:    v_fma_mix_f32 v3, v0, v1, v2 op_sel:[1,1,1] op_sel_hi:[1,1,1]
; DAG-GFX906-NEXT:    v_fma_mix_f32 v0, v0, v1, v2 op_sel_hi:[1,1,1]
; DAG-GFX906-NEXT:    v_mov_b32_e32 v1, v3
...
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v4, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v5, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v6, v1
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v1, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v2
; DAG-VI-NEXT:    v_mac_f32_e32 v1, v3, v5
; DAG-VI-NEXT:    v_mac_f32_e32 v0, v4, v6
...
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v6, v3
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v1, v1
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v4, v4
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v3, v5
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v5, v6
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v2, v2
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v6, v0
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v0, v4
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v4, v6
; DAG-CI-NEXT:    v_mac_f32_e32 v3, v1, v5
; DAG-CI-NEXT:    v_mov_b32_e32 v1, v3
; DAG-CI-NEXT:    v_mac_f32_e32 v0, v4, v2
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_v2f32_shuffle:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v3, v3
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v4, v5
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v2, v2
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v5, v1
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v0, v0
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v3, v3
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v1, v4
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v4, v5
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v5, v0
; DAG-CI-NEXT:    v_mad_f32 v0, v4, v2, v1
; DAG-CI-NEXT:    v_mac_f32_e32 v1, v5, v3
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_f32_negf16lo_f16lo_f16lo:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-VI-NEXT:    v_mad_f32 v0, -v0, v1, v2
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_negf16lo_f16lo_f16lo:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mad_f32 v0, -v0, v1, v2
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_absf16lo_f16lo_f16lo:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mad_f32 v0, |v0|, v1, v2
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_negabsf16lo_f16lo_f16lo:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mad_f32 v0, -|v0|, v1, v2
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_f16lo_f16lo_f32:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mad_f32 v0, v0, v1, v2
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_f16lo_f16lo_negf32:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mad_f32 v0, v0, v1, -v2
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_f16lo_f16lo_absf32:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mad_f32 v0, v0, v1, |v2|
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_f16lo_f16lo_negabsf32:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mad_f32 v0, v0, v1, -|v2|
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
...
; DAG-GFX900-LABEL: v_mad_mix_f32_f16lo_f16lo_f32imm1:
; DAG-GFX900:       ; %bb.0:
; DAG-GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX900-NEXT:    s_mov_b32 s4, 1.0
; DAG-GFX900-NEXT:    v_mad_mix_f32 v0, v0, v1, s4 op_sel_hi:[1,1,0]
; DAG-GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-GFX906-LABEL: v_mad_mix_f32_f16lo_f16lo_f32imm1:
; DAG-GFX906:       ; %bb.0:
; DAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX906-NEXT:    s_mov_b32 s4, 1.0
; DAG-GFX906-NEXT:    v_fma_mix_f32 v0, v0, v1, s4 op_sel_hi:[1,1,0]
; DAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
;
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_f16lo_f16lo_f32imm1:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mad_f32 v0, v0, v1, 1.0
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; DAG-GFX900-LABEL: v_mad_mix_f32_f16lo_f16lo_f32imminv2pi:
; DAG-GFX900:       ; %bb.0:
; DAG-GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX900-NEXT:    s_mov_b32 s4, 0.15915494
; DAG-GFX900-NEXT:    v_mad_mix_f32 v0, v0, v1, s4 op_sel_hi:[1,1,0]
; DAG-GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-GFX906-LABEL: v_mad_mix_f32_f16lo_f16lo_f32imminv2pi:
; DAG-GFX906:       ; %bb.0:
; DAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX906-NEXT:    s_mov_b32 s4, 0.15915494
; DAG-GFX906-NEXT:    v_fma_mix_f32 v0, v0, v1, s4 op_sel_hi:[1,1,0]
; DAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
;
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_f16lo_f16lo_f32imminv2pi:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_madak_f32 v0, v0, v1, 0x3e22f983
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; DAG-GFX900-LABEL: v_mad_mix_f32_f16lo_f16lo_cvtf16imminv2pi:
; DAG-GFX900:       ; %bb.0:
; DAG-GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX900-NEXT:    s_mov_b32 s4, 0x3e230000
; DAG-GFX900-NEXT:    v_mad_mix_f32 v0, v0, v1, s4 op_sel_hi:[1,1,0]
; DAG-GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-GFX906-LABEL: v_mad_mix_f32_f16lo_f16lo_cvtf16imminv2pi:
; DAG-GFX906:       ; %bb.0:
; DAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX906-NEXT:    s_mov_b32 s4, 0x3e230000
; DAG-GFX906-NEXT:    v_fma_mix_f32 v0, v0, v1, s4 op_sel_hi:[1,1,0]
; DAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_f32_f16lo_f16lo_cvtf16imminv2pi:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-VI-NEXT:    v_madak_f32 v0, v0, v1, 0x3e230000
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_f16lo_f16lo_cvtf16imminv2pi:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_madak_f32 v0, v0, v1, 0x3e230000
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; DAG-GFX900-LABEL: v_mad_mix_f32_f16lo_f16lo_cvtf16imm63:
; DAG-GFX900:       ; %bb.0:
; DAG-GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX900-NEXT:    s_mov_b32 s4, 0x367c0000
; DAG-GFX900-NEXT:    v_mad_mix_f32 v0, v0, v1, s4 op_sel_hi:[1,1,0]
; DAG-GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-GFX906-LABEL: v_mad_mix_f32_f16lo_f16lo_cvtf16imm63:
; DAG-GFX906:       ; %bb.0:
; DAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX906-NEXT:    s_mov_b32 s4, 0x367c0000
; DAG-GFX906-NEXT:    v_fma_mix_f32 v0, v0, v1, s4 op_sel_hi:[1,1,0]
; DAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_f32_f16lo_f16lo_cvtf16imm63:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-VI-NEXT:    v_madak_f32 v0, v0, v1, 0x367c0000
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_f16lo_f16lo_cvtf16imm63:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_madak_f32 v0, v0, v1, 0x367c0000
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; DAG-GFX900-LABEL: v_mad_mix_v2f32_f32imm1:
; DAG-GFX900:       ; %bb.0:
; DAG-GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX900-NEXT:    s_mov_b32 s4, 1.0
; DAG-GFX900-NEXT:    v_mad_mix_f32 v2, v0, v1, s4 op_sel:[1,1,0] op_sel_hi:[1,1,0]
; DAG-GFX900-NEXT:    v_mad_mix_f32 v0, v0, v1, s4 op_sel_hi:[1,1,0]
; DAG-GFX900-NEXT:    v_mov_b32_e32 v1, v2
; DAG-GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-GFX906-LABEL: v_mad_mix_v2f32_f32imm1:
; DAG-GFX906:       ; %bb.0:
; DAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX906-NEXT:    s_mov_b32 s4, 1.0
; DAG-GFX906-NEXT:    v_fma_mix_f32 v2, v0, v1, s4 op_sel:[1,1,0] op_sel_hi:[1,1,0]
; DAG-GFX906-NEXT:    v_fma_mix_f32 v0, v0, v1, s4 op_sel_hi:[1,1,0]
; DAG-GFX906-NEXT:    v_mov_b32_e32 v1, v2
; DAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_v2f32_f32imm1:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v2, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v3, v1
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v1, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_mad_f32 v0, v0, v3, 1.0
; DAG-VI-NEXT:    v_mad_f32 v1, v2, v1, 1.0
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_v2f32_f32imm1:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v3, v3
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v2, v2
...
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-CI-NEXT:    v_mad_f32 v0, v0, v2, 1.0
; DAG-CI-NEXT:    v_mad_f32 v1, v1, v3, 1.0
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; DAG-GFX900-LABEL: v_mad_mix_v2f32_cvtf16imminv2pi:
; DAG-GFX900:       ; %bb.0:
; DAG-GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX900-NEXT:    s_mov_b32 s4, 0x3e230000
; DAG-GFX900-NEXT:    v_mad_mix_f32 v2, v0, v1, s4 op_sel:[1,1,0] op_sel_hi:[1,1,0]
...
; DAG-GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-GFX906-LABEL: v_mad_mix_v2f32_cvtf16imminv2pi:
; DAG-GFX906:       ; %bb.0:
; DAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX906-NEXT:    s_mov_b32 s4, 0x3e230000
; DAG-GFX906-NEXT:    v_fma_mix_f32 v2, v0, v1, s4 op_sel:[1,1,0] op_sel_hi:[1,1,0]
...
; DAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_v2f32_cvtf16imminv2pi:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v2, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
...
; DAG-VI-NEXT:    v_mov_b32_e32 v1, 0x3e230000
; DAG-VI-NEXT:    v_madak_f32 v0, v0, v3, 0x3e230000
; DAG-VI-NEXT:    v_mac_f32_e32 v1, v2, v4
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_v2f32_cvtf16imminv2pi:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v3, v3
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v2, v2
...
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v4, v1
; DAG-CI-NEXT:    v_mov_b32_e32 v1, 0x3e230000
; DAG-CI-NEXT:    v_madak_f32 v0, v0, v2, 0x3e230000
; DAG-CI-NEXT:    v_mac_f32_e32 v1, v4, v3
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; DAG-GFX900-LABEL: v_mad_mix_v2f32_f32imminv2pi:
; DAG-GFX900:       ; %bb.0:
; DAG-GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX900-NEXT:    s_mov_b32 s4, 0.15915494
; DAG-GFX900-NEXT:    v_mad_mix_f32 v2, v0, v1, s4 op_sel:[1,1,0] op_sel_hi:[1,1,0]
...
; DAG-GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-GFX906-LABEL: v_mad_mix_v2f32_f32imminv2pi:
; DAG-GFX906:       ; %bb.0:
; DAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-GFX906-NEXT:    s_mov_b32 s4, 0.15915494
; DAG-GFX906-NEXT:    v_fma_mix_f32 v2, v0, v1, s4 op_sel:[1,1,0] op_sel_hi:[1,1,0]
...
; DAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_v2f32_f32imminv2pi:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v2, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v3, v1
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v1, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_mad_f32 v0, v0, v3, 0.15915494
; DAG-VI-NEXT:    v_mad_f32 v1, v2, v1, 0.15915494
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_v2f32_f32imminv2pi:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v3, v3
; DAG-CI-NEXT:    v_cvt_f16_f32_e32 v2, v2
...
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v4, v1
; DAG-CI-NEXT:    v_mov_b32_e32 v1, 0x3e22f983
; DAG-CI-NEXT:    v_madak_f32 v0, v0, v2, 0x3e22f983
; DAG-CI-NEXT:    v_mac_f32_e32 v1, v4, v3
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_clamp_f32_f16hi_f16hi_f16hi_elt:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mad_f32 v0, v1, v3, v5 clamp
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_f16lo_f16lo_f16lo_f32_denormals:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_fma_f32 v0, v0, v1, v2
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_f16lo_f16lo_f32_denormals:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_fma_f32 v0, v0, v1, v2
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_f16lo_f16lo_f16lo_f32_denormals_fmulfadd:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mul_f32_e32 v0, v0, v1
; DAG-CI-NEXT:    v_add_f32_e32 v0, v0, v2
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_f16lo_f16lo_f32_denormals_fmulfadd:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mul_f32_e32 v0, v0, v1
; DAG-CI-NEXT:    v_add_f32_e32 v0, v0, v2
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_f16lo_f16lo_f16lo_f32_flush_fmulfadd:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mad_f32 v0, v0, v1, v2
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_f16lo_f16lo_f32_flush_fmulfadd:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_mad_f32 v0, v0, v1, v2
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
...
; GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_f32_negprecvtf16lo_f16lo_f16lo:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
...
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_negprecvtf16lo_f16lo_f16lo:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; DAG-CI-NEXT:    v_mad_f32 v0, -v0, v1, v2
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_precvtnegf16hi_abs_f16lo_f16lo:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; DAG-CI-NEXT:    v_cvt_f32_f16_e64 v0, |v0|
; DAG-CI-NEXT:    v_mad_f32 v0, v0, v1, v2
; DAG-CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_precvtabsf16hi_f16lo_f16lo:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; DAG-CI-NEXT:    v_cvt_f32_f16_e64 v0, |v0|
...
; GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_f32_preextractfneg_f16hi_f16lo_f16lo:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v0, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; DAG-VI-NEXT:    v_mad_f32 v0, -v0, v1, v2
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_preextractfneg_f16hi_f16lo_f16lo:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; DAG-CI-NEXT:    v_cvt_f32_f16_e64 v0, -v0
...
; GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_f32_preextractfabs_f16hi_f16lo_f16lo:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v3, |v0| dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v0, v2
; DAG-VI-NEXT:    v_mac_f32_e32 v0, v3, v1
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_preextractfabs_f16hi_f16lo_f16lo:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; DAG-CI-NEXT:    v_cvt_f32_f16_e64 v0, |v0|
...
; GFX906-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-VI-LABEL: v_mad_mix_f32_preextractfabsfneg_f16hi_f16lo_f16lo:
; DAG-VI:       ; %bb.0:
; DAG-VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-VI-NEXT:    v_cvt_f32_f16_sdwa v0, |v0| dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; DAG-VI-NEXT:    v_cvt_f32_f16_e32 v1, v1
...
; DAG-VI-NEXT:    s_setpc_b64 s[30:31]
;
; DAG-CI-LABEL: v_mad_mix_f32_preextractfabsfneg_f16hi_f16lo_f16lo:
; DAG-CI:       ; %bb.0:
; DAG-CI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAG-CI-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; DAG-CI-NEXT:    v_cvt_f32_f16_e64 v0, -|v0|
