...
define void @global_atomic_fmax_uni_value_scope_agent_attr0(ptr addrspace(1) %ptr) #0 {
...
; GFX7LESS-NEXT:    v_max_f32_e32 v2, 4.0, v2
...
define void @global_atomic_fmax_div_value_scope_agent_attr0(ptr addrspace(1) %ptr) #0 {
