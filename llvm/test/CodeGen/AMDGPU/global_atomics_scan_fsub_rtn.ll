...
define float @global_atomic_fsub_uni_value_scope_agent_attr0(ptr addrspace(1) %ptr) #0 {
...
define float @global_atomic_fsub_div_value_scope_agent_attr0(ptr addrspace(1) %ptr) #0 {
...
define float @global_atomic_fsub_uni_value_scope_one_as_attr1(ptr addrspace(1) %ptr) #1 {
...
; GFX7LESS-NEXT:    v_mov_b32_e32 v4, v2
; GFX7LESS-NEXT:    s_waitcnt expcnt(0)
; GFX7LESS-NEXT:    v_subrev_f32_e32 v3, 4.0, v4
; GFX7LESS-NEXT:    v_mov_b32_e32 v2, v3
; GFX7LESS-NEXT:    v_mov_b32_e32 v3, v4
; GFX7LESS-NEXT:    buffer_atomic_cmpswap v[2:3], v[0:1], s[4:7], 0 addr64 glc
; GFX7LESS-NEXT:    s_waitcnt vmcnt(0)
...
define  float @global_atomic_fsub_div_value_scope_one_as_attr1(ptr addrspace(1) %ptr) #1 {
...
define float @global_atomic_fsub_uni_value_scope_agent_attr2(ptr addrspace(1) %ptr) #2 {
; GFX7LESS-LABEL: global_atomic_fsub_uni_value_scope_agent_attr2:
; GFX7LESS:       ; %bb.0:
; GFX7LESS-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7LESS-NEXT:    s_mov_b32 s6, 0
; GFX7LESS-NEXT:    s_mov_b32 s7, 0xf000
...
; GFX7LESS-NEXT:    s_setpc_b64 s[30:31]
;
; GFX8-LABEL: global_atomic_fsub_uni_value_scope_agent_attr2:
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    flat_load_dword v2, v[0:1]
; GFX8-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: global_atomic_fsub_uni_value_scope_agent_attr2:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    global_load_dword v2, v[0:1], off
; GFX9-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1064-LABEL: global_atomic_fsub_uni_value_scope_agent_attr2:
; GFX1064:       ; %bb.0:
; GFX1064-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1064-NEXT:    global_load_dword v2, v[0:1], off
; GFX1064-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX1064-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1032-LABEL: global_atomic_fsub_uni_value_scope_agent_attr2:
; GFX1032:       ; %bb.0:
; GFX1032-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1032-NEXT:    global_load_dword v2, v[0:1], off
; GFX1032-NEXT:    s_mov_b32 s4, 0
...
; GFX1032-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1164-LABEL: global_atomic_fsub_uni_value_scope_agent_attr2:
; GFX1164:       ; %bb.0:
; GFX1164-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1164-NEXT:    global_load_b32 v2, v[0:1], off
; GFX1164-NEXT:    s_mov_b64 s[0:1], 0
...
; GFX1164-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1132-LABEL: global_atomic_fsub_uni_value_scope_agent_attr2:
; GFX1132:       ; %bb.0:
; GFX1132-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1132-NEXT:    global_load_b32 v2, v[0:1], off
; GFX1132-NEXT:    s_mov_b32 s0, 0
...
; GFX1132-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-DPP-LABEL: global_atomic_fsub_uni_value_scope_agent_attr2:
; GFX9-DPP:       ; %bb.0:
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-DPP-NEXT:    global_load_dword v2, v[0:1], off
; GFX9-DPP-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX9-DPP-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1064-DPP-LABEL: global_atomic_fsub_uni_value_scope_agent_attr2:
; GFX1064-DPP:       ; %bb.0:
; GFX1064-DPP-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1064-DPP-NEXT:    global_load_dword v2, v[0:1], off
; GFX1064-DPP-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX1064-DPP-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1032-DPP-LABEL: global_atomic_fsub_uni_value_scope_agent_attr2:
; GFX1032-DPP:       ; %bb.0:
; GFX1032-DPP-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1032-DPP-NEXT:    global_load_dword v2, v[0:1], off
; GFX1032-DPP-NEXT:    s_mov_b32 s4, 0
...
; GFX1032-DPP-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1164-DPP-LABEL: global_atomic_fsub_uni_value_scope_agent_attr2:
; GFX1164-DPP:       ; %bb.0:
; GFX1164-DPP-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1164-DPP-NEXT:    global_load_b32 v2, v[0:1], off
; GFX1164-DPP-NEXT:    s_mov_b64 s[0:1], 0
...
; GFX1164-DPP-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1132-DPP-LABEL: global_atomic_fsub_uni_value_scope_agent_attr2:
; GFX1132-DPP:       ; %bb.0:
; GFX1132-DPP-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1132-DPP-NEXT:    global_load_b32 v2, v[0:1], off
; GFX1132-DPP-NEXT:    s_mov_b32 s0, 0
...
define float @global_atomic_fsub_div_value_scope_agent_attr2(ptr addrspace(1) %ptr) #2 {
...
define float @global_atomic_fsub_uni_value_scope_agent1(ptr addrspace(1) %ptr) #1{
; GFX7LESS-LABEL: global_atomic_fsub_uni_value_scope_agent1:
; GFX7LESS:       ; %bb.0:
; GFX7LESS-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7LESS-NEXT:    s_mov_b32 s6, 0
; GFX7LESS-NEXT:    s_mov_b32 s7, 0xf000
...
; GFX7LESS-NEXT:    s_setpc_b64 s[30:31]
;
; GFX8-LABEL: global_atomic_fsub_uni_value_scope_agent1:
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    flat_load_dword v2, v[0:1]
; GFX8-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: global_atomic_fsub_uni_value_scope_agent1:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    global_load_dword v2, v[0:1], off
; GFX9-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1064-LABEL: global_atomic_fsub_uni_value_scope_agent1:
; GFX1064:       ; %bb.0:
; GFX1064-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1064-NEXT:    global_load_dword v2, v[0:1], off
; GFX1064-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX1064-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1032-LABEL: global_atomic_fsub_uni_value_scope_agent1:
; GFX1032:       ; %bb.0:
; GFX1032-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1032-NEXT:    global_load_dword v2, v[0:1], off
; GFX1032-NEXT:    s_mov_b32 s4, 0
...
; GFX1032-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1164-LABEL: global_atomic_fsub_uni_value_scope_agent1:
; GFX1164:       ; %bb.0:
; GFX1164-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1164-NEXT:    global_load_b32 v2, v[0:1], off
; GFX1164-NEXT:    s_mov_b64 s[0:1], 0
...
; GFX1164-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1132-LABEL: global_atomic_fsub_uni_value_scope_agent1:
; GFX1132:       ; %bb.0:
; GFX1132-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1132-NEXT:    global_load_b32 v2, v[0:1], off
; GFX1132-NEXT:    s_mov_b32 s0, 0
...
; GFX1132-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-DPP-LABEL: global_atomic_fsub_uni_value_scope_agent1:
; GFX9-DPP:       ; %bb.0:
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-DPP-NEXT:    global_load_dword v2, v[0:1], off
; GFX9-DPP-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX9-DPP-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1064-DPP-LABEL: global_atomic_fsub_uni_value_scope_agent1:
; GFX1064-DPP:       ; %bb.0:
; GFX1064-DPP-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1064-DPP-NEXT:    global_load_dword v2, v[0:1], off
; GFX1064-DPP-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX1064-DPP-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1032-DPP-LABEL: global_atomic_fsub_uni_value_scope_agent1:
; GFX1032-DPP:       ; %bb.0:
; GFX1032-DPP-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1032-DPP-NEXT:    global_load_dword v2, v[0:1], off
; GFX1032-DPP-NEXT:    s_mov_b32 s4, 0
...
; GFX1032-DPP-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1164-DPP-LABEL: global_atomic_fsub_uni_value_scope_agent1:
; GFX1164-DPP:       ; %bb.0:
; GFX1164-DPP-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1164-DPP-NEXT:    global_load_b32 v2, v[0:1], off
; GFX1164-DPP-NEXT:    s_mov_b64 s[0:1], 0
...
; GFX1164-DPP-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1132-DPP-LABEL: global_atomic_fsub_uni_value_scope_agent1:
; GFX1132-DPP:       ; %bb.0:
; GFX1132-DPP-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1132-DPP-NEXT:    global_load_b32 v2, v[0:1], off
; GFX1132-DPP-NEXT:    s_mov_b32 s0, 0
...
define float @global_atomic_fsub_div_value_scope_agent_attr1(ptr addrspace(1) %ptr) #1 {
; GFX7LESS-LABEL: global_atomic_fsub_div_value_scope_agent_attr1:
; GFX7LESS:       ; %bb.0:
; GFX7LESS-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7LESS-NEXT:    s_mov_b32 s16, s33
; GFX7LESS-NEXT:    s_mov_b32 s33, s32
...
; GFX7LESS-NEXT:    s_setpc_b64 s[30:31]
;
; GFX8-LABEL: global_atomic_fsub_div_value_scope_agent_attr1:
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    s_mov_b32 s16, s33
; GFX8-NEXT:    s_mov_b32 s33, s32
...
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: global_atomic_fsub_div_value_scope_agent_attr1:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_mov_b32 s16, s33
; GFX9-NEXT:    s_mov_b32 s33, s32
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1064-LABEL: global_atomic_fsub_div_value_scope_agent_attr1:
; GFX1064:       ; %bb.0:
; GFX1064-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1064-NEXT:    s_mov_b32 s16, s33
; GFX1064-NEXT:    s_mov_b32 s33, s32
...
; GFX1064-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1032-LABEL: global_atomic_fsub_div_value_scope_agent_attr1:
; GFX1032:       ; %bb.0:
; GFX1032-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1032-NEXT:    s_mov_b32 s16, s33
; GFX1032-NEXT:    s_mov_b32 s33, s32
...
; GFX1032-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1164-LABEL: global_atomic_fsub_div_value_scope_agent_attr1:
; GFX1164:       ; %bb.0:
; GFX1164-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1164-NEXT:    s_mov_b32 s0, s33
; GFX1164-NEXT:    s_mov_b32 s33, s32
...
; GFX1164-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1132-LABEL: global_atomic_fsub_div_value_scope_agent_attr1:
; GFX1132:       ; %bb.0:
; GFX1132-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1132-NEXT:    s_mov_b32 s0, s33
; GFX1132-NEXT:    s_mov_b32 s33, s32
...
; GFX1132-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-DPP-LABEL: global_atomic_fsub_div_value_scope_agent_attr1:
; GFX9-DPP:       ; %bb.0:
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-DPP-NEXT:    s_mov_b32 s16, s33
; GFX9-DPP-NEXT:    s_mov_b32 s33, s32
...
; GFX9-DPP-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1064-DPP-LABEL: global_atomic_fsub_div_value_scope_agent_attr1:
; GFX1064-DPP:       ; %bb.0:
; GFX1064-DPP-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1064-DPP-NEXT:    s_mov_b32 s16, s33
; GFX1064-DPP-NEXT:    s_mov_b32 s33, s32
...
; GFX1064-DPP-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1032-DPP-LABEL: global_atomic_fsub_div_value_scope_agent_attr1:
; GFX1032-DPP:       ; %bb.0:
; GFX1032-DPP-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1032-DPP-NEXT:    s_mov_b32 s16, s33
; GFX1032-DPP-NEXT:    s_mov_b32 s33, s32
...
; GFX1032-DPP-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1164-DPP-LABEL: global_atomic_fsub_div_value_scope_agent_attr1:
; GFX1164-DPP:       ; %bb.0:
; GFX1164-DPP-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1164-DPP-NEXT:    s_mov_b32 s0, s33
; GFX1164-DPP-NEXT:    s_mov_b32 s33, s32
...
; GFX1164-DPP-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1132-DPP-LABEL: global_atomic_fsub_div_value_scope_agent_attr1:
; GFX1132-DPP:       ; %bb.0:
; GFX1132-DPP-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1132-DPP-NEXT:    s_mov_b32 s0, s33
; GFX1132-DPP-NEXT:    s_mov_b32 s33, s32
...
define float @global_atomic_fsub_uni_value_scope_defalut_attr2(ptr addrspace(1) %ptr) #2 {
...
define float @global_atomic_fsub_div_value_scope_defalut_attr2(ptr addrspace(1) %ptr) #2 {
