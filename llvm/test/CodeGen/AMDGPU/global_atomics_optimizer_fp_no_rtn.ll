...
define void @global_atomic_fadd_uni_value_scope_agent(ptr addrspace(1) %ptr) #0 {
...
define void @global_atomic_fadd_div_value_scope_agent(ptr addrspace(1) %ptr) #0 {
...
define void @global_atomic_fadd_uni_value_scope_one_as(ptr addrspace(1) %ptr) #1 {
...
define void @global_atomic_fadd_div_value_scope_one_as(ptr addrspace(1) %ptr) #1 {
...
define void @global_atomic_fsub_uni_value_scope_agent(ptr addrspace(1) %ptr) #2{
...
define void @global_atomic_fsub_div_value_scope_agent(ptr addrspace(1) %ptr) #2 {
...
define void @global_atomic_fmin_uni_value_scope_agent(ptr addrspace(1) %ptr) #0 {
...
define void @global_atomic_fmin_div_value_scope_agent(ptr addrspace(1) %ptr) #0 {
...
define void @global_atomic_fmax_uni_value_scope_agent(ptr addrspace(1) %ptr) #1 {
...
define void @global_atomic_fmax_div_value_scope_agent(ptr addrspace(1) %ptr) #1 {
...
define void @global_atomic_fadd_uni_value_scope_defalut(ptr addrspace(1) %ptr) #2 {
...
define void @global_atomic_fadd_div_value_scope_defalut(ptr addrspace(1) %ptr) #2 {
