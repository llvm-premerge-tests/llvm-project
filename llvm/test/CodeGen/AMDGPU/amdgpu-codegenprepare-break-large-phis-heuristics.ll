...
; CHECK:       cond0.end:
; CHECK-NEXT:    [[VAL_0:%.*]] = phi <5 x double> [ zeroinitializer, [[ENTRY:%.*]] ], [ zeroinitializer, [[COND0_TRUE]] ], !amdgpu.breakablephi !0
; CHECK-NEXT:    br i1 [[COND]], label [[COND1_TRUE:%.*]], label [[COND1_END:%.*]]
; CHECK:       cond1.true:
; CHECK-NEXT:    br label [[COND1_END]]
; CHECK:       cond1.end:
; CHECK-NEXT:    [[VAL_1:%.*]] = phi <5 x double> [ [[VAL_0]], [[COND0_END]] ], [ zeroinitializer, [[COND1_TRUE]] ], !amdgpu.breakablephi !0
...
cond0.end:
  %val.0 = phi <5 x double> [ zeroinitializer, %entry ], [ zeroinitializer, %cond0.true ], !amdgpu.breakablephi !0
...
cond1.end:
  %val.1 = phi <5 x double> [ %val.0, %cond0.end ], [ zeroinitializer, %cond1.true ], !amdgpu.breakablephi !0
