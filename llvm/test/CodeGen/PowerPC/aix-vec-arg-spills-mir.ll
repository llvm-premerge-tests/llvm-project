...
define double @caller() {
  ...
  ; MIR32-NEXT:   renamable $vsl1 = LXVD2X $zero, killed renamable $r4 :: (load (s128) from constant-pool)
  ...
  ; MIR32-NEXT:   STXVW4X renamable $vsl0, $r1, killed renamable $r4 :: (store (s128), align 8)
  ; MIR32-NEXT:   renamable $r4 = LI 48
  ; MIR32-NEXT:   STXVW4X killed renamable $vsl0, $r1, killed renamable $r3 :: (store (s128), align 8)
  ; MIR32-NEXT:   renamable $r3 = LI 512
  ; MIR32-NEXT:   STXVD2X killed renamable $vsl1, $r1, killed renamable $r4 :: (store (s128))
  ; MIR32-NEXT:   STW killed renamable $r3, 152, $r1 :: (store (s32))
  ...
  ; MIR64-NEXT:   renamable $vsl1 = LXVD2X $zero8, killed renamable $x3 :: (load (s128) from constant-pool)
  ...
  ; MIR64-NEXT:   STXVD2X killed renamable $vsl1, $x1, killed renamable $x3 :: (store (s128))
