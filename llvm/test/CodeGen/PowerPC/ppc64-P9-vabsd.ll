...
; CHECK-PWR8-NEXT:    vsububm v3, v4, v2
...
; CHECK-PWR7-NEXT:    xxlxor v3, v3, v3
; CHECK-PWR7-NEXT:    vsububm v3, v3, v2
...
; CHECK-PWR7-NEXT:    lbz r5, 304(r1)
; CHECK-PWR7-NEXT:    stxvw4x v3, 0, r3
; CHECK-PWR7-NEXT:    lbz r6, 320(r1)
; CHECK-PWR7-NEXT:    lbz r7, 305(r1)
; CHECK-PWR7-NEXT:    lbz r8, 321(r1)
; CHECK-PWR7-NEXT:    lbz r29, 309(r1)
; CHECK-PWR7-NEXT:    lbz r28, 325(r1)
; CHECK-PWR7-NEXT:    lbz r27, 310(r1)
; CHECK-PWR7-NEXT:    lbz r26, 326(r1)
; CHECK-PWR7-NEXT:    lbz r25, 311(r1)
; CHECK-PWR7-NEXT:    lbz r24, 327(r1)
...
; CHECK-PWR7-NEXT:    sub r28, r27, r26
; CHECK-PWR7-NEXT:    sub r27, r25, r24
; CHECK-PWR7-NEXT:    srawi r25, r7, 31
; CHECK-PWR7-NEXT:    lbz r0, 308(r1)
; CHECK-PWR7-NEXT:    lbz r30, 324(r1)
; CHECK-PWR7-NEXT:    lbz r23, 313(r1)
; CHECK-PWR7-NEXT:    lbz r22, 329(r1)
; CHECK-PWR7-NEXT:    sub r6, r6, r8
; CHECK-PWR7-NEXT:    srawi r8, r5, 31
; CHECK-PWR7-NEXT:    sub r0, r0, r30
; CHECK-PWR7-NEXT:    xor r7, r7, r25
; CHECK-PWR7-NEXT:    sub r26, r23, r22
; CHECK-PWR7-NEXT:    srawi r22, r0, 31
; CHECK-PWR7-NEXT:    xor r5, r5, r8
; CHECK-PWR7-NEXT:    xor r0, r0, r22
; CHECK-PWR7-NEXT:    lbz r11, 307(r1)
; CHECK-PWR7-NEXT:    lbz r12, 323(r1)
; CHECK-PWR7-NEXT:    sub r7, r7, r25
; CHECK-PWR7-NEXT:    srawi r25, r28, 31
; CHECK-PWR7-NEXT:    sub r0, r0, r22
; CHECK-PWR7-NEXT:    sub r5, r5, r8
; CHECK-PWR7-NEXT:    srawi r8, r29, 31
; CHECK-PWR7-NEXT:    lbz r22, 335(r1)
; CHECK-PWR7-NEXT:    lbz r9, 306(r1)
; CHECK-PWR7-NEXT:    xor r28, r28, r25
; CHECK-PWR7-NEXT:    lbz r10, 322(r1)
; CHECK-PWR7-NEXT:    sub r11, r11, r12
; CHECK-PWR7-NEXT:    lbz r12, 331(r1)
; CHECK-PWR7-NEXT:    xor r29, r29, r8
; CHECK-PWR7-NEXT:    sub r9, r9, r10
; CHECK-PWR7-NEXT:    lbz r10, 315(r1)
; CHECK-PWR7-NEXT:    lbz r3, 312(r1)
; CHECK-PWR7-NEXT:    sub r28, r28, r25
; CHECK-PWR7-NEXT:    lbz r25, 333(r1)
; CHECK-PWR7-NEXT:    srawi r23, r11, 31
; CHECK-PWR7-NEXT:    lbz r4, 328(r1)
; CHECK-PWR7-NEXT:    sub r8, r29, r8
; CHECK-PWR7-NEXT:    lbz r29, 317(r1)
; CHECK-PWR7-NEXT:    srawi r24, r9, 31
; CHECK-PWR7-NEXT:    lbz r30, 316(r1)
; CHECK-PWR7-NEXT:    xor r11, r11, r23
; CHECK-PWR7-NEXT:    sub r10, r10, r12
; CHECK-PWR7-NEXT:    xor r9, r9, r24
; CHECK-PWR7-NEXT:    sub r11, r11, r23
; CHECK-PWR7-NEXT:    lbz r23, 318(r1)
; CHECK-PWR7-NEXT:    srawi r12, r10, 31
; CHECK-PWR7-NEXT:    sub r29, r29, r25
; CHECK-PWR7-NEXT:    sub r9, r9, r24
; CHECK-PWR7-NEXT:    srawi r24, r27, 31
; CHECK-PWR7-NEXT:    xor r10, r10, r12
; CHECK-PWR7-NEXT:    xor r27, r27, r24
; CHECK-PWR7-NEXT:    sub r10, r10, r12
; CHECK-PWR7-NEXT:    srawi r25, r29, 31
; CHECK-PWR7-NEXT:    sub r27, r27, r24
; CHECK-PWR7-NEXT:    lbz r24, 332(r1)
; CHECK-PWR7-NEXT:    stb r10, 224(r1)
; CHECK-PWR7-NEXT:    srawi r10, r6, 31
; CHECK-PWR7-NEXT:    xor r29, r29, r25
; CHECK-PWR7-NEXT:    sub r3, r3, r4
; CHECK-PWR7-NEXT:    sub r30, r30, r24
; CHECK-PWR7-NEXT:    xor r6, r6, r10
; CHECK-PWR7-NEXT:    srawi r4, r3, 31
; CHECK-PWR7-NEXT:    sub r6, r6, r10
; CHECK-PWR7-NEXT:    sub r29, r29, r25
...
; CHECK-PWR7-NEXT:    sub r3, r3, r4
; CHECK-PWR7-NEXT:    stb r29, 256(r1)
; CHECK-PWR7-NEXT:    srawi r29, r26, 31
; CHECK-PWR7-NEXT:    sub r25, r25, r22
; CHECK-PWR7-NEXT:    stb r3, 176(r1)
; CHECK-PWR7-NEXT:    xor r6, r26, r29
; CHECK-PWR7-NEXT:    addi r3, r1, 288
; CHECK-PWR7-NEXT:    ld r26, 368(r1) # 8-byte Folded Reload
; CHECK-PWR7-NEXT:    srawi r22, r25, 31
; CHECK-PWR7-NEXT:    stb r27, 160(r1)
; CHECK-PWR7-NEXT:    ld r27, 376(r1) # 8-byte Folded Reload
; CHECK-PWR7-NEXT:    sub r6, r6, r29
; CHECK-PWR7-NEXT:    stb r28, 144(r1)
; CHECK-PWR7-NEXT:    ld r29, 392(r1) # 8-byte Folded Reload
; CHECK-PWR7-NEXT:    xor r25, r25, r22
; CHECK-PWR7-NEXT:    stb r8, 128(r1)
; CHECK-PWR7-NEXT:    ld r28, 384(r1) # 8-byte Folded Reload
; CHECK-PWR7-NEXT:    stb r6, 192(r1)
; CHECK-PWR7-NEXT:    stb r0, 112(r1)
; CHECK-PWR7-NEXT:    sub r25, r25, r22
; CHECK-PWR7-NEXT:    lbz r22, 334(r1)
; CHECK-PWR7-NEXT:    stb r11, 96(r1)
; CHECK-PWR7-NEXT:    stb r9, 80(r1)
; CHECK-PWR7-NEXT:    stb r7, 64(r1)
; CHECK-PWR7-NEXT:    stb r25, 288(r1)
; CHECK-PWR7-NEXT:    stb r5, 48(r1)
; CHECK-PWR7-NEXT:    sub r25, r23, r22
; CHECK-PWR7-NEXT:    ld r22, 336(r1) # 8-byte Folded Reload
; CHECK-PWR7-NEXT:    srawi r23, r25, 31
; CHECK-PWR7-NEXT:    xor r25, r25, r23
; CHECK-PWR7-NEXT:    sub r25, r25, r23
; CHECK-PWR7-NEXT:    ld r23, 344(r1) # 8-byte Folded Reload
; CHECK-PWR7-NEXT:    stb r25, 272(r1)
...
; CHECK-PWR7-NEXT:    vmrghb v3, v5, v4
; CHECK-PWR7-NEXT:    lxvw4x v4, 0, r3
