...
; CHECK-PWR7-NEXT:    srawi r11, r3, 31
; CHECK-PWR7-NEXT:    lbz r30, 325(r1)
; CHECK-PWR7-NEXT:    srawi r12, r4, 31
...
; CHECK-PWR7-NEXT:    xor r3, r3, r11
; CHECK-PWR7-NEXT:    xor r4, r4, r12
...
; CHECK-PWR7-NEXT:    sub r3, r3, r11
; CHECK-PWR7-NEXT:    srawi r11, r25, 31
; CHECK-PWR7-NEXT:    sub r4, r4, r12
; CHECK-PWR7-NEXT:    sub r5, r5, r0
; CHECK-PWR7-NEXT:    lbz r0, 329(r1)
; CHECK-PWR7-NEXT:    srawi r29, r7, 31
; CHECK-PWR7-NEXT:    srawi r28, r8, 31
; CHECK-PWR7-NEXT:    xor r6, r6, r30
; CHECK-PWR7-NEXT:    xor r12, r25, r11
...
; CHECK-PWR7-NEXT:    sub r11, r12, r11
; CHECK-PWR7-NEXT:    lbz r12, 313(r1)
