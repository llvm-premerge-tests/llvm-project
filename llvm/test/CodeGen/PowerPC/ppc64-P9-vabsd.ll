...
; CHECK-PWR7-NEXT:    sub r3, r3, r4
; CHECK-PWR7-NEXT:    lbz r4, 313(r1)
; CHECK-PWR7-NEXT:    sub r5, r5, r6
; CHECK-PWR7-NEXT:    lbz r6, 329(r1)
...
; CHECK-PWR7-NEXT:    sub r30, r27, r26
; CHECK-PWR7-NEXT:    lbz r25, 312(r1)
; CHECK-PWR7-NEXT:    lbz r24, 328(r1)
; CHECK-PWR7-NEXT:    sub r0, r29, r28
; CHECK-PWR7-NEXT:    sub r4, r4, r6
; CHECK-PWR7-NEXT:    srawi r6, r3, 31
; CHECK-PWR7-NEXT:    srawi r28, r5, 31
; CHECK-PWR7-NEXT:    sub r7, r7, r8
; CHECK-PWR7-NEXT:    srawi r26, r9, 31
; CHECK-PWR7-NEXT:    lbz r8, 314(r1)
; CHECK-PWR7-NEXT:    lbz r10, 330(r1)
; CHECK-PWR7-NEXT:    xor r5, r5, r28
; CHECK-PWR7-NEXT:    xor r3, r3, r6
; CHECK-PWR7-NEXT:    xor r9, r9, r26
; CHECK-PWR7-NEXT:    sub r29, r25, r24
; CHECK-PWR7-NEXT:    sub r8, r8, r10
; CHECK-PWR7-NEXT:    srawi r10, r0, 31
; CHECK-PWR7-NEXT:    sub r5, r5, r28
; CHECK-PWR7-NEXT:    srawi r28, r29, 31
; CHECK-PWR7-NEXT:    sub r9, r9, r26
; CHECK-PWR7-NEXT:    sub r3, r3, r6
; CHECK-PWR7-NEXT:    srawi r6, r30, 31
; CHECK-PWR7-NEXT:    lbz r26, 315(r1)
; CHECK-PWR7-NEXT:    xor r0, r0, r10
; CHECK-PWR7-NEXT:    xor r29, r29, r28
; CHECK-PWR7-NEXT:    sub r10, r0, r10
; CHECK-PWR7-NEXT:    srawi r27, r7, 31
; CHECK-PWR7-NEXT:    sub r0, r29, r28
; CHECK-PWR7-NEXT:    xor r30, r30, r6
; CHECK-PWR7-NEXT:    srawi r25, r11, 31
; CHECK-PWR7-NEXT:    lbz r28, 332(r1)
; CHECK-PWR7-NEXT:    sub r6, r30, r6
; CHECK-PWR7-NEXT:    lbz r30, 331(r1)
; CHECK-PWR7-NEXT:    xor r7, r7, r27
; CHECK-PWR7-NEXT:    xor r11, r11, r25
; CHECK-PWR7-NEXT:    sub r7, r7, r27
; CHECK-PWR7-NEXT:    srawi r27, r4, 31
; CHECK-PWR7-NEXT:    sub r11, r11, r25
; CHECK-PWR7-NEXT:    srawi r25, r8, 31
; CHECK-PWR7-NEXT:    sub r30, r26, r30
; CHECK-PWR7-NEXT:    xor r4, r4, r27
; CHECK-PWR7-NEXT:    xor r8, r8, r25
; CHECK-PWR7-NEXT:    sub r4, r4, r27
; CHECK-PWR7-NEXT:    sub r8, r8, r25
...
; CHECK-PWR7-NEXT:    stb r8, 208(r1)
; CHECK-PWR7-NEXT:    stb r4, 192(r1)
; CHECK-PWR7-NEXT:    stb r0, 176(r1)
; CHECK-PWR7-NEXT:    stb r6, 160(r1)
...
; CHECK-PWR7-NEXT:    lbz r29, 316(r1)
; CHECK-PWR7-NEXT:    stb r12, 128(r1)
; CHECK-PWR7-NEXT:    sub r29, r29, r28
; CHECK-PWR7-NEXT:    xor r27, r27, r26
; CHECK-PWR7-NEXT:    sub r27, r27, r26
; CHECK-PWR7-NEXT:    lbz r26, 319(r1)
; CHECK-PWR7-NEXT:    srawi r28, r29, 31
; CHECK-PWR7-NEXT:    stb r27, 256(r1)
; CHECK-PWR7-NEXT:    stb r30, 224(r1)
...
; CHECK-PWR7-NEXT:    xor r29, r29, r28
; CHECK-PWR7-NEXT:    sub r29, r29, r28
; CHECK-PWR7-NEXT:    lbz r28, 318(r1)
; CHECK-PWR7-NEXT:    stb r29, 240(r1)
...
; CHECK-PWR7-NEXT:    sub r28, r28, r25
; CHECK-PWR7-NEXT:    lbz r25, 335(r1)
; CHECK-PWR7-NEXT:    stb r28, 272(r1)
...
; CHECK-PWR7-NEXT:    stb r26, 288(r1)
