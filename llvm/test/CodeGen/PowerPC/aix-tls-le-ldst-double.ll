...
@IThreadLocalVarUninit = internal thread_local(localexec) global double 0.000000e+00, align 8
@IThreadLocalVarInit = internal thread_local(localexec) global double 5.870000e+00, align 8
@ThreadLocalVarUninit = thread_local(localexec) global double 0.000000e+00, align 8
...
; SMALL32-NEXT:    stw r0, 40(r1)
; SMALL32-NEXT:    bla .__get_tpointer[PR]
; SMALL32-NEXT:    lfd f0, 0(r5)
; SMALL32-NEXT:    lfdx f1, r3, r4
; SMALL32-NEXT:    xsadddp f1, f1, f0
; SMALL32-NEXT:    addi r1, r1, 32
; SMALL32-NEXT:    lwz r0, 8(r1)
; SMALL32-NEXT:    mtlr r0
; SMALL32-NEXT:    blr
