...
; DIS:      0000000000000000 (idx: 5) .StoreArrays1:
; DIS-NEXT: [[#%x, ADDR:]]: {{.*}}                addi 3, 13, 0
; DIS-NEXT: {{0*}}[[#ADDR]]:     R_REF	(idx: 1)  __tls_get_addr[DS]
; DIS-NEXT: {{0*}}[[#ADDR + 2]]: R_TLS_LE	(idx: 17) mySmallLocalExecTLSv1[TL]
...
; DIS:      0000000000000050 (idx: 7) .StoreArrays2:
; DIS-NEXT: [[#%x, ADDR:]]: {{.*}}                addis 3, 2, 0
; DIS-NEXT: {{0*}}[[#ADDR + 2]]: R_TOCU	(idx: 15) mySmallLocalExecTLSv2[TE]
; DIS-NEXT: [[#%x, ADDR:]]: {{.*}}                li 4, 1
; DIS-NEXT: [[#%x, ADDR:]]: {{.*}}                li 5, 4
; DIS-NEXT: [[#%x, ADDR:]]: {{.*}}                addi 6, 13, 32748
; DIS-NEXT: {{0*}}[[#ADDR + 2]]: R_TLS_LE	(idx: 19) mySmallLocalExecTLS2[TL]
...
; DIS-NEXT: {{0*}}[[#ADDR + 2]]: R_TOCL	(idx: 15) mySmallLocalExecTLSv2[TE]
...
; DIS:      00000000000000a0 (idx: 9) StoreArrays1[DS]:
; DIS-NEXT:       a0: 00 00 00 00
; DIS-NEXT: 00000000000000a0:  R_POS	(idx: 5) .StoreArrays1
; DIS-NEXT:       a4: 00 00 00 00
; DIS-NEXT:       a8: 00 00 00 00
; DIS-NEXT: 00000000000000a8:  R_POS        (idx: 13) TOC[TC0]
; DIS-NEXT:       ac: 00 00 00 d0

; DIS:      00000000000000b8 (idx: 11) StoreArrays2[DS]:
; DIS-NEXT:       b8: 00 00 00 00
; DIS-NEXT: 00000000000000b8:  R_POS	(idx: 7) .StoreArrays2
; DIS-NEXT:       bc: 00 00 00 50
; DIS-NEXT:       c0: 00 00 00 00
; DIS-NEXT: 00000000000000c0:  R_POS        (idx: 13) TOC[TC0]
; DIS-NEXT:       c4: 00 00 00 d0

; DIS:      00000000000000d0 (idx: 15) mySmallLocalExecTLSv2[TE]:
; DIS-NEXT:       d0: 00 00 00 00
; DIS-NEXT: 00000000000000d0:  R_TLS_LE     (idx: 27) mySmallLocalExecTLSv2[TL]
