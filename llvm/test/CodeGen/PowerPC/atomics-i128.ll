...
; AIX64-PWR8:       # %bb.0: # %entry
; AIX64-PWR8-NEXT:    sync
; AIX64-PWR8-NEXT:  L..BB1_1: # %entry
; AIX64-PWR8-NEXT:    #
; AIX64-PWR8-NEXT:    lqarx r6, 0, r3
; AIX64-PWR8-NEXT:    addc r9, r5, r7
; AIX64-PWR8-NEXT:    adde r8, r4, r6
; AIX64-PWR8-NEXT:    stqcx. r8, 0, r3
; AIX64-PWR8-NEXT:    bne cr0, L..BB1_1
; AIX64-PWR8-NEXT:  # %bb.2: # %entry
; AIX64-PWR8-NEXT:    lwsync
; AIX64-PWR8-NEXT:    mr r3, r6
; AIX64-PWR8-NEXT:    mr r4, r7
...
; AIX64-PWR8:       # %bb.0: # %entry
; AIX64-PWR8-NEXT:    sync
; AIX64-PWR8-NEXT:  L..BB2_1: # %entry
; AIX64-PWR8-NEXT:    #
; AIX64-PWR8-NEXT:    lqarx r6, 0, r3
; AIX64-PWR8-NEXT:    subc r9, r7, r5
; AIX64-PWR8-NEXT:    subfe r8, r4, r6
; AIX64-PWR8-NEXT:    stqcx. r8, 0, r3
; AIX64-PWR8-NEXT:    bne cr0, L..BB2_1
; AIX64-PWR8-NEXT:  # %bb.2: # %entry
; AIX64-PWR8-NEXT:    lwsync
; AIX64-PWR8-NEXT:    mr r3, r6
; AIX64-PWR8-NEXT:    mr r4, r7
...
; AIX64-PWR8:       # %bb.0: # %entry
; AIX64-PWR8-NEXT:    sync
; AIX64-PWR8-NEXT:  L..BB3_1: # %entry
; AIX64-PWR8-NEXT:    #
; AIX64-PWR8-NEXT:    lqarx r6, 0, r3
; AIX64-PWR8-NEXT:    and r9, r5, r7
; AIX64-PWR8-NEXT:    and r8, r4, r6
; AIX64-PWR8-NEXT:    stqcx. r8, 0, r3
; AIX64-PWR8-NEXT:    bne cr0, L..BB3_1
; AIX64-PWR8-NEXT:  # %bb.2: # %entry
; AIX64-PWR8-NEXT:    lwsync
; AIX64-PWR8-NEXT:    mr r3, r6
; AIX64-PWR8-NEXT:    mr r4, r7
...
; AIX64-PWR8:       # %bb.0: # %entry
; AIX64-PWR8-NEXT:    sync
; AIX64-PWR8-NEXT:  L..BB4_1: # %entry
; AIX64-PWR8-NEXT:    #
; AIX64-PWR8-NEXT:    lqarx r6, 0, r3
; AIX64-PWR8-NEXT:    or r9, r5, r7
; AIX64-PWR8-NEXT:    or r8, r4, r6
; AIX64-PWR8-NEXT:    stqcx. r8, 0, r3
; AIX64-PWR8-NEXT:    bne cr0, L..BB4_1
; AIX64-PWR8-NEXT:  # %bb.2: # %entry
; AIX64-PWR8-NEXT:    lwsync
; AIX64-PWR8-NEXT:    mr r3, r6
; AIX64-PWR8-NEXT:    mr r4, r7
...
; AIX64-PWR8:       # %bb.0: # %entry
; AIX64-PWR8-NEXT:    sync
; AIX64-PWR8-NEXT:  L..BB5_1: # %entry
; AIX64-PWR8-NEXT:    #
; AIX64-PWR8-NEXT:    lqarx r6, 0, r3
; AIX64-PWR8-NEXT:    xor r9, r5, r7
; AIX64-PWR8-NEXT:    xor r8, r4, r6
; AIX64-PWR8-NEXT:    stqcx. r8, 0, r3
; AIX64-PWR8-NEXT:    bne cr0, L..BB5_1
; AIX64-PWR8-NEXT:  # %bb.2: # %entry
; AIX64-PWR8-NEXT:    lwsync
; AIX64-PWR8-NEXT:    mr r3, r6
; AIX64-PWR8-NEXT:    mr r4, r7
...
; AIX64-PWR8:       # %bb.0: # %entry
; AIX64-PWR8-NEXT:    sync
; AIX64-PWR8-NEXT:  L..BB6_1: # %entry
; AIX64-PWR8-NEXT:    #
; AIX64-PWR8-NEXT:    lqarx r6, 0, r3
; AIX64-PWR8-NEXT:    nand r9, r5, r7
; AIX64-PWR8-NEXT:    nand r8, r4, r6
; AIX64-PWR8-NEXT:    stqcx. r8, 0, r3
; AIX64-PWR8-NEXT:    bne cr0, L..BB6_1
; AIX64-PWR8-NEXT:  # %bb.2: # %entry
; AIX64-PWR8-NEXT:    lwsync
; AIX64-PWR8-NEXT:    mr r3, r6
; AIX64-PWR8-NEXT:    mr r4, r7
...
; AIX64-PWR8:       # %bb.0: # %entry
; AIX64-PWR8-NEXT:    lwsync
; AIX64-PWR8-NEXT:  L..BB8_1: # %entry
; AIX64-PWR8-NEXT:    #
; AIX64-PWR8-NEXT:    lqarx r8, 0, r3
; AIX64-PWR8-NEXT:    xor r11, r9, r5
; AIX64-PWR8-NEXT:    xor r10, r8, r4
; AIX64-PWR8-NEXT:    or. r11, r11, r10
; AIX64-PWR8-NEXT:    bne cr0, L..BB8_3
; AIX64-PWR8-NEXT:  # %bb.2: # %entry
; AIX64-PWR8-NEXT:    #
; AIX64-PWR8-NEXT:    mr r11, r7
; AIX64-PWR8-NEXT:    mr r10, r6
...
; AIX64-PWR8:       # %bb.0: # %entry
; AIX64-PWR8-NEXT:    sync
; AIX64-PWR8-NEXT:  L..BB9_1: # %entry
; AIX64-PWR8-NEXT:    #
; AIX64-PWR8-NEXT:    lqarx r8, 0, r3
; AIX64-PWR8-NEXT:    xor r11, r9, r5
; AIX64-PWR8-NEXT:    xor r10, r8, r4
; AIX64-PWR8-NEXT:    or. r11, r11, r10
; AIX64-PWR8-NEXT:    bne cr0, L..BB9_3
; AIX64-PWR8-NEXT:  # %bb.2: # %entry
; AIX64-PWR8-NEXT:    #
; AIX64-PWR8-NEXT:    mr r11, r7
; AIX64-PWR8-NEXT:    mr r10, r6
...
; AIX64-PWR8:       # %bb.0: # %entry
; AIX64-PWR8-NEXT:    lwsync
; AIX64-PWR8-NEXT:  L..BB10_1: # %entry
; AIX64-PWR8-NEXT:    #
; AIX64-PWR8-NEXT:    lqarx r8, 0, r3
; AIX64-PWR8-NEXT:    xor r11, r9, r5
; AIX64-PWR8-NEXT:    xor r10, r8, r4
; AIX64-PWR8-NEXT:    or. r11, r11, r10
; AIX64-PWR8-NEXT:    bne cr0, L..BB10_3
; AIX64-PWR8-NEXT:  # %bb.2: # %entry
; AIX64-PWR8-NEXT:    #
; AIX64-PWR8-NEXT:    mr r11, r7
; AIX64-PWR8-NEXT:    mr r10, r6
...
; AIX64-PWR8:       # %bb.0: # %entry
; AIX64-PWR8-NEXT:    lwsync
; AIX64-PWR8-NEXT:  L..BB11_1: # %entry
; AIX64-PWR8-NEXT:    #
; AIX64-PWR8-NEXT:    lqarx r8, 0, r3
; AIX64-PWR8-NEXT:    xor r11, r9, r5
; AIX64-PWR8-NEXT:    xor r10, r8, r4
; AIX64-PWR8-NEXT:    or. r11, r11, r10
; AIX64-PWR8-NEXT:    bne cr0, L..BB11_3
; AIX64-PWR8-NEXT:  # %bb.2: # %entry
; AIX64-PWR8-NEXT:    #
; AIX64-PWR8-NEXT:    mr r11, r7
; AIX64-PWR8-NEXT:    mr r10, r6
