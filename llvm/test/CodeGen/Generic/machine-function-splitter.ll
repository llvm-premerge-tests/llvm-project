...
; RUN: llc < %s -mtriple=aarch64-unknown-linux-gnu -enable-split-machine-functions -mfs-ignore-triple -aarch64-redzone | FileCheck %s -check-prefixes=MFS-DEFAULTS,MFS-REDZONE-AARCH64
