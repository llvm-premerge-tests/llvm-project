...
; RV32IC-NEXT:    c.mv a0, a2
; RV32IC-NEXT:    c.lw a2, 0(a1)
; RV32IC-NEXT:    bltu a0, a2, 0x2e
; RV32IC-NEXT:    c.mv a2, a0
; RV32IC-NEXT:    c.lw a0, 0(a1)
; RV32IC-NEXT:    bltu a2, a0, 0x36
; RV32IC-NEXT:    c.mv a2, a0
; RV32IC-NEXT:    c.lw a0, 0(a1)
...
; RV32IC-NEXT:    c.mv a0, a2
; RV32IC-NEXT:    c.lw a2, 0(a1)
; RV32IC-NEXT:    blt a0, a2, 0x4e
; RV32IC-NEXT:    c.mv a2, a0
; RV32IC-NEXT:    c.lw a0, 0(a1)
; RV32IC-NEXT:    blt a2, a0, 0x56
; RV32IC-NEXT:    c.mv a2, a0
; RV32IC-NEXT:    c.lw a0, 0(a1)
; RV32IC-NEXT:    blt a0, a2, 0x5e
; RV32IC-NEXT:    c.mv a0, a2
; RV32IC-NEXT:    c.jr ra
