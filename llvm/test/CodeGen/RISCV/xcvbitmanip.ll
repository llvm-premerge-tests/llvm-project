...
define i32 @test.cv.ff1.llvm(i32 %a) {
; CHECK-LABEL: test.cv.ff1.llvm:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.ff1 a0, a0
; CHECK-NEXT:    ret
...
define i32 @test.cv.fl1.llvm(i32 %a) {
; CHECK-LABEL: test.cv.fl1.llvm:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.fl1 a0, a0
; CHECK-NEXT:    ret
...
define i32 @test.cv.cnt.llvm(i32 %a) {
; CHECK-LABEL: test.cv.cnt.llvm:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.cnt a0, a0
; CHECK-NEXT:    ret
...
define i32 @test.cv.fshl.llvm.imm(i32 %a) {
; CHECK-LABEL: test.cv.fshl.llvm.imm:
; CHECK:       # %bb.0:
; CHECK-NEXT:    li a1, 30
; CHECK-NEXT:    cv.ror a0, a0, a1
; CHECK-NEXT:    ret
...
define i32 @test.cv.fshl.llvm.reg(i32 %a, i32 %b) {
; CHECK-O0-LABEL: test.cv.fshl.llvm.reg:
; CHECK-O0:       # %bb.0:
...
; CHECK-O0-NEXT:    ret
;
; CHECK-O3-LABEL: test.cv.fshl.llvm.reg:
; CHECK-O3:       # %bb.0:
...
define i32 @test.cv.fshr.llvm.imm(i32 %a) {
; CHECK-LABEL: test.cv.fshr.llvm.imm:
; CHECK:       # %bb.0:
; CHECK-NEXT:    li a1, 2
; CHECK-NEXT:    cv.ror a0, a0, a1
; CHECK-NEXT:    ret
...
define i32 @test.cv.fshr.llvm.reg(i32 %a, i32 %b) {
; CHECK-LABEL: test.cv.fshr.llvm.reg:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.ror a0, a0, a1
; CHECK-NEXT:    ret
...
define i32 @test.cv.bitrev.llvm(i32 %a) {
; CHECK-LABEL: test.cv.bitrev.llvm:
; CHECK:       # %bb.0:
