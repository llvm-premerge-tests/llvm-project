...
; LP64E-FPELIM-NEXT:    call notdead@plt
...
; LP64E-WITHFP-NEXT:    call notdead@plt
...
; LP64E-FPELIM-NEXT:    sd a2, 32(sp)
; LP64E-FPELIM-NEXT:    sd a1, 24(sp)
; LP64E-FPELIM-NEXT:    addi a0, sp, 24
; LP64E-FPELIM-NEXT:    sd a0, 8(sp)
; LP64E-FPELIM-NEXT:    lw a0, 8(sp)
; LP64E-FPELIM-NEXT:    addi a0, a0, 7
; LP64E-FPELIM-NEXT:    slli a1, a0, 32
; LP64E-FPELIM-NEXT:    srli a1, a1, 32
; LP64E-FPELIM-NEXT:    addi a1, a1, 8
; LP64E-FPELIM-NEXT:    sd a1, 8(sp)
; LP64E-FPELIM-NEXT:    srliw a0, a0, 3
; LP64E-FPELIM-NEXT:    slli a0, a0, 3
...
; LP64E-WITHFP-NEXT:    sd a0, -24(s0)
; LP64E-WITHFP-NEXT:    lw a0, -24(s0)
; LP64E-WITHFP-NEXT:    addi a0, a0, 7
; LP64E-WITHFP-NEXT:    slli a1, a0, 32
; LP64E-WITHFP-NEXT:    srli a1, a1, 32
; LP64E-WITHFP-NEXT:    addi a1, a1, 8
; LP64E-WITHFP-NEXT:    sd a1, -24(s0)
; LP64E-WITHFP-NEXT:    srliw a0, a0, 3
; LP64E-WITHFP-NEXT:    slli a0, a0, 3
...
; LP64E-FPELIM-NEXT:    lw a0, 8(sp)
; LP64E-FPELIM-NEXT:    addi a0, a0, 7
; LP64E-FPELIM-NEXT:    slli a2, a0, 32
; LP64E-FPELIM-NEXT:    srli a2, a2, 32
; LP64E-FPELIM-NEXT:    addi a2, a2, 8
; LP64E-FPELIM-NEXT:    sd a2, 8(sp)
; LP64E-FPELIM-NEXT:    srliw a0, a0, 3
; LP64E-FPELIM-NEXT:    slli a0, a0, 3
; LP64E-FPELIM-NEXT:    ld a0, 0(a0)
; LP64E-FPELIM-NEXT:    add a0, a1, a0
; LP64E-FPELIM-NEXT:    addi sp, sp, 48
; LP64E-FPELIM-NEXT:    ret
;
...
; LP64E-WITHFP-NEXT:    mv a0, s0
; LP64E-WITHFP-NEXT:    sd a0, -24(s0)
; LP64E-WITHFP-NEXT:    lw a0, -24(s0)
; LP64E-WITHFP-NEXT:    addi a0, a0, 7
; LP64E-WITHFP-NEXT:    slli a2, a0, 32
; LP64E-WITHFP-NEXT:    srli a2, a2, 32
; LP64E-WITHFP-NEXT:    addi a2, a2, 8
; LP64E-WITHFP-NEXT:    sd a2, -24(s0)
; LP64E-WITHFP-NEXT:    srliw a0, a0, 3
; LP64E-WITHFP-NEXT:    slli a0, a0, 3
; LP64E-WITHFP-NEXT:    ld a0, 0(a0)
; LP64E-WITHFP-NEXT:    add a0, a1, a0
; LP64E-WITHFP-NEXT:    ld ra, 24(sp) # 8-byte Folded Reload
; LP64E-WITHFP-NEXT:    ld s0, 16(sp) # 8-byte Folded Reload
; LP64E-WITHFP-NEXT:    addi sp, sp, 64
; LP64E-WITHFP-NEXT:    ret
