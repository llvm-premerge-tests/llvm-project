...
; ZVFH-NEXT:    srli a2, a1, 1
; ZVFH-NEXT:    vsetvli a3, zero, e8, m1, ta, ma
; ZVFH-NEXT:    vslidedown.vx v24, v0, a2
; ZVFH-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
; ZVFH-NEXT:    slli a1, a1, 2
; ZVFH-NEXT:    vfmv.s.f v25, fa0
; ZVFH-NEXT:    mv a2, a0
; ZVFH-NEXT:    bltu a0, a1, .LBB6_2
; ZVFH-NEXT:  # %bb.1:
; ZVFH-NEXT:    mv a2, a1
; ZVFH-NEXT:  .LBB6_2:
; ZVFH-NEXT:    vsetvli zero, a2, e16, m8, ta, ma
; ZVFH-NEXT:    vfredusum.vs v25, v8, v25, v0.t
; ZVFH-NEXT:    sub a1, a0, a1
; ZVFH-NEXT:    sltu a0, a0, a1
...
; ZVFHMIN-NEXT:    slli a2, a3, 1
; ZVFHMIN-NEXT:    sub a4, a1, a2
; ZVFHMIN-NEXT:    sltu a6, a1, a4
; ZVFHMIN-NEXT:    fcvt.s.h fa5, fa0
; ZVFHMIN-NEXT:    bltu a0, a5, .LBB6_2
; ZVFHMIN-NEXT:  # %bb.1:
; ZVFHMIN-NEXT:    mv a0, a5
; ZVFHMIN-NEXT:  .LBB6_2:
; ZVFHMIN-NEXT:    addi a5, a6, -1
; ZVFHMIN-NEXT:    vsetvli a6, zero, e16, m4, ta, ma
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v24, v8
; ZVFHMIN-NEXT:    vsetivli zero, 1, e32, m1, ta, ma
; ZVFHMIN-NEXT:    vfmv.s.f v8, fa5
; ZVFHMIN-NEXT:    mv a6, a0
; ZVFHMIN-NEXT:    bltu a0, a2, .LBB6_4
; ZVFHMIN-NEXT:  # %bb.3:
; ZVFHMIN-NEXT:    mv a6, a2
; ZVFHMIN-NEXT:  .LBB6_4:
...
; ZVFHMIN-NEXT:    vsetivli zero, 1, e32, m1, ta, ma
; ZVFHMIN-NEXT:    vfmv.s.f v8, fa5
; ZVFHMIN-NEXT:    sub a5, a0, a2
; ZVFHMIN-NEXT:    sltu a0, a0, a5
; ZVFHMIN-NEXT:    addi a0, a0, -1
; ZVFHMIN-NEXT:    and a0, a0, a5
...
; ZVFHMIN-NEXT:    vsetivli zero, 1, e32, m1, ta, ma
; ZVFHMIN-NEXT:    vfmv.s.f v8, fa5
; ZVFHMIN-NEXT:    bltu a1, a2, .LBB6_6
; ZVFHMIN-NEXT:  # %bb.5:
; ZVFHMIN-NEXT:    mv a1, a2
; ZVFHMIN-NEXT:  .LBB6_6:
...
; ZVFHMIN-NEXT:    sltu a6, a1, a4
; ZVFHMIN-NEXT:    fcvt.s.h fa5, fa0
; ZVFHMIN-NEXT:    bltu a0, a5, .LBB7_2
; ZVFHMIN-NEXT:  # %bb.1:
; ZVFHMIN-NEXT:    mv a0, a5
; ZVFHMIN-NEXT:  .LBB7_2:
; ZVFHMIN-NEXT:    addi a5, a6, -1
...
; ZVFHMIN-NEXT:    vfmv.s.f v8, fa5
; ZVFHMIN-NEXT:    mv a6, a0
; ZVFHMIN-NEXT:    bltu a0, a2, .LBB7_4
; ZVFHMIN-NEXT:  # %bb.3:
; ZVFHMIN-NEXT:    mv a6, a2
; ZVFHMIN-NEXT:  .LBB7_4:
; ZVFHMIN-NEXT:    and a4, a5, a4
...
; ZVFHMIN-NEXT:    vsetivli zero, 1, e32, m1, ta, ma
; ZVFHMIN-NEXT:    vfmv.s.f v8, fa5
; ZVFHMIN-NEXT:    bltu a1, a2, .LBB7_6
; ZVFHMIN-NEXT:  # %bb.5:
; ZVFHMIN-NEXT:    mv a1, a2
; ZVFHMIN-NEXT:  .LBB7_6:
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, m4, ta, ma
