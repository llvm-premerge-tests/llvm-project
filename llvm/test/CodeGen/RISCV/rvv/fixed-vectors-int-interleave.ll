...
; RV32-V128-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x08, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 8 * vlenb
; RV32-V128-NEXT:    vmv8r.v v0, v8
...
; RV32-V128-NEXT:    vid.v v8
; RV32-V128-NEXT:    vsrl.vi v8, v8, 1
; RV32-V128-NEXT:    li a1, 16
; RV32-V128-NEXT:    vadd.vx v8, v8, a1
; RV32-V128-NEXT:    vrgather.vv v24, v0, v8
...
; RV32-V128-NEXT:    vrgather.vv v24, v16, v8, v0.t
...
; RV64-V128-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x08, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 8 * vlenb
; RV64-V128-NEXT:    vmv8r.v v0, v8
...
; RV64-V128-NEXT:    vid.v v8
; RV64-V128-NEXT:    vsrl.vi v8, v8, 1
; RV64-V128-NEXT:    li a1, 16
; RV64-V128-NEXT:    vadd.vx v8, v8, a1
; RV64-V128-NEXT:    vrgather.vv v24, v0, v8
...
; RV64-V128-NEXT:    vrgather.vv v24, v16, v8, v0.t
