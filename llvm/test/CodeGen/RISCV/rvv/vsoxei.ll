...
; CHECK-NEXT:    vsoxei32.v v10, (a0), v8
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetvli zero, a1, e8, mf2, ta, ma
; CHECK-NEXT:    vsoxei32.v v10, (a0), v8, v0.t
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vsoxei32.v v12, (a0), v8
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetvli zero, a1, e8, m1, ta, ma
; CHECK-NEXT:    vsoxei32.v v12, (a0), v8, v0.t
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetvli zero, a1, e8, m1, ta, ma
; CHECK-NEXT:    vsoxei16.v v10, (a0), v8
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetvli zero, a1, e8, m1, ta, ma
; CHECK-NEXT:    vsoxei16.v v10, (a0), v8, v0.t
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetvli zero, a1, e8, m2, ta, ma
; CHECK-NEXT:    vsoxei16.v v12, (a0), v8
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetvli zero, a1, e8, m2, ta, ma
; CHECK-NEXT:    vsoxei16.v v12, (a0), v8, v0.t
; CHECK-NEXT:    ret
entry:
