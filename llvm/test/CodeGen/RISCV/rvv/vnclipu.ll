...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wv v10, v8, v11, v0.t
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wv v12, v8, v14, v0.t
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wv v16, v8, v20, v0.t
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wx v10, v8, a0, v0.t
; CHECK-NEXT:    vmv.v.v v8, v10
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wx v12, v8, a0, v0.t
; CHECK-NEXT:    vmv.v.v v8, v12
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wx v16, v8, a0, v0.t
; CHECK-NEXT:    vmv.v.v v8, v16
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vsetvli zero, a0, e8, m1, ta, mu
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wi v10, v8, 9, v0.t
; CHECK-NEXT:    vmv.v.v v8, v10
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i8> @llvm.riscv.vnclipu.mask.nxv8i8.nxv8i16(
...
; CHECK-NEXT:    vsetvli zero, a0, e8, m2, ta, mu
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wi v12, v8, 9, v0.t
; CHECK-NEXT:    vmv.v.v v8, v12
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i8> @llvm.riscv.vnclipu.mask.nxv16i8.nxv16i16(
...
; CHECK-NEXT:    vsetvli zero, a0, e8, m4, ta, mu
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wi v16, v8, 9, v0.t
; CHECK-NEXT:    vmv.v.v v8, v16
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i8> @llvm.riscv.vnclipu.mask.nxv32i8.nxv32i16(
