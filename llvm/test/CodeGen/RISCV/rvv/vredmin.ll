...
; CHECK-NEXT:    vredmin.vs v10, v8, v11
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetvli zero, a0, e8, m2, ta, ma
; CHECK-NEXT:    vredmin.vs v10, v8, v11, v0.t
; CHECK-NEXT:    vmv1r.v v8, v10
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vredmin.vs v12, v8, v13
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetvli zero, a0, e8, m4, ta, ma
; CHECK-NEXT:    vredmin.vs v12, v8, v13, v0.t
; CHECK-NEXT:    vmv1r.v v8, v12
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vredmin.vs v16, v8, v17
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetvli zero, a0, e16, m8, ta, ma
; CHECK-NEXT:    vredmin.vs v16, v8, v17, v0.t
; CHECK-NEXT:    vmv1r.v v8, v16
; CHECK-NEXT:    ret
entry:
