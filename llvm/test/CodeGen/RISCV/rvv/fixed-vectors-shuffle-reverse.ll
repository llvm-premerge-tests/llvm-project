...
; RUN: llc -mtriple=riscv32 -mattr=+m,+v,+f,+d,+zfh,+zvfh -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,RV64-NO-ZVBB,RV32-BITS-UNKNOWN
; RUN: llc -mtriple=riscv32 -mattr=+m,+v,+f,+d,+zfh,+zvfh -riscv-v-vector-bits-max=256 -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,RV64-NO-ZVBB,RV32-BITS-256
; RUN: llc -mtriple=riscv32 -mattr=+m,+v,+f,+d,+zfh,+zvfh -riscv-v-vector-bits-max=512 -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,RV64-NO-ZVBB,RV32-BITS-512
; RUN: llc -mtriple=riscv64 -mattr=+m,+v,+f,+d,+zfh,+zvfh -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,RV64-NO-ZVBB,RV64-BITS-UNKNOWN
; RUN: llc -mtriple=riscv64 -mattr=+m,+v,+f,+d,+zfh,+zvfh -riscv-v-vector-bits-max=256 -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,RV64-NO-ZVBB,RV64-BITS-256
; RUN: llc -mtriple=riscv64 -mattr=+m,+v,+f,+d,+zfh,+zvfh -riscv-v-vector-bits-max=512 -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,RV64-NO-ZVBB,RV64-BITS-512
; RUN: llc -mtriple=riscv32 -mattr=+m,+v,+f,+d,+zfh,+zvfh,+experimental-zvbb -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,RV64-ZVBB
; RUN: llc -mtriple=riscv64 -mattr=+m,+v,+f,+d,+zfh,+zvfh,+experimental-zvbb -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,RV64-ZVBB
...
; RV64-NO-ZVBB-LABEL: reverse_v2i1:
; RV64-NO-ZVBB:       # %bb.0:
; RV64-NO-ZVBB-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; RV64-NO-ZVBB-NEXT:    vmv.v.i v8, 0
; RV64-NO-ZVBB-NEXT:    vmerge.vim v8, v8, 1, v0
; RV64-NO-ZVBB-NEXT:    vslidedown.vi v9, v8, 1
; RV64-NO-ZVBB-NEXT:    vslideup.vi v9, v8, 1
; RV64-NO-ZVBB-NEXT:    vmsne.vi v0, v9, 0
; RV64-NO-ZVBB-NEXT:    ret
;
; RV64-ZVBB-LABEL: reverse_v2i1:
; RV64-ZVBB:       # %bb.0:
; RV64-ZVBB-NEXT:    vsetivli zero, 1, e8, mf8, ta, ma
; RV64-ZVBB-NEXT:    vbrev.v v8, v0
; RV64-ZVBB-NEXT:    vsrl.vi v0, v8, 6
; RV64-ZVBB-NEXT:    ret
...
; RV64-NO-ZVBB-LABEL: reverse_v4i1:
; RV64-NO-ZVBB:       # %bb.0:
; RV64-NO-ZVBB-NEXT:    vsetivli zero, 4, e8, mf4, ta, ma
; RV64-NO-ZVBB-NEXT:    vmv.v.i v8, 0
; RV64-NO-ZVBB-NEXT:    vmerge.vim v8, v8, 1, v0
; RV64-NO-ZVBB-NEXT:    vid.v v9
; RV64-NO-ZVBB-NEXT:    vrsub.vi v9, v9, 3
; RV64-NO-ZVBB-NEXT:    vrgather.vv v10, v8, v9
; RV64-NO-ZVBB-NEXT:    vmsne.vi v0, v10, 0
; RV64-NO-ZVBB-NEXT:    ret
;
; RV64-ZVBB-LABEL: reverse_v4i1:
; RV64-ZVBB:       # %bb.0:
; RV64-ZVBB-NEXT:    vsetivli zero, 1, e8, mf8, ta, ma
; RV64-ZVBB-NEXT:    vbrev.v v8, v0
; RV64-ZVBB-NEXT:    vsrl.vi v0, v8, 4
; RV64-ZVBB-NEXT:    ret
...
; RV64-NO-ZVBB-LABEL: reverse_v8i1:
; RV64-NO-ZVBB:       # %bb.0:
; RV64-NO-ZVBB-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; RV64-NO-ZVBB-NEXT:    vmv.v.i v8, 0
; RV64-NO-ZVBB-NEXT:    vmerge.vim v8, v8, 1, v0
; RV64-NO-ZVBB-NEXT:    vid.v v9
; RV64-NO-ZVBB-NEXT:    vrsub.vi v9, v9, 7
; RV64-NO-ZVBB-NEXT:    vrgather.vv v10, v8, v9
; RV64-NO-ZVBB-NEXT:    vmsne.vi v0, v10, 0
; RV64-NO-ZVBB-NEXT:    ret
;
; RV64-ZVBB-LABEL: reverse_v8i1:
; RV64-ZVBB:       # %bb.0:
; RV64-ZVBB-NEXT:    vsetivli zero, 1, e8, mf8, ta, ma
; RV64-ZVBB-NEXT:    vbrev.v v0, v0
; RV64-ZVBB-NEXT:    ret
...
; RV64-NO-ZVBB-LABEL: reverse_v16i1:
; RV64-NO-ZVBB:       # %bb.0:
; RV64-NO-ZVBB-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
; RV64-NO-ZVBB-NEXT:    vmv.v.i v8, 0
; RV64-NO-ZVBB-NEXT:    vmerge.vim v8, v8, 1, v0
; RV64-NO-ZVBB-NEXT:    vid.v v9
; RV64-NO-ZVBB-NEXT:    vrsub.vi v9, v9, 15
; RV64-NO-ZVBB-NEXT:    vrgather.vv v10, v8, v9
; RV64-NO-ZVBB-NEXT:    vmsne.vi v0, v10, 0
; RV64-NO-ZVBB-NEXT:    ret
;
; RV64-ZVBB-LABEL: reverse_v16i1:
; RV64-ZVBB:       # %bb.0:
; RV64-ZVBB-NEXT:    vsetivli zero, 1, e16, mf4, ta, ma
; RV64-ZVBB-NEXT:    vbrev.v v0, v0
; RV64-ZVBB-NEXT:    ret
...
; RV64-NO-ZVBB-LABEL: reverse_v32i1:
; RV64-NO-ZVBB:       # %bb.0:
; RV64-NO-ZVBB-NEXT:    lui a0, %hi(.LCPI4_0)
; RV64-NO-ZVBB-NEXT:    addi a0, a0, %lo(.LCPI4_0)
; RV64-NO-ZVBB-NEXT:    li a1, 32
; RV64-NO-ZVBB-NEXT:    vsetvli zero, a1, e8, m2, ta, ma
; RV64-NO-ZVBB-NEXT:    vle8.v v8, (a0)
; RV64-NO-ZVBB-NEXT:    vmv.v.i v10, 0
; RV64-NO-ZVBB-NEXT:    vmerge.vim v10, v10, 1, v0
; RV64-NO-ZVBB-NEXT:    vrgather.vv v12, v10, v8
; RV64-NO-ZVBB-NEXT:    vmsne.vi v0, v12, 0
; RV64-NO-ZVBB-NEXT:    ret
;
; RV64-ZVBB-LABEL: reverse_v32i1:
; RV64-ZVBB:       # %bb.0:
; RV64-ZVBB-NEXT:    vsetivli zero, 1, e32, mf2, ta, ma
; RV64-ZVBB-NEXT:    vbrev.v v0, v0
; RV64-ZVBB-NEXT:    ret
...
; RV64-NO-ZVBB-LABEL: reverse_v64i1:
; RV64-NO-ZVBB:       # %bb.0:
; RV64-NO-ZVBB-NEXT:    lui a0, %hi(.LCPI5_0)
; RV64-NO-ZVBB-NEXT:    addi a0, a0, %lo(.LCPI5_0)
; RV64-NO-ZVBB-NEXT:    li a1, 64
; RV64-NO-ZVBB-NEXT:    vsetvli zero, a1, e8, m4, ta, ma
; RV64-NO-ZVBB-NEXT:    vle8.v v8, (a0)
; RV64-NO-ZVBB-NEXT:    vmv.v.i v12, 0
; RV64-NO-ZVBB-NEXT:    vmerge.vim v12, v12, 1, v0
; RV64-NO-ZVBB-NEXT:    vrgather.vv v16, v12, v8
; RV64-NO-ZVBB-NEXT:    vmsne.vi v0, v16, 0
; RV64-NO-ZVBB-NEXT:    ret
;
; RV64-ZVBB-LABEL: reverse_v64i1:
; RV64-ZVBB:       # %bb.0:
; RV64-ZVBB-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV64-ZVBB-NEXT:    vbrev.v v0, v0
; RV64-ZVBB-NEXT:    ret
