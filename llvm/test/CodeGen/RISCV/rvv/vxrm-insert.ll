...
; FIXME: We should hoist vxrm write out of the loop.
...
; CHECK-NEXT:    vsetvli zero, a4, e8, mf8, ta, ma
...
for.body:
  ...
  %vl = tail call iXLen @llvm.riscv.vsetvli.iXLen(iXLen %n.addr.011, iXLen 0, iXLen 2)
...
; CHECK-NEXT:    ret
entry:
  %vl = tail call iXLen @llvm.riscv.vsetvli.iXLen(iXLen %n, iXLen 0, iXLen 2)
...
for.body:
  ...
  %vl2 = tail call iXLen @llvm.riscv.vsetvli.iXLen(iXLen %n.addr.011, iXLen 0, iXLen 2)
