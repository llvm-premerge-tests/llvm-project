...
define <vscale x 64 x i8> @vrem_vv_nxv64i8_sext_twice(<vscale x 64 x i8> %va, <vscale x 64 x i8> %vb) {
; CHECK-LABEL: vrem_vv_nxv64i8_sext_twice:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e8, m4, ta, ma
; CHECK-NEXT:    vrem.vv v12, v12, v20
; CHECK-NEXT:    vrem.vv v8, v8, v16
; CHECK-NEXT:    ret
  %sext_va = sext <vscale x 64 x i8> %va to <vscale x 64 x i16>
  %sext_vb = sext <vscale x 64 x i8> %vb to <vscale x 64 x i16>
  %vc_ext = srem <vscale x 64 x i16> %sext_va, %sext_vb
  %vc = trunc <vscale x 64 x i16> %vc_ext to <vscale x 64 x i8>
  ret <vscale x 64 x i8> %vc
}
...
; RV64-V:       # %bb.0:
; RV64-V-NEXT:    lui a0, %hi(.LCPI68_0)
; RV64-V-NEXT:    ld a0, %lo(.LCPI68_0)(a0)
...
; RV64-V:       # %bb.0:
; RV64-V-NEXT:    lui a0, %hi(.LCPI71_0)
; RV64-V-NEXT:    ld a0, %lo(.LCPI71_0)(a0)
...
; RV64-V:       # %bb.0:
; RV64-V-NEXT:    lui a0, %hi(.LCPI74_0)
; RV64-V-NEXT:    ld a0, %lo(.LCPI74_0)(a0)
...
; RV64-V:       # %bb.0:
; RV64-V-NEXT:    lui a0, %hi(.LCPI77_0)
; RV64-V-NEXT:    ld a0, %lo(.LCPI77_0)(a0)
