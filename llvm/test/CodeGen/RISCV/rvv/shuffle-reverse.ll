...
; RV32-NEXT:    vid.v v14
; RV32-NEXT:    li a1, 31
; RV32-NEXT:    vrsub.vx v16, v14, a1
; RV32-NEXT:    vrgather.vv v10, v8, v16
; RV32-NEXT:    vrsub.vi v8, v14, 15
; RV32-NEXT:    lui a1, 16
; RV32-NEXT:    addi a1, a1, -1
; RV32-NEXT:    vsetivli zero, 1, e32, mf2, ta, ma
; RV32-NEXT:    vmv.v.x v0, a1
; RV32-NEXT:    vsetvli zero, a0, e8, m2, ta, mu
; RV32-NEXT:    vrgather.vv v10, v12, v8, v0.t
...
; RV64-NEXT:    vid.v v14
; RV64-NEXT:    li a1, 31
; RV64-NEXT:    vrsub.vx v16, v14, a1
; RV64-NEXT:    vrgather.vv v10, v8, v16
; RV64-NEXT:    vrsub.vi v8, v14, 15
; RV64-NEXT:    lui a1, 16
; RV64-NEXT:    addiw a1, a1, -1
; RV64-NEXT:    vsetivli zero, 1, e32, mf2, ta, ma
; RV64-NEXT:    vmv.v.x v0, a1
; RV64-NEXT:    vsetvli zero, a0, e8, m2, ta, mu
; RV64-NEXT:    vrgather.vv v10, v12, v8, v0.t
...
; RV32-NEXT:    vid.v v20
; RV32-NEXT:    li a1, 31
; RV32-NEXT:    vrsub.vx v24, v20, a1
; RV32-NEXT:    vrgather.vv v12, v8, v24
; RV32-NEXT:    vrsub.vi v8, v20, 15
; RV32-NEXT:    lui a1, 16
; RV32-NEXT:    addi a1, a1, -1
; RV32-NEXT:    vsetivli zero, 1, e32, mf2, ta, ma
; RV32-NEXT:    vmv.v.x v0, a1
; RV32-NEXT:    vsetvli zero, a0, e16, m4, ta, mu
...
; RV64-NEXT:    vid.v v20
; RV64-NEXT:    li a1, 31
; RV64-NEXT:    vrsub.vx v24, v20, a1
; RV64-NEXT:    vrgather.vv v12, v8, v24
; RV64-NEXT:    vrsub.vi v8, v20, 15
; RV64-NEXT:    lui a1, 16
; RV64-NEXT:    addiw a1, a1, -1
; RV64-NEXT:    vsetivli zero, 1, e32, mf2, ta, ma
; RV64-NEXT:    vmv.v.x v0, a1
