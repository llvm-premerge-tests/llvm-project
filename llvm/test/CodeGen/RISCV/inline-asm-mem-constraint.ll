...
label:
  call void asm "lw zero, $0", "*m"(ptr nonnull elementtype(i32) getelementptr inbounds (i8, ptr blockaddress(@constraint_m_with_local_2, %label), i32 4))
  ret void
}
...
label:
  call void asm "lw zero, $0", "*m"(ptr nonnull elementtype(i32) getelementptr inbounds (i8, ptr blockaddress(@constraint_m_with_local_3, %label), i32 2000))
  ret void
}
...
label:
  call void asm "lw zero, $0", "*o"(ptr nonnull elementtype(i32) getelementptr inbounds (i8, ptr blockaddress(@constraint_o_with_local_2, %label), i32 4))
  ret void
}
...
label:
  call void asm "lw zero, $0", "*o"(ptr nonnull elementtype(i32) getelementptr inbounds (i8, ptr blockaddress(@constraint_o_with_local_3, %label), i32 2000))
  ret void
}
...
; RV64I-MEDIUM-NEXT:    #NO_APP
; RV64I-MEDIUM-NEXT:    ret
  call void asm "sw zero, $0", "=*A"(ptr nonnull elementtype(i32) getelementptr inbounds ([400000 x i32], ptr @eg, i32 0, i32 1))
  ret void
}
...
; RV64I-MEDIUM-NEXT:    #NO_APP
; RV64I-MEDIUM-NEXT:    ret
  call void asm "sw zero, $0", "=*A"(ptr nonnull elementtype(i32) getelementptr inbounds ([400000 x i32], ptr @eg, i32 0, i32 2000))
  ret void
}
...
; RV64I-MEDIUM-NEXT:    #NO_APP
; RV64I-MEDIUM-NEXT:    ret
  call void asm "sw zero, $0", "=*A"(ptr nonnull elementtype(i32) getelementptr inbounds ([400000 x i32], ptr @ewg, i32 0, i32 1))
  ret void
}
...
; RV64I-MEDIUM-NEXT:    #NO_APP
; RV64I-MEDIUM-NEXT:    ret
  call void asm "sw zero, $0", "=*A"(ptr nonnull elementtype(i32) getelementptr inbounds ([400000 x i32], ptr @ewg, i32 0, i32 2000))
  ret void
}
...
label:
  call void asm "lw zero, $0", "*A"(ptr nonnull elementtype(i32) getelementptr inbounds (i8, ptr blockaddress(@constraint_A_with_local_2, %label), i32 4))
  ret void
}
...
label:
  call void asm "lw zero, $0", "*A"(ptr nonnull elementtype(i32) getelementptr inbounds (i8, ptr blockaddress(@constraint_A_with_local_3, %label), i32 2000))
  ret void
}
