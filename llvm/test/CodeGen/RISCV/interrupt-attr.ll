...
; CHECK-RV32-F-NEXT:    lw t0, 12(sp) # 4-byte Folded Reload
...
; CHECK-RV32-FD-NEXT:    lw t0, 12(sp) # 4-byte Folded Reload
...
; CHECK-RV64-F-NEXT:    ld t0, 8(sp) # 8-byte Folded Reload
...
; CHECK-RV64-FD-NEXT:    ld t0, 8(sp) # 8-byte Folded Reload
...
; CHECK-RV32-F-NEXT:    lw t0, 8(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    fscsr t0
; CHECK-RV32-F-NEXT:    addi sp, sp, 208
; CHECK-RV32-F-NEXT:    mret
;
...
; CHECK-RV32-FD-NEXT:    lw t0, 4(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fscsr t0
; CHECK-RV32-FD-NEXT:    addi sp, sp, 336
; CHECK-RV32-FD-NEXT:    mret
;
...
; CHECK-RV64-F-NEXT:    ld t0, 0(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    fscsr t0
; CHECK-RV64-F-NEXT:    addi sp, sp, 272
; CHECK-RV64-F-NEXT:    mret
;
...
; CHECK-RV64-FD-NEXT:    ld t0, 0(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fscsr t0
; CHECK-RV64-FD-NEXT:    addi sp, sp, 400
; CHECK-RV64-FD-NEXT:    mret
  %call = call i32 @otherfoo()
