...
; RUN: 2>&1 | FileCheck %s -check-prefix CHECK-RV32-FLOAT -check-prefix CHECK-RV32-F
; RUN: llc -mtriple riscv32-unknown-elf -mattr=+f,+d -o - %s \
; RUN: 2>&1 | FileCheck %s -check-prefix CHECK-RV32-FLOAT -check-prefix CHECK-RV32-FD
;
...
; RUN: 2>&1 | FileCheck %s -check-prefix CHECK-RV64-FLOAT -check-prefix CHECK-RV64-F
; RUN: llc -mtriple riscv64-unknown-elf -mattr=+f,+d -o - %s \
; RUN: 2>&1 | FileCheck %s -check-prefix CHECK-RV64-FLOAT -check-prefix CHECK-RV64-FD
...
; CHECK-NEXT:    sret
;
; CHECK-RV32-FLOAT-LABEL: foo_supervisor:
; CHECK-RV32-FLOAT:       # %bb.0:
; CHECK-RV32-FLOAT-NEXT:    addi sp, sp, -16
; CHECK-RV32-FLOAT-NEXT:    sw t0, 12(sp) # 4-byte Folded Spill
; CHECK-RV32-FLOAT-NEXT:    frcsr t0
; CHECK-RV32-FLOAT-NEXT:    sw t0, 8(sp)
; CHECK-RV32-FLOAT-NEXT:    lw t0, 8(sp)
; CHECK-RV32-FLOAT-NEXT:    fscsr t0
; CHECK-RV32-FLOAT-NEXT:    lw t0, 12(sp) # 4-byte Folded Reload
; CHECK-RV32-FLOAT-NEXT:    addi sp, sp, 16
; CHECK-RV32-FLOAT-NEXT:    sret
;
; CHECK-RV64-FLOAT-LABEL: foo_supervisor:
; CHECK-RV64-FLOAT:       # %bb.0:
; CHECK-RV64-FLOAT-NEXT:    addi sp, sp, -16
; CHECK-RV64-FLOAT-NEXT:    sd t0, 8(sp) # 8-byte Folded Spill
; CHECK-RV64-FLOAT-NEXT:    frcsr t0
; CHECK-RV64-FLOAT-NEXT:    sd t0, 0(sp)
; CHECK-RV64-FLOAT-NEXT:    ld t0, 0(sp)
; CHECK-RV64-FLOAT-NEXT:    fscsr t0
; CHECK-RV64-FLOAT-NEXT:    ld t0, 8(sp) # 8-byte Folded Reload
; CHECK-RV64-FLOAT-NEXT:    addi sp, sp, 16
; CHECK-RV64-FLOAT-NEXT:    sret
  ret void
}
...
; CHECK-NEXT:    mret
;
; CHECK-RV32-FLOAT-LABEL: foo_machine:
; CHECK-RV32-FLOAT:       # %bb.0:
; CHECK-RV32-FLOAT-NEXT:    addi sp, sp, -16
; CHECK-RV32-FLOAT-NEXT:    sw t0, 12(sp) # 4-byte Folded Spill
; CHECK-RV32-FLOAT-NEXT:    frcsr t0
...
; CHECK-RV32-FLOAT-NEXT:    lw t0, 12(sp) # 4-byte Folded Reload
; CHECK-RV32-FLOAT-NEXT:    addi sp, sp, 16
; CHECK-RV32-FLOAT-NEXT:    mret
;
; CHECK-RV64-FLOAT-LABEL: foo_machine:
; CHECK-RV64-FLOAT:       # %bb.0:
; CHECK-RV64-FLOAT-NEXT:    addi sp, sp, -16
; CHECK-RV64-FLOAT-NEXT:    sd t0, 8(sp) # 8-byte Folded Spill
; CHECK-RV64-FLOAT-NEXT:    frcsr t0
...
; CHECK-RV32-F-NEXT:    sw a0, 188(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    sw a1, 184(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    sw a2, 180(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    sw a3, 176(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    sw a4, 172(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    sw a5, 168(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    sw a6, 164(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    sw a7, 160(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    sw t3, 156(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    sw t4, 152(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    sw t5, 148(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    sw t6, 144(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw ft0, 140(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw ft1, 136(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw ft2, 132(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw ft3, 128(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw ft4, 124(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw ft5, 120(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw ft6, 116(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw ft7, 112(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fs0, 108(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fs1, 104(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fa0, 100(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fa1, 96(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fa2, 92(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fa3, 88(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fa4, 84(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fa5, 80(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fa6, 76(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fa7, 72(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fs2, 68(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fs3, 64(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fs4, 60(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fs5, 56(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fs6, 52(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fs7, 48(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fs8, 44(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fs9, 40(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fs10, 36(sp) # 4-byte Folded Spill
; CHECK-RV32-F-NEXT:    fsw fs11, 32(sp) # 4-byte Folded Spill
...
; CHECK-RV32-F-NEXT:    lw a0, 188(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    lw a1, 184(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    lw a2, 180(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    lw a3, 176(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    lw a4, 172(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    lw a5, 168(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    lw a6, 164(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    lw a7, 160(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    lw t3, 156(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    lw t4, 152(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    lw t5, 148(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    lw t6, 144(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw ft0, 140(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw ft1, 136(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw ft2, 132(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw ft3, 128(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw ft4, 124(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw ft5, 120(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw ft6, 116(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw ft7, 112(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fs0, 108(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fs1, 104(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fa0, 100(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fa1, 96(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fa2, 92(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fa3, 88(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fa4, 84(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fa5, 80(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fa6, 76(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fa7, 72(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fs2, 68(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fs3, 64(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fs4, 60(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fs5, 56(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fs6, 52(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fs7, 48(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fs8, 44(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fs9, 40(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fs10, 36(sp) # 4-byte Folded Reload
; CHECK-RV32-F-NEXT:    flw fs11, 32(sp) # 4-byte Folded Reload
...
; CHECK-RV32-FD-NEXT:    sw a0, 316(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-NEXT:    sw a1, 312(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-NEXT:    sw a2, 308(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-NEXT:    sw a3, 304(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-NEXT:    sw a4, 300(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-NEXT:    sw a5, 296(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-NEXT:    sw a6, 292(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-NEXT:    sw a7, 288(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-NEXT:    sw t3, 284(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-NEXT:    sw t4, 280(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-NEXT:    sw t5, 276(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-NEXT:    sw t6, 272(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd ft0, 264(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd ft1, 256(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd ft2, 248(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd ft3, 240(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd ft4, 232(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd ft5, 224(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd ft6, 216(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd ft7, 208(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd fs0, 200(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd fs1, 192(sp) # 8-byte Folded Spill
...
; CHECK-RV32-FD-NEXT:    fsd fs2, 120(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd fs3, 112(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd fs4, 104(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd fs5, 96(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd fs6, 88(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd fs7, 80(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd fs8, 72(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd fs9, 64(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd fs10, 56(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-NEXT:    fsd fs11, 48(sp) # 8-byte Folded Spill
...
; CHECK-RV32-FD-NEXT:    lw a0, 316(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-NEXT:    lw a1, 312(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-NEXT:    lw a2, 308(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-NEXT:    lw a3, 304(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-NEXT:    lw a4, 300(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-NEXT:    lw a5, 296(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-NEXT:    lw a6, 292(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-NEXT:    lw a7, 288(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-NEXT:    lw t3, 284(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-NEXT:    lw t4, 280(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-NEXT:    lw t5, 276(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-NEXT:    lw t6, 272(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld ft0, 264(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld ft1, 256(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld ft2, 248(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld ft3, 240(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld ft4, 232(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld ft5, 224(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld ft6, 216(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld ft7, 208(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld fs0, 200(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld fs1, 192(sp) # 8-byte Folded Reload
...
; CHECK-RV32-FD-NEXT:    fld fs2, 120(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld fs3, 112(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld fs4, 104(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld fs5, 96(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld fs6, 88(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld fs7, 80(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld fs8, 72(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld fs9, 64(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld fs10, 56(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-NEXT:    fld fs11, 48(sp) # 8-byte Folded Reload
...
; CHECK-RV64-F-NEXT:    sd a0, 232(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd a1, 224(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd a2, 216(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd a3, 208(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd a4, 200(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd a5, 192(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd a6, 184(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd a7, 176(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd t3, 168(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd t4, 160(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd t5, 152(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd t6, 144(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft0, 140(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft1, 136(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft2, 132(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft3, 128(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft4, 124(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft5, 120(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft6, 116(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft7, 112(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fs0, 108(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fs1, 104(sp) # 4-byte Folded Spill
...
; CHECK-RV64-F-NEXT:    fsw fs2, 68(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fs3, 64(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fs4, 60(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fs5, 56(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fs6, 52(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fs7, 48(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fs8, 44(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fs9, 40(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fs10, 36(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fs11, 32(sp) # 4-byte Folded Spill
...
; CHECK-RV64-F-NEXT:    ld a0, 232(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld a1, 224(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld a2, 216(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld a3, 208(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld a4, 200(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld a5, 192(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld a6, 184(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld a7, 176(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld t3, 168(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld t4, 160(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld t5, 152(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld t6, 144(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft0, 140(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft1, 136(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft2, 132(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft3, 128(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft4, 124(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft5, 120(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft6, 116(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft7, 112(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fs0, 108(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fs1, 104(sp) # 4-byte Folded Reload
...
; CHECK-RV64-F-NEXT:    flw fs2, 68(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fs3, 64(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fs4, 60(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fs5, 56(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fs6, 52(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fs7, 48(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fs8, 44(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fs9, 40(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fs10, 36(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fs11, 32(sp) # 4-byte Folded Reload
...
; CHECK-RV64-FD-NEXT:    sd a0, 360(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd a1, 352(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd a2, 344(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd a3, 336(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd a4, 328(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd a5, 320(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd a6, 312(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd a7, 304(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd t3, 296(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd t4, 288(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd t5, 280(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd t6, 272(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft0, 264(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft1, 256(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft2, 248(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft3, 240(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft4, 232(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft5, 224(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft6, 216(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft7, 208(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fs0, 200(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fs1, 192(sp) # 8-byte Folded Spill
...
; CHECK-RV64-FD-NEXT:    fsd fs2, 120(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fs3, 112(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fs4, 104(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fs5, 96(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fs6, 88(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fs7, 80(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fs8, 72(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fs9, 64(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fs10, 56(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fs11, 48(sp) # 8-byte Folded Spill
...
; CHECK-RV64-FD-NEXT:    ld a0, 360(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld a1, 352(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld a2, 344(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld a3, 336(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld a4, 328(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld a5, 320(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld a6, 312(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld a7, 304(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld t3, 296(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld t4, 288(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld t5, 280(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld t6, 272(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft0, 264(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft1, 256(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft2, 248(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft3, 240(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft4, 232(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft5, 224(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft6, 216(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft7, 208(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fs0, 200(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fs1, 192(sp) # 8-byte Folded Reload
...
; CHECK-RV64-FD-NEXT:    fld fs2, 120(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fs3, 112(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fs4, 104(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fs5, 96(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fs6, 88(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fs7, 80(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fs8, 72(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fs9, 64(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fs10, 56(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fs11, 48(sp) # 8-byte Folded Reload
