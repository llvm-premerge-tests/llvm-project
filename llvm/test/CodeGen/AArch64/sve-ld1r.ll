...
; RUN: llc -mtriple=aarch64-linux-gnu -mattr=+sve,+no-sve-fp-ld1r < %s | FileCheck %s --check-prefixes=CHECK-AVOID-LD1R
;
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1r_stack:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    sub sp, sp, #16
; CHECK-AVOID-LD1R-NEXT:    .cfi_def_cfa_offset 16
; CHECK-AVOID-LD1R-NEXT:    adrp x8, :got:g8
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.b
; CHECK-AVOID-LD1R-NEXT:    ldr x8, [x8, :got_lo12:g8]
; CHECK-AVOID-LD1R-NEXT:    ldrb w8, [x8]
; CHECK-AVOID-LD1R-NEXT:    strb w8, [sp, #12]
; CHECK-AVOID-LD1R-NEXT:    ld1rb { z0.b }, p0/z, [sp, #14]
; CHECK-AVOID-LD1R-NEXT:    add sp, sp, #16
; CHECK-AVOID-LD1R-NEXT:    ret
  %valp = alloca i8
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rb:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.b
; CHECK-AVOID-LD1R-NEXT:    ld1rb { z0.b }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rb_gep:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.b
; CHECK-AVOID-LD1R-NEXT:    ld1rb { z0.b }, p0/z, [x0, #63]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rb_gep_out_of_range_up:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    add x8, x0, #64
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.b
; CHECK-AVOID-LD1R-NEXT:    ld1rb { z0.b }, p0/z, [x8]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rb_gep_out_of_range_down:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    sub x8, x0, #1
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.b
; CHECK-AVOID-LD1R-NEXT:    ld1rb { z0.b }, p0/z, [x8]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rb_i8_i16_zext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.h
; CHECK-AVOID-LD1R-NEXT:    ld1rb { z0.h }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i8, ptr %valp
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rb_i8_i16_sext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.h
; CHECK-AVOID-LD1R-NEXT:    ld1rsb { z0.h }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i8, ptr %valp
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rb_i8_i32_zext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.s
; CHECK-AVOID-LD1R-NEXT:    ld1rb { z0.s }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i8, ptr %valp
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rb_i8_i32_sext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.s
; CHECK-AVOID-LD1R-NEXT:    ld1rsb { z0.s }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i8, ptr %valp
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rb_i8_i64_zext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.d
; CHECK-AVOID-LD1R-NEXT:    ld1rb { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i8, ptr %valp
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rb_i8_i64_sext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.d
; CHECK-AVOID-LD1R-NEXT:    ld1rsb { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i8, ptr %valp
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.h
; CHECK-AVOID-LD1R-NEXT:    ld1rh { z0.h }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_gep:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.h
; CHECK-AVOID-LD1R-NEXT:    ld1rh { z0.h }, p0/z, [x0, #126]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_gep_out_of_range_up:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    add x8, x0, #128
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.h
; CHECK-AVOID-LD1R-NEXT:    ld1rh { z0.h }, p0/z, [x8]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_gep_out_of_range_down:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    sub x8, x0, #2
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.h
; CHECK-AVOID-LD1R-NEXT:    ld1rh { z0.h }, p0/z, [x8]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_i16_i32_zext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.s
; CHECK-AVOID-LD1R-NEXT:    ld1rh { z0.s }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i16, ptr %valp
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_i16_i32_sext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.s
; CHECK-AVOID-LD1R-NEXT:    ld1rsh { z0.s }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i16, ptr %valp
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_i16_i64_zext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.d
; CHECK-AVOID-LD1R-NEXT:    ld1rh { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i16, ptr %valp
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_i16_i64_sext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.d
; CHECK-AVOID-LD1R-NEXT:    ld1rsh { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i16, ptr %valp
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rw:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.s
; CHECK-AVOID-LD1R-NEXT:    ld1rw { z0.s }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rw_gep:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.s
; CHECK-AVOID-LD1R-NEXT:    ld1rw { z0.s }, p0/z, [x0, #252]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rw_gep_out_of_range_up:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    add x8, x0, #256
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.s
; CHECK-AVOID-LD1R-NEXT:    ld1rw { z0.s }, p0/z, [x8]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rw_gep_out_of_range_down:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    sub x8, x0, #4
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.s
; CHECK-AVOID-LD1R-NEXT:    ld1rw { z0.s }, p0/z, [x8]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rw_i32_i64_zext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.d
; CHECK-AVOID-LD1R-NEXT:    ld1rw { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i32, ptr %valp
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rw_i32_i64_sext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.d
; CHECK-AVOID-LD1R-NEXT:    ld1rsw { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i32, ptr %valp
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rd:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.d
; CHECK-AVOID-LD1R-NEXT:    ld1rd { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rd_gep:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.d
; CHECK-AVOID-LD1R-NEXT:    ld1rd { z0.d }, p0/z, [x0, #504]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rd_gep_out_of_range_up:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    add x8, x0, #512
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.d
; CHECK-AVOID-LD1R-NEXT:    ld1rd { z0.d }, p0/z, [x8]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rd_gep_out_of_range_down:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    sub x8, x0, #8
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.d
; CHECK-AVOID-LD1R-NEXT:    ld1rd { z0.d }, p0/z, [x8]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_half:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr h0, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, h0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_half_gep:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr h0, [x0, #126]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, h0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_half_gep_out_of_range_up:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr h0, [x0, #128]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, h0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_half_gep_out_of_range_down:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldur h0, [x0, #-2]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, h0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_half_unpacked4:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr h0, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, h0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_half_unpacked4_gep:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr h0, [x0, #126]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, h0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_half_unpacked4_gep_out_of_range_up:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr h0, [x0, #128]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, h0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_half_unpacked4_gep_out_of_range_down:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldur h0, [x0, #-2]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, h0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_half_unpacked2:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr h0, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, h0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_half_unpacked2_gep:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr h0, [x0, #126]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, h0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_half_unpacked2_gep_out_of_range_up:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr h0, [x0, #128]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, h0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rh_half_unpacked2_gep_out_of_range_down:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldur h0, [x0, #-2]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, h0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rw_float:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr s0, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, s0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rw_float_gep:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr s0, [x0, #252]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, s0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rw_float_gep_out_of_range_up:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr s0, [x0, #256]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, s0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rw_float_gep_out_of_range_down:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldur s0, [x0, #-4]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, s0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rw_float_unpacked2:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr s0, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, s0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rw_float_unpacked2_gep:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr s0, [x0, #252]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, s0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rw_float_unpacked2_gep_out_of_range_up:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr s0, [x0, #256]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, s0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rw_float_unpacked2_gep_out_of_range_down:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldur s0, [x0, #-4]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, s0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rd_double:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr d0, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, d0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rd_double_gep:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr d0, [x0, #504]
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, d0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rd_double_gep_out_of_range_up:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr d0, [x0, #512]
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, d0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: ld1rd_double_gep_out_of_range_down:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldur d0, [x0, #-8]
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, d0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dupq_ld1rqd_f64:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.d
; CHECK-AVOID-LD1R-NEXT:    ld1rqd { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dupq_ld1rqw_f32:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.s
; CHECK-AVOID-LD1R-NEXT:    ld1rqw { z0.s }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dupq_ld1rqh_f16:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.h
; CHECK-AVOID-LD1R-NEXT:    ld1rqh { z0.h }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dupq_ld1rqh_bf16:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.h
; CHECK-AVOID-LD1R-NEXT:    ld1rqh { z0.h }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dupq_ld1rqd_i64:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.d
; CHECK-AVOID-LD1R-NEXT:    ld1rqd { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dupq_ld1rqw_i32:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.s
; CHECK-AVOID-LD1R-NEXT:    ld1rqw { z0.s }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dupq_ld1rqw_i16:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.h
; CHECK-AVOID-LD1R-NEXT:    ld1rqh { z0.h }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dupq_ld1rqw_i8:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.b
; CHECK-AVOID-LD1R-NEXT:    ld1rqb { z0.b }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rb_i8_passthruundef_nxv16i8:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rb { z0.b }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i8, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rh_i16_passthruundef_nxv8i16:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rh { z0.h }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rh_i8_passthruundef_nxv8i16_sext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rsb { z0.h }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i8, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rh_i8_passthruundef_nxv8i16_zext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rb { z0.h }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i8, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rs_i32_passthruundef_nxv4i32:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rw { z0.s }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rs_i8_passthruundef_nxv4i32_sext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rsb { z0.s }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i8, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rs_i8_passthruundef_nxv4i32_zext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rb { z0.s }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i8, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rs_i16_passthruundef_nxv4i32_sext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rsh { z0.s }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i16, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rs_i16_passthruundef_nxv4i32_zext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rh { z0.s }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i16, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rd_i64_passthruundef_nxv2i64:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rd { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rs_i8_passthruundef_nxv2i64_sext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rsb { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i8, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rs_i8_passthruundef_nxv2i64_zext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rb { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i8, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rs_i16_passthruundef_nxv2i64_sext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rsh { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i16, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rs_i16_passthruundef_nxv2i64_zext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rh { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i16, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rs_i32_passthruundef_nxv2i64_sext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rsw { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i32, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rs_i32_passthruundef_nxv2i64_zext:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rw { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i32, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rh_half_passthruundef_nxv8f16:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr h0, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, p0/m, h0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rs_float_passthruundef_nxv4f32:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr s0, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, p0/m, s0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rd_double_passthruundef_nxv2f64:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr d0, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, p0/m, d0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rh_half_passthruundef_nxv4f16:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr h0, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, p0/m, h0
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rb_i8_passthruzero_nxv16i8:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rb { z0.b }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i8, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rh_i16_passthruzero_nxv8i16:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rh { z0.h }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i16, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rs_i32_passthruzero_nxv4i32:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rw { z0.s }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i32, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rd_i64_passthruzero_nxv2i64:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ld1rd { z0.d }, p0/z, [x0]
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i64, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rh_half_passthruzero_nxv8f16:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr h1, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, #0 // =0x0
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, p0/m, h1
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load half, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rs_float_passthruzero_nxv4f32:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr s1, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, #0 // =0x0
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, p0/m, s1
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load float, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rd_double_passthruzero_nxv2f64:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr d1, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, #0 // =0x0
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, p0/m, d1
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load double, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rh_half_passthruzero_nxv4f16:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr h1, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, #0 // =0x0
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, p0/m, h1
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rh_half_passthruzero_nxv2f16:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr h1, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, #0 // =0x0
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, p0/m, h1
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: dup_ld1rs_float_passthruzero_nxv2f32:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr s1, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, #0 // =0x0
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, p0/m, s1
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: negtest_dup_ld1rb_i8_passthru_nxv16i8:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldrb w8, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.b, p0/m, w8
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i8, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: negtest_dup_ld1rh_i16_passthru_nxv8i16:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldrh w8, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, p0/m, w8
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i16, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: negtest_dup_ld1rs_i32_passthru_nxv4i32:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr w8, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, p0/m, w8
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i32, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: negtest_dup_ld1rd_i64_passthru_nxv2i64:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr x8, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, p0/m, x8
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i64, ptr %addr
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: negtest_dup_ld1rh_half_passthru_nxv8f16:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr h1, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, p0/m, h1
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: negtest_dup_ld1rs_float_passthru_nxv4f32:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr s1, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, p0/m, s1
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: negtest_dup_ld1rd_double_passthru_nxv2f64:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr d1, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, p0/m, d1
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: avoid_preindex_load:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.d
; CHECK-AVOID-LD1R-NEXT:    add x8, x0, #1
; CHECK-AVOID-LD1R-NEXT:    ld1rsb { z0.d }, p0/z, [x0, #1]
; CHECK-AVOID-LD1R-NEXT:    mov x0, x8
; CHECK-AVOID-LD1R-NEXT:    st1d { z0.d }, p0, [x1]
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: avoid_preindex_load_dup:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    add x8, x0, #1
; CHECK-AVOID-LD1R-NEXT:    ld1rsb { z0.d }, p0/z, [x0, #1]
; CHECK-AVOID-LD1R-NEXT:    mov x0, x8
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: avoid_preindex_load_dup_passthru_zero:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    add x8, x0, #1
; CHECK-AVOID-LD1R-NEXT:    ld1rsb { z0.d }, p0/z, [x0, #1]
; CHECK-AVOID-LD1R-NEXT:    mov x0, x8
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: preindex_load_dup_passthru:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldrsb x8, [x0, #1]!
; CHECK-AVOID-LD1R-NEXT:    ptrue p1.d
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, p0/m, x8
; CHECK-AVOID-LD1R-NEXT:    st1d { z0.d }, p1, [x1]
; CHECK-AVOID-LD1R-NEXT:    ret
  %ptr = getelementptr inbounds i8, i8* %src, i64 1
  %tmp = load i8, i8* %ptr, align 4
  %ext = sext i8 %tmp to i64
...
; CHECK-NEXT:    ret
;
; CHECK-AVOID-LD1R-LABEL: preidx8sext64_instead_of_ld1r:
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldrsb x8, [x0, #1]!
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.d
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, x8
; CHECK-AVOID-LD1R-NEXT:    st1d { z0.d }, p0, [x1]
; CHECK-AVOID-LD1R-NEXT:    str x8, [x2]
; CHECK-AVOID-LD1R-NEXT:    ret
  %ptr = getelementptr inbounds i8, i8* %src, i64 1
  %tmp = load i8, i8* %ptr, align 4
  %ext = sext i8 %tmp to i64
