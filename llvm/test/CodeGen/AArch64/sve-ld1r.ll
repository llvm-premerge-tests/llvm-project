...
; RUN: llc -mtriple=aarch64-linux-gnu -mcpu=neoverse-v1 < %s | FileCheck %s --check-prefixes=CHECK,CHECK-NEOVERSE-V1
;
...
; CHECK-LD1R-LABEL: ld1rb_gep_out_of_range_up:
; CHECK-LD1R:       // %bb.0:
; CHECK-LD1R-NEXT:    add x8, x0, #64
; CHECK-LD1R-NEXT:    ptrue p0.b
; CHECK-LD1R-NEXT:    ld1rb { z0.b }, p0/z, [x8]
; CHECK-LD1R-NEXT:    ret
;
; CHECK-NO-LD1R-LABEL: ld1rb_gep_out_of_range_up:
; CHECK-NO-LD1R:       // %bb.0:
; CHECK-NO-LD1R-NEXT:    add x8, x0, #64
; CHECK-NO-LD1R-NEXT:    ptrue p0.b
; CHECK-NO-LD1R-NEXT:    ld1rb { z0.b }, p0/z, [x8]
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rb_gep_out_of_range_up:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ptrue p0.b
; CHECK-NEOVERSE-V1-NEXT:    add x8, x0, #64
; CHECK-NEOVERSE-V1-NEXT:    ld1rb { z0.b }, p0/z, [x8]
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-LD1R-LABEL: ld1rb_gep_out_of_range_down:
; CHECK-LD1R:       // %bb.0:
; CHECK-LD1R-NEXT:    sub x8, x0, #1
; CHECK-LD1R-NEXT:    ptrue p0.b
; CHECK-LD1R-NEXT:    ld1rb { z0.b }, p0/z, [x8]
; CHECK-LD1R-NEXT:    ret
;
; CHECK-NO-LD1R-LABEL: ld1rb_gep_out_of_range_down:
; CHECK-NO-LD1R:       // %bb.0:
; CHECK-NO-LD1R-NEXT:    sub x8, x0, #1
; CHECK-NO-LD1R-NEXT:    ptrue p0.b
; CHECK-NO-LD1R-NEXT:    ld1rb { z0.b }, p0/z, [x8]
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rb_gep_out_of_range_down:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ptrue p0.b
; CHECK-NEOVERSE-V1-NEXT:    sub x8, x0, #1
; CHECK-NEOVERSE-V1-NEXT:    ld1rb { z0.b }, p0/z, [x8]
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-LD1R-LABEL: ld1rh_gep_out_of_range_up:
; CHECK-LD1R:       // %bb.0:
...
; CHECK-LD1R-NEXT:    ret
;
; CHECK-NO-LD1R-LABEL: ld1rh_gep_out_of_range_up:
; CHECK-NO-LD1R:       // %bb.0:
; CHECK-NO-LD1R-NEXT:    add x8, x0, #128
; CHECK-NO-LD1R-NEXT:    ptrue p0.h
; CHECK-NO-LD1R-NEXT:    ld1rh { z0.h }, p0/z, [x8]
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rh_gep_out_of_range_up:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ptrue p0.h
; CHECK-NEOVERSE-V1-NEXT:    add x8, x0, #128
; CHECK-NEOVERSE-V1-NEXT:    ld1rh { z0.h }, p0/z, [x8]
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-LD1R-LABEL: ld1rh_gep_out_of_range_down:
; CHECK-LD1R:       // %bb.0:
...
; CHECK-LD1R-NEXT:    ret
;
; CHECK-NO-LD1R-LABEL: ld1rh_gep_out_of_range_down:
; CHECK-NO-LD1R:       // %bb.0:
; CHECK-NO-LD1R-NEXT:    sub x8, x0, #2
; CHECK-NO-LD1R-NEXT:    ptrue p0.h
; CHECK-NO-LD1R-NEXT:    ld1rh { z0.h }, p0/z, [x8]
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rh_gep_out_of_range_down:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ptrue p0.h
; CHECK-NEOVERSE-V1-NEXT:    sub x8, x0, #2
; CHECK-NEOVERSE-V1-NEXT:    ld1rh { z0.h }, p0/z, [x8]
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-LD1R-LABEL: ld1rw_gep_out_of_range_up:
; CHECK-LD1R:       // %bb.0:
...
; CHECK-LD1R-NEXT:    ret
;
; CHECK-NO-LD1R-LABEL: ld1rw_gep_out_of_range_up:
; CHECK-NO-LD1R:       // %bb.0:
; CHECK-NO-LD1R-NEXT:    add x8, x0, #256
; CHECK-NO-LD1R-NEXT:    ptrue p0.s
; CHECK-NO-LD1R-NEXT:    ld1rw { z0.s }, p0/z, [x8]
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rw_gep_out_of_range_up:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ptrue p0.s
; CHECK-NEOVERSE-V1-NEXT:    add x8, x0, #256
; CHECK-NEOVERSE-V1-NEXT:    ld1rw { z0.s }, p0/z, [x8]
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-LD1R-LABEL: ld1rw_gep_out_of_range_down:
; CHECK-LD1R:       // %bb.0:
...
; CHECK-LD1R-NEXT:    ret
;
; CHECK-NO-LD1R-LABEL: ld1rw_gep_out_of_range_down:
; CHECK-NO-LD1R:       // %bb.0:
; CHECK-NO-LD1R-NEXT:    sub x8, x0, #4
; CHECK-NO-LD1R-NEXT:    ptrue p0.s
; CHECK-NO-LD1R-NEXT:    ld1rw { z0.s }, p0/z, [x8]
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rw_gep_out_of_range_down:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ptrue p0.s
; CHECK-NEOVERSE-V1-NEXT:    sub x8, x0, #4
; CHECK-NEOVERSE-V1-NEXT:    ld1rw { z0.s }, p0/z, [x8]
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-LD1R-LABEL: ld1rd_gep_out_of_range_up:
; CHECK-LD1R:       // %bb.0:
...
; CHECK-LD1R-NEXT:    ret
;
; CHECK-NO-LD1R-LABEL: ld1rd_gep_out_of_range_up:
; CHECK-NO-LD1R:       // %bb.0:
; CHECK-NO-LD1R-NEXT:    add x8, x0, #512
; CHECK-NO-LD1R-NEXT:    ptrue p0.d
; CHECK-NO-LD1R-NEXT:    ld1rd { z0.d }, p0/z, [x8]
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rd_gep_out_of_range_up:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ptrue p0.d
; CHECK-NEOVERSE-V1-NEXT:    add x8, x0, #512
; CHECK-NEOVERSE-V1-NEXT:    ld1rd { z0.d }, p0/z, [x8]
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-LD1R-LABEL: ld1rd_gep_out_of_range_down:
; CHECK-LD1R:       // %bb.0:
...
; CHECK-LD1R-NEXT:    ret
;
; CHECK-NO-LD1R-LABEL: ld1rd_gep_out_of_range_down:
; CHECK-NO-LD1R:       // %bb.0:
; CHECK-NO-LD1R-NEXT:    sub x8, x0, #8
; CHECK-NO-LD1R-NEXT:    ptrue p0.d
; CHECK-NO-LD1R-NEXT:    ld1rd { z0.d }, p0/z, [x8]
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rd_gep_out_of_range_down:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ptrue p0.d
; CHECK-NEOVERSE-V1-NEXT:    sub x8, x0, #8
; CHECK-NEOVERSE-V1-NEXT:    ld1rd { z0.d }, p0/z, [x8]
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rh_half:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr h0, [x0]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, h0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rh_half_gep:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr h0, [x0, #126]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, h0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rh_half_gep_out_of_range_up:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr h0, [x0, #128]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, h0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rh_half_gep_out_of_range_down:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldur h0, [x0, #-2]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, h0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rh_half_unpacked4:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr h0, [x0]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, h0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rh_half_unpacked4_gep:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr h0, [x0, #126]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, h0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rh_half_unpacked4_gep_out_of_range_up:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr h0, [x0, #128]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, h0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rh_half_unpacked4_gep_out_of_range_down:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldur h0, [x0, #-2]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, h0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rh_half_unpacked2:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr h0, [x0]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, h0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rh_half_unpacked2_gep:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr h0, [x0, #126]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, h0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rh_half_unpacked2_gep_out_of_range_up:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr h0, [x0, #128]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, h0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rh_half_unpacked2_gep_out_of_range_down:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldur h0, [x0, #-2]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, h0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rw_float:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr s0, [x0]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.s, s0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rw_float_gep:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr s0, [x0, #252]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.s, s0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rw_float_gep_out_of_range_up:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr s0, [x0, #256]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.s, s0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rw_float_gep_out_of_range_down:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldur s0, [x0, #-4]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.s, s0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rw_float_unpacked2:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr s0, [x0]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.s, s0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rw_float_unpacked2_gep:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr s0, [x0, #252]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.s, s0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rw_float_unpacked2_gep_out_of_range_up:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr s0, [x0, #256]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.s, s0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rw_float_unpacked2_gep_out_of_range_down:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldur s0, [x0, #-4]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.s, s0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rd_double:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr d0, [x0]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.d, d0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rd_double_gep:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr d0, [x0, #504]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.d, d0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rd_double_gep_out_of_range_up:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr d0, [x0, #512]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.d, d0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: ld1rd_double_gep_out_of_range_down:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldur d0, [x0, #-8]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.d, d0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: dup_ld1rh_half_passthruundef_nxv8f16:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr h0, [x0]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, p0/m, h0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: dup_ld1rs_float_passthruundef_nxv4f32:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr s0, [x0]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.s, p0/m, s0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: dup_ld1rd_double_passthruundef_nxv2f64:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr d0, [x0]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.d, p0/m, d0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: dup_ld1rh_half_passthruundef_nxv4f16:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr h0, [x0]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, p0/m, h0
; CHECK-NEOVERSE-V1-NEXT:    ret
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: dup_ld1rh_half_passthruzero_nxv8f16:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr h1, [x0]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, #0 // =0x0
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, p0/m, h1
; CHECK-NEOVERSE-V1-NEXT:    ret
    %ld = load half, ptr %addr
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: dup_ld1rs_float_passthruzero_nxv4f32:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr s1, [x0]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.s, #0 // =0x0
; CHECK-NEOVERSE-V1-NEXT:    mov z0.s, p0/m, s1
; CHECK-NEOVERSE-V1-NEXT:    ret
    %ld = load float, ptr %addr
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: dup_ld1rd_double_passthruzero_nxv2f64:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr d1, [x0]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.d, #0 // =0x0
; CHECK-NEOVERSE-V1-NEXT:    mov z0.d, p0/m, d1
; CHECK-NEOVERSE-V1-NEXT:    ret
    %ld = load double, ptr %addr
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: dup_ld1rh_half_passthruzero_nxv4f16:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr h1, [x0]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, #0 // =0x0
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, p0/m, h1
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: dup_ld1rh_half_passthruzero_nxv2f16:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr h1, [x0]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, #0 // =0x0
; CHECK-NEOVERSE-V1-NEXT:    mov z0.h, p0/m, h1
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: dup_ld1rs_float_passthruzero_nxv2f32:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldr s1, [x0]
; CHECK-NEOVERSE-V1-NEXT:    mov z0.s, #0 // =0x0
; CHECK-NEOVERSE-V1-NEXT:    mov z0.s, p0/m, s1
...
; CHECK-LD1R-LABEL: avoid_preindex_load_dup:
; CHECK-LD1R:       // %bb.0:
; CHECK-LD1R-NEXT:    add x8, x0, #1
; CHECK-LD1R-NEXT:    ld1rsb { z0.d }, p0/z, [x0, #1]
; CHECK-LD1R-NEXT:    mov x0, x8
; CHECK-LD1R-NEXT:    ptrue p0.d
; CHECK-LD1R-NEXT:    st1d { z0.d }, p0, [x1]
; CHECK-LD1R-NEXT:    ret
;
; CHECK-NO-LD1R-LABEL: avoid_preindex_load_dup:
; CHECK-NO-LD1R:       // %bb.0:
; CHECK-NO-LD1R-NEXT:    add x8, x0, #1
; CHECK-NO-LD1R-NEXT:    ld1rsb { z0.d }, p0/z, [x0, #1]
; CHECK-NO-LD1R-NEXT:    mov x0, x8
; CHECK-NO-LD1R-NEXT:    ptrue p0.d
; CHECK-NO-LD1R-NEXT:    st1d { z0.d }, p0, [x1]
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: avoid_preindex_load_dup:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ld1rsb { z0.d }, p0/z, [x0, #1]
; CHECK-NEOVERSE-V1-NEXT:    add x8, x0, #1
; CHECK-NEOVERSE-V1-NEXT:    ptrue p0.d
; CHECK-NEOVERSE-V1-NEXT:    mov x0, x8
; CHECK-NEOVERSE-V1-NEXT:    st1d { z0.d }, p0, [x1]
; CHECK-NEOVERSE-V1-NEXT:    ret
  %ptr = getelementptr inbounds i8, i8* %src, i64 1
  %tmp = load i8, i8* %ptr, align 4
  %ext = sext i8 %tmp to i64
...
; CHECK-LD1R-LABEL: avoid_preindex_load_dup_passthru_zero:
; CHECK-LD1R:       // %bb.0:
; CHECK-LD1R-NEXT:    add x8, x0, #1
; CHECK-LD1R-NEXT:    ld1rsb { z0.d }, p0/z, [x0, #1]
; CHECK-LD1R-NEXT:    mov x0, x8
...
; CHECK-LD1R-NEXT:    ret
;
; CHECK-NO-LD1R-LABEL: avoid_preindex_load_dup_passthru_zero:
; CHECK-NO-LD1R:       // %bb.0:
; CHECK-NO-LD1R-NEXT:    add x8, x0, #1
; CHECK-NO-LD1R-NEXT:    ld1rsb { z0.d }, p0/z, [x0, #1]
; CHECK-NO-LD1R-NEXT:    mov x0, x8
...
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: avoid_preindex_load_dup_passthru_zero:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ld1rsb { z0.d }, p0/z, [x0, #1]
; CHECK-NEOVERSE-V1-NEXT:    add x8, x0, #1
; CHECK-NEOVERSE-V1-NEXT:    ptrue p0.d
...
; CHECK-LD1R-LABEL: preindex_load_dup_passthru:
; CHECK-LD1R:       // %bb.0:
; CHECK-LD1R-NEXT:    ldrsb x8, [x0, #1]!
; CHECK-LD1R-NEXT:    ptrue p1.d
; CHECK-LD1R-NEXT:    mov z0.d, p0/m, x8
; CHECK-LD1R-NEXT:    st1d { z0.d }, p1, [x1]
; CHECK-LD1R-NEXT:    ret
;
; CHECK-NO-LD1R-LABEL: preindex_load_dup_passthru:
; CHECK-NO-LD1R:       // %bb.0:
; CHECK-NO-LD1R-NEXT:    ldrsb x8, [x0, #1]!
; CHECK-NO-LD1R-NEXT:    ptrue p1.d
; CHECK-NO-LD1R-NEXT:    mov z0.d, p0/m, x8
; CHECK-NO-LD1R-NEXT:    st1d { z0.d }, p1, [x1]
; CHECK-NO-LD1R-NEXT:    ret
;
; CHECK-NEOVERSE-V1-LABEL: preindex_load_dup_passthru:
; CHECK-NEOVERSE-V1:       // %bb.0:
; CHECK-NEOVERSE-V1-NEXT:    ldrsb x8, [x0, #1]!
; CHECK-NEOVERSE-V1-NEXT:    mov z0.d, p0/m, x8
; CHECK-NEOVERSE-V1-NEXT:    ptrue p0.d
; CHECK-NEOVERSE-V1-NEXT:    st1d { z0.d }, p0, [x1]
; CHECK-NEOVERSE-V1-NEXT:    ret
  %ptr = getelementptr inbounds i8, i8* %src, i64 1
