...
; RUN: llc -mtriple=aarch64-linux-gnu -mattr=+sve,+avoid-ld1r < %s | FileCheck %s --check-prefixes=CHECK-AVOID-LD1R
;
...
; CHECK-AVOID-LD1R-NEXT:    ldrb w8, [sp, #14]
; CHECK-AVOID-LD1R-NEXT:    mov z0.b, w8
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldrb w8, [x0, #63]
; CHECK-AVOID-LD1R-NEXT:    mov z0.b, w8
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldrb w8, [x0, #64]
; CHECK-AVOID-LD1R-NEXT:    mov z0.b, w8
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldurb w8, [x0, #-1]
; CHECK-AVOID-LD1R-NEXT:    mov z0.b, w8
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldrb w8, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, w8
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i8, ptr %valp
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldrsb w8, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, w8
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i8, ptr %valp
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldrb w8, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, w8
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i8, ptr %valp
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldrsb x8, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, x8
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i8, ptr %valp
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldrh w8, [x0, #126]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, w8
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldrh w8, [x0, #128]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, w8
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldurh w8, [x0, #-2]
; CHECK-AVOID-LD1R-NEXT:    mov z0.h, w8
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldrsh w8, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, w8
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i16, ptr %valp
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldrsh x8, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, x8
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i16, ptr %valp
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr w8, [x0, #252]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, w8
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr w8, [x0, #256]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, w8
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldur w8, [x0, #-4]
; CHECK-AVOID-LD1R-NEXT:    mov z0.s, w8
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldrsw x8, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, x8
; CHECK-AVOID-LD1R-NEXT:    ret
  %val = load i32, ptr %valp
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr x8, [x0, #504]
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, x8
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldr x8, [x0, #512]
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, x8
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldur x8, [x0, #-8]
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, x8
; CHECK-AVOID-LD1R-NEXT:    ret
...
; CHECK-AVOID-LD1R:       // %bb.0:
; CHECK-AVOID-LD1R-NEXT:    ldrb w8, [x0]
; CHECK-AVOID-LD1R-NEXT:    mov z0.b, #0 // =0x0
; CHECK-AVOID-LD1R-NEXT:    mov z0.b, p0/m, w8
; CHECK-AVOID-LD1R-NEXT:    ret
    %ld = load i8, ptr %addr
...
; CHECK-AVOID-LD1R-NEXT:    ldrsb x9, [x0, #1]
; CHECK-AVOID-LD1R-NEXT:    mov x0, x8
; CHECK-AVOID-LD1R-NEXT:    ptrue p0.d
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, x9
...
; CHECK-AVOID-LD1R-NEXT:    mov z0.d, p0/m, x9
