...
; RUN: llc -mattr=+sve2 -force-streaming-compatible-sve -aarch64-sve-vector-bits-min=128 -aarch64-sve-vector-bits-max=256  < %s | FileCheck %s -check-prefixes=CHECK,SVE2_256
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: shuffle_ext_byone_v4i8:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    adrp x8, .LCPI0_0
; SVE2_256-NEXT:    // kill: def $d0 killed $d0 def $z0
; SVE2_256-NEXT:    ldr q1, [x8, :lo12:.LCPI0_0]
; SVE2_256-NEXT:    tbl z0.h, { z0.h }, z1.h
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: shuffle_ext_byone_v32i8:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    ldr q0, [x0, #16]
; SVE2_256-NEXT:    ldp q1, q3, [x1]
; SVE2_256-NEXT:    mov z0.b, z0.b[15]
; SVE2_256-NEXT:    mov z2.b, z1.b[15]
; SVE2_256-NEXT:    fmov w8, s0
; SVE2_256-NEXT:    insr z1.b, w8
; SVE2_256-NEXT:    fmov w8, s2
; SVE2_256-NEXT:    insr z3.b, w8
; SVE2_256-NEXT:    stp q1, q3, [x0]
; SVE2_256-NEXT:    ret
;
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: shuffle_ext_byone_v16i16:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    ldr q0, [x0, #16]
; SVE2_256-NEXT:    ldp q1, q3, [x1]
; SVE2_256-NEXT:    mov z0.h, z0.h[7]
; SVE2_256-NEXT:    mov z2.h, z1.h[7]
; SVE2_256-NEXT:    fmov w8, s0
; SVE2_256-NEXT:    insr z1.h, w8
; SVE2_256-NEXT:    fmov w8, s2
; SVE2_256-NEXT:    insr z3.h, w8
; SVE2_256-NEXT:    stp q1, q3, [x0]
; SVE2_256-NEXT:    ret
;
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: shuffle_ext_byone_v8i32:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    ldr q0, [x0, #16]
; SVE2_256-NEXT:    ldp q1, q3, [x1]
; SVE2_256-NEXT:    mov z0.s, z0.s[3]
; SVE2_256-NEXT:    mov z2.s, z1.s[3]
; SVE2_256-NEXT:    fmov w8, s0
; SVE2_256-NEXT:    insr z1.s, w8
; SVE2_256-NEXT:    fmov w8, s2
; SVE2_256-NEXT:    insr z3.s, w8
; SVE2_256-NEXT:    stp q1, q3, [x0]
; SVE2_256-NEXT:    ret
;
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: shuffle_ext_byone_v4i64:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    ldr q0, [x0, #16]
; SVE2_256-NEXT:    ldp q1, q3, [x1]
; SVE2_256-NEXT:    mov z0.d, z0.d[1]
; SVE2_256-NEXT:    mov z2.d, z1.d[1]
; SVE2_256-NEXT:    fmov x8, d0
; SVE2_256-NEXT:    insr z1.d, x8
; SVE2_256-NEXT:    fmov x8, d2
; SVE2_256-NEXT:    insr z3.d, x8
; SVE2_256-NEXT:    stp q1, q3, [x0]
; SVE2_256-NEXT:    ret
;
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: shuffle_ext_byone_v16f16:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    ldp q1, q3, [x1]
; SVE2_256-NEXT:    ldr q0, [x0, #16]
; SVE2_256-NEXT:    mov z0.h, z0.h[7]
; SVE2_256-NEXT:    mov z2.h, z1.h[7]
; SVE2_256-NEXT:    insr z1.h, h0
; SVE2_256-NEXT:    insr z3.h, h2
; SVE2_256-NEXT:    stp q1, q3, [x0]
; SVE2_256-NEXT:    ret
;
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: shuffle_ext_byone_v8f32:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    ldp q1, q3, [x1]
; SVE2_256-NEXT:    ldr q0, [x0, #16]
; SVE2_256-NEXT:    mov z0.s, z0.s[3]
; SVE2_256-NEXT:    mov z2.s, z1.s[3]
; SVE2_256-NEXT:    insr z1.s, s0
; SVE2_256-NEXT:    insr z3.s, s2
; SVE2_256-NEXT:    stp q1, q3, [x0]
; SVE2_256-NEXT:    ret
;
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: shuffle_ext_byone_v4f64:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    ldp q1, q3, [x1]
; SVE2_256-NEXT:    ldr q0, [x0, #16]
; SVE2_256-NEXT:    mov z0.d, z0.d[1]
; SVE2_256-NEXT:    mov z2.d, z1.d[1]
; SVE2_256-NEXT:    insr z1.d, d0
; SVE2_256-NEXT:    insr z3.d, d2
; SVE2_256-NEXT:    stp q1, q3, [x0]
; SVE2_256-NEXT:    ret
;
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: shuffle_ext_byone_reverse:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    ldp q1, q3, [x0]
; SVE2_256-NEXT:    ldr q0, [x1, #16]
; SVE2_256-NEXT:    mov z0.d, z0.d[1]
; SVE2_256-NEXT:    mov z2.d, z1.d[1]
; SVE2_256-NEXT:    insr z1.d, d0
; SVE2_256-NEXT:    insr z3.d, d2
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: shuffle_ext_invalid:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    ldr q0, [x0, #16]
; SVE2_256-NEXT:    ldr q1, [x1]
; SVE2_256-NEXT:    stp q0, q1, [x0]
; SVE2_256-NEXT:    ret
;
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: sve2_shuffle_v4i16_tbl2:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    sub sp, sp, #16
; SVE2_256-NEXT:    .cfi_def_cfa_offset 16
; SVE2_256-NEXT:    ldr d0, [x0]
; SVE2_256-NEXT:    ldr d1, [x1]
; SVE2_256-NEXT:    mov z2.h, z0.h[3]
; SVE2_256-NEXT:    fmov w8, s1
; SVE2_256-NEXT:    mov z0.h, z0.h[1]
; SVE2_256-NEXT:    mov z3.h, z1.h[2]
; SVE2_256-NEXT:    strh w8, [sp, #14]
; SVE2_256-NEXT:    fmov w8, s2
; SVE2_256-NEXT:    fmov w9, s0
; SVE2_256-NEXT:    strh w8, [sp, #12]
; SVE2_256-NEXT:    fmov w8, s3
; SVE2_256-NEXT:    strh w9, [sp, #10]
; SVE2_256-NEXT:    strh w8, [sp, #8]
; SVE2_256-NEXT:    ldr d0, [sp, #8]
; SVE2_256-NEXT:    add sp, sp, #16
; SVE2_256-NEXT:    ret
;
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: sve2_shuffle_v8i16_tbl2:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    sub sp, sp, #16
; SVE2_256-NEXT:    .cfi_def_cfa_offset 16
; SVE2_256-NEXT:    ldr q0, [x0]
; SVE2_256-NEXT:    ldr q1, [x1]
; SVE2_256-NEXT:    mov z2.h, z0.h[1]
; SVE2_256-NEXT:    fmov w8, s0
; SVE2_256-NEXT:    mov z1.h, z1.h[7]
; SVE2_256-NEXT:    mov z3.h, z0.h[7]
; SVE2_256-NEXT:    mov z0.h, z0.h[3]
; SVE2_256-NEXT:    strh w8, [sp, #12]
; SVE2_256-NEXT:    fmov w9, s2
; SVE2_256-NEXT:    strh w8, [sp, #10]
; SVE2_256-NEXT:    strh w8, [sp]
; SVE2_256-NEXT:    fmov w8, s1
; SVE2_256-NEXT:    strh w9, [sp, #14]
; SVE2_256-NEXT:    fmov w9, s3
; SVE2_256-NEXT:    strh w8, [sp, #8]
; SVE2_256-NEXT:    fmov w8, s0
; SVE2_256-NEXT:    strh w9, [sp, #6]
; SVE2_256-NEXT:    strh w9, [sp, #4]
; SVE2_256-NEXT:    strh w8, [sp, #2]
; SVE2_256-NEXT:    ldr q0, [sp], #16
; SVE2_256-NEXT:    ret
;
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: sve2_shuffle_v8i16_tbl_op1:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    adrp x8, .LCPI25_0
; SVE2_256-NEXT:    ldr q0, [x0]
; SVE2_256-NEXT:    ldr q1, [x8, :lo12:.LCPI25_0]
; SVE2_256-NEXT:    tbl z0.h, { z0.h }, z1.h
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: sve2_shuffle_v8i16_tbl_op2:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    adrp x8, .LCPI26_0
; SVE2_256-NEXT:    ldr q0, [x1]
; SVE2_256-NEXT:    ldr q1, [x8, :lo12:.LCPI26_0]
; SVE2_256-NEXT:    tbl z0.h, { z0.h }, z1.h
; SVE2_256-NEXT:    // kill: def $q0 killed $q0 killed $z0
; SVE2_256-NEXT:    ret
;
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: sve2_shuffle_v4f32_tbl2_op2:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    sub sp, sp, #16
; SVE2_256-NEXT:    .cfi_def_cfa_offset 16
; SVE2_256-NEXT:    ldr q0, [x0]
; SVE2_256-NEXT:    ldr q1, [x1]
; SVE2_256-NEXT:    mov z2.s, z0.s[1]
; SVE2_256-NEXT:    mov z1.s, z1.s[1]
; SVE2_256-NEXT:    mov z3.s, z0.s[3]
; SVE2_256-NEXT:    stp s1, s2, [sp, #8]
; SVE2_256-NEXT:    stp s0, s3, [sp]
; SVE2_256-NEXT:    ldr q0, [sp], #16
; SVE2_256-NEXT:    ret
;
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: sve2_shuffle_v4f32_tbl_op1:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    adrp x8, .LCPI28_0
; SVE2_256-NEXT:    ldr q0, [x0]
; SVE2_256-NEXT:    ldr q1, [x8, :lo12:.LCPI28_0]
; SVE2_256-NEXT:    tbl z0.s, { z0.s }, z1.s
; SVE2_256-NEXT:    // kill: def $q0 killed $q0 killed $z0
; SVE2_256-NEXT:    ret
;
...
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    adrp x8, .LCPI29_0
; SVE2_256-NEXT:    ldr d0, [x1]
; SVE2_256-NEXT:    ldr q1, [x8, :lo12:.LCPI29_0]
...
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    adrp x8, .LCPI30_0
; SVE2_256-NEXT:    ldr d0, [x0]
; SVE2_256-NEXT:    ldr q1, [x8, :lo12:.LCPI30_0]
; SVE2_256-NEXT:    tbl z0.b, { z0.b }, z1.b
; SVE2_256-NEXT:    // kill: def $d0 killed $d0 killed $z0
; SVE2_256-NEXT:    ret
;
...
; SVE2_256-NEXT:    .cfi_def_cfa_offset 16
; SVE2_256-NEXT:    ldr d0, [x1]
; SVE2_256-NEXT:    mov z1.b, z0.b[7]
; SVE2_256-NEXT:    mov z2.b, z0.b[6]
; SVE2_256-NEXT:    mov z3.b, z0.b[4]
; SVE2_256-NEXT:    fmov w8, s1
; SVE2_256-NEXT:    ldr d1, [x0]
; SVE2_256-NEXT:    fmov w9, s2
; SVE2_256-NEXT:    mov z2.b, z0.b[3]
; SVE2_256-NEXT:    mov z1.b, z1.b[1]
; SVE2_256-NEXT:    strb w8, [sp, #15]
; SVE2_256-NEXT:    fmov w8, s3
; SVE2_256-NEXT:    mov z3.b, z0.b[2]
; SVE2_256-NEXT:    strb w9, [sp, #14]
; SVE2_256-NEXT:    mov z0.b, z0.b[1]
; SVE2_256-NEXT:    fmov w9, s2
; SVE2_256-NEXT:    strb w8, [sp, #13]
; SVE2_256-NEXT:    strb w8, [sp, #12]
; SVE2_256-NEXT:    fmov w8, s3
; SVE2_256-NEXT:    strb w9, [sp, #11]
; SVE2_256-NEXT:    fmov w9, s0
; SVE2_256-NEXT:    strb w8, [sp, #10]
; SVE2_256-NEXT:    fmov w8, s1
; SVE2_256-NEXT:    strb w9, [sp, #9]
; SVE2_256-NEXT:    strb w8, [sp, #8]
; SVE2_256-NEXT:    ldr d0, [sp, #8]
; SVE2_256-NEXT:    add sp, sp, #16
; SVE2_256-NEXT:    ret
;
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: shuffle_index_size_unacceptable_op_both_maxhw:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    sub sp, sp, #16
; SVE2_256-NEXT:    .cfi_def_cfa_offset 16
; SVE2_256-NEXT:    ldr d0, [x1]
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: shuffle_index_size_acceptable_i16_op_both:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    sub sp, sp, #16
; SVE2_256-NEXT:    .cfi_def_cfa_offset 16
; SVE2_256-NEXT:    ldr q0, [x1]
; SVE2_256-NEXT:    mov z1.h, z0.h[7]
; SVE2_256-NEXT:    mov z2.h, z0.h[6]
; SVE2_256-NEXT:    mov z3.h, z0.h[4]
; SVE2_256-NEXT:    fmov w8, s1
; SVE2_256-NEXT:    ldr q1, [x0]
; SVE2_256-NEXT:    fmov w9, s2
; SVE2_256-NEXT:    mov z2.h, z0.h[3]
; SVE2_256-NEXT:    mov z1.h, z1.h[1]
; SVE2_256-NEXT:    strh w8, [sp, #14]
; SVE2_256-NEXT:    fmov w8, s3
; SVE2_256-NEXT:    mov z3.h, z0.h[2]
; SVE2_256-NEXT:    strh w9, [sp, #12]
; SVE2_256-NEXT:    mov z0.h, z0.h[1]
; SVE2_256-NEXT:    fmov w9, s2
; SVE2_256-NEXT:    strh w8, [sp, #10]
; SVE2_256-NEXT:    strh w8, [sp, #8]
...
; SVE2_256-NEXT:    strh w9, [sp, #6]
; SVE2_256-NEXT:    fmov w9, s0
; SVE2_256-NEXT:    strh w8, [sp, #4]
; SVE2_256-NEXT:    fmov w8, s1
; SVE2_256-NEXT:    strh w9, [sp, #2]
; SVE2_256-NEXT:    strh w8, [sp]
; SVE2_256-NEXT:    ldr q0, [sp], #16
; SVE2_256-NEXT:    ret
;
...
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    sub sp, sp, #48
; SVE2_256-NEXT:    .cfi_def_cfa_offset 48
; SVE2_256-NEXT:    ldp q0, q3, [x0]
; SVE2_256-NEXT:    ldr q1, [x0, #32]
; SVE2_256-NEXT:    ldr q4, [x1, #48]
; SVE2_256-NEXT:    mov z1.d, z1.d[1]
; SVE2_256-NEXT:    mov z2.d, z0.d[1]
; SVE2_256-NEXT:    mov z3.d, z3.d[1]
; SVE2_256-NEXT:    stp d1, d2, [sp, #16]
; SVE2_256-NEXT:    mov z2.d, z4.d[1]
; SVE2_256-NEXT:    stp d0, d3, [sp, #32]
; SVE2_256-NEXT:    stp d1, d2, [sp]
; SVE2_256-NEXT:    ldp q1, q0, [sp, #16]
; SVE2_256-NEXT:    ldr q7, [sp], #48
; SVE2_256-NEXT:    mov z2.d, z0.d
; SVE2_256-NEXT:    mov z3.d, z1.d
; SVE2_256-NEXT:    mov z5.d, z1.d
; SVE2_256-NEXT:    mov z4.d, z0.d
; SVE2_256-NEXT:    mov z6.d, z0.d
; SVE2_256-NEXT:    ret
;
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: shuffle_doublemask_size_acceptable_i16_op_both:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    sub sp, sp, #16
; SVE2_256-NEXT:    .cfi_def_cfa_offset 16
; SVE2_256-NEXT:    ldr d0, [x1]
; SVE2_256-NEXT:    ldr d1, [x0]
; SVE2_256-NEXT:    fmov w8, s0
; SVE2_256-NEXT:    mov z2.h, z1.h[3]
; SVE2_256-NEXT:    fmov w9, s1
; SVE2_256-NEXT:    mov z3.h, z0.h[2]
; SVE2_256-NEXT:    mov z0.h, z0.h[3]
; SVE2_256-NEXT:    mov z1.h, z1.h[1]
; SVE2_256-NEXT:    strh w8, [sp, #14]
...
; SVE2_256-NEXT:    strh w9, [sp, #12]
; SVE2_256-NEXT:    strh w9, [sp, #10]
; SVE2_256-NEXT:    strh w9, [sp, #8]
; SVE2_256-NEXT:    fmov w9, s3
; SVE2_256-NEXT:    strh w8, [sp, #6]
; SVE2_256-NEXT:    fmov w8, s0
; SVE2_256-NEXT:    strh w9, [sp, #4]
; SVE2_256-NEXT:    fmov w9, s1
; SVE2_256-NEXT:    strh w8, [sp, #2]
; SVE2_256-NEXT:    strh w9, [sp]
; SVE2_256-NEXT:    ldr q0, [sp], #16
; SVE2_256-NEXT:    ret
;
...
; SVE2_128-NEXT:    ret
;
; SVE2_256-LABEL: shuffle_halfmask_size_acceptable_float_op_one:
; SVE2_256:       // %bb.0:
; SVE2_256-NEXT:    adrp x8, .LCPI36_0
; SVE2_256-NEXT:    ldr q1, [x0]
; SVE2_256-NEXT:    ldr q0, [x8, :lo12:.LCPI36_0]
; SVE2_256-NEXT:    tbl z0.s, { z1.s }, z0.s
; SVE2_256-NEXT:    // kill: def $q0 killed $q0 killed $z0
; SVE2_256-NEXT:    ret
;
