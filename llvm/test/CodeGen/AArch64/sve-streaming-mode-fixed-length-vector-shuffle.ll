...
; CHECK:       // %bb.0:
; CHECK-NEXT:    ldp q5, q3, [x0, #16]
; CHECK-NEXT:    index z0.d, #3, #-2
; CHECK-NEXT:    index z6.d, #0, #3
; CHECK-NEXT:    ldr q2, [x0]
; CHECK-NEXT:    ldr q17, [x1, #48]
; CHECK-NEXT:    mov z16.d, z3.d[1]
; CHECK-NEXT:    mov z4.d, z2.d
; CHECK-NEXT:    tbl z1.d, { z2.d, z3.d }, z0.d
; CHECK-NEXT:    tbl z0.d, { z4.d, z5.d }, z6.d
; CHECK-NEXT:    tbl z7.d, { z16.d, z17.d }, z6.d
