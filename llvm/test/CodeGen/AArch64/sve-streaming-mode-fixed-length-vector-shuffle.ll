...
; CHECK-NEXT:	.byte	255
; CHECK-NEXT:	.byte	255
define <8 x i8> @shuffle_index_size_acceptable_op_both(ptr %a, ptr %b) #1 {
...
define <8 x i8> @shuffle_index_size_acceptable_op_both_maxhw(ptr %a, ptr %b) #3 {
; CHECK-LABEL: shuffle_index_size_acceptable_op_both_maxhw:
; CHECK:       // %bb.0:
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    ldr d0, [x0]
...
; CHECK: .LCPI33_0:
; CHECK-NEXT:	.hword	1
; CHECK-NEXT:	.hword	129
; CHECK-NEXT:	.hword	130
; CHECK-NEXT:	.hword	131
; CHECK-NEXT:	.hword	132
; CHECK-NEXT:	.hword	132
; CHECK-NEXT:	.hword	134
; CHECK-NEXT:	.hword	135
; CHECK-NEXT:	.hword  65535
; CHECK-NEXT:	.hword  65535
define <8 x i16> @shuffle_index_size_acceptable_i16_op_both(ptr %a, ptr %b) #3 {
; CHECK-LABEL: shuffle_index_size_acceptable_i16_op_both:
; CHECK:       // %bb.0:
; CHECK-NEXT:    ptrue p0.h
; CHECK-NEXT:    ldr q0, [x0]
; CHECK-NEXT:    adrp x8, .LCPI33_0
; CHECK-NEXT:    add x8, x8, :lo12:.LCPI33_0
; CHECK-NEXT:    ldr q1, [x1]
...
; CHECK:       // %bb.0:
; CHECK-NEXT:    ldp q5, q2, [x0, #16]
; CHECK-NEXT:    index z0.d, #3, #-2
; CHECK-NEXT:    ldr q1, [x0]
; CHECK-NEXT:    index z3.d, #0, #3
; CHECK-NEXT:    ldr q7, [x1, #48]
; CHECK-NEXT:    mov z6.d, z2.d[1]
; CHECK-NEXT:    mov z4.d, z1.d
; CHECK-NEXT:    tbl z1.d, { z1.d, z2.d }, z0.d
; CHECK-NEXT:    tbl z7.d, { z6.d, z7.d }, z3.d
; CHECK-NEXT:    tbl z0.d, { z4.d, z5.d }, z3.d
...
; CHECK-NEXT:        .hword  0
; CHECK-NEXT:        .hword  8
define <8 x i16> @shuffle_doublemask_size_acceptable_i16_op_both(ptr %a, ptr %b) #1 {
; CHECK-LABEL: shuffle_doublemask_size_acceptable_i16_op_both:
; CHECK:       // %bb.0:
...
; CHECK-NEXT:	.word	4294967295
define <4 x float> @shuffle_halfmask_size_acceptable_float_op_one(ptr %ptr1, ptr %ptr2) #2 {
; CHECK-LABEL: shuffle_halfmask_size_acceptable_float_op_one:
; CHECK:       // %bb.0:
