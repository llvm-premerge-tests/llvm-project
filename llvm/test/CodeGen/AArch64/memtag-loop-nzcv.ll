...
; This test function includes a 256-byte buffer. We expect it to
; require its MTE tags to be set to a useful value on entry, and
; cleared again on exit. At the time of writing this test, the
; pseudo-instructions chosen are STGloop_wback and STGloop
; respectively, but if different pseudos are selected in future,
