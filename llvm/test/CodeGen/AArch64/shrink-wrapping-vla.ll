...
; CHECK-NEXT:    ldr w12, [x1, w11, sxtw #2]
; CHECK-NEXT:    str w12, [x10], #4
; CHECK-NEXT:    b.ne .LBB0_3
; CHECK-NEXT:  // %bb.4: // %for.cond6.preheader
; CHECK-NEXT:    cmp w0, #1
...
; CHECK-NEXT:    str w10, [x1], #4
; CHECK-NEXT:    b.ne .LBB0_5
; CHECK-NEXT:  .LBB0_6: // %for.cond.cleanup8
