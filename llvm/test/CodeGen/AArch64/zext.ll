...
; CHECK-GI:      warning: Instruction selection used fallback path for zext_v3i8_v3i16
; CHECK-GI-NEXT: warning: Instruction selection used fallback path for zext_v3i10_v3i16
; CHECK-GI-NEXT: warning: Instruction selection used fallback path for zext_v16i10_v16i16
...
; CHECK-LABEL: zext_v3i10_v3i16:
; CHECK:       // %bb.0: // %entry
; CHECK-NEXT:    fmov s0, w0
; CHECK-NEXT:    mov v0.h[1], w1
; CHECK-NEXT:    mov v0.h[2], w2
; CHECK-NEXT:    bic v0.4h, #252, lsl #8
; CHECK-NEXT:    // kill: def $d0 killed $d0 killed $q0
; CHECK-NEXT:    ret
entry:
