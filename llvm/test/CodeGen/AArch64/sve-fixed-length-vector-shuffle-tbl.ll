...
; CHECK-NEXT:    ret
  %op1 = load <8 x i8>, ptr %a
  %1 = shufflevector <8 x i8> %op1, <8 x i8> poison, <8 x i32> <i32 1, i32 9, i32 10, i32 11, i32 12, i32 12, i32 14, i32 15>
  ret <8 x i8> %1
}

define <8 x i8> @shuffle_ops_both_poison(ptr %a, ptr %b) {
; CHECK-LABEL: shuffle_ops_both_poison:
; CHECK:       // %bb.0:
; CHECK-NEXT:    adrp x8, .LCPI6_0
; CHECK-NEXT:    ldr d0, [x8, :lo12:.LCPI6_0]
; CHECK-NEXT:    ret
  %1 = shufflevector <8 x i8> poison, <8 x i8> poison, <8 x i32> <i32 1, i32 9, i32 10, i32 11, i32 12, i32 12, i32 14, i32 15>
  ret <8 x i8> %1
}
