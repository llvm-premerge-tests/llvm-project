...
; CHECK-GI-NEXT:    lsr x10, x1, #1
; CHECK-GI-NEXT:    lsl x9, x0, x9
; CHECK-GI-NEXT:    lsr x8, x10, x8
...
; CHECK-SD-NEXT:    ubfiz x10, x1, #26, #37
...
; CHECK-SD-NEXT:    // kill: def $w2 killed $w2 def $x2
; CHECK-SD-NEXT:    mvn w8, w2
; CHECK-SD-NEXT:    lsl w9, w0, #1
; CHECK-SD-NEXT:    lsr w10, w1, w2
; CHECK-SD-NEXT:    lsl w8, w9, w8
...
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    mvn w8, w2
; CHECK-SD-NEXT:    lsl x9, x0, #1
; CHECK-SD-NEXT:    lsr x10, x1, x2
; CHECK-SD-NEXT:    lsl x8, x9, x8
...
; CHECK-SD-NEXT:    and x8, x2, #0x1fffffffff
; CHECK-SD-NEXT:    movk x9, #12398, lsl #16
; CHECK-SD-NEXT:    lsl x10, x1, #27
; CHECK-SD-NEXT:    movk x9, #15941, lsl #32
; CHECK-SD-NEXT:    lsl x11, x0, #1
; CHECK-SD-NEXT:    movk x9, #1771, lsl #48
; CHECK-SD-NEXT:    umulh x8, x8, x9
; CHECK-SD-NEXT:    mov w9, #37 // =0x25
; CHECK-SD-NEXT:    msub w8, w8, w9, w2
...
; CHECK-SD-LABEL: fshl_i32_shift_by_bitwidth:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: fshl_i32_shift_by_bitwidth:
; CHECK-GI:       // %bb.0:
...
; CHECK-SD-LABEL: fshr_i32_shift_by_bitwidth:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    mov w0, w1
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: fshr_i32_shift_by_bitwidth:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    extr w0, w0, w1, #0
; CHECK-GI-NEXT:    ret
...
; CHECK-SD-NEXT:    lsr w10, w1, #1
; CHECK-SD-NEXT:    lsr w9, w10, w9
...
; CHECK-GI-NEXT:    and w9, w2, #0x1f
; CHECK-GI-NEXT:    bic w8, w8, w2
; CHECK-GI-NEXT:    lsl w10, w1, w2
; CHECK-GI-NEXT:    lsr w11, w1, #1
; CHECK-GI-NEXT:    lsl w9, w0, w9
; CHECK-GI-NEXT:    lsr w8, w11, w8
; CHECK-GI-NEXT:    orr w9, w9, w10
; CHECK-GI-NEXT:    orr w0, w9, w8
; CHECK-GI-NEXT:    ret
  %shy = shl i32 %y, %s
...
; CHECK-GI-NEXT:    and w9, w2, #0x1f
; CHECK-GI-NEXT:    bic w8, w8, w2
; CHECK-GI-NEXT:    lsr w10, w1, w2
; CHECK-GI-NEXT:    lsl w11, w1, #1
; CHECK-GI-NEXT:    lsr w9, w0, w9
; CHECK-GI-NEXT:    lsl w8, w11, w8
; CHECK-GI-NEXT:    orr w9, w9, w10
; CHECK-GI-NEXT:    orr w0, w8, w9
; CHECK-GI-NEXT:    ret
  %shy = lshr i32 %y, %s
