...
define float @scvtf_v1i16_f32(ptr %0) {
; CHECK-LABEL: scvtf_v1i16_f32:
; CHECK:       // %bb.0:
; CHECK-NEXT:    ldrsh w8, [x0]
...
define double @scvtf_v1i16_f64(ptr %0) {
; CHECK-LABEL: scvtf_v1i16_f64:
; CHECK:       // %bb.0:
; CHECK-NEXT:    ldrsh w8, [x0]
...
define half @scvtf_v1i32_v1f16(ptr %0) {
; CHECK-LABEL: scvtf_v1i32_v1f16:
; CHECK:       // %bb.0:
...
define float @scvtf_v1i32_v1f32(ptr %0) {
; CHECK-LABEL: scvtf_v1i32_v1f32:
; CHECK:       // %bb.0:
; CHECK-NEXT:    ldr w8, [x0]
; CHECK-NEXT:    scvtf s0, w8
; CHECK-NEXT:    ret
...
define double @scvtf_v1i32_v1f64(ptr %0) {
...
define half @scvtf_v1i64_v1f16(ptr %0) {
...
define float @scvtf_v1i64_v1f32(ptr %0) {
...
define double @scvtf_v1i64_v1f64(ptr %0) {
...
define half @ucvtf_v1i16_f16(ptr %0) {
; CHECK-LABEL: ucvtf_v1i16_f16:
; CHECK:       // %bb.0:
...
define float @ucvtf_v1i16_f32(ptr %0) {
; CHECK-LABEL: ucvtf_v1i16_f32:
; CHECK:       // %bb.0:
...
define double @ucvtf_v1i16_f64(ptr %0) {
; CHECK-LABEL: ucvtf_v1i16_f64:
; CHECK:       // %bb.0:
; CHECK-NEXT:    ldr h0, [x0]
...
define half @ucvtf_v1i32_v1f16(ptr %0) {
; CHECK-LABEL: ucvtf_v1i32_v1f16:
; CHECK:       // %bb.0:
; CHECK-NEXT:    ldr w8, [x0]
; CHECK-NEXT:    ucvtf h0, w8
; CHECK-NEXT:    ret
...
define float @ucvtf_v1i32_v1f32(ptr %0) {
; CHECK-LABEL: ucvtf_v1i32_v1f32:
; CHECK:       // %bb.0:
; CHECK-NEXT:    ldr w8, [x0]
...
define double @ucvtf_v1i32_v1f64(ptr %0) {
...
define half @ucvtf_v1i64_v1f16(ptr %0) {
...
define float @ucvtf_v1i64_v1f32(ptr %0) {
...
define double @ucvtf_v1i64_v1f64(ptr %0) {
