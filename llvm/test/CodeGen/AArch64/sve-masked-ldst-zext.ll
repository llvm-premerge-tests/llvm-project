...
define <vscale x 4 x i64> @masked_zload_4i8_4i64(ptr %a, ptr %b, <vscale x 4 x i1> %c) {
...
define <vscale x 4 x i64> @masked_zload_4i16_4i64(ptr %a, ptr %b, <vscale x 4 x i1> %c) {
...
define <vscale x 8 x i32> @masked_zload_8i8_8i32(ptr %a, ptr %b, <vscale x 8 x i1> %c) {
...
define <vscale x 8 x i64> @masked_zload_8i8_8i64(ptr %a, ptr %b, <vscale x 8 x i1> %c) {
