...
define <vscale x 4 x i64> @masked_sload_4i8_4i64(ptr %a, ptr %b, <vscale x 4 x i1> %c) {
...
define <vscale x 4 x i64> @masked_sload_4i16_4i64(ptr %a, ptr %b, <vscale x 4 x i1> %c) {
...
define <vscale x 8 x i32> @masked_sload_8i8_8i32(ptr %a, ptr %b, <vscale x 8 x i1> %c) {
...
define <vscale x 8 x i64> @masked_sload_8i8_8i64(ptr %a, ptr %b, <vscale x 8 x i1> %c) {
...
; CHECK-NEXT:    sunpklo z0.d, z0.s
; CHECK-NEXT:    sunpkhi z6.d, z3.s
; CHECK-NEXT:    sunpklo z3.d, z3.s
; CHECK-NEXT:    sunpkhi z7.d, z1.s
; CHECK-NEXT:    sunpklo z1.d, z1.s
; CHECK-NEXT:    add z0.d, z0.d, z1.d
; CHECK-NEXT:    add z1.d, z5.d, z7.d
; CHECK-NEXT:    add z2.d, z2.d, z3.d
; CHECK-NEXT:    add z3.d, z4.d, z6.d
; CHECK-NEXT:    ret
  %aval = call <vscale x 8 x i8> @llvm.masked.load.nxv8i8(<vscale x 8 x i8> *%a, i32 16, <vscale x 8 x i1> %c, <vscale x 8 x i8> zeroinitializer)
  %bval = call <vscale x 8 x i8> @llvm.masked.load.nxv8i8(<vscale x 8 x i8> *%b, i32 16, <vscale x 8 x i1> %c, <vscale x 8 x i8> zeroinitializer)
