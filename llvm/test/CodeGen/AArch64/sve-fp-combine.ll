...
define <vscale x 4 x float> @fadd_sel_fma_s_different_arg_order(<vscale x 4 x i1> %pred, <vscale x 4 x float> %m1, <vscale x 4 x float> %m2, <vscale x 4 x float> %acc) {
; CHECK-LABEL: fadd_sel_fma_s_different_arg_order:
; CHECK:       // %bb.0:
...
define <vscale x 2 x double> @fadd_sel_fma_d_different_arg_order(<vscale x 2 x i1> %pred, <vscale x 2 x double> %m1, <vscale x 2 x double> %m2, <vscale x 2 x double> %acc) {
; CHECK-LABEL: fadd_sel_fma_d_different_arg_order:
; CHECK:       // %bb.0:
