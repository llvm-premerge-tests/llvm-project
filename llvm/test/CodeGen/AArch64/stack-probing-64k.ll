...
; 4*64k-16, the largest frame probed without a loop.
define void @static_262128(i8** %out) #0 {
; CHECK-LABEL: static_262128:
; CHECK:       // %bb.0: // %entry
; CHECK-NEXT:    str x29, [sp, #-16]! // 8-byte Folded Spill
; CHECK-NEXT:    .cfi_def_cfa_offset 16
; CHECK-NEXT:    .cfi_offset w29, -16
...
; CHECK-NEXT:    .cfi_def_cfa_offset 258064
; CHECK-NEXT:    sub sp, sp, #4080
; CHECK-NEXT:    .cfi_def_cfa_offset 262144
; CHECK-NEXT:    str xzr, [sp]
; CHECK-NEXT:    mov x8, sp
; CHECK-NEXT:    str x8, [x0]
; CHECK-NEXT:    add sp, sp, #63, lsl #12 // =258048
...
; CHECK-NEXT:    ret
entry:
  %vla = alloca i8, i64 262128, align 1
  store i8* %vla, i8** %out, align 8
  ret void
}

; 4*64k, smallest frame probed with a loop.
define void @static_262144(i8** %out) #0 {
; CHECK-LABEL: static_262144:
; CHECK:       // %bb.0: // %entry
; CHECK-NEXT:    str x29, [sp, #-16]! // 8-byte Folded Spill
; CHECK-NEXT:    .cfi_def_cfa_offset 16
; CHECK-NEXT:    .cfi_offset w29, -16
; CHECK-NEXT:    sub x9, sp, #64, lsl #12 // =262144
; CHECK-NEXT:    .cfi_def_cfa w9, 262160
...
; CHECK-NEXT:    mov x8, sp
; CHECK-NEXT:    str x8, [x0]
; CHECK-NEXT:    add sp, sp, #64, lsl #12 // =262144
; CHECK-NEXT:    .cfi_def_cfa_offset 16
; CHECK-NEXT:    ldr x29, [sp], #16 // 8-byte Folded Reload
; CHECK-NEXT:    .cfi_def_cfa_offset 0
; CHECK-NEXT:    .cfi_restore w29
; CHECK-NEXT:    ret
entry:
  %vla = alloca i8, i64 262144, align 1
  store i8* %vla, i8** %out, align 8
  ret void
}

; 4*64k+1024, large enough to use a loop, but not a multiple of 64KiB
; so has a reminder, but no extra probe.
define void @static_263168(i8** %out) #0 {
; CHECK-LABEL: static_263168:
; CHECK:       // %bb.0: // %entry
; CHECK-NEXT:    str x29, [sp, #-16]! // 8-byte Folded Spill
; CHECK-NEXT:    .cfi_def_cfa_offset 16
; CHECK-NEXT:    .cfi_offset w29, -16
...
; CHECK-NEXT:    .cfi_def_cfa_register wsp
; CHECK-NEXT:    sub sp, sp, #1024
; CHECK-NEXT:    .cfi_def_cfa_offset 263184
; CHECK-NEXT:    mov x8, sp
; CHECK-NEXT:    str x8, [x0]
; CHECK-NEXT:    add sp, sp, #64, lsl #12 // =262144
; CHECK-NEXT:    .cfi_def_cfa_offset 1040
...
; CHECK-NEXT:    ret
entry:
  %vla = alloca i8, i64 263168, align 1
  store i8* %vla, i8** %out, align 8
  ret void
}

; 4*64k+1040, large enough to use a loop, has a reminder and
; an extra probe.
define void @static_263183(i8** %out) #0 {
; CHECK-LABEL: static_263183:
; CHECK:       // %bb.0: // %entry
; CHECK-NEXT:    str x29, [sp, #-16]! // 8-byte Folded Spill
; CHECK-NEXT:    .cfi_def_cfa_offset 16
; CHECK-NEXT:    .cfi_offset w29, -16
...
; CHECK-NEXT:    .cfi_def_cfa_register wsp
; CHECK-NEXT:    sub sp, sp, #1040
; CHECK-NEXT:    .cfi_def_cfa_offset 263200
; CHECK-NEXT:    str xzr, [sp]
; CHECK-NEXT:    mov x8, sp
; CHECK-NEXT:    str x8, [x0]
; CHECK-NEXT:    add sp, sp, #64, lsl #12 // =262144
...
; CHECK-NEXT:    ret
entry:
  %vla = alloca i8, i64 263184, align 1
  store i8* %vla, i8** %out, align 8
  ret void
}
...
; CHECK-NEXT:    sub x9, x9, #4080
; CHECK-NEXT:    and x9, x9, #0xffffffffffff8000
; CHECK-NEXT:    str xzr, [x9]
; CHECK-NEXT:    mov sp, x9
; CHECK-NEXT:    mov x8, sp
; CHECK-NEXT:    str x8, [x0]
