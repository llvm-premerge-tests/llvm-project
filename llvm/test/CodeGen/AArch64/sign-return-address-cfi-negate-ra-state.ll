...
; CHECK-DUMP-NEXT:   DW_CFA_def_cfa_offset: +16
; CHECK-DUMP-NEXT:   DW_CFA_offset: W30 -16
; CHECK-DUMP-NEXT:   DW_CFA_remember_state:
; CHECK-DUMP-NEXT:   DW_CFA_advance_loc: 16
; CHECK-DUMP-NEXT:   DW_CFA_def_cfa_offset: +0
; CHECK-DUMP-NEXT:   DW_CFA_advance_loc: 4
; CHECK-DUMP-NEXT:   DW_CFA_AARCH64_negate_ra_state:
; CHECK-DUMP-NEXT:   DW_CFA_restore: W30
; CHECK-DUMP-NEXT:   DW_CFA_advance_loc: 4
; CHECK-DUMP-NEXT:   DW_CFA_restore_state:
; CHECK-DUMP-NEXT:   DW_CFA_advance_loc: 12
; CHECK-DUMP-NEXT:   DW_CFA_def_cfa_offset: +0
; CHECK-DUMP-NEXT:   DW_CFA_advance_loc: 4
; CHECK-DUMP-NEXT:   DW_CFA_AARCH64_negate_ra_state:
; CHECK-DUMP-NEXT:   DW_CFA_restore: W30
; CHECK-DUMP-NEXT:   DW_CFA_nop
; CHECK-DUMP-NOT:    DW_CFA_
