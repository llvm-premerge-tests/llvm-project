...
; CHECK-NEXT:    imull %edx, %ebp
; CHECK-NEXT:    addl (%ecx,%ebp,4), %eax
; CHECK-NEXT:    leal 1(%edx), %ebp
; CHECK-NEXT:    cmpl %edi, %ebp
...
; CHECK-NEXT:    .p2align 4, 0x90
; CHECK-NEXT:  .LBB7_2: # %loop.body2
; CHECK-NEXT:    # in Loop: Header=BB7_1 Depth=1
; CHECK-NEXT:    movl (%eax), %ecx
; CHECK-NEXT:  .LBB7_3: # %loop.body3
; CHECK-NEXT:    # in Loop: Header=BB7_1 Depth=1
...
; CHECK-NEXT:    # => This Inner Loop Header: Depth=2
; CHECK-NEXT:    cmpl $1769472, %eax # imm = 0x1B0000
...
; CHECK-NEXT:    # in Loop: Header=BB8_1 Depth=1
; CHECK-NEXT:    cmpl $48, %eax
; CHECK-NEXT:    je .LBB8_4
; CHECK-NEXT:    jmp .LBB8_6
; CHECK-NEXT:  .LBB8_8: # %bail
...
; CHECK-NEXT:    cmpl $84, %eax
; CHECK-NEXT:    ja .LBB9_4
...
; CHECK-NEXT:    .cfi_offset %esi, -8
; CHECK-NEXT:    movl {{[0-9]+}}(%esp), %eax
; CHECK-NEXT:    movl 4(%eax), %esi
; CHECK-NEXT:    cmpl $2, %esi
; CHECK-NEXT:    jae .LBB20_1
; CHECK-NEXT:  # %bb.2: # %else
; CHECK-NEXT:    movl 8(%eax), %esi
; CHECK-NEXT:  .LBB20_3: # %exit
; CHECK-NEXT:    movl %esi, %eax
; CHECK-NEXT:    addl $8, %esp
; CHECK-NEXT:    .cfi_def_cfa_offset 8
; CHECK-NEXT:    popl %esi
...
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    cmpl $9000001, %ebx # imm = 0x895441
; CHECK-NEXT:    jge .LBB31_2
; CHECK-NEXT:  # %bb.3: # %.middle
; CHECK-NEXT:    # in Loop: Header=BB31_1 Depth=1
; CHECK-NEXT:    testl $1023, %ebx # imm = 0x3FF
; CHECK-NEXT:    je .LBB31_4
; CHECK-NEXT:  .LBB31_5: # %.backedge
; CHECK-NEXT:    # in Loop: Header=BB31_1 Depth=1
; CHECK-NEXT:    addl %ebx, %esi
; CHECK-NEXT:    incl %ebx
; CHECK-NEXT:    cmpl %edi, %ebx
...
; CHECK-NEXT:    movl %esi, (%esp)
; CHECK-NEXT:    calll effect@PLT
; CHECK-NEXT:    jmp .LBB31_5
; CHECK-NEXT:  .LBB31_2: # %.bailout
; CHECK-NEXT:    incl %edi
...
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    cmpl $9000000, %esi # imm = 0x895440
; CHECK-NEXT:    jg .LBB32_8
...
; CHECK-NEXT:    # in Loop: Header=BB32_3 Depth=1
; CHECK-NEXT:    leal 1(%ebx), %eax
; CHECK-NEXT:    cmpl $10000000, %ebx # imm = 0x989680
; CHECK-NEXT:    jl .LBB32_3
; CHECK-NEXT:    jmp .LBB32_7
; CHECK-NEXT:  .LBB32_5: # %.slow
; CHECK-NEXT:    # in Loop: Header=BB32_3 Depth=1
; CHECK-NEXT:    movl %ebx, (%esp)
; CHECK-NEXT:    calll effect@PLT
...
; CHECK-NEXT:    .cfi_def_cfa_offset 4
; CHECK-NEXT:    retl
; CHECK-NEXT:  .LBB32_8: # %.bailout
; CHECK-NEXT:    .cfi_def_cfa_offset 32
; CHECK-NEXT:    xorl %eax, %eax
; CHECK-NEXT:    jmp .LBB32_9
.entry:
  %sum.0 = shl nsw i32 %count, 1
