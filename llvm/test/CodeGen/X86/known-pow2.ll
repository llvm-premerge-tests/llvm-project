...
define <4 x i1> @pow2_vselect(<4 x i1> %c, <4 x i32> %x, <4 x i32> %y, <4 x i32> %z) {
; CHECK-LABEL: pow2_vselect:
; CHECK:       # %bb.0:
...
define <4 x i1> @pow2_vselect_fail0(<4 x i1> %c, <4 x i32> %x, <4 x i32> %y, <4 x i32> %z) {
; CHECK-LABEL: pow2_vselect_fail0:
; CHECK:       # %bb.0:
; CHECK-NEXT:    pslld $31, %xmm0
; CHECK-NEXT:    psrad $31, %xmm0
; CHECK-NEXT:    pslld $23, %xmm2
...
define <4 x i1> @pow2_vselect_fail2(<4 x i1> %c, <4 x i32> %x, <4 x i32> %y, <4 x i32> %z) {
; CHECK-LABEL: pow2_vselect_fail2:
; CHECK:       # %bb.0:
; CHECK-NEXT:    pslld $31, %xmm0
; CHECK-NEXT:    psrad $31, %xmm0
; CHECK-NEXT:    pslld $23, %xmm2
