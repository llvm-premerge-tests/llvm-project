...
; CHECK-NEXT:    je LBB0_24
; CHECK-NEXT:  ## %bb.11: ## %bb91.i8504
; CHECK-NEXT:    ## in Loop: Header=BB0_5 Depth=1
; CHECK-NEXT:    testb $1, %bl
; CHECK-NEXT:    je LBB0_13
; CHECK-NEXT:  ## %bb.12: ## %bb155.i8541
; CHECK-NEXT:    ## in Loop: Header=BB0_5 Depth=1
; CHECK-NEXT:  Ltmp4:
; CHECK-NEXT:    movl $0, {{[0-9]+}}(%esp)
; CHECK-NEXT:    movl $0, (%esp)
...
; CHECK-NEXT:  Ltmp5:
; CHECK-NEXT:  LBB0_13: ## %bb182.i8560
; CHECK-NEXT:    ## in Loop: Header=BB0_5 Depth=1
; CHECK-NEXT:    testb $1, %bl
; CHECK-NEXT:    je LBB0_14
; CHECK-NEXT:  ## %bb.15: ## %bb278.i8617
; CHECK-NEXT:    ## in Loop: Header=BB0_5 Depth=1
; CHECK-NEXT:    je LBB0_17
; CHECK-NEXT:  ## %bb.16: ## %bb440.i8663
; CHECK-NEXT:    ## in Loop: Header=BB0_5 Depth=1
; CHECK-NEXT:  Ltmp6:
...
; CHECK-NEXT:  LBB0_14: ## %bb187.i8591
; CHECK-NEXT:    ## in Loop: Header=BB0_5 Depth=1
; CHECK-NEXT:    jne LBB0_24
; CHECK-NEXT:  LBB0_17: ## %invcont5814
; CHECK-NEXT:    ## in Loop: Header=BB0_5 Depth=1
; CHECK-NEXT:  Ltmp8:
; CHECK-NEXT:    movl $0, {{[0-9]+}}(%esp)
; CHECK-NEXT:    movl $0, {{[0-9]+}}(%esp)
...
; CHECK-NEXT:    subl $4, %esp
; CHECK-NEXT:  Ltmp3:
; CHECK-NEXT:  LBB0_24: ## %bb115.critedge.i
...
; CHECK-NEXT:    popl %ebp
; CHECK-NEXT:    retl $4
; CHECK-NEXT:  LBB0_22: ## %lpad.loopexit.split-lp
; CHECK-NEXT:  Ltmp15:
; CHECK-NEXT:    jmp LBB0_24
; CHECK-NEXT:  LBB0_23: ## %lpad8185
; CHECK-NEXT:  Ltmp12:
; CHECK-NEXT:    jmp LBB0_24
; CHECK-NEXT:  LBB0_21: ## %lpad.loopexit
; CHECK-NEXT:  Ltmp18:
; CHECK-NEXT:    jmp LBB0_24
