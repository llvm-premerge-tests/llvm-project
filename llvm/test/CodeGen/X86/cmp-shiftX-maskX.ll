...
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+bmi2 | FileCheck %s --check-prefixes=CHECK,CHECK-BMI2
...
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+bmi2,+avx512f,+avx512vl | FileCheck %s --check-prefixes=CHECK,CHECK-BMI2,CHECK-AVX2,CHECK-AVX512
...
; CHECK-NOBMI-NEXT:    pxor %xmm2, %xmm1
...
; CHECK-BMI2-SSE2-NEXT:    pcmpeqd %xmm2, %xmm2
; CHECK-BMI2-SSE2-NEXT:    pxor %xmm2, %xmm1
