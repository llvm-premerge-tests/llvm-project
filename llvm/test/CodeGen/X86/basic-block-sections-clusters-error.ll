...
; CHECK-ERROR3: LLVM ERROR: invalid profile {{.*}} at line 2: unable to parse BB id: '-1': unsigned integer expected
...
; CHECK-ERROR7: LLVM ERROR: invalid profile {{.*}} at line 2: unable to parse basic block id: '1.1.1'
; RUN: echo '!dummy1' > %t8
; RUN: echo '!!0 1.a' >> %t8
...
; CHECK-ERROR8: LLVM ERROR: invalid profile {{.*}} at line 2: unable to parse clone id: 'a' 
; RUN: echo '!dummy1' > %t9
; RUN: echo '!!0 1' >> %t9
; RUN: echo '!!!1 2.1' >> %t9
...
; CHECK-ERROR9: LLVM ERROR: invalid profile {{.*}} at line 3: unsigned integer expected: '2.1'
; RUN: echo '!dummy1' > %t10
; RUN: echo '!!0 1' >> %t10
; RUN: echo '!!!1 2 3 2' >> %t10
; RUN: not --crash llc < %s -O0 -mtriple=x86_64 -function-sections -basic-block-sections=%t9 2>&1 | FileCheck %s --check-prefix=CHECK-ERROR10
; CHECK-ERROR10: LLVM ERROR: invalid profile {{.*}} at line 3: duplicate cloned block in path: '2'
