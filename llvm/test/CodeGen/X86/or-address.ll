...
; CHECK-NEXT:    leal (,%r9,4), %r10d
; CHECK-NEXT:    movl %esi, (%rdi,%r10)
; CHECK-NEXT:    leal 8(,%r9,4), %r10d
; CHECK-NEXT:    movl %esi, (%rdi,%r10)
; CHECK-NEXT:    leal 4(,%r9,4), %r10d
; CHECK-NEXT:    movl %esi, (%rdi,%r10)
; CHECK-NEXT:    leal 12(,%r9,4), %r9d
; CHECK-NEXT:    movl %esi, (%rdi,%r9)
; CHECK-NEXT:    incb %r8b
; CHECK-NEXT:    decb %al
