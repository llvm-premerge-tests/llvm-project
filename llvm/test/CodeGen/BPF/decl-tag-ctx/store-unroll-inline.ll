...
;
; Check position of bpf-context-marker pass in the pipeline:
; - context.marker.bpf call is preserved if address is passed as
;   a parameter to an inline-able function;
; - second bpf-context-marker pass (after inlining) should introduce
...
while.body:                                       ; preds = %while.cond
  %0 = call ptr @llvm.context.marker.bpf(ptr %p)
...
declare ptr @llvm.context.marker.bpf(ptr nocapture readnone) #3
...
!1 = !{!"clang version 17.0.0 (/home/eddy/work/llvm-project/clang 24793f24a0c419509b42ca4d86ec12f45f059b1f)"}
!2 = distinct !{!2, !3, !4}
