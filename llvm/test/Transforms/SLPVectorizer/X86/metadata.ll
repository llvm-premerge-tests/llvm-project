...
; CHECK-NEXT:    [[TMP2:%.*]] = fmul <2 x double> [[TMP0]], [[TMP1]], !fpmath [[FPMATH5:![0-9]+]]
...
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x double>, ptr [[B:%.*]], align 8, !tbaa [[TBAA0]], !freeze_bits [[FREEZE_BITS4]]
; CHECK-NEXT:    [[TMP2:%.*]] = fmul <2 x double> [[TMP0]], [[TMP1]], !fpmath [[FPMATH6:![0-9]+]]
...
;.
; CHECK: attributes #[[ATTR0:[0-9]+]] = { "target-cpu"="corei7-avx" }
;.
; CHECK: [[TBAA0]] = !{!1, !1, i64 0}
; CHECK: [[META1:![0-9]+]] = !{!"double", !2}
; CHECK: [[META2:![0-9]+]] = !{!"omnipotent char", !3}
; CHECK: [[META3:![0-9]+]] = !{!"Simple C/C++ TBAA"}
; CHECK: [[FREEZE_BITS4]] = !{}
; CHECK: [[FPMATH5]] = !{float 5.000000e+00}
; CHECK: [[FPMATH6]] = !{float 2.500000e+00}
;.
