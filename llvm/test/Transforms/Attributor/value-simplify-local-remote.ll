; NOTE: Assertions have been autogenerated by utils/update_test_checks.py UTC_ARGS: --function-signature --check-attributes --check-globals --prefix-filecheck-ir-name FileCheck
...
; CGSCC-NEXT:  entry:
; CGSCC-NEXT:    [[QQFIRST_ADDR:%.*]] = alloca i64, i32 0, align 8
...
; TUNIT-NEXT:  entry:
; TUNIT-NEXT:    [[RETVAL:%.*]] = alloca i64, i32 0, align 8
...
; TUNIT-NEXT:  entry:
; TUNIT-NEXT:    [[DATA_ADDR:%.*]] = alloca i64, i32 0, align 8
...
; CGSCC-NEXT:  entry:
; CGSCC-NEXT:    [[DATA_ADDR:%.*]] = alloca i64, i32 0, align 8
...
; TUNIT:       bb16:
; TUNIT-NEXT:    [[FILECHECKTMP18:%.*]] = icmp eq i32 [[X]], 0
; TUNIT-NEXT:    br i1 [[FILECHECKTMP18]], label [[BB35:%.*]], label [[BB19:%.*]]
; TUNIT:       bb19:
...
; CGSCC:       bb16:
; CGSCC-NEXT:    [[FILECHECKTMP18:%.*]] = icmp eq i32 [[X]], 0
; CGSCC-NEXT:    br i1 [[FILECHECKTMP18]], label [[BB35:%.*]], label [[BB19:%.*]]
; CGSCC:       bb19:
...
; TUNIT-NEXT:  entry:
; TUNIT-NEXT:    [[THIS_ADDR:%.*]] = alloca i64, i32 0, align 8
...
; CGSCC-NEXT:  entry:
; CGSCC-NEXT:    [[THIS_ADDR:%.*]] = alloca i64, i32 0, align 8
