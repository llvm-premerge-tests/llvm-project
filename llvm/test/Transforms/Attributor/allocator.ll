...
;.
define dso_local void @positive_test_reduce_alloca_size(i32 noundef %val) #0 {
; CHECK-LABEL: define dso_local void @positive_test_reduce_alloca_size
...
define dso_local void @positive_test_reduce_malloc_allocation(ptr noundef %val) #0 {
; CHECK-LABEL: define dso_local void @positive_test_reduce_malloc_allocation
