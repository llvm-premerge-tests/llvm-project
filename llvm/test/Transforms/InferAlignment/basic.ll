...
; CHECK-SAME: (ptr [[P:%.*]]) {
; CHECK-NEXT:    [[RET:%.*]] = load i32, ptr null, align 4
; CHECK-NEXT:    ret i32 [[RET]]
;
...
; CHECK-NEXT:    store i8 [[X]], ptr [[ALLOC]], align 1
...
; CHECK-SAME: (i8 [[X:%.*]], i32 [[Y:%.*]]) {
; CHECK-NEXT:    store i8 [[X]], ptr @test2_global, align 1
; CHECK-NEXT:    store i32 [[Y]], ptr @test2_global, align 4
; CHECK-NEXT:    [[RET:%.*]] = load i8, ptr @test2_global, align 1
; CHECK-NEXT:    ret i8 [[RET]]
;
