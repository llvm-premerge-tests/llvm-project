...
; CHECK-NEXT:    [[V:%.*]] = load atomic i8, ptr @c seq_cst, align 8
; CHECK-NEXT:    ret i8 [[V]]
;
...
; CHECK-NEXT:    [[X:%.*]] = load atomic i32, ptr @c unordered, align 8
...
; CHECK-NEXT:    [[X:%.*]] = load atomic i32, ptr @c monotonic, align 8
; CHECK-NEXT:    ret i32 [[X]]
;
...
; CHECK-NEXT:    [[X:%.*]] = load atomic i32, ptr @c seq_cst, align 8
; CHECK-NEXT:    ret i32 [[X]]
;
