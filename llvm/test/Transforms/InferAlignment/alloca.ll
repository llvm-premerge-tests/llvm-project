...
; CHECK-SAME: (i32 [[X:%.*]]) {
; CHECK-NEXT:    [[ALLOCA_STRUCT:%.*]] = alloca [[STRUCT_PAIR:%.*]], align 1
; CHECK-NEXT:    [[GEP_0:%.*]] = getelementptr [[STRUCT_PAIR]], ptr [[ALLOCA_STRUCT]], i32 [[X]], i32 0
; CHECK-NEXT:    [[GEP_1:%.*]] = getelementptr { i32, i32 }, ptr [[GEP_0]], i32 [[X]]
; CHECK-NEXT:    [[LOAD_1:%.*]] = load i32, ptr [[GEP_1]], align 1
; CHECK-NEXT:    store i32 0, ptr [[GEP_1]], align 1
; CHECK-NEXT:    ret void
;
  %alloca.struct = alloca %struct.pair, align 1
