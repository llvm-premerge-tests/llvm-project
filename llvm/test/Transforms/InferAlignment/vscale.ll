...
; CHECK-NEXT:    [[ALLOCA:%.*]] = alloca <vscale x 4 x i32>, align 1
; CHECK-NEXT:    [[GEP:%.*]] = getelementptr <vscale x 4 x i32>, ptr [[ALLOCA]], i32 3
...
; CHECK-NEXT:    [[GEP:%.*]] = getelementptr <vscale x 8 x i32>, ptr [[ALLOCA]], i32 3
...
;
  ...
  %gep = getelementptr <vscale x 8 x i32>, ptr %alloca, i32 3
