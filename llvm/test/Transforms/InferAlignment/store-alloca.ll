...
; RUN: opt < %s -passes=no-op-function -S -data-layout="E-p:64:64:64-a0:0:8-f32:32:32-f64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:32:64-v64:64:64-v128:128:128" | FileCheck %s -check-prefixes=ALL,CHECK
; RUN: opt < %s -passes=no-op-function -S -data-layout="E-p:32:32:32-a0:0:8-f32:32:32-f64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:32:64-v64:64:64-v128:128:128" | FileCheck %s -check-prefixes=ALL,P32
; RUN: opt < %s -passes=no-op-function -S | FileCheck %s -check-prefixes=NODL
...
; NODL-NEXT:    store i32 123, ptr [[B]], align 4
; NODL-NEXT:    ret void
;
...
; CHECK-NEXT:    store i32 123, ptr [[B]], align 4
...
; NODL-NEXT:    store i32 123, ptr [[A]], align 4
; NODL-NEXT:    store ptr [[A]], ptr [[B]], align 8
; NODL-NEXT:    store i32 123, ptr [[B]], align 4
; NODL-NEXT:    store atomic i32 2, ptr [[A]] unordered, align 4
; NODL-NEXT:    store atomic i32 3, ptr [[A]] release, align 4
; NODL-NEXT:    store atomic i32 4, ptr [[A]] seq_cst, align 4
