...
; IF-EVL-NEXT:    EXPLICIT-VECTOR-LANE-PHI vp<[[EVL_PHI:%[0-9]+]]> = phi ir<0>, vp<[[IV_NEXT:%[0-9]+]]>
...
; FORCE-EVL-NEXT:    EXPLICIT-VECTOR-LANE-PHI vp<[[EVL_PHI:%[0-9]+]]> = phi ir<0>, vp<[[IV_NEXT:%[0-9]+]]>
