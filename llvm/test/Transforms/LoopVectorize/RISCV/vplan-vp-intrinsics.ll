...
; IF-EVL-NEXT:    EXPLICIT-VECTOR-LANE-EXIT-PHI vp<[[EXIT:%[0-9]+]]> = phi ir<0>, vp<[[IV_NEXT_EXIT:%[0-9]+]]>
...
; IF-EVL-NEXT:    EMIT vp<[[IV_NEXT_EXIT]]> = VF * UF + vp<[[EXIT]]>
...
; FORCE-EVL-NEXT:    EXPLICIT-VECTOR-LANE-EXIT-PHI vp<[[EXIT:%[0-9]+]]> = phi ir<0>, vp<[[IV_NEXT_EXIT:%[0-9]+]]>
...
; FORCE-EVL-NEXT:    EMIT vp<[[IV_NEXT_EXIT]]> = VF * UF + vp<[[EXIT]]>
