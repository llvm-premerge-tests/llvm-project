...
; CHECK-NEXT:    [[DOTNOT7:%.*]] = select <4 x i1> [[TMP19]], <4 x i1> [[TMP44]], <4 x i1> <i1 true, i1 true, i1 true, i1 true>
; CHECK-NEXT:    [[TMP45:%.*]] = bitcast <4 x i1> [[DOTNOT7]] to i4
; CHECK-NEXT:    [[TMP46:%.*]] = call i4 @llvm.ctpop.i4(i4 [[TMP45]]), !range [[RNG42:![0-9]+]]
; CHECK-NEXT:    [[TMP47:%.*]] = zext i4 [[TMP46]] to i32
; CHECK-NEXT:    [[TMP48]] = add i32 [[VEC_PHI]], [[TMP47]]
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i32 [[INDEX]], 4
; CHECK-NEXT:    [[TMP49:%.*]] = icmp eq i32 [[INDEX_NEXT]], 1000
; CHECK-NEXT:    br i1 [[TMP49]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP43:![0-9]+]]
; CHECK:       middle.block:
