...
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr double, ptr [[A:%.*]], i64 [[TMP1]]
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr double, ptr [[TMP5]], i64 -3
; CHECK-NEXT:    [[TMP7:%.*]] = fcmp une <4 x double> [[WIDE_LOAD:%.*]], zeroinitializer
; CHECK-NEXT:    [[WIDE_MASKED_LOAD:%.*]] = call <4 x double> @llvm.masked.load.v4f64.p0(ptr [[TMP6]], i32 8, <4 x i1> [[TMP7]], <4 x double> poison)
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr double, ptr [[TMP5]], i64 -7
; CHECK-NEXT:    [[TMP9:%.*]] = fcmp une <4 x double> [[WIDE_LOAD1:%.*]], zeroinitializer
; CHECK-NEXT:    [[WIDE_MASKED_LOAD6:%.*]] = call <4 x double> @llvm.masked.load.v4f64.p0(ptr [[TMP8]], i32 8, <4 x i1> [[TMP9]], <4 x double> poison)
...
; CHECK-NEXT:    call void @llvm.masked.store.v4f64.p0(<4 x double> [[TMP10]], ptr [[TMP6]], i32 8, <4 x i1> [[TMP7]])
; CHECK-NEXT:    call void @llvm.masked.store.v4f64.p0(<4 x double> [[TMP11]], ptr [[TMP8]], i32 8, <4 x i1> [[TMP9]])
