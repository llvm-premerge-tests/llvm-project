...
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds double, ptr [[TMP5]], i64 [[N]]
...
; CHECK-NEXT:    [[TMP19:%.*]] = getelementptr double, ptr [[A:%.*]], i64 [[TMP4]]
; CHECK-NEXT:    [[TMP20:%.*]] = getelementptr inbounds double, ptr [[TMP19]], i64 [[N]]
; CHECK-NEXT:    [[TMP21:%.*]] = call i64 @llvm.vscale.i64()
; CHECK-NEXT:    [[TMP22:%.*]] = shl i64 [[TMP21]], 3
; CHECK-NEXT:    [[TMP23:%.*]] = sub i64 1, [[TMP22]]
; CHECK-NEXT:    [[TMP24:%.*]] = getelementptr inbounds double, ptr [[TMP20]], i64 [[TMP23]]
; CHECK-NEXT:    store <vscale x 8 x double> [[TMP17]], ptr [[TMP24]], align 8
; CHECK-NEXT:    [[TMP25:%.*]] = call i64 @llvm.vscale.i64()
; CHECK-NEXT:    [[TMP26:%.*]] = shl i64 [[TMP25]], 3
; CHECK-NEXT:    [[TMP27:%.*]] = sub i64 0, [[TMP26]]
; CHECK-NEXT:    [[TMP28:%.*]] = sub i64 1, [[TMP26]]
; CHECK-NEXT:    [[TMP29:%.*]] = getelementptr inbounds double, ptr [[TMP20]], i64 [[TMP27]]
; CHECK-NEXT:    [[TMP30:%.*]] = getelementptr inbounds double, ptr [[TMP29]], i64 [[TMP28]]
; CHECK-NEXT:    store <vscale x 8 x double> [[TMP18]], ptr [[TMP30]], align 8
; CHECK-NEXT:    [[TMP31:%.*]] = call i64 @llvm.vscale.i64()
; CHECK-NEXT:    [[TMP32:%.*]] = shl i64 [[TMP31]], 4
...
; CHECK-NEXT:    [[TMP34:%.*]] = getelementptr double, ptr [[B]], i64 [[I_08_IN]]
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds double, ptr [[TMP34]], i64 -1
; CHECK-NEXT:    [[TMP35:%.*]] = load double, ptr [[ARRAYIDX]], align 8
; CHECK-NEXT:    [[ADD:%.*]] = fadd double [[TMP35]], 1.000000e+00
; CHECK-NEXT:    [[TMP36:%.*]] = getelementptr double, ptr [[A]], i64 [[I_08_IN]]
; CHECK-NEXT:    [[ARRAYIDX1:%.*]] = getelementptr inbounds double, ptr [[TMP36]], i64 -1
...
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr i64, ptr [[B]], i64 [[TMP10]]
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr inbounds i64, ptr [[TMP11]], i64 [[N]]
...
; CHECK-NEXT:    [[TMP25:%.*]] = getelementptr i64, ptr [[A]], i64 [[TMP10]]
; CHECK-NEXT:    [[TMP26:%.*]] = getelementptr inbounds i64, ptr [[TMP25]], i64 [[N]]
; CHECK-NEXT:    [[TMP27:%.*]] = call i64 @llvm.vscale.i64()
; CHECK-NEXT:    [[TMP28:%.*]] = shl i64 [[TMP27]], 3
; CHECK-NEXT:    [[TMP29:%.*]] = sub i64 1, [[TMP28]]
; CHECK-NEXT:    [[TMP30:%.*]] = getelementptr inbounds i64, ptr [[TMP26]], i64 [[TMP29]]
; CHECK-NEXT:    store <vscale x 8 x i64> [[TMP23]], ptr [[TMP30]], align 8
; CHECK-NEXT:    [[TMP31:%.*]] = call i64 @llvm.vscale.i64()
; CHECK-NEXT:    [[TMP32:%.*]] = shl i64 [[TMP31]], 3
; CHECK-NEXT:    [[TMP33:%.*]] = sub i64 0, [[TMP32]]
; CHECK-NEXT:    [[TMP34:%.*]] = sub i64 1, [[TMP32]]
; CHECK-NEXT:    [[TMP35:%.*]] = getelementptr inbounds i64, ptr [[TMP26]], i64 [[TMP33]]
; CHECK-NEXT:    [[TMP36:%.*]] = getelementptr inbounds i64, ptr [[TMP35]], i64 [[TMP34]]
; CHECK-NEXT:    store <vscale x 8 x i64> [[TMP24]], ptr [[TMP36]], align 8
; CHECK-NEXT:    [[TMP37:%.*]] = call i64 @llvm.vscale.i64()
; CHECK-NEXT:    [[TMP38:%.*]] = shl i64 [[TMP37]], 4
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], [[TMP38]]
; CHECK-NEXT:    [[TMP39:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; CHECK-NEXT:    br i1 [[TMP39]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP5:![0-9]+]]
; CHECK:       middle.block:
; CHECK-NEXT:    [[CMP_N:%.*]] = icmp eq i64 [[N_MOD_VF]], 0
; CHECK-NEXT:    br i1 [[CMP_N]], label [[FOR_COND_CLEANUP_LOOPEXIT:%.*]], label [[SCALAR_PH]]
; CHECK:       scalar.ph:
...
; CHECK-NEXT:    [[TMP40:%.*]] = getelementptr i64, ptr [[B]], i64 [[I_09_IN]]
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i64, ptr [[TMP40]], i64 -1
; CHECK-NEXT:    [[TMP41:%.*]] = load i64, ptr [[ARRAYIDX]], align 8
; CHECK-NEXT:    [[ADD:%.*]] = add i64 [[TMP41]], 1
; CHECK-NEXT:    [[TMP42:%.*]] = getelementptr i64, ptr [[A]], i64 [[I_09_IN]]
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds i64, ptr [[TMP42]], i64 -1
