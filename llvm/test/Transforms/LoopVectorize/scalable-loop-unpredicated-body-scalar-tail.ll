...
; CHECKUF1: br i1 %[[CMP]], label %middle.block, label %vector.body, !llvm.loop [[LOOP_META0:![0-9]+]]
...
; CHECKUF2: br i1 %[[CMP]], label %middle.block, label %vector.body, !llvm.loop [[LOOP_META0:![0-9]+]]
