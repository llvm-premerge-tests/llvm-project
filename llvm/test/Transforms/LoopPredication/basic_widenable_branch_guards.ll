...
; CHECK-NEXT:    [[TMP4:%.*]] = and i1 [[WIDENABLE_COND]], [[TMP3]]
...
; CHECK-NEXT:    [[WITHIN_BOUNDS:%.*]] = icmp ult i32 [[I]], [[LENGTH]]
; CHECK-NEXT:    [[WIDENABLE_COND:%.*]] = call i1 @llvm.experimental.widenable.condition()
; CHECK-NEXT:    [[TMP3:%.*]] = and i1 [[WIDENABLE_COND]], [[TMP2]]
...
; CHECK-NEXT:    [[WITHIN_BOUNDS:%.*]] = icmp ult i32 [[I]], [[LENGTH]]
; CHECK-NEXT:    [[WIDENABLE_COND:%.*]] = call i1 @llvm.experimental.widenable.condition()
; CHECK-NEXT:    [[TMP5:%.*]] = and i1 [[WIDENABLE_COND]], [[TMP4]]
...
; CHECK-NEXT:    [[WITHIN_BOUNDS:%.*]] = icmp ult i32 [[J]], [[LENGTH]]
; CHECK-NEXT:    [[WIDENABLE_COND:%.*]] = call i1 @llvm.experimental.widenable.condition()
; CHECK-NEXT:    [[TMP6:%.*]] = and i1 [[WIDENABLE_COND]], [[TMP5]]
...
; CHECK-NEXT:    [[WIDENABLE_COND:%.*]] = call i1 @llvm.experimental.widenable.condition()
; CHECK-NEXT:    [[TMP8:%.*]] = and i1 [[WIDENABLE_COND]], [[TMP3]]
...
; CHECK-NEXT:    [[WIDENABLE_COND:%.*]] = call i1 @llvm.experimental.widenable.condition()
; CHECK-NEXT:    [[TMP12:%.*]] = and i1 [[WIDENABLE_COND]], [[TMP3]]
; CHECK-NEXT:    [[TMP13:%.*]] = and i1 [[TMP12]], [[TMP7]]
; CHECK-NEXT:    [[TMP14:%.*]] = and i1 [[TMP13]], [[TMP11]]
...
; CHECK-NEXT:    [[TMP13:%.*]] = and i1 [[WIDENABLE_COND4]], [[TMP7]]
...
; CHECK-NEXT:    [[TMP14:%.*]] = and i1 [[WIDENABLE_COND9]], [[TMP11]]
...
; CHECK-NEXT:    [[WIDENABLE_COND:%.*]] = call i1 @llvm.experimental.widenable.condition()
; CHECK-NEXT:    [[TMP4:%.*]] = and i1 [[WIDENABLE_COND]], [[UNRELATED_COND]]
