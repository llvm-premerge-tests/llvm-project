...
; CHECK-NEXT:    [[Y_NOT_NOT:%.*]] = ashr i8 [[Y:%.*]], [[SHAMT]]
; CHECK-NEXT:    [[Y_NOT_SHIFT:%.*]] = xor i8 [[Y_NOT_NOT]], -1
; CHECK-NEXT:    [[AND:%.*]] = and i8 [[X_SHIFT]], [[Y_NOT_SHIFT]]
; CHECK-NEXT:    ret i8 [[AND]]
;
  %x.shift = ashr i8 %x, %shamt
  %y.not = xor i8 %y, -1
  %y.not.shift = ashr i8 %y.not, %shamt
  %and = and i8 %x.shift, %y.not.shift
  ret i8 %and
}
...
;
  ...
  %y.not = xor i8 %y, -1
  %y.not.shift = ashr i8 %y.not, %shamt
  %and = and i8 %y.not.shift, %x.shift
  ret i8 %and
}

define i8 @and_ashr_not_fail_1(i8 %x, i8 %y, i8 %shamt) {
...
define i8 @and_ashr_not_fail_2(i8 %x, i8 %y, i8 %shamt) {
; CHECK-LABEL: @and_ashr_not_fail_2(
; CHECK-NEXT:    [[X_SHIFT:%.*]] = ashr i8 [[X:%.*]], [[SHAMT:%.*]]
; CHECK-NEXT:    [[Y_NOT:%.*]] = xor i8 [[Y:%.*]], -1
; CHECK-NEXT:    [[Y_NOT_SHIFT:%.*]] = lshr i8 [[Y_NOT]], [[SHAMT]]
; CHECK-NEXT:    [[AND:%.*]] = and i8 [[X_SHIFT]], [[Y_NOT_SHIFT]]
; CHECK-NEXT:    ret i8 [[AND]]
;
  %x.shift = ashr i8 %x, %shamt
  %y.not = xor i8 %y, -1
  %y.not.shift = lshr i8 %y.not, %shamt
  %and = and i8 %x.shift, %y.not.shift
  ret i8 %and
}
...
; CHECK-NEXT:    [[Y_NOT_NOT:%.*]] = ashr <4 x i8> [[Y:%.*]], [[SHAMT]]
; CHECK-NEXT:    [[Y_NOT_SHIFT:%.*]] = xor <4 x i8> [[Y_NOT_NOT]], <i8 -1, i8 -1, i8 -1, i8 -1>
; CHECK-NEXT:    [[AND:%.*]] = and <4 x i8> [[X_SHIFT]], [[Y_NOT_SHIFT]]
; CHECK-NEXT:    ret <4 x i8> [[AND]]
;
  %x.shift = ashr <4 x i8> %x, %shamt
  %y.not = xor <4 x i8> %y, <i8 -1, i8 -1, i8 -1, i8 -1>
  %y.not.shift = ashr <4 x i8> %y.not, %shamt
  %and = and <4 x i8> %x.shift, %y.not.shift
  ret <4 x i8> %and
}
...
;
  ...
  %y.not = xor <4 x i8> %y, <i8 -1, i8 -1, i8 -1, i8 -1>
  %y.not.shift = ashr <4 x i8> %y.not, %shamt
  %and = and <4 x i8> %y.not.shift, %x.shift
  ret <4 x i8> %and
}
...
;
  %x.shift = ashr <4 x i8> %x, %shamt
  %y.not = xor <4 x i8> %y, <i8 -1, i8 undef, i8 undef, i8 undef>
  %y.not.shift = ashr <4 x i8> %y.not, %shamt
  %and = and <4 x i8> %x.shift, %y.not.shift
  ret <4 x i8> %and
}
...
;
  %x.shift = ashr <4 x i8> %x, %shamt
  %y.not = xor <4 x i8> %y, <i8 undef, i8 undef, i8 undef, i8 undef>
  %y.not.shift = ashr <4 x i8> %y.not, %shamt
  %and = and <4 x i8> %x.shift, %y.not.shift
  ret <4 x i8> %and
}
...
; CHECK-NEXT:    [[Y_NOT_NOT:%.*]] = ashr i8 [[Y:%.*]], [[SHAMT]]
; CHECK-NEXT:    [[Y_NOT_SHIFT:%.*]] = xor i8 [[Y_NOT_NOT]], -1
; CHECK-NEXT:    [[OR:%.*]] = or i8 [[X_SHIFT]], [[Y_NOT_SHIFT]]
; CHECK-NEXT:    ret i8 [[OR]]
;
  %x.shift = ashr i8 %x, %shamt
  %y.not = xor i8 %y, -1
  %y.not.shift = ashr i8 %y.not, %shamt
  %or = or i8 %x.shift, %y.not.shift
  ret i8 %or
}
...
;
  ...
  %y.not = xor i8 %y, -1
  %y.not.shift = ashr i8 %y.not, %shamt
  %or = or i8 %y.not.shift, %x.shift
  ret i8 %or
}

define i8 @or_ashr_not_fail_1(i8 %x, i8 %y, i8 %shamt) {
...
define i8 @or_ashr_not_fail_2(i8 %x, i8 %y, i8 %shamt) {
...
; CHECK-NEXT:    [[Y_NOT_NOT:%.*]] = ashr <4 x i8> [[Y:%.*]], [[SHAMT]]
; CHECK-NEXT:    [[Y_NOT_SHIFT:%.*]] = xor <4 x i8> [[Y_NOT_NOT]], <i8 -1, i8 -1, i8 -1, i8 -1>
; CHECK-NEXT:    [[OR:%.*]] = or <4 x i8> [[X_SHIFT]], [[Y_NOT_SHIFT]]
; CHECK-NEXT:    ret <4 x i8> [[OR]]
;
  %x.shift = ashr <4 x i8> %x, %shamt
  %y.not = xor <4 x i8> %y, <i8 -1, i8 -1, i8 -1, i8 -1>
  %y.not.shift = ashr <4 x i8> %y.not, %shamt
  %or = or <4 x i8> %x.shift, %y.not.shift
  ret <4 x i8> %or
}
...
;
  ...
  %y.not = xor <4 x i8> %y, <i8 -1, i8 -1, i8 -1, i8 -1>
  %y.not.shift = ashr <4 x i8> %y.not, %shamt
  %or = or <4 x i8> %y.not.shift, %x.shift
  ret <4 x i8> %or
}
...
; CHECK-NEXT:    [[Y_NOT_NOT1:%.*]] = xor i8 [[Y:%.*]], [[X:%.*]]
; CHECK-NEXT:    [[TMP1:%.*]] = ashr i8 [[Y_NOT_NOT1]], [[SHAMT:%.*]]
...
;
  ...
  %y.not = xor i8 %y, -1
  %y.not.shift = ashr i8 %y.not, %shamt
  %xor = xor i8 %x.shift, %y.not.shift
  ret i8 %xor
}
...
;
  ...
  %y.not = xor i8 %y, -1
  %y.not.shift = ashr i8 %y.not, %shamt
  %xor = xor i8 %y.not.shift, %x.shift
  ret i8 %xor
}

define i8 @xor_ashr_not_fail_1(i8 %x, i8 %y, i8 %shamt) {
; CHECK-LABEL: @xor_ashr_not_fail_1(
; CHECK-NEXT:    [[X_SHIFT:%.*]] = lshr i8 [[X:%.*]], [[SHAMT:%.*]]
; CHECK-NEXT:    [[Y_NOT_NOT:%.*]] = ashr i8 [[Y:%.*]], [[SHAMT]]
; CHECK-NEXT:    [[TMP1:%.*]] = xor i8 [[Y_NOT_NOT]], [[X_SHIFT]]
; CHECK-NEXT:    [[XOR:%.*]] = xor i8 [[TMP1]], -1
; CHECK-NEXT:    ret i8 [[XOR]]
;
  %x.shift = lshr i8 %x, %shamt
...
define i8 @xor_ashr_not_fail_2(i8 %x, i8 %y, i8 %shamt) {
; CHECK-LABEL: @xor_ashr_not_fail_2(
; CHECK-NEXT:    [[X_SHIFT:%.*]] = ashr i8 [[X:%.*]], [[SHAMT:%.*]]
; CHECK-NEXT:    [[Y_NOT:%.*]] = xor i8 [[Y:%.*]], -1
; CHECK-NEXT:    [[Y_NOT_SHIFT:%.*]] = lshr i8 [[Y_NOT]], [[SHAMT]]
; CHECK-NEXT:    [[XOR:%.*]] = xor i8 [[X_SHIFT]], [[Y_NOT_SHIFT]]
; CHECK-NEXT:    ret i8 [[XOR]]
;
  %x.shift = ashr i8 %x, %shamt
  %y.not = xor i8 %y, -1
...
; CHECK-NEXT:    [[Y_NOT_NOT1:%.*]] = xor <4 x i8> [[Y:%.*]], [[X:%.*]]
; CHECK-NEXT:    [[TMP1:%.*]] = ashr <4 x i8> [[Y_NOT_NOT1]], [[SHAMT:%.*]]
...
;
  ...
  %y.not = xor <4 x i8> %y, <i8 -1, i8 -1, i8 -1, i8 -1>
  %y.not.shift = ashr <4 x i8> %y.not, %shamt
  %xor = xor <4 x i8> %x.shift, %y.not.shift
  ret <4 x i8> %xor
}
...
;
  ...
  %y.not = xor <4 x i8> %y, <i8 -1, i8 -1, i8 -1, i8 -1>
  %y.not.shift = ashr <4 x i8> %y.not, %shamt
  %xor = xor <4 x i8> %y.not.shift, %x.shift
  ret <4 x i8> %xor
}
