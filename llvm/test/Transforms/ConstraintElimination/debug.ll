...
; CHECK:      Processing fact to add to the system:  ule i4 %x, i4 %y
; CHECK-NEXT: Adding 'ule %x, %y'
; CHECK-NEXT:  constraint: %x + -1 * %y <= 0

; CHECK:      Processing fact to add to the system:  ule i4 %y, i4 %z
...
; CHECK:      Processing fact to add to the system:   ugt i4 %x, i4 %y
; CHECK-NEXT: Adding 'ugt %x, %y'
; CHECK-NEXT:  constraint: -1 * %x + %y <= -1

; CHECK:      Processing fact to add to the system:   ugt i4 %y, i4 %z
