...
; RUN: opt -S -passes=hotcoldsplit -hotcoldsplit-cold-probability-denom=1000 < %s | FileCheck --check-prefix=CHECK-PROB %s
...
; CHECK-NOT: internal void @baz.cold.1()
; CHECK: attributes #[[ATTR0]] = { cold minsize }
