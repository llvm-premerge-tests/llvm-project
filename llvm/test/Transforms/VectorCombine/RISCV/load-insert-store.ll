...
; CHECK-SAME: (ptr [[A:%.*]], i32 [[B:%.*]]) #[[ATTR0:[0-9]+]] {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr inbounds <4 x i32>, ptr [[A]], i32 0, i32 1
; CHECK-NEXT:    store i32 [[B]], ptr [[TMP0]], align 4
; CHECK-NEXT:    ret void
;
entry:
...
; CHECK-SAME: (ptr [[A:%.*]], float [[B:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[T0:%.*]] = load <8 x float>, ptr [[A]], align 32
; CHECK-NEXT:    [[T1:%.*]] = insertelement <8 x float> [[T0]], float [[B]], i32 2
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr inbounds <8 x float>, ptr [[A]], i32 0, i32 2
; CHECK-NEXT:    store float [[B]], ptr [[TMP0]], align 8
...
; CHECK-SAME: (ptr [[A:%.*]], i16 [[B:%.*]], i16 [[C:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (ptr [[A:%.*]], i16 [[B:%.*]], i16 [[C:%.*]], i16 [[D:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[T0:%.*]] = load <16 x i16>, ptr [[A]], align 32
; CHECK-NEXT:    [[T1:%.*]] = insertelement <16 x i16> [[T0]], i16 [[B]], i32 4
; CHECK-NEXT:    [[T2:%.*]] = insertelement <16 x i16> [[T1]], i16 [[C]], i32 6
...
; CHECK-SAME: (ptr [[A:%.*]], float [[B:%.*]], float [[C:%.*]], float [[D:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[T0:%.*]] = load <8 x float>, ptr [[A]], align 32
...
; CHECK-SAME: (ptr [[A:%.*]], ptr [[B:%.*]], i32 [[C:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[T0:%.*]] = load <4 x i32>, ptr [[A]], align 16
