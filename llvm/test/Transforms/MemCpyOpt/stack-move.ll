...
; Tests that failure because after copy mod could be before copy on branch.
define void @multi_bb_branch_dest_mod_before_copy(i1 %b) {
; CHECK-LABEL: define void @multi_bb_branch_dest_mod_before_copy
; CHECK-SAME: (i1 [[B:%.*]]) {
; CHECK-NEXT:    [[SRC:%.*]] = alloca [[STRUCT_FOO:%.*]], align 4
; CHECK-NEXT:    [[DEST:%.*]] = alloca [[STRUCT_FOO]], align 4
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 12, ptr nocapture [[SRC]])
