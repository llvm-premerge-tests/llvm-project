...
public:
  ...
  DwarfStringPoolEntryWithExtString *add(StringEntry *String) {
  ...
  getExistingEntry(StringEntry *String) const {
...
protected:
  using DwarfStringPoolEntriesTy =
      DenseMap<StringEntry *, DwarfStringPoolEntryWithExtString *>;
