...
private:
  ...
  void emitLocations(SectionDescriptor &DebugInfoSection,
  ...
  /// Emit .debug_aranges.
  void emitAranges(SectionDescriptor &DebugInfoSection,
                   SectionDescriptor &OutArangesSection,
                   AddressRanges &LinkedFunctionRanges);

  /// Clone and emit .debug_ranges/.debug_rnglists.
  void cloneAndEmitRangeList(SectionDescriptor &DebugInfoSection,
  ...
  /// Array of addresses which should be emitted into the .debug_addr section.
