...
void RISCVFrameLowering::emitPrologue(MachineFunction &MF,
  ...
  // register.
  std::advance(MBBI, getUnmanagedCSI(MF, CSI, /*IsRestore*/ false).size());
...
void RISCVFrameLowering::emitEpilogue(MachineFunction &MF,
  ...
  const auto &CSI =
      getUnmanagedCSI(MF, MFI.getCalleeSavedInfo(), /*IsRestore*/ true);
...
bool RISCVFrameLowering::spillCalleeSavedRegisters(
  ...
  const auto &UnmanagedCSI = getUnmanagedCSI(*MF, CSI, /*IsRestore*/ false);
...
bool RISCVFrameLowering::restoreCalleeSavedRegisters(
  ...
  const auto &UnmanagedCSI = getUnmanagedCSI(*MF, CSI, /*IsRestore*/ true);
  for (auto &CS : UnmanagedCSI) {
    Register Reg = CS.getReg();
    const TargetRegisterClass *RC = TRI->getMinimalPhysRegClass(Reg);
