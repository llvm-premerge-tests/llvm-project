...
static inline bool isCompressibleLwOrSw(const RISCVSubtarget &STI,
...
static inline bool isCompressibleLdOrSd(const RISCVSubtarget &STI,
                                        const unsigned Opcode) {
  if ((STI.hasStdExtCOrZca() || STI.hasStdExtZce()) &&
...
static inline bool isCompressibleFlwOrFsw(const RISCVSubtarget &STI,
                                          const unsigned Opcode) {
...
static inline bool isCompressibleFldOrFsd(const RISCVSubtarget &STI,
                                          const unsigned Opcode) {
...
static bool isCompressibleLdOrSt(const MachineInstr &MI) {
  ...
  return isCompressibleLwOrSw(STI, Opcode) ||
         ...
         isCompressibleFlwOrFsw(STI, Opcode) ||
         isCompressibleFldOrFsd(STI, Opcode);
}
