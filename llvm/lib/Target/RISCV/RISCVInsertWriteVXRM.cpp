...
//           2. The loop has a preheader.
//           3. Incoming round mode from all backedges are the same.
//           4. Incoming round mode is the required round mode of the header
...
private:
  bool computeVXRMChanges(const MachineBasicBlock &MBB, VXRMInfo &CurInfo);
