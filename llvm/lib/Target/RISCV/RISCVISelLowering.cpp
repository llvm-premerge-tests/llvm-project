...
SDValue RISCVTargetLowering::LowerINTRINSIC_WO_CHAIN(SDValue Op,
  ...
  case Intrinsic::riscv_vsm4r_vs: {
    if (!isValidEGW(4, Op.getSimpleValueType()) ||
        !isValidEGW(4, Op->getOperand(1).getSimpleValueType()) ||
        !isValidEGW(4, Op->getOperand(2).getSimpleValueType()))
  ...
  case Intrinsic::riscv_vsm3me: {
    if (!isValidEGW(8, Op.getSimpleValueType()) ||
        !isValidEGW(8, Op->getOperand(1).getSimpleValueType()))
