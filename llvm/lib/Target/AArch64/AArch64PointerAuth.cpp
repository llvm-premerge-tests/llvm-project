...
void AArch64PointerAuth::signLR(MachineBasicBlock::iterator MBBI,
...
void AArch64PointerAuth::authenticateLR(MachineBasicBlock::iterator MBBI,
                                        bool *HasWinCFI) const {
  MachineBasicBlock &MBB = *MBBI->getParent();
...
bool AArch64PointerAuth::runOnMachineFunction(MachineFunction &MF) {
  ...
  EmitAsyncCFI = MFnI->needsAsyncDwarfUnwindInfo(MF);

  // Set by AArch64FrameLowering::emitPrologue as needed.
  NeedsWinCFI = MF.hasWinCFI();
