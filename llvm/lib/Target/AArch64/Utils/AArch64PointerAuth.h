//===-- AArch64PointerAuth.h - PtrAuth helpers ------------------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_AARCH64_UTILS_AARCH64POINTERAUTH_H
#define LLVM_LIB_TARGET_AARCH64_UTILS_AARCH64POINTERAUTH_H
...
#define AUTH_CHECK_METHOD_CL_VALUES_COMMON                                     \
      clEnumValN(AuthCheckMethod::None, "none",                                \
                 "Do not check authenticated address"),                        \
      clEnumValN(AuthCheckMethod::DummyLoad, "load",                           \
                 "Perform dummy load from authenticated address"),             \
      clEnumValN(AuthCheckMethod::HighBitsNoTBI, "high-bits-notbi",            \
...
#define AUTH_CHECK_METHOD_CL_VALUES_LR                                         \
      ...
      clEnumValN(AuthCheckMethod::XPACHint, "xpac-hint",                       \
...
#endif // LLVM_LIB_TARGET_AARCH64_UTILS_AARCH64POINTERAUTH_H
