...
class VPExplicitVectorLengthPHIRecipe : public VPHeaderPHIRecipe {
public:
  VPExplicitVectorLengthPHIRecipe(VPValue *StartMask, DebugLoc DL)
      : VPHeaderPHIRecipe(VPDef::VPExplicitVectorLengthPHISC, nullptr,
                          StartMask, DL) {}

  ~VPExplicitVectorLengthPHIRecipe() override = default;

  VP_CLASSOF_IMPL(VPDef::VPExplicitVectorLengthPHISC)

  static inline bool classof(const VPHeaderPHIRecipe *D) {
    return D->getVPDefID() == VPDef::VPExplicitVectorLengthPHISC;
  }

  /// Generate phi for handling EVL over iterations correctly.
  void execute(VPTransformState &State) override;
