...
struct AAAllocationInfoImpl : public AAAllocationInfo {
  ...
  ChangeStatus updateImpl(Attributor &A) override {
    ...
    auto CheckAllocaInstruction = [&](Attributor &A){
    ...
    case Instruction::Alloca:
      return CheckAllocaInstruction(A);
    case Instruction::Call:
      //TODO: Check if the instruction is a malloc instruction.
      break;
    default:
      LLVM_DEBUG(dbgs() << "Instruction not supported!"<< "\n");
      return indicatePessimisticFixpoint();
    }
