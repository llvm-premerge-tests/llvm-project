...
SDValue SelectionDAG::getScalarizedAnyExtOrTrunc(SDValue Op, const SDLoc &DL,
                                                 EVT VT) {
  assert(!VT.isVector());
...
SDValue SelectionDAG::getScalarizedSExtOrTrunc(SDValue Op, const SDLoc &DL,
                                               EVT VT) {
  assert(!VT.isVector());
  auto Type = Op.getValueType();
  SDValue DestOp;
...
SDValue SelectionDAG::getScalarizedZExtOrTrunc(SDValue Op, const SDLoc &DL,
                                               EVT VT) {
  assert(!VT.isVector());
  auto Type = Op.getValueType();
  SDValue DestOp;
