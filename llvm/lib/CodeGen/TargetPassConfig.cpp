...
static cl::opt<bool>
    GCEmptyBlocks("gc-empty-blocks", cl::init(false), cl::Hidden,
                  cl::desc("Enable garbage-collecting empty blocks"));
...
void TargetPassConfig::addMachinePasses() {
  ...
  if (GCEmptyBlocks || TM->getBBSectionsType() != llvm::BasicBlockSection::None)
