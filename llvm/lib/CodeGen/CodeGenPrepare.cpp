...
private:
  ...
  bool eliminateMostlyEmptyBlocks(Function &F, bool &ResetDT);
...
bool CodeGenPrepare::eliminateMostlyEmptyBlocks(Function &F, bool &ResetDT) {
  ...
  for (auto &Block : Blocks) {
    ...
    ResetDT |= eliminateMostlyEmptyBlock(BB);
    MadeChange = true;
  }
  return MadeChange;
}
