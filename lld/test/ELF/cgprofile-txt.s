...
# RUN: ld.lld -e A %t --call-graph-ordering-file %t.call_graph --no-use-cache-directed-sort -o %t2
# RUN: llvm-readobj --symbols %t2 | FileCheck %s
# RUN: ld.lld -e A %t --call-graph-ordering-file %t.call_graph --use-cache-directed-sort -o %t2
