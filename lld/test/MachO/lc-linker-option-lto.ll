...
; (2) NoLTO-ThinLTO
; RUN: %lld -dylib -lSystem -L%t %t/f.nolto.o %t/b.nolto.o -o %t/nolto-thinlto.out
; RUN: llvm-objdump --syms %t/nolto-thinlto.out | FileCheck %s

; (3) ThinLTO-NoLTO
; RUN: %lld -dylib -lSystem -L%t %t/f.nolto.o %t/b.nolto.o -o %t/thinlto-nolto.out
; RUN: llvm-objdump --syms %t/thinlto-nolto.out | FileCheck %s

; (4) NoLTO-LTO
; RUN: %lld -dylib -lSystem -L%t %t/f.nolto.o %t/b.nolto.o -o %t/nolto-lto.out
; RUN: llvm-objdump --syms %t/nolto-lto.out | FileCheck %s

; (5) LTO-NoLTO
; RUN: %lld -dylib -lSystem -L%t %t/f.nolto.o %t/b.nolto.o -o %t/lto-nolto.out
; RUN: llvm-objdump --syms %t/lto-nolto.out | FileCheck %s

; (6) LTO-ThinLTO
; RUN: %lld -dylib -lSystem -L%t %t/f.nolto.o %t/b.nolto.o -o %t/lto-thinlto.out
; RUN: llvm-objdump --syms %t/lto-thinlto.out | FileCheck %s

; (7) ThinLTO-NoLTO
; RUN: %lld -dylib -lSystem -L%t %t/f.nolto.o %t/b.nolto.o -o %t/thinlto-lto.out
