...
/// - _r_debug.state is set to "eAdd" and the debugger notification
///   function is called notifying the debugger that shared libraries are
///   about to be added, but are not yet ready for use.
/// - Once the the shared libraries are fully loaded, _r_debug.state is set to
///   "eConsistent" and the debugger notification function is called again
///   notifying the debugger that shared libraries are ready for use.
///   DYLDRendezvous must remember that the previous state was "eAdd" when it
///   receives a "eConsistent" in order to know to add libraries
///
...
/// - _r_debug.state is set to "eRemove" and the debugger notification
///   function is called notifying the debugger that shared libraries are
///   about to be removed.
/// - Once the the shared libraries are removed _r_debug.state is set to
///   "eConsistent" and the debugger notification function is called again
///   notifying the debugger that shared libraries have been removed.
///   DYLDRendezvous must remember that the previous state was "eRemove" when
///   it receives a "eConsistent" in order to know to remove libraries
///
class DYLDRendezvous {
