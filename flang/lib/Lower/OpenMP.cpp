...
genParallelOp(Fortran::lower::AbstractConverter &converter,
  ...
  // TODO Is skipping these when directive is combined expected behavior?
  if (!outerCombined) {
    cp.processDefault();
