...
genDataOperandOperations(const Fortran::parser::AccObjectList &objectList,
  ...
  for (const auto &accObject : objectList.v) {
    ...
    mlir::Value baseAddr = Fortran::lower::gatherDataOperandAddrAndBounds(
        converter, builder, semanticsContext, stmtCtx, accObject.u,
        operandLocation, asFortran,
        builder.getType<mlir::acc::DataBoundsType>(),
        &Fortran::lower::createDataBoundsOp<mlir::acc::DataBoundsOp>, bounds);
