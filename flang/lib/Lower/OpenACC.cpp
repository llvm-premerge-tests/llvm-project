...
static void createRegisterFunc(mlir::OpBuilder &modBuilder,
  ...
  registerFuncName << globalOp.getSymName().str() << "_acc_declare_update_desc_post_alloc";
  ...
  asFortran << "_desc";
  mlir::acc::UpdateDeviceOp updateDeviceOp = createDataEntryOp<mlir::acc::UpdateDeviceOp>(
      builder, loc, addrOp, asFortran, bounds,
      /*structured=*/false, /*implicit=*/true, mlir::acc::DataClause::acc_update_device, addrOp.getType());
