            ...
            if (const auto *name{
              ...
              if (auto *symbol{ResolveOmp(*name, ompFlag, currScope())}) {
                ...
                if (llvm::omp::allTargetSet.test(GetContext().directive)) {
                  ...
                  checkExclusivelists(hostAssocSym, Symbol::Flag::OmpMapTo,
                      symbol, Symbol::Flag::OmpPrivate);
                  checkExclusivelists(hostAssocSym, Symbol::Flag::OmpMapFrom,
                      symbol, Symbol::Flag::OmpPrivate);
                  checkExclusivelists(hostAssocSym, Symbol::Flag::OmpMapToFrom,
                      symbol, Symbol::Flag::OmpPrivate);
                  checkExclusivelists(hostAssocSym, Symbol::Flag::OmpMapAlloc,
                      symbol, Symbol::Flag::OmpPrivate);
                  checkExclusivelists(hostAssocSym, Symbol::Flag::OmpMapRelease,
                      symbol, Symbol::Flag::OmpPrivate);
                  checkExclusivelists(hostAssocSym, Symbol::Flag::OmpMapDelete,
                      symbol, Symbol::Flag::OmpPrivate);
                  checkExclusivelists(hostAssocSym, Symbol::Flag::OmpMapTo,
                      symbol, Symbol::Flag::OmpFirstPrivate);
                  checkExclusivelists(hostAssocSym, Symbol::Flag::OmpMapFrom,
                      symbol, Symbol::Flag::OmpFirstPrivate);
                  checkExclusivelists(hostAssocSym, Symbol::Flag::OmpMapToFrom,
                      symbol, Symbol::Flag::OmpFirstPrivate);
