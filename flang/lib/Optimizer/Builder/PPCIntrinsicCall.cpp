...
PPCIntrinsicLibrary::genVecMerge(mlir::Type resultType,
  ...
  auto callOp{
      builder.create<mlir::vector::ShuffleOp>(loc, vargs[0], vargs[1], mMask)};
...
PPCIntrinsicLibrary::genVecPerm(mlir::Type resultType,
  ...
  case VecOp::Perm: {
    ...
    auto vNegOne{builder.create<mlir::vector::BroadcastOp>(loc, v8Ty, negOne)};
  ...
  case VecOp::Permi: {
    ...
    // TODO: handle element order
    auto res{builder.create<mlir::vector::ShuffleOp>(loc, mArg0, mArg1, nMask)};
