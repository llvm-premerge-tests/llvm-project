...
public:
  ...
  CallOpRewriter(mlir::MLIRContext *ctx) : OpRewritePattern(ctx) {}
  ...
  matchAndRewrite(fir::CallOp callOp,
    ...
    fir::CallOp newOp = rewriter.create<fir::CallOp>(
        loc, newResultTypes,
...
public:
  ...
  void runOnOperation() override {
    ...
    patterns.insert<CallOpRewriter>(context);
    if (mlir::failed(
