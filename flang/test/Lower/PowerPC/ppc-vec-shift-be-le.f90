! RUN: %flang_fc1 -emit-fir -triple ppc64le-unknown-linux %s -o - | FileCheck --check-prefixes="CHECK-FIR" %s
! RUN: %flang_fc1 -emit-llvm -triple ppc64le-unknown-linux %s -o - | FileCheck --check-prefixes="CHECK" %s
!
! RUN: %flang_fc1 -emit-fir -triple ppc64-unknown-aix %s -o - | FileCheck --check-prefixes="BE-FIR" %s
! RUN: %flang_fc1 -emit-llvm -triple ppc64-unknown-aix %s -o - | FileCheck --check-prefixes="BE-IR" %s
