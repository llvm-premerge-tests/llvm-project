...
!CHECK: %[[ENTRY:.*]] = omp.map_entry var_ptr(%[[ARG1]] : !fir.ref<!fir.array<10xi32>>)   map_type_value(35) capture(ByRef) bounds(%[[BOUNDS]]) -> !fir.ref<!fir.array<10xi32>> {name = "sp_write(2:5)"}
!CHECK: omp.target   map_entries((tofrom -> %[[ENTRY]] : !fir.ref<!fir.array<10xi32>>)) {
