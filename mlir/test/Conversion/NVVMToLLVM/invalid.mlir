...
func.func @wgmma_f32_satfinite(%descA : i64, %descB : i64) {  
  ...
  %res = nvvm.wgmma.mma_async %descA, %descB, 
      ...
      scale_out = <zero> , 
      [lhs = #nvvm.mma_type<f16>, #nvvm.wgmma_scale_in<neg>, #nvvm.mma_layout<col>], 
      [rhs = #nvvm.mma_type<f16>, #nvvm.wgmma_scale_in<neg>, #nvvm.mma_layout<col>] {satfinite}
...
func.func @wgmma_f32_m32(%descA : i64, %descB : i64) {  
  ...
  %res = nvvm.wgmma.mma_async %descA, %descB, 
      ...
      [lhs = #nvvm.mma_type<f16>, #nvvm.wgmma_scale_in<neg>, #nvvm.mma_layout<col>], 
      [rhs = #nvvm.mma_type<f16>, #nvvm.wgmma_scale_in<neg>, #nvvm.mma_layout<col>]
       -> !llvm.struct<(f32, f32, i32, i32, f32, f32, f32, f32)>
  return 
}
...
func.func @wgmma_transpose(%descA : i64, %descB : i64) {  
  ...
  %res = nvvm.wgmma.mma_async %descA, %descB, 
      ...
      scale_out = <zero> , 
      [lhs = #nvvm.mma_type<tf32>, #nvvm.wgmma_scale_in<neg>, #nvvm.mma_layout<col>], 
      [rhs = #nvvm.mma_type<tf32>, #nvvm.wgmma_scale_in<neg>, #nvvm.mma_layout<col>]
       -> !llvm.struct<(f32, f32, f32, f32, f32, f32, f32, f32)>
  return 
}
...
func.func @wgmma_transpose(%descA : i64, %descB : i64) {  
  ...
  %res = nvvm.wgmma.mma_async %descA, %descB, 
      #nvvm.shape<m = 64, n = 16, k = 8>, 
      scale_out = <zero> , 
      [lhs = #nvvm.mma_type<tf32>, #nvvm.wgmma_scale_in<neg>, #nvvm.mma_layout<row>], 
      [rhs = #nvvm.mma_type<tf32>, #nvvm.wgmma_scale_in<neg>, #nvvm.mma_layout<row>]
