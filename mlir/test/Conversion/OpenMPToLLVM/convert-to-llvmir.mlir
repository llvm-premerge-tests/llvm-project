...
// CHECK: %[[MAP0:.*]] = omp.map_entry var_ptr(%[[ARG0]] : !llvm.ptr<i32>)   map_clauses(to, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
// CHECK: %[[MAP1:.*]] = omp.map_entry var_ptr(%[[ARG1]] : !llvm.ptr<i32>)   map_clauses(to, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
// CHECK: %[[MAP2:.*]] = omp.map_entry var_ptr(%[[ARG2]] : !llvm.ptr<i32>)   map_clauses(always, exit_release_or_enter_alloc, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
// CHECK: omp.target_enter_data map_entries(%[[MAP0]], %[[MAP1]], %[[MAP2]] : !llvm.ptr<i32>, !llvm.ptr<i32>, !llvm.ptr<i32>)
// CHECK: %[[MAP3:.*]] = omp.map_entry var_ptr(%[[ARG0]] : !llvm.ptr<i32>)   map_clauses(from, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
// CHECK: %[[MAP4:.*]] = omp.map_entry var_ptr(%[[ARG1]] : !llvm.ptr<i32>)   map_clauses(from, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
// CHECK: %[[MAP5:.*]] = omp.map_entry var_ptr(%[[ARG2]] : !llvm.ptr<i32>)   map_clauses(exit_release_or_enter_alloc, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
// CHECK: %[[MAP6:.*]] = omp.map_entry var_ptr(%[[ARG3]] : !llvm.ptr<i32>)   map_clauses(always, delete, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
...
llvm.func @_QPomp_target_data(%a : !llvm.ptr<i32>, %b : !llvm.ptr<i32>, %c : !llvm.ptr<i32>, %d : !llvm.ptr<i32>) {
  %0 = omp.map_entry var_ptr(%a : !llvm.ptr<i32>)   map_clauses(to, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
  %1 = omp.map_entry var_ptr(%b : !llvm.ptr<i32>)   map_clauses(to, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
  %2 = omp.map_entry var_ptr(%c : !llvm.ptr<i32>)   map_clauses(always, exit_release_or_enter_alloc, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
  omp.target_enter_data map_entries(%0, %1, %2 : !llvm.ptr<i32>, !llvm.ptr<i32>, !llvm.ptr<i32>) {}
  %3 = omp.map_entry var_ptr(%a : !llvm.ptr<i32>)   map_clauses(from, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
  %4 = omp.map_entry var_ptr(%b : !llvm.ptr<i32>)   map_clauses(from, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
  %5 = omp.map_entry var_ptr(%c : !llvm.ptr<i32>)   map_clauses(exit_release_or_enter_alloc, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
  %6 = omp.map_entry var_ptr(%d : !llvm.ptr<i32>)   map_clauses(always, delete, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
...
// CHECK: %[[MAP_0:.*]] = omp.map_entry var_ptr(%[[ARG0]] : !llvm.ptr<array<1024 x i32>>)  map_clauses(tofrom, target_param) capture(ByRef) -> !llvm.ptr<array<1024 x i32>> {name = ""}
...
llvm.func @_QPomp_target_data_region(%a : !llvm.ptr<array<1024 x i32>>, %i : !llvm.ptr<i32>) {
  %1 = omp.map_entry var_ptr(%a : !llvm.ptr<array<1024 x i32>>)   map_clauses(tofrom, target_param) capture(ByRef) -> !llvm.ptr<array<1024 x i32>> {name = ""}
...
// CHECK:           %[[MAP:.*]] = omp.map_entry var_ptr(%[[ARG_0]] : !llvm.ptr<array<1024 x i32>>)   map_clauses(tofrom, target_param) capture(ByRef) -> !llvm.ptr<array<1024 x i32>> {name = ""}
...
// CHECK: %[[MAP0:.*]] = omp.map_entry var_ptr(%[[ARG_1]] : !llvm.ptr<array<10 x i32>>)   map_clauses(tofrom, target_param) capture(ByRef) bounds(%[[BOUNDS0]]) -> !llvm.ptr<array<10 x i32>> {name = ""}
...
// CHECK: %[[MAP1:.*]] = omp.map_entry var_ptr(%[[ARG_2]] : !llvm.ptr<array<10 x i32>>)   map_clauses(tofrom, target_param) capture(ByRef) bounds(%[[BOUNDS1]]) -> !llvm.ptr<array<10 x i32>> {name = ""}
...
llvm.func @_QPtarget_map_with_bounds(%arg0: !llvm.ptr<i32>, %arg1: !llvm.ptr<array<10 x i32>>, %arg2: !llvm.ptr<array<10 x i32>>) {
  ...
  %5 = omp.map_entry var_ptr(%arg1 : !llvm.ptr<array<10 x i32>>)   map_clauses(tofrom, target_param) capture(ByRef) bounds(%4) -> !llvm.ptr<array<10 x i32>> {name = ""}
  %6 = llvm.mlir.constant(4 : index) : i64
  %7 = llvm.mlir.constant(1 : index) : i64
  %8 = llvm.mlir.constant(1 : index) : i64
  %9 = llvm.mlir.constant(1 : index) : i64
  %10 = omp.bounds   lower_bound(%7 : i64) upper_bound(%6 : i64) stride(%9 : i64) start_idx(%9 : i64)
  %11 = omp.map_entry var_ptr(%arg2 : !llvm.ptr<array<10 x i32>>)   map_clauses(tofrom, target_param) capture(ByRef) bounds(%10) -> !llvm.ptr<array<10 x i32>> {name = ""}
