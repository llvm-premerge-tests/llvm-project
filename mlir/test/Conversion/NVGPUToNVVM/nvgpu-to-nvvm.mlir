...
func.func @create_wgmma_descriptor(%tensorMap : !tensorMap) -> i64{
  ...
  %lhsShmem = memref.reinterpret_cast %dynamicMem to offset: [0], sizes: [128,64], strides: [64,1] : memref<0xf16, 3> to memref<128x64xf16,3>
    ...
    // CHECK: %[[S9:.+]] = llvm.mlir.constant(128 : i64) : i64
    ...
    // CHECK: %[[S16:.+]] = llvm.or %[[S8]], %[[S15]]  : i64
    // CHECK: %[[S17:.+]] = llvm.mlir.constant(64 : i64) : i64
    // CHECK: %[[S18:.+]] = llvm.mlir.constant(32 : i64) : i64
    // CHECK: %[[S19:.+]] = llvm.shl %[[S17]], %[[S18]]  : i64
    // CHECK: %[[S20:.+]] = llvm.or %[[S8]], %[[S19]]  : i64
    // CHECK: %[[S21:.+]] = llvm.mlir.constant(1024 : i64) : i64
    // CHECK: %[[S22:.+]] = llvm.mlir.constant(16 : i64) : i64
    // CHECK: %[[S23:.+]] = llvm.shl %[[S21]], %[[S22]]  : i64
    // CHECK: %[[S24:.+]] = llvm.or %[[S8]], %[[S23]]  : i64
