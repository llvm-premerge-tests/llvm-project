...
// CHECK-SAME:                                      %[[INPUT:.*]]: vector<16xf32>,
// CHECK-SAME:                                      %[[MASK:.*]]: vector<16xi1>) -> f32 {
// CHECK:           %[[MASK_NEUTRAL:.*]] = arith.constant dense<-1.401300e-45> : vector<16xf32>
// CHECK:           %[[MASKED:.*]] = arith.select %[[MASK]], %[[INPUT]], %[[MASK_NEUTRAL]] : vector<16xi1>, vector<16xf32>
...
// CHECK-SAME:                                      %[[INPUT:.*]]: vector<16xf32>,
// CHECK-SAME:                                      %[[MASK:.*]]: vector<16xi1>) -> f32 {
// CHECK:           %[[MASK_NEUTRAL:.*]] = arith.constant dense<3.40282347E+38> : vector<16xf32>
// CHECK:           %[[MASKED:.*]] = arith.select %[[MASK]], %[[INPUT]], %[[MASK_NEUTRAL]] : vector<16xi1>, vector<16xf32>
