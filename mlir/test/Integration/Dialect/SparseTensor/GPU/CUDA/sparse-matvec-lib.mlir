...
// RUN: %{compile} enable-runtime-library=true data-transfer-strategy=pinned-dma" | %{run}
// RUNNOT: %{compile} enable-runtime-library=true data-transfer-strategy=zero-copy"  | %{run}
//
// without RT lib (AoS COO): note, may fall back to CPU
//
// RUN: %{compile} enable-runtime-library=false"  | %{run}
// RUN: %{compile} enable-runtime-library=false data-transfer-strategy=pinned-dma" | %{run}
// RUNNOT: %{compile} enable-runtime-library=false data-transfer-strategy=zero-copy"  | %{run}
//
