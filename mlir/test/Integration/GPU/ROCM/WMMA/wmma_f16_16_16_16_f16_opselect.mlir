...
// RUN: | mlir-opt -pass-pipeline='builtin.module(gpu.module(strip-debuginfo,convert-gpu-to-rocdl{chipset=gfx1100 index-bitwidth=32 opselect=true},gpu-to-hsaco{chip=gfx1100}))' \
