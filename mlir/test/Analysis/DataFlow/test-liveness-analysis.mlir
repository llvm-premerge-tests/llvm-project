...
// where its op could take the control is a callable or has an op with memory
// effects"
...
func.func @test_4_CallOpInterface_type_1.b(%arg0: i32, %arg1: i32, %device: i32, %m0: memref<i32>) {
