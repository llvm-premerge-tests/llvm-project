...
func.func @extract_val_idx(%arg0: vector<4x8x16xf32>, %idx: index)
  ...
  // CHECK-NEXT: vector.extract %[[VEC]][%[[IDX]], %[[IDX]], %[[IDX]]] : vector<4x8x16xf32>
  %2 = vector.extract %arg0[%idx, %idx, %idx] : vector<4x8x16xf32>
...
func.func @insert_val_idx(%a: f32, %b: vector<16xf32>, %c: vector<8x16xf32>,
  ...
  // CHECK: vector.insert %[[A]], %{{.*}}[%[[IDX]], %[[IDX]], %[[IDX]]] : f32 into vector<4x8x16xf32>
  %2 = vector.insert %a, %res[%idx, %idx, %idx] : f32 into vector<4x8x16xf32>
