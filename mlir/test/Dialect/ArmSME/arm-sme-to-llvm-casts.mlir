...
// CHECK: %[[TILE_ID:.*]] = arm_sme.get_tile_id : i8
// CHECK: %[[CAST_TILE_TO_VECTOR_0:.*]] = arm_sme.cast_tile_to_vector %[[TILE_ID]] : i8 to vector<[16]x[16]xi8>
// CHECK: scf.for
// CHECK:   %[[CAST_VECTOR_TO_TILE:.*]] = arm_sme.cast_vector_to_tile %[[CAST_TILE_TO_VECTOR_0]] : vector<[16]x[16]xi8> to i8
// CHECK:   %[[TILE_ID_I32:.*]] = arith.extui %[[CAST_VECTOR_TO_TILE]] : i8 to i32
// CHECK:   "arm_sme.intr.ld1b.horiz"({{.*}}, {{.*}}, %[[TILE_ID_I32]], {{.*}}) : (vector<[16]xi1>, !llvm.ptr, i32, i32) -> ()
// CHECK: }
// CHECK: %[[CAST_TILE_TO_VECTOR_1:.*]] = arm_sme.cast_tile_to_vector %[[TILE_ID]] : i8 to vector<[16]x[16]xi8>
// CHECK: return  %[[CAST_TILE_TO_VECTOR_1]] : vector<[16]x[16]xi8>
