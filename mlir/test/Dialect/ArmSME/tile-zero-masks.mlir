...
func.func @zero_za_b() {
  ...
  // CHECK-NEXT: "arm_sme.intr.zero"(%[[ZERO_MASK]]) : (i32) -> ()
...
func.func @zero_za_h() {
  ...
  // CHECK-NEXT: "arm_sme.intr.zero"(%[[ZERO_MASK_ZA0H]]) : (i32) -> ()
...
func.func @zero_za_s() {
  ...
  // CHECK-NEXT: "arm_sme.intr.zero"(%[[ZERO_MASK_ZA0S]]) : (i32) -> ()
...
func.func @zero_za_d() {
  ...
  // CHECK-NEXT: "arm_sme.intr.zero"(%[[ZERO_MASK_ZA0D]]) : (i32) -> ()
