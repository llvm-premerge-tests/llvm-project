...
func.func @omp_target(%map1: memref<?xi32>) {
  %mapv = omp.map_entry var_ptr(%map1 : memref<?xi32>)   map_clauses(delete, target_param) capture(ByRef) -> memref<?xi32> {name = ""}
...
func.func @omp_target_enter_data(%map1: memref<?xi32>) {
  %mapv = omp.map_entry var_ptr(%map1 : memref<?xi32>)   map_clauses(from, target_param) capture(ByRef) -> memref<?xi32> {name = ""}
...
func.func @omp_target_exit_data(%map1: memref<?xi32>) {
  %mapv = omp.map_entry var_ptr(%map1 : memref<?xi32>)   map_clauses(to, target_param) capture(ByRef) -> memref<?xi32> {name = ""}
