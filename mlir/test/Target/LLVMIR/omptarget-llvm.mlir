...
llvm.func @_QPopenmp_target_data() {
  ...
  %2 = omp.map_entry var_ptr(%1 : !llvm.ptr<i32>)   map_clauses(tofrom, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
...
llvm.func @_QPopenmp_target_data_region(%1 : !llvm.ptr<array<1024 x i32>>) {
  %2 = omp.map_entry var_ptr(%1 : !llvm.ptr<array<1024 x i32>>)   map_clauses(tofrom, target_param) capture(ByRef) -> !llvm.ptr<array<1024 x i32>> {name = ""}
...
llvm.func @_QPomp_target_enter_exit(%1 : !llvm.ptr<array<1024 x i32>>, %3 : !llvm.ptr<array<512 x i32>>) {
  ...
  %map1 = omp.map_entry var_ptr(%1 : !llvm.ptr<array<1024 x i32>>)   map_clauses(to, target_param) capture(ByRef) -> !llvm.ptr<array<1024 x i32>> {name = ""}
  %map2 = omp.map_entry var_ptr(%3 : !llvm.ptr<array<512 x i32>>)   map_clauses(exit_release_or_enter_alloc, target_param) capture(ByRef) -> !llvm.ptr<array<512 x i32>> {name = ""}
  ...
  %map3 = omp.map_entry var_ptr(%1 : !llvm.ptr<array<1024 x i32>>)   map_clauses(from, target_param) capture(ByRef) -> !llvm.ptr<array<1024 x i32>> {name = ""}
  %map4 = omp.map_entry var_ptr(%3 : !llvm.ptr<array<512 x i32>>)   map_clauses(exit_release_or_enter_alloc, target_param) capture(ByRef) -> !llvm.ptr<array<512 x i32>> {name = ""}
...
llvm.func @_QPopenmp_target_use_dev_ptr() {
  ...
  %map1 = omp.map_entry var_ptr(%a : !llvm.ptr<!llvm.ptr<i32>>)   map_clauses(from, target_param) capture(ByRef) -> !llvm.ptr<!llvm.ptr<i32>> {name = ""}
...
llvm.func @_QPopenmp_target_use_dev_addr() {
  %0 = llvm.mlir.constant(1 : i64) : i64
  %a = llvm.alloca %0 x !llvm.ptr<!llvm.ptr<i32>> : (i64) -> !llvm.ptr<!llvm.ptr<i32>>
  %map = omp.map_entry var_ptr(%a : !llvm.ptr<!llvm.ptr<i32>>)   map_clauses(from, target_param) capture(ByRef) -> !llvm.ptr<!llvm.ptr<i32>> {name = ""}
...
llvm.func @_QPopenmp_target_use_dev_addr_no_ptr() {
  ...
  %map = omp.map_entry var_ptr(%a : !llvm.ptr<i32>)   map_clauses(tofrom, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
...
llvm.func @_QPopenmp_target_use_dev_addr_nomap() {
  ...
  %map = omp.map_entry var_ptr(%b : !llvm.ptr<!llvm.ptr<i32>>)   map_clauses(from, target_param) capture(ByRef) -> !llvm.ptr<!llvm.ptr<i32>> {name = ""}
  omp.target_data  map_entries(%map : !llvm.ptr<!llvm.ptr<i32>>) use_device_addr(%a : !llvm.ptr<!llvm.ptr<i32>>)  {
  ^bb0(%arg0: !llvm.ptr<!llvm.ptr<i32>>):
...
llvm.func @_QPopenmp_target_use_dev_both() {
  ...
  %1 = llvm.mlir.constant(1 : i64) : i64
  %b = llvm.alloca %0 x !llvm.ptr<!llvm.ptr<i32>> : (i64) -> !llvm.ptr<!llvm.ptr<i32>>
  %map = omp.map_entry var_ptr(%a : !llvm.ptr<!llvm.ptr<i32>>)   map_clauses(tofrom, target_param) capture(ByRef) -> !llvm.ptr<!llvm.ptr<i32>> {name = ""}
  %map1 = omp.map_entry var_ptr(%b : !llvm.ptr<!llvm.ptr<i32>>)   map_clauses(tofrom, target_param) capture(ByRef) -> !llvm.ptr<!llvm.ptr<i32>> {name = ""}
