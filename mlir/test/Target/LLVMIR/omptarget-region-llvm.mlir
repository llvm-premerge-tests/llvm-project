...
module attributes {omp.is_target_device = false} {
  llvm.func @omp_target_region_() {
    ...
    %map1 = omp.map_entry var_ptr(%3 : !llvm.ptr<i32>)   map_clauses(tofrom, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
    %map2 = omp.map_entry var_ptr(%5 : !llvm.ptr<i32>)   map_clauses(tofrom, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
    %map3 = omp.map_entry var_ptr(%7 : !llvm.ptr<i32>)   map_clauses(tofrom, target_param) capture(ByRef) -> !llvm.ptr<i32> {name = ""}
