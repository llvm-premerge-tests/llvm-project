...
// CHECK-LABEL: func.func @clean_simple_ops(%arg0: i32, %arg1: memref<i32>, %arg2: i32) -> i32 {
// CHECK-NEXT:    %0 = arith.addi %arg0, %arg0 : i32
// CHECK-NEXT:    %c1_i32 = arith.constant 1 : i32
// CHECK-NEXT:    %1 = arith.muli %0, %c1_i32 : i32
// CHECK-NEXT:    %c3_i32 = arith.constant 3 : i32
// CHECK-NEXT:    %2 = arith.addi %c3_i32, %c3_i32 : i32
// CHECK-NEXT:    memref.store %2, %arg1[] : memref<i32>
// CHECK-NEXT:    return %1 : i32
// CHECK-NEXT:  }
//
// The simple ops which don't have memory effects or live results get
// removed but %arg2 doesn't get removed from the function even though it
// isn't live because the signature of a public function is always left
// untouched.
func.func @clean_simple_ops(%arg0 : i32, %arg1 : memref<i32>, %arg2 : i32) -> (i32) {
  %0 = arith.addi %arg0, %arg0 : i32
  %c1_i32 = arith.constant 1 : i32
  %1 = arith.muli %0, %c1_i32 : i32
  %non_live_1 = arith.addi %1, %0 : i32
  %non_live_2 = arith.constant 2 : i32
  %non_live_3 = arith.subi %arg0, %non_live_1 : i32
  %c3_i32 = arith.constant 3 : i32
  %2 = arith.addi %c3_i32, %c3_i32 : i32
  memref.store %2, %arg1[] : memref<i32>
  return %1 : i32
}
...
// CHECK-LABEL: func.func @clean_region_branch_op_keep_results_and_second_region_arg_and_remove_first_region_arg(%arg0: i1, %arg1: i32, %arg2: i32) -> i32 {
// CHECK-NEXT:    %0:2 = scf.while (%arg3 = %arg2) : (i32) -> (i32, i32) {
// CHECK-NEXT:      %1 = arith.addi %arg3, %arg3 : i32
// CHECK-NEXT:      scf.condition(%arg0) %1, %arg3 : i32, i32
// CHECK-NEXT:    } do {
// CHECK-NEXT:    ^bb0(%arg3: i32, %arg4: i32):
// CHECK-NEXT:      %1 = arith.addi %arg4, %arg4 : i32
...
//
// Values kept:
//  (1) %0#1 is not live. Yet, it is kept because %arg2 forwards to it and %arg2
//  has to be kept.
//  %arg2 in `scf.condition` has to be kept because it forwards to %arg4 which
//  is live.
//
//  (2) %arg3 is not live. Yet, it is kept because %6 forwards to it, which also
//  forwards to %0#0, which is live.
//
// Values not kept:
//  (1) %1 is not kept as an operand of `scf.while` because it only forwards to
//  %arg1, which is not kept. %arg1 is not kept because only %1 and %arg4
//  forward to it, neither of them forward anywhere else and %arg1 is not live.
// Thus, %arg4 is also not kept in the `scf.yield` op.
func.func @clean_region_branch_op_keep_results_and_second_region_arg_and_remove_first_region_arg(%arg0: i1, %1: i32, %2: i32) -> (i32) {
  %0:2 = scf.while (%arg1 = %1, %arg2 = %2) : (i32, i32) -> (i32, i32) {
    %3 = arith.addi %arg1, %arg2 : i32
    %6 = arith.addi %arg2, %arg2 : i32
    scf.condition(%arg0) %6, %arg2 : i32, i32
  } do {
  ^bb0(%arg3: i32, %arg4: i32):
    %4 = arith.addi %arg3, %arg3 : i32
    %5 = arith.addi %arg4, %arg4 : i32
    scf.yield %arg4, %5 : i32, i32
  }
  return %0#0 : i32
}
