...
An example of how the compilation instructions look is:

```
mlir-opt example.mlir -o example-nvvm.mlir \
  --nvvm-attach-target='chip=sm_90 O=3'    \# Attach an NVVM target.
  --convert-gpu-to-nvvm                    \# Convert GPU to NVVM.
