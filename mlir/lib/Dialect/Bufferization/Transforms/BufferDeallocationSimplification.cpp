...
/// `retained` list can alias, for which we use a static alias analysis and, as
/// a result, this pattern cannot be applied as a regular canonicalization
/// pattern.
///
/// Example:
/// ```mlir
/// %0 = bufferization.dealloc (%m0 : ...) if (%cond0)
///                     retain (%m0, %r0, %r1 : ...)
/// ```
/// is canonicalized to
/// ```mlir
/// %0 = bufferization.dealloc retain (%m0, %r0, %r1 : ...)
/// %1 = arith.ori %0, %cond0 : i1
/// ```
