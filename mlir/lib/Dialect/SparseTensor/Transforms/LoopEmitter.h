...
public:
  ...
  // Map from [tid, lvl] to a list of dependent [tidlvl, coeffecient] for affine
  // expression index on sparse tensors.
  //
...
private:
  ...
  // The conceptual (size, stride) for each slice used for index reduction
  // loops.
