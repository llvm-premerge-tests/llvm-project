...
void LaunchFuncOp::build(OpBuilder &builder, OperationState &result,
  ...
  size_t segmentSizesLen = std::size(prop.odsOperandSegmentSizes);
  // Initialize the segment sizes to 1.
  for (auto &sz : prop.odsOperandSegmentSizes)
    sz = 1;
  prop.odsOperandSegmentSizes[0] = asyncDependencies.size();
  prop.odsOperandSegmentSizes[segmentSizesLen - 3] =
      dynamicSharedMemorySize ? 1 : 0;
  prop.odsOperandSegmentSizes[segmentSizesLen - 2] =
      static_cast<int32_t>(kernelOperands.size());
  prop.odsOperandSegmentSizes[segmentSizesLen - 1] = 0;
}
...
void LaunchFuncOp::build(OpBuilder &builder, OperationState &result,
  ...
  for (auto &sz : prop.odsOperandSegmentSizes)
    sz = 1;
  prop.odsOperandSegmentSizes[0] = 0;
  prop.odsOperandSegmentSizes[segmentSizesLen - 3] =
      dynamicSharedMemorySize ? 1 : 0;
  prop.odsOperandSegmentSizes[segmentSizesLen - 2] =
      static_cast<int32_t>(kernelOperands.size());
  prop.odsOperandSegmentSizes[segmentSizesLen - 1] = asyncObject ? 1 : 0;
}
...
void BinaryOp::build(OpBuilder &builder, OperationState &result, StringRef name,
                     OffloadingLLVMTranslationAttrInterface offloadingHandler,
                     ArrayAttr objects) {
