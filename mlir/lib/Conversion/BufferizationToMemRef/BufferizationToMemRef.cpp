...
class DeallocOpConversion
  ...
  /// new memref helper structure and passes it to the helper function generated in
  /// 'buildDeallocationHelperFunction'. The results are stored in two lists (represented as memrefs)
  /// of booleans passed as arguments. The first list stores whether the corresponding condition should be deallocated, the second list stores the
