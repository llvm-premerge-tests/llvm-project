...
public:
  ...
  // bracket, comma, newline). The lowering splits the vector into elementary
  // printing operations. The advantage of this approach is that the library can
  // remain unaware of all low-level implementation details of vectors while
  // still supporting output of any shaped and dimensioned vector.
  //
