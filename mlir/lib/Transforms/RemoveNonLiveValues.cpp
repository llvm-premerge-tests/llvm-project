...
//===----------------------------------------------------------------------===//
//
// This transformation pass optimizes the IR by removing non-live values. The
// removal of such values involves removal of extraneous operands, extraneous
// arguments, extraneous return values, and even extraneous ops, all of which
// unnecessarily increase the runtime, in theory. The pass relies on the
// information provided by the liveness analysis utility to accomplish its
// optimization goal.
//
//===----------------------------------------------------------------------===//
