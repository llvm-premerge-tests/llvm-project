...
public:
  /// Instance of `RegionBranchPoint` representing the parent operation.
  static const RegionBranchPoint parent;

  /// Creates a `RegionBranchPoint` that branches from the given region.
  /// The pointer must not be null.
  /*implicit*/ RegionBranchPoint(Region *region) : maybeRegion(region) {
    assert(region && "Region must not be null");
  }

  /*implicit*/ RegionBranchPoint(Region &region) : RegionBranchPoint(&region) {}
  ...
  /*implicit*/ RegionBranchPoint(RegionSuccessor successor) {
...
inline const RegionBranchPoint RegionBranchPoint::parent;
