...
enum class SparseDataTransferStrategy { kRegularDMA, kZeroCopy, kPinnedDMA };
...
struct SparsificationOptions {
  SparsificationOptions(SparseParallelizationStrategy p,
                        SparseDataTransferStrategy t, bool idxReduc,
                        bool gpuLibgen, bool enableRT)
      : parallelizationStrategy(p), dataTransferStrategy(t),
        enableIndexReduction(idxReduc), enableGPULibgen(gpuLibgen),
        enableRuntimeLibrary(enableRT) {}
  SparsificationOptions()
      : SparsificationOptions(SparseParallelizationStrategy::kNone,
                              SparseDataTransferStrategy::kRegularDMA, false,
                              false, true) {}
...
void populateSparseGPULibgenPatterns(
