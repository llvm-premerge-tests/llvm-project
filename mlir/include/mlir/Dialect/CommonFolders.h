...
/// which will be diectly propagated to result.
...
template <class AttrElementT,
          ...
          class CalculationT = function_ref<
              std::optional<ElementValueT>(ElementValueT, ElementValueT)>>
Attribute constFoldBinaryOpConditionalPoison(ArrayRef<Attribute> operands,
                                             CalculationT &&calculate) {
  return constFoldBinaryOpConditional<AttrElementT, ElementValueT,
                                      ub::PoisonAttr, CalculationT>(
      operands, std::forward<CalculationT>(calculate));
}
...
template <class AttrElementT,
          ...
          class CalculationT =
              function_ref<ElementValueT(ElementValueT, ElementValueT)>>
Attribute constFoldBinaryOpPoison(ArrayRef<Attribute> operands, Type resultType,
                                  CalculationT &&calculate) {
  return constFoldBinaryOp<AttrElementT, ElementValueT, ub::PoisonAttr,
                           CalculationT>(operands, resultType,
...
template <class AttrElementT,
          ...
          class CalculationT =
              function_ref<ElementValueT(ElementValueT, ElementValueT)>>
Attribute constFoldBinaryOpPoison(ArrayRef<Attribute> operands,
                                  CalculationT &&calculate) {
  return constFoldBinaryOp<AttrElementT, ElementValueT, ub::PoisonAttr,
                           CalculationT>(operands,
                                         std::forward<CalculationT>(calculate));
}
...
template <class AttrElementT,
          ...
          class CalculationT =
              function_ref<std::optional<ElementValueT>(ElementValueT)>>
Attribute constFoldUnaryOpConditionalPoison(ArrayRef<Attribute> operands,
                                            CalculationT &&calculate) {
  return constFoldUnaryOpConditional<AttrElementT, ElementValueT,
                                     ub::PoisonAttr, CalculationT>(
      operands, std::forward<CalculationT>(calculate));
}
...
template <class AttrElementT,
          class ElementValueT = typename AttrElementT::ValueType,
          class CalculationT = function_ref<ElementValueT(ElementValueT)>>
Attribute constFoldUnaryOpPoison(ArrayRef<Attribute> operands,
                                 CalculationT &&calculate) {
  return constFoldUnaryOp<AttrElementT, ElementValueT, ub::PoisonAttr,
                          CalculationT>(operands,
                                        std::forward<CalculationT>(calculate));
}
...
template <
    ...
    class TargetElementValueT = typename TargetAttrElementT::ValueType,
    class CalculationT = function_ref<TargetElementValueT(ElementValueT, bool)>>
Attribute constFoldCastOpPoison(ArrayRef<Attribute> operands, Type resType,
                                CalculationT &&calculate) {
  return constFoldCastOp<AttrElementT, TargetAttrElementT, ElementValueT,
                         TargetElementValueT, ub::PoisonAttr, CalculationT>(
