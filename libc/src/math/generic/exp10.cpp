...
Float128 exp10_f128(double x, double kd, int idx1, int idx2) {
  ...
  // std::cout << "  Super slow pass: \n"
  //           << "    k: " << kd << "\n"
  //           << "   t1: " << std::hexfloat << t1 << std::defaultfloat << "\n"
  //           << "   t2: " << std::hexfloat << t2 << std::defaultfloat << "\n"
  //           << "   t3: " << std::hexfloat << t3 << std::defaultfloat << "\n"
  //           << "   dx: " << (dx.sign ? "-(" : "(") << dx.mantissa.val[1] << "
  //           * 2^64 + " << dx.mantissa.val[0] << ") * 2^(" << dx.exponent <<
  //           ") \n"
  //           << "   hm: " << (exp_mid.sign ? "-(" : "(") <<
  //           exp_mid.mantissa.val[1] << " * 2^64 + " <<
  //           exp_mid.mantissa.val[0] << ") * 2^(" << exp_mid.exponent << ")
  //           \n"
  //           << "    p: " << (p.sign ? "-(" : "(") << p.mantissa.val[1] << " *
  //           2^64 + " << p.mantissa.val[0] << ") * 2^(" << p.exponent << ")
  //           \n"
  //           << "    r: " << (r.sign ? "-(" : "(") << r.mantissa.val[1] << " *
  //           2^64 + " << r.mantissa.val[0] << ") * 2^(" << r.exponent << ")
  //           \n"
  //           << std::endl;
...
DoubleDouble exp10_double_double(double x, double kd,
  ...
  // std::cout << "  Slow pass: \n"
  //           << " dx_h: " << std::hexfloat << dx.hi << std::defaultfloat <<
  //           "\n"
  //           << " dx_l: " << std::hexfloat << dx.lo << std::defaultfloat <<
  //           "\n"
  //           << "  p_h: " << std::hexfloat << p.hi << std::defaultfloat <<
  //           "\n"
  //           << "  p_l: " << std::hexfloat << p.lo << std::defaultfloat <<
  //           "\n"
  //           << "  r_h: " << std::hexfloat << r.hi << std::defaultfloat <<
  //           "\n"
  //           << "  r_l: " << std::hexfloat << r.lo << std::defaultfloat <<
  //           "\n"
  //           << std::endl;
...
LLVM_LIBC_FUNCTION(double, exp10, (double x)) {
  ...
  //           << " mh_h: " << std::hexfloat << exp_mid.hi << std::defaultfloat
  //           << "\n"
  ...
  // Exact outputs when x = 1, 2, ..., 22.
  // Quick check mask: 0x800f'ffffU = ~(bits of 1.0 | ... | bits of 22.0)
